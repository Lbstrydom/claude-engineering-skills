...
**4 active · 126 terminal · 22 audit summaries · 4 reference docs**
...
| [Observed-Graph Coverage Honesty](./observed-graph-coverage-honesty.md) | `Draft` | audited, gate closed by decision (see Audit Trail |
