...
**8 active · 127 terminal · 22 audit summaries · 4 reference docs**
...
| [Egress secret coverage — the two layers are not independent](./egress-secret-coverage-gap.md) | `Draft` |  |
