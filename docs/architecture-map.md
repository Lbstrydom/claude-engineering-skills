...
- Generated: 2026-07-17T04:47:54.319Z   commit: 530a2b285163   refresh_id: ac42150a-1f5a-4837-957b-9012809019d5
- Drift score: 28 / threshold 20   status: `RED`
- Domains: 23   Symbols: 3187   Layering violations: 0
...
> Orchestrates multi-stage audit execution by spawning GPT and Gemini review subprocesses, managing session IDs and transient artifacts (preimage worktrees, temp files), and parsing audit results.
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L3014) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 3014-3122 | Assembles audit context including plan content, project overview, history, and pass/scope configuration. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L243) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 243-254 | Writes a single pass result to the cache directory atomically with error logging. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L256) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 256-261 | Caches multiple pass results and logs the cache directory path. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L263) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 263-266 | Removes the temporary audit cache directory with retry logic. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L369) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 369-417 | Selects the smallest audit unit to warm OpenAI's prefix cache before parallel execution. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L991) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 991-1061 | Converts architecture report violations (forbidden edges, unmapped files) into structured Finding objects. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L923) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 923-972 | Formats architectural violations into prompt text with clustering and aggregation for large violation sets. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L233) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 233-241 | Initializes a temporary cache directory for storing audit pass results to survive crashes. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L270) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 270-272 | Normalizes findings using a semantic ID. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L796) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 796-818 | Converts an orphan-introduced detection into standard Finding schema with severity and recommendation. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L651) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 651-786 | Audits domain boundaries against declared architecture intent and reports violations/unmapped files. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1091) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1091-2978 | Main orchestrator for multi-pass GPT code audit with result caching, adjudication ledger, and cloud sync. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L451) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 451-633 | Orchestrates map-reduce audit: fans out files to parallel GPT units, reduces findings with optional cache seed. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L422) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 422-449 | Runs GPT audit on one code unit with concurrency slot management and pass/fail retry logic. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L837) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 837-916 | Detects files unreachable from the call graph in the changed diff and emits structured findings. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L174) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 174-178 | Decides whether to split code audit into map-reduce based on file count and character threshold. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L185) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 185-189 | Decides whether high-reasoning audit should use map-reduce based on stricter file/character limits. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L352) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 352-358 | Re-throws configuration errors from settled promises to surface programmer bugs early. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L292) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 292-324 | Validates the adjudication ledger exists, parses correctly, and counts valid entries for R2+ audits. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`buildPreExistingDebtEntry`](../scripts/lib/audit/tiered-pipeline.mjs#L368) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 368-389 | Converts a pre-existing independent finding into a debt ledger entry marked as out-of-scope. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`buildStage0RelevanceContext`](../scripts/lib/audit/tiered-pipeline.mjs#L286) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 286-324 | Pre-populates caches of file content, git history, and import impact for Stage 0 analysis. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`buildStage1TriagerPrompt`](../scripts/lib/audit/tiered-pipeline.mjs#L163) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 163-174 | Constructs a prompt for cheap-model triage with evidence blocks for commission or omission findings. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`collectCandidateAnchorFiles`](../scripts/lib/audit/tiered-pipeline.mjs#L248) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 248-264 | Extracts all file paths referenced by finding anchors across envelopes and alternatives. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`defaultTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L188) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 188-201 | Calls GPT to triage a finding using a deterministic dismissal decision. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`extractCanonicalAnchorFile`](../scripts/lib/audit/tiered-pipeline.mjs#L353) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 353-358 | Extracts the file path from a finding's canonical anchor, choosing between base and new side. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`makeBlameAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L334) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 334-344 | Returns a closure that checks whether a quoted text existed at a given line range in a prior commit. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`makeHeadContentAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L326) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 326-328 | Returns a closure that looks up current HEAD file content from the Stage 0 cache. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`makeImpactAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L330) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 330-332 | Returns a closure that looks up import impact data from the Stage 0 cache. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeModifiedAnchorPaths`](../scripts/lib/audit/tiered-pipeline.mjs#L133) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 133-149 | Fills in missing oldFile/newFile paths in audit findings to prevent downstream failures. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`routePreExistingIndependent`](../scripts/lib/audit/tiered-pipeline.mjs#L404) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 404-448 | Attempts to write pre-existing independent findings to the debt ledger, returning eligible candidates if write fails. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`runTieredAuditPipeline`](../scripts/lib/audit/tiered-pipeline.mjs#L454) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 454-968 | Executes the full tiered audit discovery and adjudication pipeline with Stage 0, 1, 2, and final decision phases. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`TieredUnavailableError`](../scripts/lib/audit/tiered-pipeline.mjs#L97) | class | `scripts/lib/audit/tiered-pipeline.mjs` | 97-103 | An exception class for signaling that a required tiered pipeline generator or resource is not available. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
| [`validatedTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L215) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 215-238 | Calls a validated/OSS triager model and rethrows on failure rather than returning null. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/openai-audit.mjs` |
...
> Builds and validates skill manifests by enumerating files, computing content hashes, and extracting metadata; verifies installation freshness by comparing bundle versions; orchestrates syncing skills to consumer repos with conflict detection.
...
_Domain has 158 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`buildCopilotMergeWrite`](../scripts/install-skills.mjs#L275) | function | `scripts/install-skills.mjs` | 275-288 | Merges the Copilot instructions block into .github/copilot-instructions.md and returns the write record. | _(internal)_ |
| [`buildSkillWrites`](../scripts/install-skills.mjs#L243) | function | `scripts/install-skills.mjs` | 243-273 | Generates the file writes for installing a skill, validating content hashes against the manifest. | _(internal)_ |
| [`checkConflicts`](../scripts/install-skills.mjs#L303) | function | `scripts/install-skills.mjs` | 303-315 | Detects conflicts between new writes and existing files, handling both repo and global scopes. | _(internal)_ |
| [`computeDeletes`](../scripts/install-skills.mjs#L290) | function | `scripts/install-skills.mjs` | 290-301 | Determines which previously-installed files should be deleted based on the new install set. | _(internal)_ |
| [`expandSkillFiles`](../scripts/install-skills.mjs#L115) | function | `scripts/install-skills.mjs` | 115-121 | Normalizes a skill's file metadata, defaulting to SKILL.md for backwards compatibility. | _(internal)_ |
| [`fileShaShort`](../scripts/install-skills.mjs#L123) | function | `scripts/install-skills.mjs` | 123-125 | Computes the first 12 hex characters of a buffer's SHA-256 hash. | _(internal)_ |
| [`loadManifest`](../scripts/install-skills.mjs#L85) | function | `scripts/install-skills.mjs` | 85-108 | Reads and validates the skills manifest JSON, checking schema version compatibility. | _(internal)_ |
| [`main`](../scripts/install-skills.mjs#L329) | function | `scripts/install-skills.mjs` | 329-423 | Orchestrates the full install workflow: parse, load manifest, build writes, detect conflicts, execute. | _(internal)_ |
| [`maybeWarnGithubSkillsDeprecation`](../scripts/install-skills.mjs#L231) | function | `scripts/install-skills.mjs` | 231-241 | Warns if .github/skills/ exists and the user hasn't opted to keep it. | _(internal)_ |
| [`parseArgs`](../scripts/install-skills.mjs#L57) | function | `scripts/install-skills.mjs` | 57-79 | Parses command-line arguments for the installer with defaults and flag handling. | _(internal)_ |
| [`printBanner`](../scripts/install-skills.mjs#L142) | function | `scripts/install-skills.mjs` | 142-150 | Prints the installer header with mode, surface, and repository information. | _(internal)_ |
| [`reconcileJournals`](../scripts/install-skills.mjs#L163) | function | `scripts/install-skills.mjs` | 163-198 | Recovers from crashed install transactions in both repo-local and global journal locations. | _(internal)_ |
| [`reportDegradations`](../scripts/install-skills.mjs#L211) | function | `scripts/install-skills.mjs` | 211-229 | Logs filesystem fsync failures to stderr, distinguishing capability limits from real I/O errors. | _(internal)_ |
| [`validateTarget`](../scripts/install-skills.mjs#L129) | function | `scripts/install-skills.mjs` | 129-140 | Validates that a target directory exists and has git or package.json markers. | _(internal)_ |
| [`writeReceiptsByScope`](../scripts/install-skills.mjs#L317) | function | `scripts/install-skills.mjs` | 317-327 | Writes install receipts separately for repo-scoped and global-scoped managed files. | _(internal)_ |
...
> CLI entry points and orchestration for the 15-skill development quality bundle (planning, code audit, UX testing, shipping); handles multi-pass LLM-audit execution, architecture indexing and symbol memory, learning store sync, and Postgres persistence.
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L59) | function | `scripts/lib/file-io.mjs` | 59-61 | Write file atomically with optional permission bits. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
| [`atomicWriteFileSyncImpl`](../scripts/lib/file-io.mjs#L23) | function | `scripts/lib/file-io.mjs` | 23-57 | Write a file atomically via temp file + rename, preserving symlinks and optional permission bits. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L72) | function | `scripts/lib/file-io.mjs` | 72-76 | Normalize paths to lowercase, forward-slash format relative to cwd for case-insensitive comparison. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-95 | Read file contents or exit the process with error if not found. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L81) | function | `scripts/lib/file-io.mjs` | 81-84 | Parse a string to integer with safe fallback value. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L105) | function | `scripts/lib/file-io.mjs` | 105-116 | Persist results as JSON to a file or stdout depending on --out flag. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +66 more |
...
| [`clampToJsonSchemaLimits`](../scripts/lib/schemas.mjs#L414) | function | `scripts/lib/schemas.mjs` | 414-439 | Truncates string/array values to JSON schema maxLength/maxItems bounds (preserving enum values). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L746) | function | `scripts/lib/schemas.mjs` | 746-762 | Validates that deferred findings include required fields based on deferredReason type (Zod custom check). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L250) | function | `scripts/lib/schemas.mjs` | 250-260 | Validates and normalizes finding evidence structure (commission with anchor, or omission with trigger+chain). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L355) | function | `scripts/lib/schemas.mjs` | 355-372 | Recursively removes Gemini-unsupported JSON schema properties (description, examples, etc.). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L381) | function | `scripts/lib/schemas.mjs` | 381-384 | Converts a Zod schema to Gemini-compatible JSON schema via toJSONSchema and cleanup. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
...
| [`assertEgressSafe`](../scripts/lib/sensitive-egress-gate.mjs#L151) | function | `scripts/lib/sensitive-egress-gate.mjs` | 151-161 | Throws if payload contains secrets; gates before sending to external providers. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +17 more |
| [`containsSecrets`](../scripts/lib/sensitive-egress-gate.mjs#L58) | function | `scripts/lib/sensitive-egress-gate.mjs` | 58-68 | Detects if text body contains secret patterns. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +17 more |
...
| [`isExtensionAllowlisted`](../scripts/lib/sensitive-egress-gate.mjs#L47) | function | `scripts/lib/sensitive-egress-gate.mjs` | 47-51 | Checks if a file extension is on the egress allowlist. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +17 more |
| [`isPathSensitive`](../scripts/lib/sensitive-egress-gate.mjs#L38) | function | `scripts/lib/sensitive-egress-gate.mjs` | 38-40 | Checks if a file path matches the sensitive-path denylist. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +17 more |
...
> Covers ~450 unit tests for deterministic seams (schemas, VCS, file-I/O, sync contracts), consumer-repo isolation + relocation, sensitive-path egress gates, and parser validation for code/SQL/markdown fixtures.
...
_Domain has 446 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
