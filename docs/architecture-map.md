...
- Generated: 2026-07-15T15:39:25.817Z   commit: 984479a8d066   refresh_id: 6a03e2e7-5612-4465-8c23-6704fc0d7b6d
- Drift score: 24 / threshold 20   status: `RED`
...
> CLI entry points for 8 AI-pair-programming skills (plan, audit-code/plan, ux-lock, persona-test, click-test, nav-audit, visual-audit, ship), backed by library modules (`scripts/lib/**`) for LLM orchestration, Postgres persistence, architecture indexing, consumer sync distribution, and learning-system telemetry.
...
> Shared library modules providing infrastructure for CLI scripts: Anthropic client factory with backend routing (SDK or CLI adapter), recursive secret redaction for API payloads, configuration resolution, and formatting utilities for markdown output and worksheets.
...
| [`insertRefreshRun`](../tests/symbol-index-drift-justification.test.mjs#L30) | function | `tests/symbol-index-drift-justification.test.mjs` | 30-36 | Inserts a symbol-index refresh run record and returns its ID. | _(internal)_ |
| [`makeSymbol`](../tests/symbol-index-drift-justification.test.mjs#L38) | function | `tests/symbol-index-drift-justification.test.mjs` | 38-45 | Records a symbol definition and index entry, returning the definition ID. | _(internal)_ |
