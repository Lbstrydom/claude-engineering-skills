...
- Generated: 2026-06-15T15:24:35.994Z   commit: 6b4c222466d0   refresh_id: 499b95a9-13bd-4228-8977-d0a2cd32019f
- Drift score: 27 / threshold 20   status: `RED`
- Domains: 22   Symbols: 2071   Layering violations: 0
...
- [cross-skill-bridge](#cross-skill-bridge) — 57 symbols
- [dashboard](#dashboard) — 98 symbols
...
- [scripts](#scripts) — 187 symbols
- [shared-lib](#shared-lib) — 605 symbols
- [stores](#stores) — 132 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 277 symbols
...
> The `audit-orchestration` domain orchestrates automated security audits by sequencing OpenAI and Gemini analyses, executing them with timeouts, parsing results, and determining convergence when findings drop below severity thresholds.
...
> The `cross-skill-bridge` domain provides CLI argument parsing, git introspection, and learning plan/witness management operations that integrate local repository context with cloud-based skill tracking and candidate spec queries.
...
_Domain has 57 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`argOption`](../scripts/cross-skill.mjs#L114) | function | `scripts/cross-skill.mjs` | 114-118 | Retrieves the value of a named CLI option flag (e.g., --port value). | _(internal)_ |
| [`cmdAbortRefreshRun`](../scripts/cross-skill.mjs#L939) | function | `scripts/cross-skill.mjs` | 939-949 | Cancels an in-progress refresh run with an optional reason. | _(internal)_ |
| [`cmdAddPersona`](../scripts/cross-skill.mjs#L530) | function | `scripts/cross-skill.mjs` | 530-542 | Creates or updates a persona identity for an application in cloud storage. | _(internal)_ |
| [`cmdAuditEffectiveness`](../scripts/cross-skill.mjs#L466) | function | `scripts/cross-skill.mjs` | 466-473 | Fetches a single security fix record by repository ID from cloud storage. | _(internal)_ |
| [`cmdComputeDriftScore`](../scripts/cross-skill.mjs#L1043) | function | `scripts/cross-skill.mjs` | 1043-1054 | Computes a code drift score comparing repository state across refresh runs. | _(internal)_ |
| [`cmdComputeTargetDomains`](../scripts/cross-skill.mjs#L798) | function | `scripts/cross-skill.mjs` | 798-810 | Tags source files with security domain classifications and returns violation counts. | _(internal)_ |
| [`cmdDetectStack`](../scripts/cross-skill.mjs#L711) | function | `scripts/cross-skill.mjs` | 711-728 | Detects the technology stack and environment manager of a repository. | _(internal)_ |
| [`cmdFinalReviewAdjudicate`](../scripts/cross-skill.mjs#L486) | function | `scripts/cross-skill.mjs` | 486-500 | Records user acceptance or dismissal of a security finding in cloud storage. | _(internal)_ |
| [`cmdFinalReviewStats`](../scripts/cross-skill.mjs#L477) | function | `scripts/cross-skill.mjs` | 477-484 | Retrieves final review statistics for a repository with optional queue limiting. | _(internal)_ |
| [`cmdFrictionLog`](../scripts/cross-skill.mjs#L1168) | function | `scripts/cross-skill.mjs` | 1168-1173 | Executes friction log analysis to identify process bottlenecks or warnings. | _(internal)_ |
| [`cmdGetActiveRefreshId`](../scripts/cross-skill.mjs#L748) | function | `scripts/cross-skill.mjs` | 748-764 | Retrieves the active snapshot refresh ID and embedding dimensions for a repository. | _(internal)_ |
| [`cmdGetCallersForFile`](../scripts/cross-skill.mjs#L812) | function | `scripts/cross-skill.mjs` | 812-875 | Fetches callers and domains that import a given symbol using the import graph. | _(internal)_ |
| [`cmdGetIncidentNeighbourhood`](../scripts/cross-skill.mjs#L766) | function | `scripts/cross-skill.mjs` | 766-796 | Queries semantically similar code locations from a repository's security memory. | _(internal)_ |
| [`cmdGetNeighbourhood`](../scripts/cross-skill.mjs#L877) | function | `scripts/cross-skill.mjs` | 877-905 | Retrieves neighboring code elements related to a given symbol with truncation handling. | _(internal)_ |
| [`cmdGetPersonaSessionsByRepo`](../scripts/cross-skill.mjs#L610) | function | `scripts/cross-skill.mjs` | 610-638 | Queries audit findings for a repository with optional filtering by limit and priority. | _(internal)_ |
| [`cmdGetPersonaSessionsByUrl`](../scripts/cross-skill.mjs#L683) | function | `scripts/cross-skill.mjs` | 683-709 | Lists personas and their metadata for a specific application URL from cloud. | _(internal)_ |
| [`cmdGetRecentFindings`](../scripts/cross-skill.mjs#L645) | function | `scripts/cross-skill.mjs` | 645-675 | Fetches enriched security findings for a repository with optional severity filtering. | _(internal)_ |
| [`cmdLearningBackfillOutcomes`](../scripts/cross-skill.mjs#L1152) | function | `scripts/cross-skill.mjs` | 1152-1162 | Backfills missing decision outcomes and optionally rebuilds learning statistics. | _(internal)_ |
| [`cmdLearningQuickfixStats`](../scripts/cross-skill.mjs#L1195) | function | `scripts/cross-skill.mjs` | 1195-1221 | Manages quickfix pattern statistics, supporting rebuild or cache-read operations. | _(internal)_ |
| [`cmdLearningRecord`](../scripts/cross-skill.mjs#L1071) | function | `scripts/cross-skill.mjs` | 1071-1110 | Records a learning decision (accept/reject) with context and outcome for audit training. | _(internal)_ |
| [`cmdLearningReplay`](../scripts/cross-skill.mjs#L1180) | function | `scripts/cross-skill.mjs` | 1180-1188 | Replays learning decisions to validate or re-run historical audit scenarios. | _(internal)_ |
| [`cmdLearningStats`](../scripts/cross-skill.mjs#L1117) | function | `scripts/cross-skill.mjs` | 1117-1128 | Retrieves learning decision statistics and pattern counts for a repository. | _(internal)_ |
| [`cmdLearningWeeklyReview`](../scripts/cross-skill.mjs#L1136) | function | `scripts/cross-skill.mjs` | 1136-1144 | Runs a weekly review of learning decisions and generates a summary report. | _(internal)_ |
| [`cmdListConsistencyCandidates`](../scripts/cross-skill.mjs#L272) | function | `scripts/cross-skill.mjs` | 272-285 | Queries recent candidate specs for a repo since a timestamp with optional result limit. | _(internal)_ |
| [`cmdListLayeringViolationsForSnapshot`](../scripts/cross-skill.mjs#L1030) | function | `scripts/cross-skill.mjs` | 1030-1041 | Fetches all violations recorded in a specific refresh run. | _(internal)_ |
| [`cmdListPersonas`](../scripts/cross-skill.mjs#L508) | function | `scripts/cross-skill.mjs` | 508-519 | Lists personas configured for a given app URL from cloud storage. | _(internal)_ |
| [`cmdListPersonaTestCandidates`](../scripts/cross-skill.mjs#L325) | function | `scripts/cross-skill.mjs` | 325-337 | Queries regressions for a repo by age, occurrence count, and severity floor thresholds. | _(internal)_ |
| [`cmdListSymbolsForSnapshot`](../scripts/cross-skill.mjs#L1017) | function | `scripts/cross-skill.mjs` | 1017-1028 | Lists all symbol definitions recorded in a specific refresh run. | _(internal)_ |
| [`cmdListUnlockedFixes`](../scripts/cross-skill.mjs#L458) | function | `scripts/cross-skill.mjs` | 458-464 | Retrieves unlocked security fixes from cloud storage for a given repository. | _(internal)_ |
| [`cmdMarkPersonaTestCandidateProposed`](../scripts/cross-skill.mjs#L339) | function | `scripts/cross-skill.mjs` | 339-351 | Marks a regression as resolved by deleting it from the learning store. | _(internal)_ |
| [`cmdOpenRefreshRun`](../scripts/cross-skill.mjs#L907) | function | `scripts/cross-skill.mjs` | 907-925 | Opens a new refresh run to begin indexing a repository's codebase. | _(internal)_ |
| [`cmdPlanSatisfaction`](../scripts/cross-skill.mjs#L423) | function | `scripts/cross-skill.mjs` | 423-433 | Retrieves satisfaction metrics for a plan and its list of persistent (recurring) test failures. | _(internal)_ |
| [`cmdPromoteRegressionSpec`](../scripts/cross-skill.mjs#L287) | function | `scripts/cross-skill.mjs` | 287-300 | Promotes a candidate spec to locked status with promotion metadata and optional phase transition. | _(internal)_ |
| [`cmdPublishRefreshRun`](../scripts/cross-skill.mjs#L927) | function | `scripts/cross-skill.mjs` | 927-937 | Publishes a completed refresh run to make it active for queries. | _(internal)_ |
| [`cmdRecordCorrelation`](../scripts/cross-skill.mjs#L371) | function | `scripts/cross-skill.mjs` | 371-388 | Correlates a persona finding with an audit finding, storing the match score and rationale. | _(internal)_ |
| [`cmdRecordLayeringViolations`](../scripts/cross-skill.mjs#L991) | function | `scripts/cross-skill.mjs` | 991-1003 | Records security constraint violations detected during a refresh run. | _(internal)_ |
| [`cmdRecordPersonaSession`](../scripts/cross-skill.mjs#L567) | function | `scripts/cross-skill.mjs` | 567-592 | Registers a new learning session with optional repository resolution and returns a session ID. | _(internal)_ |
| [`cmdRecordPlanVerifyItems`](../scripts/cross-skill.mjs#L412) | function | `scripts/cross-skill.mjs` | 412-421 | Batch inserts detailed test result items (pass/fail/skip) into a consistency-test run. | _(internal)_ |
| [`cmdRecordPlanVerifyRun`](../scripts/cross-skill.mjs#L390) | function | `scripts/cross-skill.mjs` | 390-410 | Creates a consistency-test run record tied to a plan, tracking test criteria counts and duration. | _(internal)_ |
| [`cmdRecordRegressionSpec`](../scripts/cross-skill.mjs#L202) | function | `scripts/cross-skill.mjs` | 202-270 | Records a witness finding with pre-egress redaction of sensitive fields (witnessSnapshot, evidence, journeyContext) for candidate/locked source kinds. | _(internal)_ |
| [`cmdRecordRegressionSpecRun`](../scripts/cross-skill.mjs#L353) | function | `scripts/cross-skill.mjs` | 353-369 | Records a spec validation run with pass/fail status, optional error message, and test duration. | _(internal)_ |
| [`cmdRecordShipEvent`](../scripts/cross-skill.mjs#L435) | function | `scripts/cross-skill.mjs` | 435-456 | Records a ship event with outcome, blocking reasons, open issue counts, and deployment context. | _(internal)_ |
| [`cmdRecordSymbolDefinitions`](../scripts/cross-skill.mjs#L951) | function | `scripts/cross-skill.mjs` | 951-961 | Resolves definition symbols to their canonical database IDs for a repository. | _(internal)_ |
| [`cmdRecordSymbolEmbedding`](../scripts/cross-skill.mjs#L977) | function | `scripts/cross-skill.mjs` | 977-989 | Stores vector embeddings for code definitions in the learning store. | _(internal)_ |
| [`cmdRecordSymbolIndex`](../scripts/cross-skill.mjs#L963) | function | `scripts/cross-skill.mjs` | 963-975 | Records symbol index rows (definitions, exports, imports) from a refresh run. | _(internal)_ |
| [`cmdResolveRepoIdentity`](../scripts/cross-skill.mjs#L1056) | function | `scripts/cross-skill.mjs` | 1056-1062 | Resolves and optionally persists a repository's stable UUID identity. | _(internal)_ |
| [`cmdSetActiveEmbeddingModel`](../scripts/cross-skill.mjs#L1005) | function | `scripts/cross-skill.mjs` | 1005-1015 | Marks an embedding model and dimension as active for a repository. | _(internal)_ |
| [`cmdUpdatePlanStatus`](../scripts/cross-skill.mjs#L193) | function | `scripts/cross-skill.mjs` | 193-200 | Updates an existing plan's status field in the learning store. | _(internal)_ |
| [`cmdUpsertPersonaTestCandidate`](../scripts/cross-skill.mjs#L304) | function | `scripts/cross-skill.mjs` | 304-323 | Records or updates a canary regression occurrence, tracking first/last seen timestamps and severity across occurrences. | _(internal)_ |
| [`cmdUpsertPlan`](../scripts/cross-skill.mjs#L175) | function | `scripts/cross-skill.mjs` | 175-191 | Upserts a learning plan with path, skill, status, and metadata, returning the plan ID if cloud is enabled. | _(internal)_ |
| [`cmdWhoami`](../scripts/cross-skill.mjs#L730) | function | `scripts/cross-skill.mjs` | 730-744 | Returns current authentication status, cloud enablement, and repository metadata. | _(internal)_ |
| [`currentBranch`](../scripts/cross-skill.mjs#L139) | function | `scripts/cross-skill.mjs` | 139-144 | Returns the current git branch name, or null if git fails. | _(internal)_ |
| [`currentCommitSha`](../scripts/cross-skill.mjs#L132) | function | `scripts/cross-skill.mjs` | 132-137 | Returns the current git HEAD commit SHA, or null if git fails. | _(internal)_ |
| [`emitError`](../scripts/cross-skill.mjs#L125) | function | `scripts/cross-skill.mjs` | 125-128 | Emits an error JSON response and exits with the specified code. | _(internal)_ |
| [`main`](../scripts/cross-skill.mjs#L1284) | function | `scripts/cross-skill.mjs` | 1284-1308 | Main dispatcher that routes subcommands to their handlers with error propagation. | _(internal)_ |
| [`parsePayload`](../scripts/cross-skill.mjs#L97) | function | `scripts/cross-skill.mjs` | 97-112 | Parses JSON payload from CLI arguments via --json flag, --stdin, or bare JSON in last arg position. | _(internal)_ |
| [`resolveRepoId`](../scripts/cross-skill.mjs#L160) | function | `scripts/cross-skill.mjs` | 160-171 | Resolves a repo ID from explicit payload repoId/repoUuid or by querying the canonical repo for the current directory. | _(internal)_ |

---

## dashboard

> The `dashboard` domain builds and serves HTML dashboards from audit data, reference metadata, and telemetry, handling git provenance tracking, data source degradation detection, and atomic file writes across multiple dashboard pages.
...
subgraph dom_dashboard ["dashboard"]
  ...
  file_scripts_lib_dashboard_audit_run_presente --> sym_scripts_lib_dashboard_audit_run_presente
  file_scripts_lib_dashboard_collect_audit_run_["scripts/lib/dashboard/collect-audit-run.mjs"]:::component
  sym_scripts_lib_dashboard_collect_audit_run_["coerceMeta"]:::symbol
  file_scripts_lib_dashboard_collect_audit_run_ --> sym_scripts_lib_dashboard_collect_audit_run_
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
_Domain has 98 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`collectArchitecture`](../scripts/lib/dashboard/collect-reference.mjs#L284) | function | `scripts/lib/dashboard/collect-reference.mjs` | 284-325 | Extracts architecture domains from the ## Contents block of docs/architecture-map.md and collects per-domain summaries and symbol counts. | `scripts/build-dashboard.mjs` |
| [`collectFlows`](../scripts/lib/dashboard/collect-reference.mjs#L338) | function | `scripts/lib/dashboard/collect-reference.mjs` | 338-365 | Loads and validates flows.json against a schema, cross-checking flow node skills against available skill names. | `scripts/build-dashboard.mjs` |
| [`collectReference`](../scripts/lib/dashboard/collect-reference.mjs#L372) | function | `scripts/lib/dashboard/collect-reference.mjs` | 372-474 | Discovers and collects skills, plans, domains, flows, and requirements from the repository, returning a consolidated reference with status for each source. | `scripts/build-dashboard.mjs` |
| [`discoverPlans`](../scripts/lib/dashboard/collect-reference.mjs#L45) | function | `scripts/lib/dashboard/collect-reference.mjs` | 45-124 | Discovers plan markdown files in active and completed directories, extracts metadata from front-matter, and returns an index. | `scripts/build-dashboard.mjs` |
| [`readDomainDeps`](../scripts/lib/dashboard/collect-reference.mjs#L223) | function | `scripts/lib/dashboard/collect-reference.mjs` | 223-243 | Reads and merges observed domain dependencies from envelope with manually configured dependencies, returning flattened and source-tracked results. | `scripts/build-dashboard.mjs` |
| [`readManualAllowedDeps`](../scripts/lib/dashboard/collect-reference.mjs#L178) | function | `scripts/lib/dashboard/collect-reference.mjs` | 178-203 | Loads and parses the domain-map.json file to extract allowed dependencies for manual layer configuration. | `scripts/build-dashboard.mjs` |
| [`readObservedEnvelope`](../scripts/lib/dashboard/collect-reference.mjs#L135) | function | `scripts/lib/dashboard/collect-reference.mjs` | 135-164 | Loads and validates an observed dependencies envelope from disk, checking its rule digest against the current domain-map, falling back to manual config if stale. | `scripts/build-dashboard.mjs` |
| [`readRequirementsLedger`](../scripts/lib/dashboard/collect-reference.mjs#L255) | function | `scripts/lib/dashboard/collect-reference.mjs` | 255-273 | Reads and parses the requirements ledger from .requirements/ledger.json, returning structured requirements with metadata about ledger presence. | `scripts/build-dashboard.mjs` |
| [`aggregatePasses`](../scripts/lib/dashboard/collect-telemetry.mjs#L34) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 34-46 | Aggregates pass statistics by pass name, summing run counts and finding metrics across multiple pass executions. | `scripts/build-dashboard.mjs` |
| [`attributeHighByFile`](../scripts/lib/dashboard/collect-telemetry.mjs#L441) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 441-458 | Attributes high-severity findings to purposes by mapping file paths to domains and deduplicating findings across multi-purpose domains. | `scripts/build-dashboard.mjs` |
| [`canonicalRepoId`](../scripts/lib/dashboard/collect-telemetry.mjs#L213) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 213-216 | Resolves the canonical repo ID by UUID for cloud operations, returning null on failure. | `scripts/build-dashboard.mjs` |
| [`classifyPurposeBadges`](../scripts/lib/dashboard/collect-telemetry.mjs#L465) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 465-494 | Maps purposes to health status badges based on high-severity finding attribution and refused-secret signals. | `scripts/build-dashboard.mjs` |
| [`collectAuditEffectiveness`](../scripts/lib/dashboard/collect-telemetry.mjs#L252) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 252-280 | Fetches effectiveness metrics from cloud (confirmed hits, false positives, recall/precision) and flags empty state when no correlations exist. | `scripts/build-dashboard.mjs` |
| [`collectAuditRuns`](../scripts/lib/dashboard/collect-telemetry.mjs#L57) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 57-96 | Fetches audit run telemetry from cloud (when available) and local metrics, returning aggregated pass statistics and labeled run counts. | `scripts/build-dashboard.mjs` |
| [`collectLearning`](../scripts/lib/dashboard/collect-telemetry.mjs#L153) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 153-173 | Fetches learning statistics from cloud using the canonical repo ID or repo name, returning pending triage and cluster counts. | `scripts/build-dashboard.mjs` |
| [`collectPromptVariants`](../scripts/lib/dashboard/collect-telemetry.mjs#L180) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 180-210 | Loads bandit multi-armed bandit arms from cloud, calculating success means and sorting by pull count. | `scripts/build-dashboard.mjs` |
| [`collectPurposeHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L352) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 352-429 | Loads purpose taxonomy from domain-map.json and fetches cloud health metrics, attributing high-severity findings to purposes via domain mapping. | `scripts/build-dashboard.mjs` |
| [`collectRequirements`](../scripts/lib/dashboard/collect-telemetry.mjs#L99) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 99-140 | Reads the requirements ledger and returns structured requirement items with metadata about presence and active count. | `scripts/build-dashboard.mjs` |
| [`collectSecurity`](../scripts/lib/dashboard/collect-telemetry.mjs#L314) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 314-329 | Resolves the canonical repo ID and queries security incident stats, returning formatted results or empty state on error. | `scripts/build-dashboard.mjs` |
| [`collectShipHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L219) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 219-244 | Queries and returns ship event telemetry grouped by outcome with recent event details and timestamps. | `scripts/build-dashboard.mjs` |
| [`collectTelemetry`](../scripts/lib/dashboard/collect-telemetry.mjs#L501) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 501-546 | Orchestrates collection of all telemetry sources (audit runs, learning, security, purpose health, ship health, etc.) and packages them with provenance metadata. | `scripts/build-dashboard.mjs` |
| [`emptyEffectiveness`](../scripts/lib/dashboard/collect-telemetry.mjs#L247) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 247-249 | Returns an empty effectiveness data structure with all metrics set to zero or null. | `scripts/build-dashboard.mjs` |
| [`emptyPurposeHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L336) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 336-343 | Returns an empty purpose health structure with window days and empty purpose badge lists. | `scripts/build-dashboard.mjs` |
| [`emptySecurity`](../scripts/lib/dashboard/collect-telemetry.mjs#L283) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 283-288 | Returns an empty security data structure with zero incidents and no recent events. | `scripts/build-dashboard.mjs` |
| [`repoName`](../scripts/lib/dashboard/collect-telemetry.mjs#L143) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 143-150 | Extracts the repository name from package.json or environment variable as a fallback identifier. | `scripts/build-dashboard.mjs` |
| [`securityData`](../scripts/lib/dashboard/collect-telemetry.mjs#L291) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 291-307 | Transforms raw security stats into structured data with incident counts, event kinds, and recent event summaries. | `scripts/build-dashboard.mjs` |
...
| [`freshnessBanner`](../scripts/lib/dashboard/render.mjs#L93) | function | `scripts/lib/dashboard/render.mjs` | 93-105 | Renders an HTML paragraph showing freshness metadata (commit SHA, source hash, generation timestamp, or mode). | `scripts/build-dashboard.mjs` |
| [`nav`](../scripts/lib/dashboard/render.mjs#L110) | function | `scripts/lib/dashboard/render.mjs` | 110-118 | Generates the navigation bar with Reference/Telemetry tabs and hint text for dashboard setup commands. | `scripts/build-dashboard.mjs` |
| [`renderDocument`](../scripts/lib/dashboard/render.mjs#L130) | function | `scripts/lib/dashboard/render.mjs` | 130-196 | Validates dashboard data, builds tabbed UI sections, and renders a complete HTML document with error handling for malformed sections. | `scripts/build-dashboard.mjs` |
| [`validateDashboardData`](../scripts/lib/dashboard/schema.mjs#L445) | function | `scripts/lib/dashboard/schema.mjs` | 445-450 | Validates and parses dashboard data against the appropriate schema based on the document kind. | `scripts/lib/dashboard/collect-purposes.mjs`, `scripts/lib/dashboard/collect-reference.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
...
| [`generateAllPromptFiles`](../scripts/lib/install/copilot-prompts.mjs#L219) | function | `scripts/lib/install/copilot-prompts.mjs` | 219-250 | Scans the skills directory, reads SKILL.md files, extracts frontmatter, and generates prompt file entries for skills registered in the CLI. | `scripts/regenerate-skill-copies.mjs` |
| [`generatePromptFile`](../scripts/lib/install/copilot-prompts.mjs#L170) | function | `scripts/lib/install/copilot-prompts.mjs` | 170-208 | Generates a Copilot prompt file for a skill with YAML frontmatter, CLI invocation instructions, and usage notes. | `scripts/regenerate-skill-copies.mjs` |
| [`parseSkillFrontmatter`](../scripts/lib/install/copilot-prompts.mjs#L130) | function | `scripts/lib/install/copilot-prompts.mjs` | 130-159 | Parses YAML frontmatter from markdown content, extracting name and description fields while normalizing line endings and handling block-scalar syntax. | `scripts/regenerate-skill-copies.mjs` |
| [`shaOfManagedBlock`](../scripts/lib/install/copilot-prompts.mjs#L260) | function | `scripts/lib/install/copilot-prompts.mjs` | 260-268 | Computes a 16-character SHA256 hash of a managed block (between START and END markers) in file content. | `scripts/regenerate-skill-copies.mjs` |
| [`yamlQuote`](../scripts/lib/install/copilot-prompts.mjs#L119) | function | `scripts/lib/install/copilot-prompts.mjs` | 119-121 | Escapes backslashes and quotes in a string, then wraps it in double quotes for YAML compatibility. | `scripts/regenerate-skill-copies.mjs` |
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L372) | function | `scripts/sync-to-repos.mjs` | 372-380 | Lists all .prompt.md files in the .github/prompts directory. | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L270) | function | `scripts/sync-to-repos.mjs` | 270-287 | Walks the source tree to build a set of all files in scripts and .claude directories, excluding node_modules and hidden audit dirs. | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L333) | function | `scripts/sync-to-repos.mjs` | 333-345 | Builds a list of skill files from the skills directory, optionally mirroring to .github/skills. | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L402) | function | `scripts/sync-to-repos.mjs` | 402-409 | Bundles core, learning, and arch entry points for a repo, including debt entry for wine-cellar-app. | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L449) | function | `scripts/sync-to-repos.mjs` | 449-460 | Recursively merges a source object into a target object, deep-merging nested objects. | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L464) | function | `scripts/sync-to-repos.mjs` | 464-974 | <no body> | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L976) | function | `scripts/sync-to-repos.mjs` | 976-1007 | <no body> | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L290) | function | `scripts/sync-to-repos.mjs` | 290-293 | Reads a source file from disk relative to SOURCE_ROOT, returning null on failure. | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L317) | function | `scripts/sync-to-repos.mjs` | 317-322 | Filters unresolved dependencies to return only real missing relative imports (not template literals or external modules). | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L302) | function | `scripts/sync-to-repos.mjs` | 302-307 | Resolves a bundle of files and their dependencies starting from entry points. | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L418) | function | `scripts/sync-to-repos.mjs` | 418-425 | Computes the SHA256 hash of a file's contents. | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L170) | function | `scripts/sync-to-repos.mjs` | 170-180 | Scans and returns a sorted list of SQL migration files from the supabase/migrations directory. | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L427) | function | `scripts/sync-to-repos.mjs` | 427-440 | Generates a unified diff between two files using git diff --no-index. | _(internal)_ |
...
> The `scripts` domain provides utility and automation functions for Claude API testing, project bootstrapping with template setup, dependency graph analysis, and plan file management including status parsing and archival of completed audits.
...
_Domain has 187 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
> The `shared-lib` domain configures and instantiates Anthropic SDK clients with environment validation, backend selection (SDK vs. CLI), request redaction for sensitive data, and timeout/caching mechanisms.
...
_Domain has 605 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`_resetClientCache`](../scripts/lib/anthropic-client.mjs#L300) | function | `scripts/lib/anthropic-client.mjs` | 300-303 | Clears the internal client cache and resets warning flags. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
| [`applyRedactor`](../scripts/lib/anthropic-client.mjs#L265) | function | `scripts/lib/anthropic-client.mjs` | 265-294 | Recursively redacts system prompts and message content blocks by applying a redactor function. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
| [`assertOneShotTextMessages`](../scripts/lib/anthropic-client.mjs#L378) | function | `scripts/lib/anthropic-client.mjs` | 378-407 | Validates that CLI backend messages are user-role text-only, rejecting assistant messages or non-text content. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
| [`buildPromptFromMessages`](../scripts/lib/anthropic-client.mjs#L415) | function | `scripts/lib/anthropic-client.mjs` | 415-432 | Extracts and concatenates plain text from message content blocks (string or text-block array). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
...
| [`getDefaultRedactor`](../scripts/lib/anthropic-client.mjs#L233) | function | `scripts/lib/anthropic-client.mjs` | 233-239 | Lazily imports and caches the default redactor function from sanitizer.mjs. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
| [`keyDigest`](../scripts/lib/anthropic-client.mjs#L50) | function | `scripts/lib/anthropic-client.mjs` | 50-52 | Creates a 16-character cache key by SHA256-hashing the input value. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
...
| [`resolveBackend`](../scripts/lib/anthropic-client.mjs#L120) | function | `scripts/lib/anthropic-client.mjs` | 120-133 | Validates the CLAUDE_BACKEND environment variable against allowed values, hard-failing on invalid input. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
| [`resolveTimeoutMs`](../scripts/lib/anthropic-client.mjs#L93) | function | `scripts/lib/anthropic-client.mjs` | 93-104 | Validates and returns the timeout in milliseconds, rejecting values outside the allowed range. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
...
| [`wrapSdkWithRedactor`](../scripts/lib/anthropic-client.mjs#L246) | function | `scripts/lib/anthropic-client.mjs` | 246-255 | Wraps the Anthropic SDK client to apply redaction to message payloads before sending them. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +4 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Atomically writes a file to disk via temp-and-rename, preserving symlinks and creating parent directories. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +32 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a file path to lowercase, removes CWD prefix, and converts backslashes to forward slashes. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +32 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file from disk or exits the process with an error message if the file doesn't exist. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +32 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Safely parses a string to integer, returning a fallback value if parsing fails. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +32 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Outputs JSON data to a file or stdout, with optional directory creation and logging. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +32 more |
...
| [`redactFields`](../scripts/lib/secret-patterns.mjs#L111) | function | `scripts/lib/secret-patterns.mjs` | 111-124 | Redacts specified object fields containing secrets and returns the modified object and matches. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +10 more |
| [`redactSecrets`](../scripts/lib/secret-patterns.mjs#L80) | function | `scripts/lib/secret-patterns.mjs` | 80-103 | Redacts secret patterns in text with placeholder labels, preserving context or capturing groups. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +10 more |
| [`scanForSecrets`](../scripts/lib/secret-patterns.mjs#L54) | function | `scripts/lib/secret-patterns.mjs` | 54-67 | Scans text for secret patterns and returns matched pattern names without modifying the text. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +10 more |
...
| [`emptyDiff`](../scripts/lib/sensitive-paths.mjs#L275) | function | `scripts/lib/sensitive-paths.mjs` | 275-277 | Returns an empty diff structure with all action arrays initialized. | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +4 more |
| [`filterDiffFiles`](../scripts/lib/sensitive-paths.mjs#L291) | function | `scripts/lib/sensitive-paths.mjs` | 291-356 | <no body> | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +4 more |
...
| [`resolveAndClassify`](../scripts/lib/sensitive-paths.mjs#L179) | function | `scripts/lib/sensitive-paths.mjs` | 179-245 | <no body> | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +4 more |
...
| [`buildCopilotPromptFiles`](../scripts/lib/sync-inventory.mjs#L151) | function | `scripts/lib/sync-inventory.mjs` | 151-159 | Scans the `.github/prompts/` directory and returns paths to `.prompt.md` files. | `scripts/check-isolation-inventory.mjs` |
| [`buildFileUniverse`](../scripts/lib/sync-inventory.mjs#L176) | function | `scripts/lib/sync-inventory.mjs` | 176-193 | Recursively walks `scripts/` and `.claude/` directories to build a set of all relative file paths. | `scripts/check-isolation-inventory.mjs` |
| [`buildSkillFiles`](../scripts/lib/sync-inventory.mjs#L137) | function | `scripts/lib/sync-inventory.mjs` | 137-149 | Builds a list of skill file paths from `.claude/skills/` and optionally `.github/skills/` directories. | `scripts/check-isolation-inventory.mjs` |
| [`bundleForRepo`](../scripts/lib/sync-inventory.mjs#L215) | function | `scripts/lib/sync-inventory.mjs` | 215-227 | Builds a complete file bundle for a consumer repo including core code, skills, prompts, and migrations. | `scripts/check-isolation-inventory.mjs` |
| [`getAllConsumerInventories`](../scripts/lib/sync-inventory.mjs#L249) | function | `scripts/lib/sync-inventory.mjs` | 249-256 | Generates file bundles for all known consumer repositories. | `scripts/check-isolation-inventory.mjs` |
| [`getFileUniverse`](../scripts/lib/sync-inventory.mjs#L196) | function | `scripts/lib/sync-inventory.mjs` | 196-199 | Returns a cached universe of tracked files or builds it on first access. | `scripts/check-isolation-inventory.mjs` |
| [`getSyncInventoryForRepo`](../scripts/lib/sync-inventory.mjs#L236) | function | `scripts/lib/sync-inventory.mjs` | 236-241 | Resolves a consumer repo by alias or name and returns its file bundle and unresolved dependencies. | `scripts/check-isolation-inventory.mjs` |
| [`readSource`](../scripts/lib/sync-inventory.mjs#L201) | function | `scripts/lib/sync-inventory.mjs` | 201-204 | Reads a file from disk relative to the repo root, returning null on failure. | `scripts/check-isolation-inventory.mjs` |
| [`resolveBundle`](../scripts/lib/sync-inventory.mjs#L206) | function | `scripts/lib/sync-inventory.mjs` | 206-213 | Resolves an entry-point bundle graph, merging resolved files with provided assets. | `scripts/check-isolation-inventory.mjs` |
| [`syncMigrations`](../scripts/lib/sync-inventory.mjs#L125) | function | `scripts/lib/sync-inventory.mjs` | 125-135 | Discovers and returns sorted paths to database migration SQL files. | `scripts/check-isolation-inventory.mjs` |
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L467) | function | `scripts/lib/sync-isolation-verify.mjs` | 467-480 | Formats test gate results into human-readable text with pass/fail indicators and error details. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L411) | function | `scripts/lib/sync-isolation-verify.mjs` | 411-426 | Reports uncommitted git state as read-only information for operator review. | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L150) | function | `scripts/lib/sync-isolation-verify.mjs` | 150-211 | Verifies that `scripts/.claude-skills/` is not tracked in git (uncommitted, staged, or clean tracked files). | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L213) | function | `scripts/lib/sync-isolation-verify.mjs` | 213-244 | Validates that all manifest-recorded files exist on disk and match their expected SHA256 hashes. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L246) | function | `scripts/lib/sync-isolation-verify.mjs` | 246-271 | Scans command-bearing files for stale invocations of ownership-confirmed paths that should have been removed. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L273) | function | `scripts/lib/sync-isolation-verify.mjs` | 273-337 | Smoke-tests CLI tool executability and library imports from the synced tool directory. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L339) | function | `scripts/lib/sync-isolation-verify.mjs` | 339-383 | Scans synced markdown for npm script references and verifies they don't invoke stale owned paths in package.json. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L385) | function | `scripts/lib/sync-isolation-verify.mjs` | 385-392 | Verifies that the manifest layout is set to `isolated`. | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L394) | function | `scripts/lib/sync-isolation-verify.mjs` | 394-409 | Checks that .gitignore contains a properly formed managed block with matching begin/end markers in order. | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L70) | function | `scripts/lib/sync-isolation-verify.mjs` | 70-73 | Computes the SHA256 hash of a file and returns it with a `sha256:` prefix. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L132) | function | `scripts/lib/sync-isolation-verify.mjs` | 132-142 | Collects all command-bearing files (scripts and code) by scanning designated paths. | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L95) | function | `scripts/lib/sync-isolation-verify.mjs` | 95-114 | Reads and validates the sync manifest from disk against a schema, returning structured errors on failure. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L482) | function | `scripts/lib/sync-isolation-verify.mjs` | 482-508 | Parses command-line arguments and runs gate checks, exiting with appropriate status codes. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L75) | function | `scripts/lib/sync-isolation-verify.mjs` | 75-93 | Parses command-line arguments into configuration options for consumer root, gates, and output format. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L144) | function | `scripts/lib/sync-isolation-verify.mjs` | 144-146 | Converts an absolute path to a relative path from the consumer root. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L430) | function | `scripts/lib/sync-isolation-verify.mjs` | 430-457 | Runs a sequence of named gates in order and returns structured pass/fail results for each. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L459) | function | `scripts/lib/sync-isolation-verify.mjs` | 459-465 | Prints an error message stating the command is source-side only and exits with code 2. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L116) | function | `scripts/lib/sync-isolation-verify.mjs` | 116-130 | Generator that recursively yields all files under a directory using an iterative stack-based walk. | _(internal)_ |
...
> The `stores` domain persists and retrieves codebase architecture metadata—symbol compositions, import graphs, and domain summaries—to a cloud database, enabling efficient querying of file dependencies, symbol relationships, and refresh state across repository analyses.
...
_Domain has 132 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`backfillLearningOutcome`](../scripts/lib/store/learning-decisions.mjs#L70) | function | `scripts/lib/store/learning-decisions.mjs` | 70-77 | Updates the outcome status of an existing learning decision. | `scripts/learning-store.mjs` |
| [`callDeferFinding`](../scripts/lib/store/learning-decisions.mjs#L133) | function | `scripts/lib/store/learning-decisions.mjs` | 133-142 | Defers a finding by calling cloud RPC with finding and evidence details. | `scripts/learning-store.mjs` |
| [`callMarkFindingNeedsTriage`](../scripts/lib/store/learning-decisions.mjs#L145) | function | `scripts/lib/store/learning-decisions.mjs` | 145-152 | Calls cloud RPC to dismiss a finding with reason and evidence. | `scripts/learning-store.mjs` |
| [`insertFrictionNote`](../scripts/lib/store/learning-decisions.mjs#L232) | function | `scripts/lib/store/learning-decisions.mjs` | 232-250 | Inserts a friction log entry capturing user friction during audit execution. | `scripts/learning-store.mjs` |
| [`insertLearningDecision`](../scripts/lib/store/learning-decisions.mjs#L43) | function | `scripts/lib/store/learning-decisions.mjs` | 43-62 | Inserts or updates a learning decision record in the cloud database. | `scripts/learning-store.mjs` |
| [`readDecisionsPaginated`](../scripts/lib/store/learning-decisions.mjs#L294) | function | `scripts/lib/store/learning-decisions.mjs` | 294-335 | Paginates through learning decisions by type with optional time and repo filters. | `scripts/learning-store.mjs` |
| [`readNoBrainerRecommendations`](../scripts/lib/store/learning-decisions.mjs#L174) | function | `scripts/lib/store/learning-decisions.mjs` | 174-185 | Queries recent audit findings for a repo up to a limit. | `scripts/learning-store.mjs` |
| [`readPendingTriageFindings`](../scripts/lib/store/learning-decisions.mjs#L161) | function | `scripts/lib/store/learning-decisions.mjs` | 161-172 | Queries recent learning decisions for a repo up to a limit. | `scripts/learning-store.mjs` |
| [`readRecentFriction`](../scripts/lib/store/learning-decisions.mjs#L258) | function | `scripts/lib/store/learning-decisions.mjs` | 258-274 | Retrieves recent friction log entries for a repo within a time window. | `scripts/learning-store.mjs` |
| [`readStaleClusters`](../scripts/lib/store/learning-decisions.mjs#L187) | function | `scripts/lib/store/learning-decisions.mjs` | 187-201 | Queries stale finding clusters (open, not recently seen) older than specified days. | `scripts/learning-store.mjs` |
| [`readUnresolvedDecisions`](../scripts/lib/store/learning-decisions.mjs#L351) | function | `scripts/lib/store/learning-decisions.mjs` | 351-377 | Queries pending (unresolved) learning decisions before a cutoff date with limit. | `scripts/learning-store.mjs` |
| [`recordConvergenceState`](../scripts/lib/store/learning-decisions.mjs#L94) | function | `scripts/lib/store/learning-decisions.mjs` | 94-101 | Updates audit run state fields (redacted names) conditionally based on provided state object. | `scripts/learning-store.mjs` |
| [`recordDiffComplexity`](../scripts/lib/store/learning-decisions.mjs#L84) | function | `scripts/lib/store/learning-decisions.mjs` | 84-89 | Records the complexity metric for an audit run. | `scripts/learning-store.mjs` |
| [`recordFindingResolution`](../scripts/lib/store/learning-decisions.mjs#L115) | function | `scripts/lib/store/learning-decisions.mjs` | 115-124 | Patches an audit finding record with user-supplied resolution data (action, reason, commit sha, etc.). | `scripts/learning-store.mjs` |
| [`refreshRecurringClusters`](../scripts/lib/store/learning-decisions.mjs#L212) | function | `scripts/lib/store/learning-decisions.mjs` | 212-221 | Counts (redacted query function) for a repo with error logging. | `scripts/learning-store.mjs` |
| [`safeWrite`](../scripts/lib/store/learning-decisions.mjs#L24) | function | `scripts/lib/store/learning-decisions.mjs` | 24-31 | Wraps async function execution and returns success/error result object. | `scripts/learning-store.mjs` |
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L291) | function | `scripts/lib/store/repo.mjs` | 291-306 | Looks up repo ID by name, returning most recently created match. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-236 | Retrieves repo metadata (id, name, uuid, active refresh id, embedding dim) by UUID. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Initializes cloud store connection, performs connectivity probe, logs status. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks if cloud database pool is available and connected. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L316) | function | `scripts/lib/store/repo.mjs` | 316-325 | Retrieves all repository IDs from the database, returning an empty array if cloud is disabled or the query fails. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`resolveRepoForStore`](../scripts/lib/store/repo.mjs#L142) | function | `scripts/lib/store/repo.mjs` | 142-203 | Resolves or inserts repo identity into cloud database with optional profile update. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`upsertRepo`](../scripts/lib/store/repo.mjs#L108) | function | `scripts/lib/store/repo.mjs` | 108-116 | Delegates to stable UUID-based repo resolver (deprecated fingerprint path). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`upsertRepoByUuid`](../scripts/lib/store/repo.mjs#L246) | function | `scripts/lib/store/repo.mjs` | 246-278 | Inserts a new repo by UUID with race-condition handling, returns id. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`_resetClassificationColumnCache`](../scripts/lib/store/runs-findings.mjs#L33) | function | `scripts/lib/store/runs-findings.mjs` | 33-35 | <no body> | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`_resetPassStatsRoundColumnCache`](../scripts/lib/store/runs-findings.mjs#L62) | function | `scripts/lib/store/runs-findings.mjs` | 62-64 | <no body> | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`adjudicateFinalReviewFinding`](../scripts/lib/store/runs-findings.mjs#L367) | function | `scripts/lib/store/runs-findings.mjs` | 367-388 | Marks shadow-only findings as accepted or dismissed based on user adjudication action. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`columnExists`](../scripts/lib/store/runs-findings.mjs#L641) | function | `scripts/lib/store/runs-findings.mjs` | 641-665 | Checks if a database column exists by probing with a LIMIT 0 query, caching results and distinguishing transient from permanent errors. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`detectClassificationColumns`](../scripts/lib/store/runs-findings.mjs#L37) | function | `scripts/lib/store/runs-findings.mjs` | 37-52 | Checks if the database has sonar classification columns by probing with a zero-row SELECT query. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`detectPassStatsRoundColumn`](../scripts/lib/store/runs-findings.mjs#L66) | function | `scripts/lib/store/runs-findings.mjs` | 66-80 | Checks if the database has per-round pass statistics support by probing for the round column. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getAuditRunConvergence`](../scripts/lib/store/runs-findings.mjs#L564) | function | `scripts/lib/store/runs-findings.mjs` | 564-581 | Retrieves convergence metadata from a run including which round convergence happened and rigor pressure tracking. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getFinalReviewStats`](../scripts/lib/store/runs-findings.mjs#L404) | function | `scripts/lib/store/runs-findings.mjs` | 404-453 | Retrieves final-review findings grouped by source model and bucket, plus a queue of unadjudicated shadow-only findings. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getPassTimings`](../scripts/lib/store/runs-findings.mjs#L587) | function | `scripts/lib/store/runs-findings.mjs` | 587-615 | Aggregates token usage and latency statistics across all audit passes by computing averages. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRecentFindingsByRepo`](../scripts/lib/store/runs-findings.mjs#L740) | function | `scripts/lib/store/runs-findings.mjs` | 740-777 | Fetches the most recent high/medium severity findings for a repository. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunFindingOutcomeCounts`](../scripts/lib/store/runs-findings.mjs#L543) | function | `scripts/lib/store/runs-findings.mjs` | 543-562 | Retrieves adjudication summary counts for a run: total findings, accepted/fixed count, and whether any adjudication exists. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunFindings`](../scripts/lib/store/runs-findings.mjs#L686) | function | `scripts/lib/store/runs-findings.mjs` | 686-718 | Fetches all findings for a run sorted by severity and pass order, with optional adjudication and remediation state columns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunMeta`](../scripts/lib/store/runs-findings.mjs#L795) | function | `scripts/lib/store/runs-findings.mjs` | 795-821 | Retrieves core run metadata including plan file, mode, rounds, and verdict, dynamically including optional columns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`normaliseBucket`](../scripts/lib/store/runs-findings.mjs#L219) | function | `scripts/lib/store/runs-findings.mjs` | 219-224 | Validates and normalizes finding bucket values, returning null for invalid buckets. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordAdjudicationEvent`](../scripts/lib/store/runs-findings.mjs#L880) | function | `scripts/lib/store/runs-findings.mjs` | 880-918 | Records finding adjudication decisions and remediation state as a transaction, atomically replacing prior entries. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordFinalReviewFindings`](../scripts/lib/store/runs-findings.mjs#L322) | function | `scripts/lib/store/runs-findings.mjs` | 322-352 | Records final-review findings and their attribution metadata, replacing prior final-review rows atomically. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordFindings`](../scripts/lib/store/runs-findings.mjs#L240) | function | `scripts/lib/store/runs-findings.mjs` | 240-296 | Records individual findings from an audit pass into the database with optional classification and source model data. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordPassStats`](../scripts/lib/store/runs-findings.mjs#L465) | function | `scripts/lib/store/runs-findings.mjs` | 465-486 | Records per-pass execution statistics including token usage, latency, and reasoning effort. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordRunComplete`](../scripts/lib/store/runs-findings.mjs#L133) | function | `scripts/lib/store/runs-findings.mjs` | 133-167 | Updates audit run metadata with completion statistics like findings counts, costs, and duration. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordRunStart`](../scripts/lib/store/runs-findings.mjs#L88) | function | `scripts/lib/store/runs-findings.mjs` | 88-127 | Creates or reuses an audit run record, supporting run-unification where multiple rounds share a single run ID. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordSuppressionEvents`](../scripts/lib/store/runs-findings.mjs#L828) | function | `scripts/lib/store/runs-findings.mjs` | 828-867 | Records suppression and reopening events linking findings to matched suppression topics. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`updatePassStatsPostDeliberation`](../scripts/lib/store/runs-findings.mjs#L492) | function | `scripts/lib/store/runs-findings.mjs` | 492-523 | Updates post-deliberation findings counts in pass statistics, scoped to the latest round per pass. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`updateRunMeta`](../scripts/lib/store/runs-findings.mjs#L173) | function | `scripts/lib/store/runs-findings.mjs` | 173-211 | Updates run metadata including verdict, labels, and adjudication counts, with column existence guards for newer schema fields. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
...
> The `tests` domain provides testing utilities and fixtures, including functions to create temporary directories and files with specific structures (like repos, documents, and file trees) for integration and unit tests.
...
_Domain has 277 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
