...
- Generated: 2026-07-17T11:59:31.777Z   commit: f94371c454c2   refresh_id: 912bd79d-1027-4886-bd7a-706ad8cbb415
- Drift score: 30 / threshold 20   status: `RED`
- Domains: 33   Symbols: 3241   Layering violations: 0

## Contents
- [arch-intent](#arch-intent) — 53 symbols
- [arch-memory](#arch-memory) — 66 symbols
- [arm-eval](#arm-eval) — 45 symbols
- [audit-orchestration](#audit-orchestration) — 246 symbols
...
- [plan](#plan) — 8 symbols
- [requirements](#requirements) — 23 symbols
- [root-scripts](#root-scripts) — 14 symbols
- [scripts](#scripts) — 308 symbols
- [security](#security) — 3 symbols
- [shared-lib](#shared-lib) — 569 symbols
- [ship](#ship) — 4 symbols
- [solo-control](#solo-control) — 24 symbols
- [stores](#stores) — 255 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 473 symbols
...
```mermaid
flowchart TB
subgraph dom_arch_intent ["arch-intent"]
  ...
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["fsWalkFallback"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["inventoryAllPaths"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["inventoryFiles"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["isArchIntentReportClean"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["listRepoPaths"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["loadAdapter"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["runArchIntentAnalysis"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  sym_scripts_lib_arch_intent_adapter_contract["validateAdapterReport"]:::symbol
  file_scripts_lib_arch_intent_adapter_contract --> sym_scripts_lib_arch_intent_adapter_contract
  file_scripts_lib_arch_intent_adapters_java_mj["scripts/lib/arch-intent/adapters/java.mjs"]:::component
  sym_scripts_lib_arch_intent_adapters_java_mj["analyseImports"]:::symbol
  file_scripts_lib_arch_intent_adapters_java_mj --> sym_scripts_lib_arch_intent_adapters_java_mj
  sym_scripts_lib_arch_intent_adapters_java_mj["buildJavaResolutionIndex"]:::symbol
  file_scripts_lib_arch_intent_adapters_java_mj --> sym_scripts_lib_arch_intent_adapters_java_mj
  sym_scripts_lib_arch_intent_adapters_java_mj["extractImports"]:::symbol
  file_scripts_lib_arch_intent_adapters_java_mj --> sym_scripts_lib_arch_intent_adapters_java_mj
  sym_scripts_lib_arch_intent_adapters_java_mj["extractPackage"]:::symbol
  file_scripts_lib_arch_intent_adapters_java_mj --> sym_scripts_lib_arch_intent_adapters_java_mj
  sym_scripts_lib_arch_intent_adapters_java_mj["progressiveResolve"]:::symbol
  file_scripts_lib_arch_intent_adapters_java_mj --> sym_scripts_lib_arch_intent_adapters_java_mj
end
...
|---|---|---|---|---|---|
| [`computeDeadIntent`](../scripts/lib/arch-intent/adapter-contract.mjs#L191) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 191-199 | Identifies domains declared in config that have no actual files. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`deriveArchState`](../scripts/lib/arch-intent/adapter-contract.mjs#L363) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 363-374 | Classifies overall report state as clean, with findings, partial error, or fully failed. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`fsWalkFallback`](../scripts/lib/arch-intent/adapter-contract.mjs#L68) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 68-88 | Recursively walks repo directory to list files when git commands fail. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`inventoryAllPaths`](../scripts/lib/arch-intent/adapter-contract.mjs#L169) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 169-176 | Maps all repo paths to domains (not just source files). | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`inventoryFiles`](../scripts/lib/arch-intent/adapter-contract.mjs#L133) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 133-151 | Filters repo source files and maps each to its declared domain. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`isArchIntentReportClean`](../scripts/lib/arch-intent/adapter-contract.mjs#L349) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 349-354 | Tests whether an architecture report has zero violations and no mapping issues. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`listRepoPaths`](../scripts/lib/arch-intent/adapter-contract.mjs#L103) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 103-118 | Returns all tracked and untracked-but-not-ignored repo files. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`loadAdapter`](../scripts/lib/arch-intent/adapter-contract.mjs#L214) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 214-232 | Dynamically imports an adapter module for a given tech stack. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`runArchIntentAnalysis`](../scripts/lib/arch-intent/adapter-contract.mjs#L263) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 263-331 | Orchestrates the full architecture intent check across all enabled stacks. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`validateAdapterReport`](../scripts/lib/arch-intent/adapter-contract.mjs#L241) | function | `scripts/lib/arch-intent/adapter-contract.mjs` | 241-252 | Validates an adapter's returned findings match the expected schema. | `scripts/arch-intent-bootstrap.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
...
> Embeds code symbols and security incidents into a searchable index; queries by intent description to surface existing near-duplicates and related past incidents, preventing duplicate implementations and architectural drift.

```mermaid
flowchart TB
subgraph dom_arch_memory ["arch-memory"]
  file_scripts_lib_neighbourhood_query_mjs["scripts/lib/neighbourhood-query.mjs"]:::component
  sym_scripts_lib_neighbourhood_query_mjs_cach["cacheKey"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_cach
  sym_scripts_lib_neighbourhood_query_mjs_gene["generateIntentEmbedding"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_gene
  sym_scripts_lib_neighbourhood_query_mjs_getC["getCached"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_getC
  sym_scripts_lib_neighbourhood_query_mjs_getI["getIncidentNeighbourhoodForIntent"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_getI
  sym_scripts_lib_neighbourhood_query_mjs_getN["getNeighbourhoodForIntent"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_getN
  sym_scripts_lib_neighbourhood_query_mjs_load["loadCache"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_load
  sym_scripts_lib_neighbourhood_query_mjs_putC["putCached"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_putC
  sym_scripts_lib_neighbourhood_query_mjs_save["saveCache"]:::symbol
  file_scripts_lib_neighbourhood_query_mjs --> sym_scripts_lib_neighbourhood_query_mjs_save
  file_scripts_lib_observed_deps_mjs["scripts/lib/observed-deps.mjs"]:::component
  sym_scripts_lib_observed_deps_mjs_computeDom["computeDomainMapDigest"]:::symbol
  file_scripts_lib_observed_deps_mjs --> sym_scripts_lib_observed_deps_mjs_computeDom
  sym_scripts_lib_observed_deps_mjs_computeObs["computeObservedDomainDeps"]:::symbol
  file_scripts_lib_observed_deps_mjs --> sym_scripts_lib_observed_deps_mjs_computeObs
  sym_scripts_lib_observed_deps_mjs_flattenMer["flattenMergedDeps"]:::symbol
  file_scripts_lib_observed_deps_mjs --> sym_scripts_lib_observed_deps_mjs_flattenMer
  sym_scripts_lib_observed_deps_mjs_mergeDomai["mergeDomainDeps"]:::symbol
  file_scripts_lib_observed_deps_mjs --> sym_scripts_lib_observed_deps_mjs_mergeDomai
...
| [`atomicWrite`](../scripts/symbol-index/drift.mjs#L44) | function | `scripts/symbol-index/drift.mjs` | 44-46 | Atomically writes content to a file. | _(internal)_ |
| [`classify`](../scripts/symbol-index/drift.mjs#L48) | function | `scripts/symbol-index/drift.mjs` | 48-52 | Classifies a drift score as GREEN, AMBER, or RED based on a threshold. | _(internal)_ |
| [`main`](../scripts/symbol-index/drift.mjs#L73) | function | `scripts/symbol-index/drift.mjs` | 73-184 | Computes symbol-index drift score, classifies it, fetches duplicate clusters, and outputs the result. | _(internal)_ |
| [`parseArgs`](../scripts/symbol-index/drift.mjs#L35) | function | `scripts/symbol-index/drift.mjs` | 35-42 | Parses command-line arguments to extract --out and --json flags. | _(internal)_ |
| [`renderMarkdownViaShared`](../scripts/symbol-index/drift.mjs#L58) | function | `scripts/symbol-index/drift.mjs` | 58-71 | Renders a drift issue as markdown using the shared renderer function. | _(internal)_ |
...
```mermaid
flowchart TB
subgraph dom_arm_eval ["arm-eval"]
  file_scripts_lib_arm_eval_capture_trigger_mjs["scripts/lib/arm-eval/capture-trigger.mjs"]:::component
  sym_scripts_lib_arm_eval_capture_trigger_mjs["maybeFireArmEvalCaptureDetached"]:::symbol
  file_scripts_lib_arm_eval_capture_trigger_mjs --> sym_scripts_lib_arm_eval_capture_trigger_mjs
  file_scripts_lib_arm_eval_cross_checks_mjs["scripts/lib/arm-eval/cross-checks.mjs"]:::component
  sym_scripts_lib_arm_eval_cross_checks_mjs_en["envelope"]:::symbol
  file_scripts_lib_arm_eval_cross_checks_mjs --> sym_scripts_lib_arm_eval_cross_checks_mjs_en
  sym_scripts_lib_arm_eval_cross_checks_mjs_ru["runCrossChecks"]:::symbol
  file_scripts_lib_arm_eval_cross_checks_mjs --> sym_scripts_lib_arm_eval_cross_checks_mjs_ru
  file_scripts_lib_arm_eval_decision_mjs["scripts/lib/arm-eval/decision.mjs"]:::component
  sym_scripts_lib_arm_eval_decision_mjs_evalua["evaluateArmEval"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_evalua
  sym_scripts_lib_arm_eval_decision_mjs_kendal["kendallTau"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_kendal
  sym_scripts_lib_arm_eval_decision_mjs_mean["mean"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_mean
  sym_scripts_lib_arm_eval_decision_mjs_round4["round4"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_round4
  sym_scripts_lib_arm_eval_decision_mjs_sessio["sessionArmMeans"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_sessio
  sym_scripts_lib_arm_eval_decision_mjs_sessio["sessionSelfConsistency"]:::symbol
  file_scripts_lib_arm_eval_decision_mjs --> sym_scripts_lib_arm_eval_decision_mjs_sessio
  file_scripts_lib_arm_eval_experiments_mjs["scripts/lib/arm-eval/experiments.mjs"]:::component
  sym_scripts_lib_arm_eval_experiments_mjs_get["getExperiment"]:::symbol
  file_scripts_lib_arm_eval_experiments_mjs --> sym_scripts_lib_arm_eval_experiments_mjs_get
  sym_scripts_lib_arm_eval_experiments_mjs_isC["isClaudeFamily"]:::symbol
  file_scripts_lib_arm_eval_experiments_mjs --> sym_scripts_lib_arm_eval_experiments_mjs_isC
  sym_scripts_lib_arm_eval_experiments_mjs_rub["rubricFor"]:::symbol
  file_scripts_lib_arm_eval_experiments_mjs --> sym_scripts_lib_arm_eval_experiments_mjs_rub
  sym_scripts_lib_arm_eval_experiments_mjs_val["validateArm"]:::symbol
  file_scripts_lib_arm_eval_experiments_mjs --> sym_scripts_lib_arm_eval_experiments_mjs_val
  sym_scripts_lib_arm_eval_experiments_mjs_val["validateExperiment"]:::symbol
  file_scripts_lib_arm_eval_experiments_mjs --> sym_scripts_lib_arm_eval_experiments_mjs_val
  file_scripts_lib_arm_eval_export_mjs["scripts/lib/arm-eval/export.mjs"]:::component
  sym_scripts_lib_arm_eval_export_mjs_buildSes["buildSessionMarkdown"]:::symbol
  file_scripts_lib_arm_eval_export_mjs --> sym_scripts_lib_arm_eval_export_mjs_buildSes
  sym_scripts_lib_arm_eval_export_mjs_exportSe["exportSession"]:::symbol
  file_scripts_lib_arm_eval_export_mjs --> sym_scripts_lib_arm_eval_export_mjs_exportSe
  sym_scripts_lib_arm_eval_export_mjs_filename["filenameFor"]:::symbol
  file_scripts_lib_arm_eval_export_mjs --> sym_scripts_lib_arm_eval_export_mjs_filename
  sym_scripts_lib_arm_eval_export_mjs_redact["redact"]:::symbol
  file_scripts_lib_arm_eval_export_mjs --> sym_scripts_lib_arm_eval_export_mjs_redact
  file_scripts_lib_arm_eval_intent_context_mjs["scripts/lib/arm-eval/intent-context.mjs"]:::component
  sym_scripts_lib_arm_eval_intent_context_mjs_["buildIntentContext"]:::symbol
  file_scripts_lib_arm_eval_intent_context_mjs --> sym_scripts_lib_arm_eval_intent_context_mjs_
  sym_scripts_lib_arm_eval_intent_context_mjs_["cap"]:::symbol
  file_scripts_lib_arm_eval_intent_context_mjs --> sym_scripts_lib_arm_eval_intent_context_mjs_
  sym_scripts_lib_arm_eval_intent_context_mjs_["defaultDeps"]:::symbol
  file_scripts_lib_arm_eval_intent_context_mjs --> sym_scripts_lib_arm_eval_intent_context_mjs_
  sym_scripts_lib_arm_eval_intent_context_mjs_["tryRead"]:::symbol
  file_scripts_lib_arm_eval_intent_context_mjs --> sym_scripts_lib_arm_eval_intent_context_mjs_
  file_scripts_lib_arm_eval_judge_mjs["scripts/lib/arm-eval/judge.mjs"]:::component
  sym_scripts_lib_arm_eval_judge_mjs_buildJudg["buildJudgePrompt"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_buildJudg
  sym_scripts_lib_arm_eval_judge_mjs_callJudge["callJudgeDefault"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_callJudge
  sym_scripts_lib_arm_eval_judge_mjs_extractJs["extractJsonObject"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_extractJs
  sym_scripts_lib_arm_eval_judge_mjs_getShapeR["getShapeRedactor"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_getShapeR
  sym_scripts_lib_arm_eval_judge_mjs_judgePass["judgePassSchema"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_judgePass
  sym_scripts_lib_arm_eval_judge_mjs_judgeSess["judgeSession"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_judgeSess
  sym_scripts_lib_arm_eval_judge_mjs_scorableD["scorableDimensions"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_scorableD
  sym_scripts_lib_arm_eval_judge_mjs_seededShu["seededShuffle"]:::symbol
  file_scripts_lib_arm_eval_judge_mjs --> sym_scripts_lib_arm_eval_judge_mjs_seededShu
  file_scripts_lib_arm_eval_plan_seed_mjs["scripts/lib/arm-eval/plan-seed.mjs"]:::component
  sym_scripts_lib_arm_eval_plan_seed_mjs_build["buildPlanGenPrompt"]:::symbol
  file_scripts_lib_arm_eval_plan_seed_mjs --> sym_scripts_lib_arm_eval_plan_seed_mjs_build
  sym_scripts_lib_arm_eval_plan_seed_mjs_parse["parsePlanIntent"]:::symbol
  file_scripts_lib_arm_eval_plan_seed_mjs --> sym_scripts_lib_arm_eval_plan_seed_mjs_parse
  file_scripts_lib_arm_eval_producers__shared_m["scripts/lib/arm-eval/producers/_shared.mjs"]:::component
  sym_scripts_lib_arm_eval_producers__shared_m["hashText"]:::symbol
  file_scripts_lib_arm_eval_producers__shared_m --> sym_scripts_lib_arm_eval_producers__shared_m
  file_scripts_lib_arm_eval_producers_brainstor["scripts/lib/arm-eval/producers/brainstorm.mjs"]:::component
  sym_scripts_lib_arm_eval_producers_brainstor["callModelDefault"]:::symbol
  file_scripts_lib_arm_eval_producers_brainstor --> sym_scripts_lib_arm_eval_producers_brainstor
  sym_scripts_lib_arm_eval_producers_brainstor["produceBrainstorm"]:::symbol
  file_scripts_lib_arm_eval_producers_brainstor --> sym_scripts_lib_arm_eval_producers_brainstor
  file_scripts_lib_arm_eval_producers_model_cal["scripts/lib/arm-eval/producers/model-call.mjs"]:::component
  sym_scripts_lib_arm_eval_producers_model_cal["callModelFreeText"]:::symbol
  file_scripts_lib_arm_eval_producers_model_cal --> sym_scripts_lib_arm_eval_producers_model_cal
  sym_scripts_lib_arm_eval_producers_model_cal["providerFor"]:::symbol
  file_scripts_lib_arm_eval_producers_model_cal --> sym_scripts_lib_arm_eval_producers_model_cal
  file_scripts_lib_arm_eval_producers_plan_mjs["scripts/lib/arm-eval/producers/plan.mjs"]:::component
  sym_scripts_lib_arm_eval_producers_plan_mjs_["callModelDefault"]:::symbol
  file_scripts_lib_arm_eval_producers_plan_mjs --> sym_scripts_lib_arm_eval_producers_plan_mjs_
  sym_scripts_lib_arm_eval_producers_plan_mjs_["producePlan"]:::symbol
  file_scripts_lib_arm_eval_producers_plan_mjs --> sym_scripts_lib_arm_eval_producers_plan_mjs_
  file_scripts_lib_arm_eval_run_mjs["scripts/lib/arm-eval/run.mjs"]:::component
  sym_scripts_lib_arm_eval_run_mjs_defaultDeps["defaultDeps"]:::symbol
  file_scripts_lib_arm_eval_run_mjs --> sym_scripts_lib_arm_eval_run_mjs_defaultDeps
  sym_scripts_lib_arm_eval_run_mjs_hashTask["hashTask"]:::symbol
  file_scripts_lib_arm_eval_run_mjs --> sym_scripts_lib_arm_eval_run_mjs_hashTask
  sym_scripts_lib_arm_eval_run_mjs_runArmEvalS["runArmEvalSession"]:::symbol
  file_scripts_lib_arm_eval_run_mjs --> sym_scripts_lib_arm_eval_run_mjs_runArmEvalS
  file_scripts_lib_arm_eval_toggle_mjs["scripts/lib/arm-eval/toggle.mjs"]:::component
  sym_scripts_lib_arm_eval_toggle_mjs_readTogg["readToggle"]:::symbol
  file_scripts_lib_arm_eval_toggle_mjs --> sym_scripts_lib_arm_eval_toggle_mjs_readTogg
  sym_scripts_lib_arm_eval_toggle_mjs_resolveS["resolveShadowArmsWithToggle"]:::symbol
  file_scripts_lib_arm_eval_toggle_mjs --> sym_scripts_lib_arm_eval_toggle_mjs_resolveS
  sym_scripts_lib_arm_eval_toggle_mjs_writeTog["writeToggle"]:::symbol
  file_scripts_lib_arm_eval_toggle_mjs --> sym_scripts_lib_arm_eval_toggle_mjs_writeTog
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
> Orchestrates iterative and single-shot code/plan audit pipelines with convergence tracking, subprocess management, and cleanup of aged transient audit artifacts.

```mermaid
flowchart TB
subgraph dom_audit_orchestration ["audit-orchestration"]
  file_scripts_audit_clean_mjs["scripts/audit-clean.mjs"]:::component
  sym_scripts_audit_clean_mjs_collectCandidate["collectCandidates"]:::symbol
  file_scripts_audit_clean_mjs --> sym_scripts_audit_clean_mjs_collectCandidate
...
_Domain has 246 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`collectCandidates`](../scripts/audit-clean.mjs#L162) | function | `scripts/audit-clean.mjs` | 162-199 | Recursively collects files matching regex and age cutoff for deletion. | _(internal)_ |
| [`listStalePreimages`](../scripts/audit-clean.mjs#L61) | function | `scripts/audit-clean.mjs` | 61-89 | Finds orphaned preimage directories older than retention threshold. | _(internal)_ |
| [`main`](../scripts/audit-clean.mjs#L201) | function | `scripts/audit-clean.mjs` | 201-244 | Parses arguments, collects aged transient files, reports or applies deletion. | _(internal)_ |
...
| [`classifyDeferralEvidence`](../scripts/lib/audit/deferral-classifier.mjs#L162) | function | `scripts/lib/audit/deferral-classifier.mjs` | 162-295 | Classifies whether an audit finding qualifies for auto-deferral via scope, class allowlist, and SCM evidence (plan markers or file changes). | `scripts/lib/audit/findings-pipeline.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs` |
| [`globMatch`](../scripts/lib/audit/deferral-classifier.mjs#L98) | function | `scripts/lib/audit/deferral-classifier.mjs` | 98-115 | Tests if a file path matches a glob pattern by translating glob syntax to regex. | `scripts/lib/audit/findings-pipeline.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs` |
| [`parseAcceptV1Markers`](../scripts/lib/audit/deferral-classifier.mjs#L77) | function | `scripts/lib/audit/deferral-classifier.mjs` | 77-87 | Extracts `<!-- audit:accept-v1: ... -->` markers from plan content into file-glob/reason pairs. | `scripts/lib/audit/findings-pipeline.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs` |
| [`cleanupTempRoot`](../scripts/lib/audit/diff-scope-resolver.mjs#L255) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 255-265 | Removes a temporary git worktree directory via git or fallback filesystem deletion. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`computeEntryPoints`](../scripts/lib/audit/diff-scope-resolver.mjs#L354) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 354-423 | Extracts CLI entry points from package.json and discovers source equivalents via tsconfig rootDir/outDir mappings. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`cruiseTempRoot`](../scripts/lib/audit/diff-scope-resolver.mjs#L277) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 277-339 | Runs dep-cruiser dependency analysis on preimage files and converts results to temp-tree-relative paths. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`gitBuf`](../scripts/lib/audit/diff-scope-resolver.mjs#L73) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 73-85 | Executes a git command and returns the buffer output, logging failures to stderr. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`materialisePreimages`](../scripts/lib/audit/diff-scope-resolver.mjs#L214) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 214-253 | Creates temporary git worktrees for modified/deleted/renamed source files at a base commit for dependency analysis. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
...
| [`parseNameStatusZ`](../scripts/lib/audit/diff-scope-resolver.mjs#L100) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 100-145 | Parses git diff --name-status -z output into structured records with variable-width status codes. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`resolveDiffScope`](../scripts/lib/audit/diff-scope-resolver.mjs#L440) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 440-541 | Determines changed files between commits via git diff and extracts dependency edges from preimage worktrees. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`stripLeadingDotSlash`](../scripts/lib/audit/diff-scope-resolver.mjs#L27) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 27-29 | Removes leading "./" from a path string if present. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`sweepStaleOrphanPreimages`](../scripts/lib/audit/diff-scope-resolver.mjs#L188) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 188-212 | Removes temporary git worktrees older than max age from the system temp directory. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`walkEntryPointDir`](../scripts/lib/audit/diff-scope-resolver.mjs#L49) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 49-63 | Discovers source files in a directory (non-recursive) by extension and adds them to a set. | `scripts/audit-clean.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
...
| [`defaultAdapters`](../scripts/lib/audit/duplication-detector.mjs#L63) | function | `scripts/lib/audit/duplication-detector.mjs` | 63-95 | Factory returning default implementations for symbol extraction, git queries, embeddings, and file I/O. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`extractViaSubprocess`](../scripts/lib/audit/duplication-detector.mjs#L103) | function | `scripts/lib/audit/duplication-detector.mjs` | 103-115 | Spawns the symbol-index extractor as a subprocess for a file list and returns parsed symbol records. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`findPragmaAbove`](../scripts/lib/audit/duplication-detector.mjs#L135) | function | `scripts/lib/audit/duplication-detector.mjs` | 135-143 | Searches up to 3 lines above a declaration for a duplication-justification pragma and extracts its metadata. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`isEligibleChange`](../scripts/lib/audit/duplication-detector.mjs#L145) | function | `scripts/lib/audit/duplication-detector.mjs` | 145-150 | Filters a changed file entry to include only non-deleted source files outside duplication-query exclusions. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`log`](../scripts/lib/audit/duplication-detector.mjs#L60) | function | `scripts/lib/audit/duplication-detector.mjs` | 60-60 | Logs a message to stderr with a duplication-detector prefix. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`runDuplicationAnalysis`](../scripts/lib/audit/duplication-detector.mjs#L160) | function | `scripts/lib/audit/duplication-detector.mjs` | 160-326 | Performs cross-symbol duplication detection via architectural-memory embeddings and neighbourhood queries. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`symKey`](../scripts/lib/audit/duplication-detector.mjs#L125) | function | `scripts/lib/audit/duplication-detector.mjs` | 125-127 | Generates a unique key for a symbol using file path, name, and kind. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`writeTempSource`](../scripts/lib/audit/duplication-detector.mjs#L118) | function | `scripts/lib/audit/duplication-detector.mjs` | 118-122 | Writes file content to a temporary directory, creating parent directories as needed. | `scripts/lib/audit/legacy-production-audit.mjs` |
...
| [`extractFileDiffSection`](../scripts/lib/audit/evidence-triage.mjs#L64) | function | `scripts/lib/audit/evidence-triage.mjs` | 64-94 | Extracts a single file's diff section from a unified diff by matching its path. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`findLineRangeInContent`](../scripts/lib/audit/evidence-triage.mjs#L194) | function | `scripts/lib/audit/evidence-triage.mjs` | 194-206 | Finds the line-number range where a quoted snippet appears in source content. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`mapHeadLineToBase`](../scripts/lib/audit/evidence-triage.mjs#L227) | function | `scripts/lib/audit/evidence-triage.mjs` | 227-242 | Maps a line number from new version to old version using hunk offset deltas. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`mapHeadRangeToBase`](../scripts/lib/audit/evidence-triage.mjs#L255) | function | `scripts/lib/audit/evidence-triage.mjs` | 255-262 | Maps a line range from new to old version, preserving the span length. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`parseHunkHeader`](../scripts/lib/audit/evidence-triage.mjs#L105) | function | `scripts/lib/audit/evidence-triage.mjs` | 105-114 | Parses hunk header syntax to extract line ranges for old and new versions. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`quoteAppearsOnSide`](../scripts/lib/audit/evidence-triage.mjs#L154) | function | `scripts/lib/audit/evidence-triage.mjs` | 154-177 | Checks if a normalized quote exists anywhere in a diff hunk on a specified side. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`resolveAnchorLocation`](../scripts/lib/audit/evidence-triage.mjs#L306) | function | `scripts/lib/audit/evidence-triage.mjs` | 306-346 | Validates an evidence anchor against a diff, classifying it as verified/contradicted/malformed/unverifiable. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`resolveScopeBucketForFinding`](../scripts/lib/audit/evidence-triage.mjs#L437) | function | `scripts/lib/audit/evidence-triage.mjs` | 437-447 | Determines the scope bucket (change_related, out_of_scope, etc.) for a finding. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`resolveWithFallback`](../scripts/lib/audit/evidence-triage.mjs#L470) | function | `scripts/lib/audit/evidence-triage.mjs` | 470-494 | Tries primary evidence verification, falls back to alternatives on failure. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`runStage0EvidenceTriage`](../scripts/lib/audit/evidence-triage.mjs#L555) | function | `scripts/lib/audit/evidence-triage.mjs` | 555-671 | Triages all candidate findings via Stage-0 evidence anchor validation. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`splitIntoHunks`](../scripts/lib/audit/evidence-triage.mjs#L125) | function | `scripts/lib/audit/evidence-triage.mjs` | 125-139 | Splits a file diff into hunks, each with a header and content lines. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`tagPreExisting`](../scripts/lib/audit/evidence-triage.mjs#L403) | function | `scripts/lib/audit/evidence-triage.mjs` | 403-409 | Checks whether a finding is pre-existing and unrelated to the current change. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`verifyAnchor`](../scripts/lib/audit/evidence-triage.mjs#L369) | function | `scripts/lib/audit/evidence-triage.mjs` | 369-380 | Returns true if a finding's evidence quote actually appears in the diff hunk. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`anchorFileCandidates`](../scripts/lib/audit/final-adjudication.mjs#L330) | function | `scripts/lib/audit/final-adjudication.mjs` | 330-333 | Extracts file paths from a finding's anchor and trigger anchor fields. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildAlternativeEvidenceLines`](../scripts/lib/audit/final-adjudication.mjs#L375) | function | `scripts/lib/audit/final-adjudication.mjs` | 375-384 | Formats alternative evidence lines for a finding, filtering out sensitive paths and canonical duplicates. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildFindingDetail`](../scripts/lib/audit/final-adjudication.mjs#L387) | function | `scripts/lib/audit/final-adjudication.mjs` | 387-391 | Combines a finding's base detail with alternative evidence lines for Gemini review. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`createGeminiReviewSubprocessAdapters`](../scripts/lib/audit/final-adjudication.mjs#L495) | function | `scripts/lib/audit/final-adjudication.mjs` | 495-585 | Factory creating adapter functions for subprocess-based Gemini review with sensitive-path gating. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`defaultGeminiReviewScriptPath`](../scripts/lib/audit/final-adjudication.mjs#L64) | function | `scripts/lib/audit/final-adjudication.mjs` | 64-66 | Returns the filesystem path to the sibling gemini-review.mjs script using module-relative resolution. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`envelopeReferencedFiles`](../scripts/lib/audit/final-adjudication.mjs#L342) | function | `scripts/lib/audit/final-adjudication.mjs` | 342-345 | Collects all files referenced by a finding envelope's canonical finding and trigger anchor. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`interpretVerdict`](../scripts/lib/audit/final-adjudication.mjs#L181) | function | `scripts/lib/audit/final-adjudication.mjs` | 181-210 | Maps Gemini review verdicts (reversed/confirmed/verified) to adjudication outcomes with suppression logic. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`invokeGeminiReviewSubprocess`](../scripts/lib/audit/final-adjudication.mjs#L422) | function | `scripts/lib/audit/final-adjudication.mjs` | 422-465 | Spawns gemini-review.mjs as a subprocess with a staged transcript and returns the parsed JSON result. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`isPathSensitive`](../scripts/lib/audit/final-adjudication.mjs#L354) | function | `scripts/lib/audit/final-adjudication.mjs` | 354-361 | Determines whether a file path resolves to a sensitive resource (credentials, keys, etc.). | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`primaryFile`](../scripts/lib/audit/final-adjudication.mjs#L394) | function | `scripts/lib/audit/final-adjudication.mjs` | 394-399 | Extracts the primary file reference from a finding envelope's section, file, or nested anchor fields. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`runFinalAdjudication`](../scripts/lib/audit/final-adjudication.mjs#L230) | function | `scripts/lib/audit/final-adjudication.mjs` | 230-321 | Orchestrates Gemini review of sampled findings and routes outcomes to verified/dismissed/unresolved/security-review buckets. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectAdjudicationSample`](../scripts/lib/audit/final-adjudication.mjs#L84) | function | `scripts/lib/audit/final-adjudication.mjs` | 84-112 | Uses seeded randomization to select mandatory escalations, sampled mechanical dismissals, and clean-region files for review. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectFinalAdjudicationWorkItems`](../scripts/lib/audit/final-adjudication.mjs#L151) | function | `scripts/lib/audit/final-adjudication.mjs` | 151-166 | Builds a work queue for Gemini review from escalated, sampled, and clean-region candidates with optional budgets. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L3138) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 3138-3257 | Assembles all audit inputs and constructs provider handles | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L244) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 244-255 | Caches single pass result to disk | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L257) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 257-262 | Caches multiple pass results to directory | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L264) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 264-267 | Removes the cache directory | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L370) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 370-418 | Decides whether to seed OpenAI prefix cache and selects seed unit | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L992) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 992-1062 | Converts architecture violations to Finding objects | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L924) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 924-973 | Formats architecture violations and dead domains for prompts | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L234) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 234-242 | Creates temp directory for caching audit pass results | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L271) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 271-273 | Normalizes findings for output | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L797) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 797-819 | Converts orphan-code finding to Finding object | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L652) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 652-787 | Analyzes cross-domain imports and dead domains for audit | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1092) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1092-3102 | Main orchestrator for multi-pass GPT audit with map-reduce and suppression | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L452) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 452-634 | Runs map-reduce audit with optional prefix-cache warm-up | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L423) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 423-450 | Runs GPT audit on single code unit with slot-based concurrency | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L838) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 838-917 | Detects orphaned or newly-orphan files in diff | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L175) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 175-179 | Decides whether audit needs map-reduce based on file/character count | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L186) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 186-190 | Decides whether high-reasoning audit needs map-reduce (higher threshold) | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L353) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 353-359 | Re-throws config-level LLM errors from settled promises | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L293) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 293-325 | Validates ledger exists and parses for R2+ suppression | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`completePlanAuditRun`](../scripts/lib/audit/plan-audit-cloud.mjs#L91) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 91-116 | Records plan audit findings and completion status in the cloud store (non-blocking). | `scripts/openai-audit.mjs` |
| [`gitAnchor`](../scripts/lib/audit/plan-audit-cloud.mjs#L33) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 33-41 | Extracts current git commit SHA and branch name. | `scripts/openai-audit.mjs` |
| [`registerPlanAuditRun`](../scripts/lib/audit/plan-audit-cloud.mjs#L52) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 52-79 | Records plan audit start in the cloud store and upserts the plan artifact with commit metadata. | `scripts/openai-audit.mjs` |
...
| [`buildPreExistingDebtEntry`](../scripts/lib/audit/tiered-pipeline.mjs#L373) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 373-394 | Converts a pre-existing independent finding into a debt ledger entry. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`buildStage0RelevanceContext`](../scripts/lib/audit/tiered-pipeline.mjs#L291) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 291-329 | Pre-loads file contents and code-impact data for Stage-0 triage. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`buildStage1TriagerPrompt`](../scripts/lib/audit/tiered-pipeline.mjs#L163) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 163-174 | Builds system and user prompts for the cheap Stage-1 triager. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`collectCandidateAnchorFiles`](../scripts/lib/audit/tiered-pipeline.mjs#L253) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 253-269 | Collects all file paths referenced in evidence anchors across candidates. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`defaultTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L188) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 188-201 | Calls GPT to triage a finding for evidence-based dismissal. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`extractCanonicalAnchorFile`](../scripts/lib/audit/tiered-pipeline.mjs#L358) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 358-363 | Extracts the file path from a finding's primary evidence anchor. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`makeBlameAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L339) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 339-349 | Returns a function that checks if code predates the current commit. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`makeHeadContentAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L331) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 331-333 | Returns a function that retrieves cached head-version file content. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`makeImpactAdapter`](../scripts/lib/audit/tiered-pipeline.mjs#L335) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 335-337 | Returns a function that retrieves cached code-impact data. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeModifiedAnchorPaths`](../scripts/lib/audit/tiered-pipeline.mjs#L133) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 133-149 | Repairs incomplete file paths in evidence anchors for modified files. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`routePreExistingIndependent`](../scripts/lib/audit/tiered-pipeline.mjs#L409) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 409-453 | Writes pre-existing independent findings to debt ledger instead of escalating. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`runTieredAuditPipeline`](../scripts/lib/audit/tiered-pipeline.mjs#L459) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 459-1014 | Orchestrates discovery, Stage-0 triage, Stage-1 triaging, and Stage-2 adjudication. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`TieredUnavailableError`](../scripts/lib/audit/tiered-pipeline.mjs#L97) | class | `scripts/lib/audit/tiered-pipeline.mjs` | 97-103 | Error class raised when a required tiered pipeline component is unavailable. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`validatedTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L215) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 215-243 | Calls an OSS provider to triage a finding with validation guards. | `scripts/lib/audit/tiered-shadow-compare.mjs`, `scripts/model-eval-discovery.mjs`, `scripts/openai-audit.mjs` |
| [`appendShadowLog`](../scripts/lib/audit/tiered-shadow-compare.mjs#L404) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 404-411 | Writes a shadow observation to the local JSONL audit log. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`buildLegacyBuckets`](../scripts/lib/audit/tiered-shadow-compare.mjs#L469) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 469-477 | Maps legacy findings to scope buckets based on which files changed. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`buildShadowCtx`](../scripts/lib/audit/tiered-shadow-compare.mjs#L84) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 84-137 | Creates an audit context for shadow runs that avoids mutating shared state. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`buildTieredBuckets`](../scripts/lib/audit/tiered-shadow-compare.mjs#L490) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 490-496 | Extracts scope buckets from tiered pipeline findings. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`compareAuditRunResults`](../scripts/lib/audit/tiered-shadow-compare.mjs#L219) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 219-336 | Compares legacy and tiered audit results, measuring pipeline equivalence. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`findingFile`](../scripts/lib/audit/tiered-shadow-compare.mjs#L165) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 165-171 | Extracts the primary file path from a finding object. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`parseTotalSeconds`](../scripts/lib/audit/tiered-shadow-compare.mjs#L146) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 146-154 | Parses and validates a duration string (e.g., "12.34s") from timing output. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`recordObservation`](../scripts/lib/audit/tiered-shadow-compare.mjs#L507) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 507-524 | Logs a shadow observation locally and attempts cloud persistence. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runShadowTieredPipeline`](../scripts/lib/audit/tiered-shadow-compare.mjs#L363) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 363-394 | Executes the tiered pipeline in shadow mode with timeout handling. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runTieredShadowComparison`](../scripts/lib/audit/tiered-shadow-compare.mjs#L424) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 424-450 | Orchestrates parallel execution and comparison of legacy vs shadow pipelines. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
...
| [`median`](../scripts/lib/audit/tiered-shadow-summary.mjs#L36) | function | `scripts/lib/audit/tiered-shadow-summary.mjs` | 36-41 | Calculates the median value of a numeric array. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`normalizeDbRow`](../scripts/lib/audit/tiered-shadow-summary.mjs#L28) | function | `scripts/lib/audit/tiered-shadow-summary.mjs` | 28-34 | Converts database row column names from snake_case to camelCase. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`readRecords`](../scripts/lib/audit/tiered-shadow-summary.mjs#L49) | function | `scripts/lib/audit/tiered-shadow-summary.mjs` | 49-55 | Reads and parses JSONL log file, silently skipping malformed lines. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`summarize`](../scripts/lib/audit/tiered-shadow-summary.mjs#L117) | function | `scripts/lib/audit/tiered-shadow-summary.mjs` | 117-238 | Computes tiered-recall audit statistics: legacy failures, shadow-only failures, and comparison status metrics. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`windowProgress`](../scripts/lib/audit/tiered-shadow-summary.mjs#L246) | function | `scripts/lib/audit/tiered-shadow-summary.mjs` | 246-253 | Reports whether a collection window has met its minimum/maximum comparison targets. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/tiered-shadow-report.mjs` |
...
| [`applyExclusions`](../scripts/openai-audit.mjs#L169) | function | `scripts/openai-audit.mjs` | 169-178 | Filters files by micromatch exclusion patterns and reports excluded count. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`loadExcludePatterns`](../scripts/openai-audit.mjs#L150) | function | `scripts/openai-audit.mjs` | 150-161 | Reads exclusion patterns from CLI arguments and a `.auditignore` file. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`main`](../scripts/openai-audit.mjs#L484) | function | `scripts/openai-audit.mjs` | 484-1151 | CLI entry point that refreshes models, checks tool staleness, and runs the audit. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`printAuditResult`](../scripts/openai-audit.mjs#L344) | function | `scripts/openai-audit.mjs` | 344-399 | Outputs audit results as markdown, JSON, or a summary file depending on output mode. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`printCostPreflight`](../scripts/openai-audit.mjs#L106) | function | `scripts/openai-audit.mjs` | 106-124 | Estimates and logs the audit cost based on model pricing and token budgets. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`resolveDiffBase`](../scripts/openai-audit.mjs#L477) | function | `scripts/openai-audit.mjs` | 477-480 | Returns the git base for diffing (explicit, HEAD, or HEAD~1). | `scripts/lib/model-eval/arm-generation.mjs` |
| [`runMultiPassCodeAudit`](../scripts/openai-audit.mjs#L429) | function | `scripts/openai-audit.mjs` | 429-456 | Routes audit to tiered or legacy pipeline with optional shadow validation. | `scripts/lib/model-eval/arm-generation.mjs` |
...
| [`buildInsightFile`](../scripts/lib/brainstorm/insight-store.mjs#L138) | function | `scripts/lib/brainstorm/insight-store.mjs` | 138-153 | Assembles a markdown file with validated YAML frontmatter and insight text. | `scripts/brainstorm-round.mjs` |
| [`findExistingSlugForTopic`](../scripts/lib/brainstorm/insight-store.mjs#L98) | function | `scripts/lib/brainstorm/insight-store.mjs` | 98-116 | Locates the disk directory slug for a topic by scanning matching candidates. | `scripts/brainstorm-round.mjs` |
| [`listAllInsights`](../scripts/lib/brainstorm/insight-store.mjs#L234) | function | `scripts/lib/brainstorm/insight-store.mjs` | 234-246 | Returns all insights from all topics, skipping dotfiles and invalid directories. | `scripts/brainstorm-round.mjs` |
| [`listInsightsByTopic`](../scripts/lib/brainstorm/insight-store.mjs#L216) | function | `scripts/lib/brainstorm/insight-store.mjs` | 216-225 | Returns all insights matching an exact topic name. | `scripts/brainstorm-round.mjs` |
| [`parseFrontmatter`](../scripts/lib/brainstorm/insight-store.mjs#L125) | function | `scripts/lib/brainstorm/insight-store.mjs` | 125-132 | Extracts YAML frontmatter from a markdown string, returning fields and body. | `scripts/brainstorm-round.mjs` |
| [`readInsightsFromDirs`](../scripts/lib/brainstorm/insight-store.mjs#L248) | function | `scripts/lib/brainstorm/insight-store.mjs` | 248-278 | Loads insight metadata from markdown files in specified directories, sorted by mtime descending. | `scripts/brainstorm-round.mjs` |
| [`resolveUniqueSlug`](../scripts/lib/brainstorm/insight-store.mjs#L74) | function | `scripts/lib/brainstorm/insight-store.mjs` | 74-85 | Allocates a unique slug by appending numeric suffixes to avoid collisions. | `scripts/brainstorm-round.mjs` |
| [`rootDir`](../scripts/lib/brainstorm/insight-store.mjs#L34) | function | `scripts/lib/brainstorm/insight-store.mjs` | 34-36 | Returns the insights directory path, using override or default. | `scripts/brainstorm-round.mjs` |
| [`saveInsight`](../scripts/lib/brainstorm/insight-store.mjs#L162) | function | `scripts/lib/brainstorm/insight-store.mjs` | 162-205 | Persists an insight to disk with collision-safe slug allocation and idempotency checking. | `scripts/brainstorm-round.mjs` |
| [`shortHash`](../scripts/lib/brainstorm/insight-store.mjs#L39) | function | `scripts/lib/brainstorm/insight-store.mjs` | 39-41 | Generates a 16-character SHA256 hash of concatenated parts. | `scripts/brainstorm-round.mjs` |
| [`slugifyTopic`](../scripts/lib/brainstorm/insight-store.mjs#L57) | function | `scripts/lib/brainstorm/insight-store.mjs` | 57-63 | Converts a topic string to a URL-safe slug with hyphenated word separation. | `scripts/brainstorm-round.mjs` |
...
| [`appendQuarantine`](../scripts/lib/brainstorm/session-store.mjs#L229) | function | `scripts/lib/brainstorm/session-store.mjs` | 229-263 | Appends invalid session lines to a quarantine log for forensic review. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`appendSession`](../scripts/lib/brainstorm/session-store.mjs#L77) | function | `scripts/lib/brainstorm/session-store.mjs` | 77-114 | Records a brainstorm round with schema validation, round numbering, and idempotency checking. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`loadSession`](../scripts/lib/brainstorm/session-store.mjs#L150) | function | `scripts/lib/brainstorm/session-store.mjs` | 150-227 | Loads a brainstorm session from JSONL, validating each round and quarantining corrupt lines. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`lockPath`](../scripts/lib/brainstorm/session-store.mjs#L36) | function | `scripts/lib/brainstorm/session-store.mjs` | 36-38 | Constructs the lock file path for a session. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`normalizeArchFields`](../scripts/lib/brainstorm/session-store.mjs#L141) | function | `scripts/lib/brainstorm/session-store.mjs` | 141-148 | Ensures architectural context fields have consistent defaults (false/0/null). | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`pruneOldSessions`](../scripts/lib/brainstorm/session-store.mjs#L295) | function | `scripts/lib/brainstorm/session-store.mjs` | 295-337 | Deletes session files exceeding a retention age, throttled by a sentinel file. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`quarantinePath`](../scripts/lib/brainstorm/session-store.mjs#L40) | function | `scripts/lib/brainstorm/session-store.mjs` | 40-42 | Constructs the quarantine file path for a session's invalid lines. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`readLinesUnvalidated`](../scripts/lib/brainstorm/session-store.mjs#L53) | function | `scripts/lib/brainstorm/session-store.mjs` | 53-67 | Reads session JSONL lines, assigning inferred round numbers to invalid entries. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`sessionDir`](../scripts/lib/brainstorm/session-store.mjs#L28) | function | `scripts/lib/brainstorm/session-store.mjs` | 28-30 | Returns the brainstorm sessions directory path, using override or default. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`sessionPath`](../scripts/lib/brainstorm/session-store.mjs#L32) | function | `scripts/lib/brainstorm/session-store.mjs` | 32-34 | Constructs the file path for a session's JSONL log. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
| [`summariseRound`](../scripts/lib/brainstorm/session-store.mjs#L272) | function | `scripts/lib/brainstorm/session-store.mjs` | 272-280 | Formats a brainstorm round as a human-readable debug summary. | `scripts/brainstorm-round.mjs`, `scripts/lib/brainstorm/resume-context.mjs` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`applyFixes`](../scripts/lib/claudemd/autofix.mjs#L17) | function | `scripts/lib/claudemd/autofix.mjs` | 17-74 | Removes stale markdown file references with dryRun-capable line-based replacement. | `scripts/claudemd-lint.mjs` |
...
> Collects audit runs, telemetry, and architectural data, rendering them into static HTML dashboard pages (reference, telemetry, per-run views) while monitoring and reporting data-source health and degradation.
...
| [`sectionModelAb`](../scripts/lib/dashboard/sections/model-ab.mjs#L21) | function | `scripts/lib/dashboard/sections/model-ab.mjs` | 21-69 | Generates the HTML dashboard panel displaying model-A/B/C adjudication telemetry. | `scripts/lib/dashboard/render.mjs` |
...
> Persists and analyzes audit-finding outcomes (JSONL-based), computes pass-level performance metrics (acceptance rate, weighted reward) for adaptive learning, and tracks remediation tasks.
...
| [`applyLazyDecay`](../scripts/lib/findings-tracker.mjs#L29) | function | `scripts/lib/findings-tracker.mjs` | 29-54 | Applies exponential decay to a false-positive pattern's acceptance and dismissal counters over time. | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
| [`buildPatternKey`](../scripts/lib/findings-tracker.mjs#L103) | function | `scripts/lib/findings-tracker.mjs` | 103-105 | Builds a composite key from finding dimensions for pattern matching. | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
| [`effectiveSampleSize`](../scripts/lib/findings-tracker.mjs#L59) | function | `scripts/lib/findings-tracker.mjs` | 59-61 | Calculates the effective sample size by summing decayed accepted and dismissed counts. | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
| [`extractDimensions`](../scripts/lib/findings-tracker.mjs#L90) | function | `scripts/lib/findings-tracker.mjs` | 90-98 | Extracts finding metadata into structured dimensions (category, severity, principle, repo, file type). | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
| [`FalsePositiveTracker`](../scripts/lib/findings-tracker.mjs#L113) | class | `scripts/lib/findings-tracker.mjs` | 113-254 | Tracks false-positive patterns with decay, persistence, and cloud synchronization. | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
| [`recordWithDecay`](../scripts/lib/findings-tracker.mjs#L67) | function | `scripts/lib/findings-tracker.mjs` | 67-83 | Records a finding outcome (accepted/dismissed) and recomputes the pattern's decay and EMA. | `scripts/lib/findings.mjs`, `scripts/lib/suppression-policy.mjs` |
...
```mermaid
flowchart TB
subgraph dom_fit_check ["fit-check"]
  file_scripts_lib_fit_check_detect_mjs["scripts/lib/fit-check/detect.mjs"]:::component
  sym_scripts_lib_fit_check_detect_mjs_detectS["detectShape"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_detectS
  sym_scripts_lib_fit_check_detect_mjs_detectT["detectTestRunner"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_detectT
  sym_scripts_lib_fit_check_detect_mjs_existsA["existsAny"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_existsA
  sym_scripts_lib_fit_check_detect_mjs_grepFor["grepForAnnotations"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_grepFor
  sym_scripts_lib_fit_check_detect_mjs_hasJson["hasJsonMarker"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_hasJson
  sym_scripts_lib_fit_check_detect_mjs_pickFra["pickFramework"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_pickFra
  sym_scripts_lib_fit_check_detect_mjs_pkgHas["pkgHas"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_pkgHas
  sym_scripts_lib_fit_check_detect_mjs_pkgHasB["pkgHasBin"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_pkgHasB
  sym_scripts_lib_fit_check_detect_mjs_pyDepHa["pyDepHas"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_pyDepHa
  sym_scripts_lib_fit_check_detect_mjs_readHea["readHeadOf"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_readHea
  sym_scripts_lib_fit_check_detect_mjs_readPkg["readPkg"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_readPkg
  sym_scripts_lib_fit_check_detect_mjs_walkBou["walkBounded"]:::symbol
  file_scripts_lib_fit_check_detect_mjs --> sym_scripts_lib_fit_check_detect_mjs_walkBou
  file_scripts_lib_fit_check_rules_mjs["scripts/lib/fit-check/rules.mjs"]:::component
  sym_scripts_lib_fit_check_rules_mjs_applyRul["applyRules"]:::symbol
  file_scripts_lib_fit_check_rules_mjs --> sym_scripts_lib_fit_check_rules_mjs_applyRul
  sym_scripts_lib_fit_check_rules_mjs_groupByL["groupByLabel"]:::symbol
  file_scripts_lib_fit_check_rules_mjs --> sym_scripts_lib_fit_check_rules_mjs_groupByL
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
| [`applyRules`](../scripts/lib/fit-check/rules.mjs#L201) | function | `scripts/lib/fit-check/rules.mjs` | 201-206 | Evaluates all skill-fit rules against a user profile and returns verdicts. | `scripts/skills-fit-check.mjs` |
| [`groupByLabel`](../scripts/lib/fit-check/rules.mjs#L212) | function | `scripts/lib/fit-check/rules.mjs` | 212-218 | Partitions skill verdicts into FITS, PARTIAL, and MISMATCH buckets. | `scripts/skills-fit-check.mjs` |
...
```mermaid
flowchart TB
subgraph dom_friction ["friction"]
  file_scripts_lib_friction_breadcrumb_mjs["scripts/lib/friction/breadcrumb.mjs"]:::component
  sym_scripts_lib_friction_breadcrumb_mjs_appe["appendInjected"]:::symbol
  file_scripts_lib_friction_breadcrumb_mjs --> sym_scripts_lib_friction_breadcrumb_mjs_appe
  sym_scripts_lib_friction_breadcrumb_mjs_read["readLines"]:::symbol
  file_scripts_lib_friction_breadcrumb_mjs --> sym_scripts_lib_friction_breadcrumb_mjs_read
  sym_scripts_lib_friction_breadcrumb_mjs_read["readRecent"]:::symbol
  file_scripts_lib_friction_breadcrumb_mjs --> sym_scripts_lib_friction_breadcrumb_mjs_read
  file_scripts_lib_friction_commands_mjs["scripts/lib/friction/commands.mjs"]:::component
  sym_scripts_lib_friction_commands_mjs_annota["annotateCluster"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_annota
  sym_scripts_lib_friction_commands_mjs_buildM["buildMemoryFileContent"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_buildM
  sym_scripts_lib_friction_commands_mjs_fricti["frictionAdd"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_fricti["frictionDigest"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_fricti["frictionLink"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_fricti["frictionMirror"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_fricti["frictionNeighbourhood"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_fricti["frictionSessionReview"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_fricti
  sym_scripts_lib_friction_commands_mjs_isSafe["isSafeMemoryName"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_isSafe
  sym_scripts_lib_friction_commands_mjs_mirror["mirrorOneRow"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_mirror
  sym_scripts_lib_friction_commands_mjs_redact["redactText"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_redact
  sym_scripts_lib_friction_commands_mjs_resolv["resolveDeps"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_resolv
  sym_scripts_lib_friction_commands_mjs_resolv["resolveReadRepoId"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_resolv
  sym_scripts_lib_friction_commands_mjs_resolv["resolveWriteRepoId"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_resolv
  sym_scripts_lib_friction_commands_mjs_saniti["sanitizeFrictionQueryInput"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_saniti
  sym_scripts_lib_friction_commands_mjs_saniti["sanitizeRef"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_saniti
  sym_scripts_lib_friction_commands_mjs_slugif["slugifyTitle"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_slugif
  sym_scripts_lib_friction_commands_mjs_update["updateMemoryIndex"]:::symbol
  file_scripts_lib_friction_commands_mjs --> sym_scripts_lib_friction_commands_mjs_update
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`appendInjected`](../scripts/lib/friction/breadcrumb.mjs#L62) | function | `scripts/lib/friction/breadcrumb.mjs` | 62-88 | Logs a friction memory injection with TTL-based pruning and atomic rotation. | `scripts/lib/friction/commands.mjs` |
| [`readLines`](../scripts/lib/friction/breadcrumb.mjs#L36) | function | `scripts/lib/friction/breadcrumb.mjs` | 36-50 | Reads a breadcrumb log file, returning only valid JSON records with required fields. | `scripts/lib/friction/commands.mjs` |
| [`readRecent`](../scripts/lib/friction/breadcrumb.mjs#L98) | function | `scripts/lib/friction/breadcrumb.mjs` | 98-111 | Returns recent friction memory injections within a time window, deduplicated by name. | `scripts/lib/friction/commands.mjs` |
| [`annotateCluster`](../scripts/lib/friction/commands.mjs#L397) | function | `scripts/lib/friction/commands.mjs` | 397-405 | Adds protection status, alarm flag, and rank to a friction cluster. | `scripts/cross-skill.mjs` |
| [`buildMemoryFileContent`](../scripts/lib/friction/commands.mjs#L211) | function | `scripts/lib/friction/commands.mjs` | 211-231 | Assembles a friction memory markdown file with typed YAML frontmatter. | `scripts/cross-skill.mjs` |
| [`frictionAdd`](../scripts/lib/friction/commands.mjs#L258) | function | `scripts/lib/friction/commands.mjs` | 258-311 | Creates a friction memory file locally and optionally mirrors it to cloud. | `scripts/cross-skill.mjs` |
| [`frictionDigest`](../scripts/lib/friction/commands.mjs#L374) | function | `scripts/lib/friction/commands.mjs` | 374-394 | Queries cloud for recurring friction clusters, ranked by recurrence and cost. | `scripts/cross-skill.mjs` |
| [`frictionLink`](../scripts/lib/friction/commands.mjs#L416) | function | `scripts/lib/friction/commands.mjs` | 416-466 | Records a mitigation reference (commit/doc/rule) in a friction memory's YAML. | `scripts/cross-skill.mjs` |
| [`frictionMirror`](../scripts/lib/friction/commands.mjs#L321) | function | `scripts/lib/friction/commands.mjs` | 321-365 | Mirrors local friction memory files to cloud, tracking hash changes and secret refusals. | `scripts/cross-skill.mjs` |
| [`frictionNeighbourhood`](../scripts/lib/friction/commands.mjs#L513) | function | `scripts/lib/friction/commands.mjs` | 513-546 | Queries cloud for friction memories semantically similar to a prompt. | `scripts/cross-skill.mjs` |
| [`frictionSessionReview`](../scripts/lib/friction/commands.mjs#L483) | function | `scripts/lib/friction/commands.mjs` | 483-502 | Returns recently-injected friction memories for user-gated closure linking. | `scripts/cross-skill.mjs` |
| [`isSafeMemoryName`](../scripts/lib/friction/commands.mjs#L167) | function | `scripts/lib/friction/commands.mjs` | 167-169 | Checks whether a memory name matches the safe single-segment slug pattern. | `scripts/cross-skill.mjs` |
| [`mirrorOneRow`](../scripts/lib/friction/commands.mjs#L196) | function | `scripts/lib/friction/commands.mjs` | 196-208 | Writes one friction record to cloud with secret-redaction and error reporting. | `scripts/cross-skill.mjs` |
| [`redactText`](../scripts/lib/friction/commands.mjs#L48) | function | `scripts/lib/friction/commands.mjs` | 48-48 | Redacts secrets from text, returning plain text or non-string passthrough. | `scripts/cross-skill.mjs` |
| [`resolveDeps`](../scripts/lib/friction/commands.mjs#L51) | function | `scripts/lib/friction/commands.mjs` | 51-69 | Merges dependency implementations, allowing test-time mocking via overrides. | `scripts/cross-skill.mjs` |
| [`resolveReadRepoId`](../scripts/lib/friction/commands.mjs#L189) | function | `scripts/lib/friction/commands.mjs` | 189-193 | Looks up a repo ID by UUID for reading friction records from cloud. | `scripts/cross-skill.mjs` |
| [`resolveWriteRepoId`](../scripts/lib/friction/commands.mjs#L183) | function | `scripts/lib/friction/commands.mjs` | 183-186 | Fetches the repo ID for cloud mirroring, returning null if unresolved. | `scripts/cross-skill.mjs` |
| [`sanitizeFrictionQueryInput`](../scripts/lib/friction/commands.mjs#L102) | function | `scripts/lib/friction/commands.mjs` | 102-158 | Filters friction query fields through an egress allowlist and pre-write secret gate. | `scripts/cross-skill.mjs` |
| [`sanitizeRef`](../scripts/lib/friction/commands.mjs#L469) | function | `scripts/lib/friction/commands.mjs` | 469-472 | Redacts secrets from a mitigation reference link. | `scripts/cross-skill.mjs` |
| [`slugifyTitle`](../scripts/lib/friction/commands.mjs#L172) | function | `scripts/lib/friction/commands.mjs` | 172-180 | Converts a friction title to a URL-safe slug prefixed with 'friction-'. | `scripts/cross-skill.mjs` |
| [`updateMemoryIndex`](../scripts/lib/friction/commands.mjs#L234) | function | `scripts/lib/friction/commands.mjs` | 234-246 | Appends a friction memory link to the local MEMORY.md index. | `scripts/cross-skill.mjs` |

---

## gate-honesty

> Gate-honesty validates that skills' stated enforcement gates (convergence thresholds, unverified functions, exit codes) actually exist in the code and match gate-contract.json declarations.

```mermaid
flowchart TB
subgraph dom_gate_honesty ["gate-honesty"]
  file_scripts_lib_gate_honesty_loader_mjs["scripts/lib/gate-honesty/loader.mjs"]:::component
  sym_scripts_lib_gate_honesty_loader_mjs_form["formatSummaryLines"]:::symbol
  file_scripts_lib_gate_honesty_loader_mjs --> sym_scripts_lib_gate_honesty_loader_mjs_form
  sym_scripts_lib_gate_honesty_loader_mjs_load["loadGateContracts"]:::symbol
  file_scripts_lib_gate_honesty_loader_mjs --> sym_scripts_lib_gate_honesty_loader_mjs_load
  file_scripts_lib_gate_honesty_oracles_mjs["scripts/lib/gate-honesty/oracles.mjs"]:::component
  sym_scripts_lib_gate_honesty_oracles_mjs_cli["cliExit"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_cli
  sym_scripts_lib_gate_honesty_oracles_mjs_con["convergenceThreshold"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_con
  sym_scripts_lib_gate_honesty_oracles_mjs_imp["importImplementation"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_imp
  sym_scripts_lib_gate_honesty_oracles_mjs_run["runOracle"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_run
  sym_scripts_lib_gate_honesty_oracles_mjs_tie["tieredShadowWindow"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_tie
  sym_scripts_lib_gate_honesty_oracles_mjs_vis["visualGateUnverified"]:::symbol
  file_scripts_lib_gate_honesty_oracles_mjs --> sym_scripts_lib_gate_honesty_oracles_mjs_vis
  file_scripts_lib_gate_honesty_schema_mjs["scripts/lib/gate-honesty/schema.mjs"]:::component
  sym_scripts_lib_gate_honesty_schema_mjs_exis["existsFile"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_exis
  sym_scripts_lib_gate_honesty_schema_mjs_file["fileTextContains"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_file
  sym_scripts_lib_gate_honesty_schema_mjs_file["fileTextReferencesId"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_file
  sym_scripts_lib_gate_honesty_schema_mjs_isAp["isApprovedStatedInSource"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_isAp
  sym_scripts_lib_gate_honesty_schema_mjs_reso["resolveContainedPath"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_reso
  sym_scripts_lib_gate_honesty_schema_mjs_vali["validateGateContract"]:::symbol
  file_scripts_lib_gate_honesty_schema_mjs --> sym_scripts_lib_gate_honesty_schema_mjs_vali
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
| [`cliExit`](../scripts/lib/gate-honesty/oracles.mjs#L131) | function | `scripts/lib/gate-honesty/oracles.mjs` | 131-151 | Test that a CLI tool exits with expected code and stderr output under a fixture. | _(internal)_ |
| [`convergenceThreshold`](../scripts/lib/gate-honesty/oracles.mjs#L28) | function | `scripts/lib/gate-honesty/oracles.mjs` | 28-56 | Verify that a gate's stated convergence threshold constants match the implementation. | _(internal)_ |
| [`importImplementation`](../scripts/lib/gate-honesty/oracles.mjs#L22) | function | `scripts/lib/gate-honesty/oracles.mjs` | 22-25 | Dynamically import a module from a repo-relative path. | _(internal)_ |
| [`runOracle`](../scripts/lib/gate-honesty/oracles.mjs#L167) | function | `scripts/lib/gate-honesty/oracles.mjs` | 167-175 | Dispatch a gate-honesty test to the appropriate oracle adapter. | _(internal)_ |
| [`tieredShadowWindow`](../scripts/lib/gate-honesty/oracles.mjs#L59) | function | `scripts/lib/gate-honesty/oracles.mjs` | 59-81 | Verify that a tiered-shadow window's progress metrics match the implementation. | _(internal)_ |
| [`visualGateUnverified`](../scripts/lib/gate-honesty/oracles.mjs#L84) | function | `scripts/lib/gate-honesty/oracles.mjs` | 84-111 | Verify that visual-audit's unverified-reason function returns correct values for test inputs. | _(internal)_ |
...
> Computes skill manifests with file hashes and YAML metadata to enable safe, conflict-detecting installation when syncing skills to consumer repos.
...
subgraph dom_install ["install"]
  ...
  sym_scripts_build_manifest_mjs_readManifestO["readManifestOrNull"]:::symbol
  file_scripts_build_manifest_mjs --> sym_scripts_build_manifest_mjs_readManifestO
  sym_scripts_build_manifest_mjs_sameIgnoringT["sameIgnoringTimestamp"]:::symbol
  file_scripts_build_manifest_mjs --> sym_scripts_build_manifest_mjs_sameIgnoringT
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`buildManifest`](../scripts/build-manifest.mjs#L99) | function | `scripts/build-manifest.mjs` | 99-163 | Generates skill manifest with file metadata, hashes, and bundle version. | _(internal)_ |
| [`extractFrontmatterBody`](../scripts/build-manifest.mjs#L49) | function | `scripts/build-manifest.mjs` | 49-54 | Extracts YAML frontmatter section from markdown document. | _(internal)_ |
| [`extractSkillSummary`](../scripts/build-manifest.mjs#L64) | function | `scripts/build-manifest.mjs` | 64-94 | Extracts description field value from skill frontmatter YAML. | _(internal)_ |
| [`fileSha`](../scripts/build-manifest.mjs#L40) | function | `scripts/build-manifest.mjs` | 40-43 | Computes 12-char hex SHA256 checksum of file content. | _(internal)_ |
| [`main`](../scripts/build-manifest.mjs#L165) | function | `scripts/build-manifest.mjs` | 165-212 | Loads existing manifest, compares to computed version, or writes fresh copy. | _(internal)_ |
| [`readManifestOrNull`](../scripts/build-manifest.mjs#L214) | function | `scripts/build-manifest.mjs` | 214-219 | Reads manifest.json, returning null on missing/invalid file. | _(internal)_ |
| [`sameIgnoringTimestamp`](../scripts/build-manifest.mjs#L229) | function | `scripts/build-manifest.mjs` | 229-232 | Compares two manifests for equality, ignoring updatedAt timestamp. | _(internal)_ |
...
| [`main`](../scripts/check-docs-placement.mjs#L62) | function | `scripts/check-docs-placement.mjs` | 62-109 | Validates that files in the docs/ root directory match an allowlist and reports unexpected files. | _(internal)_ |
...
| [`checkAuditApiKeys`](../scripts/check-setup.mjs#L159) | function | `scripts/check-setup.mjs` | 159-192 | Validates that required API keys (OPENAI, GEMINI, or Azure) are configured for the audit. | _(internal)_ |
| [`checkAuditLoop`](../scripts/check-setup.mjs#L257) | function | `scripts/check-setup.mjs` | 257-261 | Orchestrates validation checks for audit-loop API keys and cloud persistence. | _(internal)_ |
| [`checkAuditSupabase`](../scripts/check-setup.mjs#L194) | function | `scripts/check-setup.mjs` | 194-255 | Validates the AUDIT_DB_URL is set and Postgres has all required audit-loop tables. | _(internal)_ |
| [`checkConsistencyMode`](../scripts/check-setup.mjs#L421) | function | `scripts/check-setup.mjs` | 421-467 | Validates consistency-mode adoption including surfaces.json, canaries directory, and Playwright. | _(internal)_ |
| [`checkPersonaTest`](../scripts/check-setup.mjs#L265) | function | `scripts/check-setup.mjs` | 265-313 | Validates persona-test configuration including REPO_NAME, Postgres tables, and Playwright. | _(internal)_ |
| [`checkPlaywrightAvailable`](../scripts/check-setup.mjs#L401) | function | `scripts/check-setup.mjs` | 401-419 | Probes for Playwright package, CLI version, and Chromium binary availability. | _(internal)_ |
| [`checkTables`](../scripts/check-setup.mjs#L70) | function | `scripts/check-setup.mjs` | 70-80 | Queries Postgres `information_schema` to verify a list of table names exist. | _(internal)_ |
| [`injectResolvedDbEnv`](../scripts/check-setup.mjs#L490) | function | `scripts/check-setup.mjs` | 490-501 | Injects resolved cloud config (AUDIT_DB_URL, SSL mode) into process.env if not already set. | _(internal)_ |
| [`loadEnv`](../scripts/check-setup.mjs#L47) | function | `scripts/check-setup.mjs` | 47-62 | Parses a `.env` file into a key-value object, skipping comments and blank lines. | _(internal)_ |
| [`main`](../scripts/check-setup.mjs#L503) | function | `scripts/check-setup.mjs` | 503-517 | Runs all setup checks, injects cloud config, and exits with success/failure status. | _(internal)_ |
| [`printJsonReport`](../scripts/check-setup.mjs#L376) | function | `scripts/check-setup.mjs` | 376-386 | Outputs the check report as JSON to stdout for machine consumption. | _(internal)_ |
| [`printReport`](../scripts/check-setup.mjs#L344) | function | `scripts/check-setup.mjs` | 344-374 | Prints the entire check report to console with colored sections, status icons, and fix hints. | _(internal)_ |
| [`Report`](../scripts/check-setup.mjs#L120) | class | `scripts/check-setup.mjs` | 120-155 | Accumulates check results organized by sections with counters for passes, fails, and warnings. | _(internal)_ |
| [`statusIcon`](../scripts/check-setup.mjs#L320) | function | `scripts/check-setup.mjs` | 320-329 | Returns a colored terminal icon (✓/✗/⚠/ℹ) for a check status. | _(internal)_ |
| [`verdictLine`](../scripts/check-setup.mjs#L331) | function | `scripts/check-setup.mjs` | 331-342 | Formats a summary line showing failure and warning counts with color codes. | _(internal)_ |
...
| [`main`](../scripts/check-skill-updates.mjs#L25) | function | `scripts/check-skill-updates.mjs` | 25-131 | Scans installed skills against receipts and reports drift/staleness. | _(internal)_ |
| [`parseArgs`](../scripts/check-skill-updates.mjs#L16) | function | `scripts/check-skill-updates.mjs` | 16-23 | Parses command-line flags (--json, --no-cache, --target). | _(internal)_ |
...
| [`authoritativeScopesFor`](../scripts/install-skills.mjs#L365) | function | `scripts/install-skills.mjs` | 365-369 | Returns authoritative surface set for a surface mode. | _(internal)_ |
| [`buildCopilotMergeWrite`](../scripts/install-skills.mjs#L287) | function | `scripts/install-skills.mjs` | 287-300 | Builds merged copilot-instructions file and manifest entry. | _(internal)_ |
| [`buildSkillWrites`](../scripts/install-skills.mjs#L255) | function | `scripts/install-skills.mjs` | 255-285 | Builds file write operations for skill installation across surfaces. | _(internal)_ |
| [`checkConflicts`](../scripts/install-skills.mjs#L389) | function | `scripts/install-skills.mjs` | 389-401 | Detects file-write conflicts against previous receipts, split by scope (repo/global). | _(internal)_ |
| [`computeDeletes`](../scripts/install-skills.mjs#L338) | function | `scripts/install-skills.mjs` | 338-358 | Computes set of old managed files to delete based on filters. | _(internal)_ |
| [`expandSkillFiles`](../scripts/install-skills.mjs#L127) | function | `scripts/install-skills.mjs` | 127-133 | Returns file metadata list from manifest or legacy single-SKILL.md fallback. | _(internal)_ |
| [`fileShaShort`](../scripts/install-skills.mjs#L135) | function | `scripts/install-skills.mjs` | 135-137 | Computes 12-char hex SHA256 checksum of buffer. | _(internal)_ |
| [`loadManifest`](../scripts/install-skills.mjs#L97) | function | `scripts/install-skills.mjs` | 97-120 | Reads and schema-validates manifest JSON file. | _(internal)_ |
| [`main`](../scripts/install-skills.mjs#L427) | function | `scripts/install-skills.mjs` | 427-536 | Orchestrates skill installation: parse args, load manifest, build writes, detect conflicts, write receipts. | _(internal)_ |
| [`maybeWarnGithubSkillsDeprecation`](../scripts/install-skills.mjs#L243) | function | `scripts/install-skills.mjs` | 243-253 | Warns about .github/skills deprecation unless suppressed. | _(internal)_ |
| [`parseArgs`](../scripts/install-skills.mjs#L57) | function | `scripts/install-skills.mjs` | 57-91 | Parses installation flags (surface, skills, force, dry-run, target, etc). | _(internal)_ |
| [`printBanner`](../scripts/install-skills.mjs#L154) | function | `scripts/install-skills.mjs` | 154-162 | Prints installer banner showing mode, surface, target. | _(internal)_ |
| [`reconcileJournals`](../scripts/install-skills.mjs#L175) | function | `scripts/install-skills.mjs` | 175-210 | Recovers from failed installs using persisted transaction journals. | _(internal)_ |
| [`reportDegradations`](../scripts/install-skills.mjs#L223) | function | `scripts/install-skills.mjs` | 223-241 | Dedupes filesystem degradation warnings and logs to stderr. | _(internal)_ |
| [`retainUnmanagedEntries`](../scripts/install-skills.mjs#L378) | function | `scripts/install-skills.mjs` | 378-387 | Filters previously-managed files now out-of-scope based on removed skills or scopes. | _(internal)_ |
| [`validateTarget`](../scripts/install-skills.mjs#L141) | function | `scripts/install-skills.mjs` | 141-152 | Validates target directory exists with .git or package.json. | _(internal)_ |
| [`writeReceiptsByScope`](../scripts/install-skills.mjs#L403) | function | `scripts/install-skills.mjs` | 403-425 | Persists installation receipts for each scope when files exist or previously existed in that scope. | _(internal)_ |
...
| [`generateAllPromptFiles`](../scripts/lib/install/copilot-prompts.mjs#L214) | function | `scripts/lib/install/copilot-prompts.mjs` | 214-245 | Generates Copilot prompt files for all skills with SKILL.md in a repository. | `scripts/regenerate-skill-copies.mjs` |
| [`generatePromptFile`](../scripts/lib/install/copilot-prompts.mjs#L165) | function | `scripts/lib/install/copilot-prompts.mjs` | 165-203 | Generates a Copilot prompt file from skill metadata (name, description, CLI entry). | `scripts/regenerate-skill-copies.mjs` |
| [`parseSkillFrontmatter`](../scripts/lib/install/copilot-prompts.mjs#L125) | function | `scripts/lib/install/copilot-prompts.mjs` | 125-154 | Extracts name and description from SKILL.md YAML frontmatter, normalizing line endings and block-scalar syntax. | `scripts/regenerate-skill-copies.mjs` |
| [`shaOfManagedBlock`](../scripts/lib/install/copilot-prompts.mjs#L255) | function | `scripts/lib/install/copilot-prompts.mjs` | 255-263 | Computes the SHA256 hash of a managed prompt file block for change detection. | `scripts/regenerate-skill-copies.mjs` |
| [`yamlQuote`](../scripts/lib/install/copilot-prompts.mjs#L114) | function | `scripts/lib/install/copilot-prompts.mjs` | 114-116 | Escapes a string for YAML double-quoted format with backslash and quote handling. | `scripts/regenerate-skill-copies.mjs` |
...
| [`checkAuditGitignore`](../scripts/lib/install/gitignore.mjs#L233) | function | `scripts/lib/install/gitignore.mjs` | 233-257 | Verifies which required gitignore patterns are present or missing. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`ensureAuditGitignore`](../scripts/lib/install/gitignore.mjs#L180) | function | `scripts/lib/install/gitignore.mjs` | 180-224 | Adds missing audit-loop patterns to .gitignore, creating the file if needed. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`hasPattern`](../scripts/lib/install/gitignore.mjs#L157) | function | `scripts/lib/install/gitignore.mjs` | 157-166 | Checks whether a gitignore file contains a specific pattern, accounting for whitespace edge cases. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`requiredPatternsFor`](../scripts/lib/install/gitignore.mjs#L131) | function | `scripts/lib/install/gitignore.mjs` | 131-136 | Returns the list of gitignore patterns required by the repo type (source vs consumer). | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
...
| [`buildReceipt`](../scripts/lib/install/receipt.mjs#L45) | function | `scripts/lib/install/receipt.mjs` | 45-54 | Construct an installation receipt with bundle version, timestamp, and managed file list. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`readReceipt`](../scripts/lib/install/receipt.mjs#L13) | function | `scripts/lib/install/receipt.mjs` | 13-24 | Load and validate the installation receipt JSON. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`writeReceipt`](../scripts/lib/install/receipt.mjs#L31) | function | `scripts/lib/install/receipt.mjs` | 31-34 | Validate and atomically persist the installation receipt JSON. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs` |
| [`findRepoRoot`](../scripts/lib/install/surface-paths.mjs#L14) | function | `scripts/lib/install/surface-paths.mjs` | 14-37 | Walks directory tree upward to find outermost .git directory or package.json root. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`globalJournalPath`](../scripts/lib/install/surface-paths.mjs#L72) | function | `scripts/lib/install/surface-paths.mjs` | 72-74 | Returns the global install journal path in the user's home directory. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`globalQuarantineDir`](../scripts/lib/install/surface-paths.mjs#L85) | function | `scripts/lib/install/surface-paths.mjs` | 85-87 | Returns the global quarantine directory for failed installations. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`globalSurfaceRoot`](../scripts/lib/install/surface-paths.mjs#L51) | function | `scripts/lib/install/surface-paths.mjs` | 51-53 | Returns global skill directory path (~/.claude/skills). | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`managedFileAbsPath`](../scripts/lib/install/surface-paths.mjs#L193) | function | `scripts/lib/install/surface-paths.mjs` | 193-195 | Resolves a managed file record to its absolute filesystem path. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`partitionManagedFilesByScope`](../scripts/lib/install/surface-paths.mjs#L204) | function | `scripts/lib/install/surface-paths.mjs` | 204-212 | Partitions managed files into global and repo-scoped lists. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`receiptPath`](../scripts/lib/install/surface-paths.mjs#L169) | function | `scripts/lib/install/surface-paths.mjs` | 169-174 | Returns the install receipt path (global or repo-scoped based on scope parameter). | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`repoQuarantineDir`](../scripts/lib/install/surface-paths.mjs#L95) | function | `scripts/lib/install/surface-paths.mjs` | 95-97 | Returns the repo-local quarantine directory under `.audit/`. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`resolveSkillFiles`](../scripts/lib/install/surface-paths.mjs#L138) | function | `scripts/lib/install/surface-paths.mjs` | 138-153 | Expands skill targets into file paths with scope and surface metadata. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`resolveSkillTargets`](../scripts/lib/install/surface-paths.mjs#L106) | function | `scripts/lib/install/surface-paths.mjs` | 106-125 | Maps a skill name to target directories across Claude/Copilot/Agents surfaces. | `scripts/check-skill-updates.mjs`, `scripts/install-skills.mjs`, `scripts/lib/install/transaction.mjs` |
| [`anchorFor`](../scripts/lib/install/transaction.mjs#L274) | function | `scripts/lib/install/transaction.mjs` | 274-282 | Returns the journal path and quarantine directory for a transaction anchor. | `scripts/install-skills.mjs` |
| [`anchorForJournal`](../scripts/lib/install/transaction.mjs#L288) | function | `scripts/lib/install/transaction.mjs` | 288-292 | Resolves the scope and quarantine dir for a journal based on its location. | `scripts/install-skills.mjs` |
| [`attemptDelete`](../scripts/lib/install/transaction.mjs#L526) | function | `scripts/lib/install/transaction.mjs` | 526-545 | Deletes a file if present, optionally verifying its SHA hasn't changed since install. | `scripts/install-skills.mjs` |
| [`cleanupJournal`](../scripts/lib/install/transaction.mjs#L742) | function | `scripts/lib/install/transaction.mjs` | 742-745 | Removes the transaction journal file after successful completion. | `scripts/install-skills.mjs` |
| [`defaultJournalPath`](../scripts/lib/install/transaction.mjs#L880) | function | `scripts/lib/install/transaction.mjs` | 880-882 | Returns the default file path for a transaction journal. | `scripts/install-skills.mjs` |
| [`executeTransaction`](../scripts/lib/install/transaction.mjs#L558) | function | `scripts/lib/install/transaction.mjs` | 558-718 | Executes an atomic file-system transaction with locking, snapshots, and journal-based recovery. | `scripts/install-skills.mjs` |
| [`findUnresolvedQuarantine`](../scripts/lib/install/transaction.mjs#L449) | function | `scripts/lib/install/transaction.mjs` | 449-457 | Locates an unresolved quarantined journal in one or more directories. | `scripts/install-skills.mjs` |
| [`fsyncDir`](../scripts/lib/install/transaction.mjs#L162) | function | `scripts/lib/install/transaction.mjs` | 162-179 | Syncs a directory to disk on Unix (no-op on Windows). | `scripts/install-skills.mjs` |
| [`fsyncFile`](../scripts/lib/install/transaction.mjs#L123) | function | `scripts/lib/install/transaction.mjs` | 123-134 | Syncs an open file descriptor to disk with optional error handling. | `scripts/install-skills.mjs` |
| [`globalSurfaceLockPath`](../scripts/lib/install/transaction.mjs#L398) | function | `scripts/lib/install/transaction.mjs` | 398-400 | Returns the path to the global install lock file. | `scripts/install-skills.mjs` |
| [`isWithinAllowedRoots`](../scripts/lib/install/transaction.mjs#L202) | function | `scripts/lib/install/transaction.mjs` | 202-228 | Checks whether a path, after resolving symlinks, lies within allowed root directories. | `scripts/install-skills.mjs` |
| [`journalBody`](../scripts/lib/install/transaction.mjs#L505) | function | `scripts/lib/install/transaction.mjs` | 505-517 | Constructs the contents of a transaction journal from staged and delete operations. | `scripts/install-skills.mjs` |
| [`quarantineJournal`](../scripts/lib/install/transaction.mjs#L414) | function | `scripts/lib/install/transaction.mjs` | 414-434 | Backs up a problematic journal to quarantine with metadata. | `scripts/install-skills.mjs` |
| [`recoverFromJournal`](../scripts/lib/install/transaction.mjs#L759) | function | `scripts/lib/install/transaction.mjs` | 759-878 | Replays or rolls back an incomplete transaction by reading and applying journal entries. | `scripts/install-skills.mjs` |
| [`rollbackPartialTransaction`](../scripts/lib/install/transaction.mjs#L720) | function | `scripts/lib/install/transaction.mjs` | 720-740 | Reverts a partially-completed transaction by restoring files from in-memory snapshots. | `scripts/install-skills.mjs` |
| [`sameRoot`](../scripts/lib/install/transaction.mjs#L299) | function | `scripts/lib/install/transaction.mjs` | 299-306 | Compares two paths for identity after resolving symlinks and case-normalization. | `scripts/install-skills.mjs` |
| [`shaShort`](../scripts/lib/install/transaction.mjs#L105) | function | `scripts/lib/install/transaction.mjs` | 105-107 | Computes a 12-character SHA256 hash of a buffer. | `scripts/install-skills.mjs` |
| [`tmpSuffix`](../scripts/lib/install/transaction.mjs#L100) | function | `scripts/lib/install/transaction.mjs` | 100-103 | Generates a unique temporary filename suffix from PID, timestamp, and entropy. | `scripts/install-skills.mjs` |
| [`touchesGlobalSurface`](../scripts/lib/install/transaction.mjs#L255) | function | `scripts/lib/install/transaction.mjs` | 255-258 | Determines whether a transaction modifies any file in the global skills surface. | `scripts/install-skills.mjs` |
| [`validateJournal`](../scripts/lib/install/transaction.mjs#L357) | function | `scripts/lib/install/transaction.mjs` | 357-384 | Validates a transaction journal's schema and structural integrity. | `scripts/install-skills.mjs` |
| [`writeJournal`](../scripts/lib/install/transaction.mjs#L467) | function | `scripts/lib/install/transaction.mjs` | 467-503 | Atomically writes a transaction journal to disk with data-durability fsync. | `scripts/install-skills.mjs` |
| [`computeVerdict`](../scripts/regenerate-skill-copies.mjs#L196) | function | `scripts/regenerate-skill-copies.mjs` | 196-200 | Returns a verdict string (VIOLATIONS, CHANGES, or IN SYNC) based on write/delete counts and violation count. | _(internal)_ |
| [`copyFileIfChanged`](../scripts/regenerate-skill-copies.mjs#L76) | function | `scripts/regenerate-skill-copies.mjs` | 76-88 | Copies a file to its destination only if the content differs, tracking whether the file was written or unchanged. | _(internal)_ |
| [`emitVerdict`](../scripts/regenerate-skill-copies.mjs#L202) | function | `scripts/regenerate-skill-copies.mjs` | 202-214 | Prints the final sync status with counts and verdict, exiting with appropriate codes for violations and check mode. | _(internal)_ |
| [`loadSkillsOrDie`](../scripts/regenerate-skill-copies.mjs#L63) | function | `scripts/regenerate-skill-copies.mjs` | 63-74 | Loads all skill names from the skills directory, exiting with an error if the directory is missing or empty. | _(internal)_ |
| [`main`](../scripts/regenerate-skill-copies.mjs#L216) | function | `scripts/regenerate-skill-copies.mjs` | 216-244 | Orchestrates the full skill regeneration pipeline: syncing to destinations, pruning orphans, and emitting a final verdict. | _(internal)_ |
| [`pruneFilesNotInSource`](../scripts/regenerate-skill-copies.mjs#L90) | function | `scripts/regenerate-skill-copies.mjs` | 90-105 | Deletes files from a destination directory that no longer exist in the source, logging each removal. | _(internal)_ |
| [`pruneOrphanSkillDirs`](../scripts/regenerate-skill-copies.mjs#L130) | function | `scripts/regenerate-skill-copies.mjs` | 130-146 | Removes skill directories from all destination roots that no longer have a corresponding source skill. | _(internal)_ |
| [`pruneStalePrompts`](../scripts/regenerate-skill-copies.mjs#L168) | function | `scripts/regenerate-skill-copies.mjs` | 168-186 | Deletes stale managed prompt files that are no longer generated from source, while preserving operator-authored prompts. | _(internal)_ |
| [`syncCopilotPrompts`](../scripts/regenerate-skill-copies.mjs#L188) | function | `scripts/regenerate-skill-copies.mjs` | 188-194 | Generates GitHub Copilot prompt files from skill definitions and syncs them to the .github/prompts directory. | _(internal)_ |
| [`syncSkillToDests`](../scripts/regenerate-skill-copies.mjs#L107) | function | `scripts/regenerate-skill-copies.mjs` | 107-128 | Syncs a single skill from source to all destination roots by copying files and pruning orphans. | _(internal)_ |
| [`warnGithubSkillsDeprecation`](../scripts/regenerate-skill-copies.mjs#L51) | function | `scripts/regenerate-skill-copies.mjs` | 51-61 | Warns that .github/skills/ is deprecated and no longer maintained, offering the --keep-github-skills option. | _(internal)_ |
| [`writePromptFiles`](../scripts/regenerate-skill-copies.mjs#L148) | function | `scripts/regenerate-skill-copies.mjs` | 148-166 | Writes prompt files to disk, de-duplicates based on content hash, and returns counts of writes/unchanged files. | _(internal)_ |
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L453) | function | `scripts/sync-to-repos.mjs` | 453-461 | Lists all .github/prompts/*.prompt.md files for syncing to consumer repos | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L351) | function | `scripts/sync-to-repos.mjs` | 351-368 | Walks the source repo to enumerate all non-ignored files in scripts/ and .claude/ | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L414) | function | `scripts/sync-to-repos.mjs` | 414-426 | Enumerates all skill files in .claude/skills/ (and optionally .github/skills/) for sync | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L483) | function | `scripts/sync-to-repos.mjs` | 483-490 | Determines the final file bundle to sync for a specific consumer repo | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L530) | function | `scripts/sync-to-repos.mjs` | 530-541 | Recursively merges a source object into a target, preserving nested structures | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L545) | function | `scripts/sync-to-repos.mjs` | 545-1074 | Orchestrates syncing audit-loop tooling to multiple consumer repos with dry-run and diff reporting | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L1076) | function | `scripts/sync-to-repos.mjs` | 1076-1107 | Prompts the operator to update or create shared cloud credentials if outdated | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L371) | function | `scripts/sync-to-repos.mjs` | 371-374 | Reads a file from the source repo directory, returning null on file errors | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L398) | function | `scripts/sync-to-repos.mjs` | 398-403 | Filters unresolved imports to identify real missing dependencies (excludes dynamic strings) | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L383) | function | `scripts/sync-to-repos.mjs` | 383-388 | Resolves entry points to a complete file bundle including the full import graph | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L499) | function | `scripts/sync-to-repos.mjs` | 499-506 | Computes the SHA256 hash of a file's binary content | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L251) | function | `scripts/sync-to-repos.mjs` | 251-261 | Collects Supabase migration SQL files from the source repo for syncing | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L508) | function | `scripts/sync-to-repos.mjs` | 508-521 | Generates a unified diff between two files using git diff --no-index | _(internal)_ |

---

## learning-store

> Adaptive prompt variant learning via Thompson Sampling bandits—tests prompt variants stratified by repo size/language, computes reward signals from audit findings and persona feedback, and selects high-performing variants for deployment.
...
| [`_canonicalise`](../scripts/lib/learning/decision-logger.mjs#L183) | function | `scripts/lib/learning/decision-logger.mjs` | 183-190 | Recursively sorts object keys and canonicalizes values for stable comparison. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_getStateForTest`](../scripts/lib/learning/decision-logger.mjs#L532) | function | `scripts/lib/learning/decision-logger.mjs` | 532-539 | Returns current queue sizes and dropped-entry counts per decision type for test inspection. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_isKeyInt`](../scripts/lib/learning/decision-logger.mjs#L51) | function | `scripts/lib/learning/decision-logger.mjs` | 51-51 | Predicate checking if a value is a safe non-negative integer. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_isNonEmptyString`](../scripts/lib/learning/decision-logger.mjs#L50) | function | `scripts/lib/learning/decision-logger.mjs` | 50-50 | Predicate checking if a value is a non-empty, colon-free string (safe for decision keys). | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_resetForTest`](../scripts/lib/learning/decision-logger.mjs#L521) | function | `scripts/lib/learning/decision-logger.mjs` | 521-527 | Resets all module-global state (queues, counters, hooks) for test isolation. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`backfillOutcome`](../scripts/lib/learning/decision-logger.mjs#L263) | function | `scripts/lib/learning/decision-logger.mjs` | 263-295 | Updates the outcome of a prior decision record, either in-queue or as an enqueued outcome-only update. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`buildDecisionKey`](../scripts/lib/learning/decision-logger.mjs#L156) | function | `scripts/lib/learning/decision-logger.mjs` | 156-171 | Constructs a unique decision key from audit-bound or external identifiers. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`bumpDropped`](../scripts/lib/learning/decision-logger.mjs#L90) | function | `scripts/lib/learning/decision-logger.mjs` | 90-92 | Increments the dropped-decision counter for a decision type. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`canonicaliseContext`](../scripts/lib/learning/decision-logger.mjs#L192) | function | `scripts/lib/learning/decision-logger.mjs` | 192-194 | Converts a context object to a canonical JSON string. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`contextHash`](../scripts/lib/learning/decision-logger.mjs#L196) | function | `scripts/lib/learning/decision-logger.mjs` | 196-198 | Creates a SHA256 hash of canonicalized decision context for deduplication. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`DecisionLoggerError`](../scripts/lib/learning/decision-logger.mjs#L109) | class | `scripts/lib/learning/decision-logger.mjs` | 109-111 | Custom error class for decision logger exceptions with a code property. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`drain`](../scripts/lib/learning/decision-logger.mjs#L482) | function | `scripts/lib/learning/decision-logger.mjs` | 482-492 | Drains pending decisions via flush and prevents concurrent drain calls using a promise gate. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`flush`](../scripts/lib/learning/decision-logger.mjs#L308) | function | `scripts/lib/learning/decision-logger.mjs` | 308-377 | Flushes queued learning decisions to cloud or local outbox via two-phase drain with per-queue retention. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`getQueue`](../scripts/lib/learning/decision-logger.mjs#L84) | function | `scripts/lib/learning/decision-logger.mjs` | 84-88 | Retrieves or creates the queue for a decision type. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`installLifecycleHooks`](../scripts/lib/learning/decision-logger.mjs#L494) | function | `scripts/lib/learning/decision-logger.mjs` | 494-516 | Installs beforeExit and SIGINT handlers to gracefully drain the decision queue on process termination. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`isCiEnv`](../scripts/lib/learning/decision-logger.mjs#L59) | function | `scripts/lib/learning/decision-logger.mjs` | 59-61 | Detects if running in a CI environment. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`reconcileOutbox`](../scripts/lib/learning/decision-logger.mjs#L388) | function | `scripts/lib/learning/decision-logger.mjs` | 388-413 | Processes outbox files and retries their cloud writes when the store becomes available again. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`recordDecision`](../scripts/lib/learning/decision-logger.mjs#L218) | function | `scripts/lib/learning/decision-logger.mjs` | 218-252 | Records a learning decision to a per-type bounded queue, dropping oldest entry when cap is reached. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`resolveQueueCap`](../scripts/lib/learning/decision-logger.mjs#L27) | function | `scripts/lib/learning/decision-logger.mjs` | 27-38 | Parses and validates LEARNING_QUEUE_CAP_PER_TYPE env var with fallback default. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`retryWithBackoff`](../scripts/lib/learning/decision-logger.mjs#L435) | function | `scripts/lib/learning/decision-logger.mjs` | 435-452 | Retries a function with exponential backoff (3 attempts in CI, 1 in local) and treats truthy or {ok:true} as success. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`throttledWarn`](../scripts/lib/learning/decision-logger.mjs#L94) | function | `scripts/lib/learning/decision-logger.mjs` | 94-101 | Logs a warning to stderr at most once per throttle interval. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`tryWrite`](../scripts/lib/learning/decision-logger.mjs#L417) | function | `scripts/lib/learning/decision-logger.mjs` | 417-433 | Attempts to write a decision entry to cloud store with retry logic, branching on outcome-only vs regular paths. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`validateInput`](../scripts/lib/learning/decision-logger.mjs#L113) | function | `scripts/lib/learning/decision-logger.mjs` | 113-148 | Validates a decision-logger input object against required types and audit-key constraints. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`writeOutbox`](../scripts/lib/learning/decision-logger.mjs#L454) | function | `scripts/lib/learning/decision-logger.mjs` | 454-465 | Atomically writes a decision entry to the local outbox directory with timestamp-keyed filename. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`aggregateDecisions`](../scripts/lib/learning/quickfix-stats.mjs#L199) | function | `scripts/lib/learning/quickfix-stats.mjs` | 199-224 | Computes Beta-posterior acceptance rates per quickfix pattern from decision records using alpha/beta counters. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`cliMain`](../scripts/lib/learning/quickfix-stats.mjs#L277) | function | `scripts/lib/learning/quickfix-stats.mjs` | 277-330 | CLI entry point for quickfix-stats with --stats, --rebuild, --bootstrap, --reset, and --format flags. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`computeWatermark`](../scripts/lib/learning/quickfix-stats.mjs#L226) | function | `scripts/lib/learning/quickfix-stats.mjs` | 226-233 | Extracts the maximum outcome_at timestamp and total row count from decision records for cache watermarking. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`loadStats`](../scripts/lib/learning/quickfix-stats.mjs#L54) | function | `scripts/lib/learning/quickfix-stats.mjs` | 54-64 | Loads cached quickfix pattern statistics from disk, returning empty object on missing file or parse error. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`readQuickfixDecisions`](../scripts/lib/learning/quickfix-stats.mjs#L240) | function | `scripts/lib/learning/quickfix-stats.mjs` | 240-258 | Reads quickfix hit decisions from cloud store via paginated RPC, gracefully returning empty on cloud-off. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`rebuildFromBootstrap`](../scripts/lib/learning/quickfix-stats.mjs#L139) | function | `scripts/lib/learning/quickfix-stats.mjs` | 139-183 | Rebuilds quickfix statistics from a bootstrap JSONL log with synthesized neutral outcomes (no user feedback yet). | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`rebuildFromCloud`](../scripts/lib/learning/quickfix-stats.mjs#L97) | function | `scripts/lib/learning/quickfix-stats.mjs` | 97-122 | Rebuilds quickfix statistics from cloud learning store and writes aggregated stats to cache. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`shouldSkipPattern`](../scripts/lib/learning/quickfix-stats.mjs#L77) | function | `scripts/lib/learning/quickfix-stats.mjs` | 77-83 | Checks if a quickfix pattern should be skipped based on low acceptance rate and minimum hit threshold. | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
| [`writeAtomic`](../scripts/lib/learning/quickfix-stats.mjs#L264) | function | `scripts/lib/learning/quickfix-stats.mjs` | 264-266 | Atomically writes content to a target file path (thin wrapper around atomicWriteFileSync). | `scripts/cross-skill.mjs`, `scripts/learning/backfill-outcomes.mjs` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`atomicWrite`](../scripts/memory-health.mjs#L292) | function | `scripts/memory-health.mjs` | 292-294 | Atomically writes markdown report contents to a file path. | _(internal)_ |
| [`callRpc`](../scripts/memory-health.mjs#L71) | function | `scripts/memory-health.mjs` | 71-82 | Invokes the memory_health_metrics Postgres RPC via the db client to measure signal decay. | _(internal)_ |
| [`collectFrictionSection`](../scripts/memory-health.mjs#L94) | function | `scripts/memory-health.mjs` | 94-124 | Gathers recurring friction recurrence data from store with protection status and priority ranking. | _(internal)_ |
| [`evaluateTriggers`](../scripts/memory-health.mjs#L170) | function | `scripts/memory-health.mjs` | 170-205 | Evaluates three memory-health metrics against thresholds to determine overall status (GREEN/AMBER/RED/INSUFFICIENT_DATA). | _(internal)_ |
| [`main`](../scripts/memory-health.mjs#L296) | function | `scripts/memory-health.mjs` | 296-336 | Orchestrates memory-health check: calls RPC, evaluates triggers, collects friction, renders report, outputs summary. | _(internal)_ |
| [`numEnv`](../scripts/memory-health.mjs#L31) | function | `scripts/memory-health.mjs` | 31-40 | Parses an environment variable as a finite number with fallback default and validation. | _(internal)_ |
| [`parseArgs`](../scripts/memory-health.mjs#L51) | function | `scripts/memory-health.mjs` | 51-69 | Parses CLI arguments for memory-health script (--out, --json, --help flags). | _(internal)_ |
| [`pct`](../scripts/memory-health.mjs#L207) | function | `scripts/memory-health.mjs` | 207-209 | Formats a decimal number as a percentage string with one decimal place. | _(internal)_ |
| [`renderFrictionSection`](../scripts/memory-health.mjs#L126) | function | `scripts/memory-health.mjs` | 126-168 | Formats friction recurrence clusters into a markdown table with recurrence, cost, age, and protection columns. | _(internal)_ |
| [`renderMarkdown`](../scripts/memory-health.mjs#L211) | function | `scripts/memory-health.mjs` | 211-290 | Generates complete markdown memory-health report including metrics, evaluation, friction section, and status. | _(internal)_ |
...
```mermaid
flowchart TB
subgraph dom_model_eval ["model-eval"]
  file_scripts_lib_model_eval_arm_generation_mj["scripts/lib/model-eval/arm-generation.mjs"]:::component
  sym_scripts_lib_model_eval_arm_generation_mj["buildGenericPlanContent"]:::symbol
  file_scripts_lib_model_eval_arm_generation_mj --> sym_scripts_lib_model_eval_arm_generation_mj
  sym_scripts_lib_model_eval_arm_generation_mj["resolveGenerationClient"]:::symbol
  file_scripts_lib_model_eval_arm_generation_mj --> sym_scripts_lib_model_eval_arm_generation_mj
  sym_scripts_lib_model_eval_arm_generation_mj["runAuditGenerationArm"]:::symbol
  file_scripts_lib_model_eval_arm_generation_mj --> sym_scripts_lib_model_eval_arm_generation_mj
  sym_scripts_lib_model_eval_arm_generation_mj["UnsupportedGenerationTransport"]:::symbol
  file_scripts_lib_model_eval_arm_generation_mj --> sym_scripts_lib_model_eval_arm_generation_mj
  file_scripts_lib_model_eval_blind_judge_mjs["scripts/lib/model-eval/blind-judge.mjs"]:::component
  sym_scripts_lib_model_eval_blind_judge_mjs_a["appendJudgeBatch"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_a
  sym_scripts_lib_model_eval_blind_judge_mjs_a["assertJudgePayloadSafe"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_a
  sym_scripts_lib_model_eval_blind_judge_mjs_b["blindFindings"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_b
  sym_scripts_lib_model_eval_blind_judge_mjs_g["getJudgeBatchesForRun"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_g
  sym_scripts_lib_model_eval_blind_judge_mjs_M["MalformedJudgeOutputError"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_M
  sym_scripts_lib_model_eval_blind_judge_mjs_r["runBlindJudgeProtocol"]:::symbol
  file_scripts_lib_model_eval_blind_judge_mjs --> sym_scripts_lib_model_eval_blind_judge_mjs_r
  file_scripts_lib_model_eval_config_schema_mjs["scripts/lib/model-eval/config/schema.mjs"]:::component
  sym_scripts_lib_model_eval_config_schema_mjs["parseThresholdConfig"]:::symbol
  file_scripts_lib_model_eval_config_schema_mjs --> sym_scripts_lib_model_eval_config_schema_mjs
  sym_scripts_lib_model_eval_config_schema_mjs["tierSchema"]:::symbol
  file_scripts_lib_model_eval_config_schema_mjs --> sym_scripts_lib_model_eval_config_schema_mjs
  file_scripts_lib_model_eval_cost_mjs["scripts/lib/model-eval/cost.mjs"]:::component
  sym_scripts_lib_model_eval_cost_mjs_assemble["assembleCostRows"]:::symbol
  file_scripts_lib_model_eval_cost_mjs --> sym_scripts_lib_model_eval_cost_mjs_assemble
  sym_scripts_lib_model_eval_cost_mjs_buildUsa["buildUsageEvent"]:::symbol
  file_scripts_lib_model_eval_cost_mjs --> sym_scripts_lib_model_eval_cost_mjs_buildUsa
  file_scripts_lib_model_eval_deterministic_sco["scripts/lib/model-eval/deterministic-scorer.mjs"]:::component
  sym_scripts_lib_model_eval_deterministic_sco["basename"]:::symbol
  file_scripts_lib_model_eval_deterministic_sco --> sym_scripts_lib_model_eval_deterministic_sco
end
classDef container fill:#f5f5f5,stroke:#333,stroke-width:2px,color:#000
classDef component fill:#e8f0ff,stroke:#3178c6,color:#000
classDef symbol fill:#fff,stroke:#999,color:#444
...
| [`callCrossSkill`](../scripts/persona-consistency-promote.mjs#L71) | function | `scripts/persona-consistency-promote.mjs` | 71-96 | Invokes cross-skill.mjs CLI commands with JSON input, parsing structured error responses from stdout. | _(internal)_ |
| [`defaultPrompt`](../scripts/persona-consistency-promote.mjs#L563) | function | `scripts/persona-consistency-promote.mjs` | 563-568 | Prompts the user for input via stdin and returns their response. | _(internal)_ |
| [`listConsistencyCandidatesViaCli`](../scripts/persona-consistency-promote.mjs#L98) | function | `scripts/persona-consistency-promote.mjs` | 98-107 | Fetches pending consistency promotion candidates from cloud store via cross-skill CLI. | _(internal)_ |
| [`parseArgs`](../scripts/persona-consistency-promote.mjs#L142) | function | `scripts/persona-consistency-promote.mjs` | 142-159 | Parses CLI arguments for persona-consistency-promote script (--auto, --since, --repo-root, --out, --help). | _(internal)_ |
| [`promoteCandidates`](../scripts/persona-consistency-promote.mjs#L195) | function | `scripts/persona-consistency-promote.mjs` | 195-276 | Main orchestrator: lists consistency candidates, prompts for approval (or auto-approves), and promotes each via CLI. | _(internal)_ |
| [`promoteOne`](../scripts/persona-consistency-promote.mjs#L282) | function | `scripts/persona-consistency-promote.mjs` | 282-423 | Validates and renders a Playwright regression spec candidate, then promotes it to a locked spec. | _(internal)_ |
| [`promoteRegressionSpecViaCli`](../scripts/persona-consistency-promote.mjs#L109) | function | `scripts/persona-consistency-promote.mjs` | 109-115 | Promotes a regression spec candidate to locked spec via cross-skill CLI. | _(internal)_ |
| [`readLocalRepoUuid`](../scripts/persona-consistency-promote.mjs#L570) | function | `scripts/persona-consistency-promote.mjs` | 570-576 | Reads the repo UUID from `.audit-loop/repo-identity.json`, returning null on error. | _(internal)_ |
| [`reconcilePromotionJournal`](../scripts/persona-consistency-promote.mjs#L429) | function | `scripts/persona-consistency-promote.mjs` | 429-546 | Recovers incomplete promotion state from the local journal by querying the DB to disambiguate pending entries. | _(internal)_ |
| [`recordShipEventViaCli`](../scripts/persona-consistency-promote.mjs#L117) | function | `scripts/persona-consistency-promote.mjs` | 117-124 | Records a ship event via cross-skill CLI, silently OK when cloud is off. | _(internal)_ |
| [`removeJournal`](../scripts/persona-consistency-promote.mjs#L558) | function | `scripts/persona-consistency-promote.mjs` | 558-561 | Deletes a promotion journal entry from disk. | _(internal)_ |
| [`safeGitBranch`](../scripts/persona-consistency-promote.mjs#L592) | function | `scripts/persona-consistency-promote.mjs` | 592-598 | Retrieves the current git branch name, returning null on error. | _(internal)_ |
| [`safeGitEmail`](../scripts/persona-consistency-promote.mjs#L578) | function | `scripts/persona-consistency-promote.mjs` | 578-584 | Retrieves the git user email configuration, returning null on error. | _(internal)_ |
| [`safeGitSha`](../scripts/persona-consistency-promote.mjs#L585) | function | `scripts/persona-consistency-promote.mjs` | 585-591 | Retrieves the current HEAD commit SHA, returning null on error. | _(internal)_ |
| [`usage`](../scripts/persona-consistency-promote.mjs#L161) | function | `scripts/persona-consistency-promote.mjs` | 161-174 | Returns usage/help text for persona-consistency-promote script. | _(internal)_ |
| [`writeJournal`](../scripts/persona-consistency-promote.mjs#L552) | function | `scripts/persona-consistency-promote.mjs` | 552-556 | Atomically writes a promotion journal entry to disk. | _(internal)_ |
| [`applyWait`](../scripts/persona-consistency-run.mjs#L702) | function | `scripts/persona-consistency-run.mjs` | 702-715 | Waits for a page condition (visible/hidden/URL match/network response/timeout) to be met using Playwright. | _(internal)_ |
| [`awaitManifestNetworkSources`](../scripts/persona-consistency-run.mjs#L534) | function | `scripts/persona-consistency-run.mjs` | 534-607 | Waits for network requests matching manifest-declared URL patterns, with per-source timeout customization and precedence resolution. | _(internal)_ |
| [`candidateDescription`](../scripts/persona-consistency-run.mjs#L766) | function | `scripts/persona-consistency-run.mjs` | 766-768 | Generates a short description of a consistency violation (kind, surface, field, severity). | _(internal)_ |
| [`candidateWorthy`](../scripts/persona-consistency-run.mjs#L759) | function | `scripts/persona-consistency-run.mjs` | 759-764 | Filters consistency violations to only P0/P1 candidates not already expected by the canary definition. | _(internal)_ |
| [`cssEscape`](../scripts/persona-consistency-run.mjs#L698) | function | `scripts/persona-consistency-run.mjs` | 698-700 | Escapes special characters in a string to make it safe for use in CSS selectors. | _(internal)_ |
| [`describeAction`](../scripts/persona-consistency-run.mjs#L717) | function | `scripts/persona-consistency-run.mjs` | 717-726 | Converts a journey step into a human-readable action description for logs and reports. | _(internal)_ |
| [`detectUnannotatedSurfaces`](../scripts/persona-consistency-run.mjs#L629) | function | `scripts/persona-consistency-run.mjs` | 629-667 | Scans the live DOM for surfaces declared in the manifest that lack data-engine-claim annotations. | _(internal)_ |
| [`emptyWitness`](../scripts/persona-consistency-run.mjs#L791) | function | `scripts/persona-consistency-run.mjs` | 791-800 | Creates a witness object for a journey step with no captured claims (empty/partial capture). | _(internal)_ |
| [`executeStep`](../scripts/persona-consistency-run.mjs#L465) | function | `scripts/persona-consistency-run.mjs` | 465-504 | Executes a single journey action (navigate/click/fill/wait) against a Playwright page and tracks navigation outcomes. | _(internal)_ |
| [`joinUrl`](../scripts/persona-consistency-run.mjs#L802) | function | `scripts/persona-consistency-run.mjs` | 802-808 | Joins a base URL with a path suffix, handling route keys, leading slashes, and protocol detection. | _(internal)_ |
| [`locatorOf`](../scripts/persona-consistency-run.mjs#L681) | function | `scripts/persona-consistency-run.mjs` | 681-692 | Transforms a locator object into a Playwright page locator for querying and interacting with DOM elements. | _(internal)_ |
| [`locatorString`](../scripts/persona-consistency-run.mjs#L728) | function | `scripts/persona-consistency-run.mjs` | 728-738 | Converts a locator object to a readable string for display in debugging output. | _(internal)_ |
| [`locatorToStringLite`](../scripts/persona-consistency-run.mjs#L669) | function | `scripts/persona-consistency-run.mjs` | 669-679 | Converts a locator object to a concise readable string (role/label/testid/id/css) for logging. | _(internal)_ |
| [`newAuthedContext`](../scripts/persona-consistency-run.mjs#L742) | function | `scripts/persona-consistency-run.mjs` | 742-755 | Creates a Playwright browser context with authentication (storage-state file or Bearer token header). | _(internal)_ |
| [`parseArgs`](../scripts/persona-consistency-run.mjs#L56) | function | `scripts/persona-consistency-run.mjs` | 56-77 | Parses CLI flags for canary name, app URL, output path, and await-before-capture timeout override. | _(internal)_ |
| [`readLocalRepoUuid`](../scripts/persona-consistency-run.mjs#L827) | function | `scripts/persona-consistency-run.mjs` | 827-836 | Reads the repo's persistent UUID from .audit-loop/repo-identity.json, returning null if absent or unparseable. | _(internal)_ |
| [`runConsistency`](../scripts/persona-consistency-run.mjs#L117) | function | `scripts/persona-consistency-run.mjs` | 117-458 | Main orchestrator that opens a ledger, drives browser journey steps, detects state consistency violations, and promotes P0/P1 findings as candidates. | _(internal)_ |
| [`safeBrowserClose`](../scripts/persona-consistency-run.mjs#L823) | function | `scripts/persona-consistency-run.mjs` | 823-825 | Closes the Playwright browser, swallowing any errors that occur. | _(internal)_ |
| [`safeCurrentRoute`](../scripts/persona-consistency-run.mjs#L810) | function | `scripts/persona-consistency-run.mjs` | 810-812 | Safely extracts the current page pathname from the URL, returning null on parse failure. | _(internal)_ |
| [`safeGitSha`](../scripts/persona-consistency-run.mjs#L814) | function | `scripts/persona-consistency-run.mjs` | 814-821 | Safely retrieves the current git commit SHA, returning null if the command fails. | _(internal)_ |
| [`shrinkWitness`](../scripts/persona-consistency-run.mjs#L773) | function | `scripts/persona-consistency-run.mjs` | 773-787 | Extracts a witness subset containing only claims matching a specific candidate's surface/field/scope. | _(internal)_ |
| [`usage`](../scripts/persona-consistency-run.mjs#L79) | function | `scripts/persona-consistency-run.mjs` | 79-96 | Returns formatted help text describing the persona-consistency-run CLI interface and all flags. | _(internal)_ |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`criterionHash`](../scripts/lib/plan-criteria-parser.mjs#L45) | function | `scripts/lib/plan-criteria-parser.mjs` | 45-48 | Hashes a criterion (severity/category/description) deterministically for stable identity. | `scripts/ux-lock-run.mjs` |
| [`locateAcceptanceSection`](../scripts/lib/plan-criteria-parser.mjs#L56) | function | `scripts/lib/plan-criteria-parser.mjs` | 56-77 | Finds the "Acceptance Criteria" heading and extracts its content lines up to the next same-level heading. | `scripts/ux-lock-run.mjs` |
| [`parseAcceptanceCriteria`](../scripts/lib/plan-criteria-parser.mjs#L96) | function | `scripts/lib/plan-criteria-parser.mjs` | 96-152 | Parses acceptance criteria from markdown into structured criterion objects (severity, category, setup, assertion). | `scripts/ux-lock-run.mjs` |
| [`summariseCriteria`](../scripts/lib/plan-criteria-parser.mjs#L158) | function | `scripts/lib/plan-criteria-parser.mjs` | 158-166 | Counts criteria by severity and category for summary statistics. | `scripts/ux-lock-run.mjs` |
...
> Extracts behavioral and correctness invariants the codebase enforces, deduplicates them, and materializes a committable ledger that audits use to enforce in-scope guardrails.

```mermaid
flowchart TB
subgraph dom_requirements ["requirements"]
  file_scripts_lib_requirements__shared_mjs["scripts/lib/requirements/_shared.mjs"]:::component
  sym_scripts_lib_requirements__shared_mjs_est["estimateTokens"]:::symbol
  file_scripts_lib_requirements__shared_mjs --> sym_scripts_lib_requirements__shared_mjs_est
...
> Interactive first-time-setup orchestration: prerequisite checks, API-key/database prompts, environment configuration, and repository installation for the engineering-skills toolkit.
...
| [`ask`](../setup.mjs#L26) | function | `setup.mjs` | 26-26 | Prompts the user for input and returns a Promise resolving to their answer. | _(internal)_ |
| [`checkPrereqs`](../setup.mjs#L35) | function | `setup.mjs` | 35-44 | Verifies Node.js v18+ and npm are installed and functional | _(internal)_ |
| [`fail`](../setup.mjs#L31) | function | `setup.mjs` | 31-31 | Prints a red X icon with an error message | _(internal)_ |
| [`installDeps`](../setup.mjs#L183) | function | `setup.mjs` | 183-190 | Installs npm dependencies for the project. | _(internal)_ |
| [`installGitHook`](../setup.mjs#L194) | function | `setup.mjs` | 194-222 | Installs a post-merge git hook that automatically rebuilds and reinstalls skills after pulling updates. | _(internal)_ |
| [`installSkills`](../setup.mjs#L165) | function | `setup.mjs` | 165-179 | Installs the skill files to the global ~/.claude/skills/ directory so they're available across all repos. | _(internal)_ |
| [`main`](../setup.mjs#L226) | function | `setup.mjs` | 226-291 | Orchestrates the complete first-time setup through 7 sequential steps (prerequisites, API keys, database, maintenance, dependencies, skills, git hook). | _(internal)_ |
| [`ok`](../setup.mjs#L29) | function | `setup.mjs` | 29-29 | Prints a green checkmark with a success message | _(internal)_ |
| [`setupApiKeys`](../setup.mjs#L55) | function | `setup.mjs` | 55-82 | Interactively prompts for required/optional API keys and saves them to .env | _(internal)_ |
| [`setupDatabase`](../setup.mjs#L91) | function | `setup.mjs` | 91-127 | Guides selection of a learning database backend (local or cloud) and saves credentials | _(internal)_ |
| [`setupMaintenance`](../setup.mjs#L136) | function | `setup.mjs` | 136-161 | Optionally enables weekly maintenance checks via an environment variable | _(internal)_ |
| [`warn`](../setup.mjs#L30) | function | `setup.mjs` | 30-30 | Prints a yellow warning icon with a message | _(internal)_ |

---

## scripts

> **CLI entry points and modular utilities for the 15-skill audit-to-ship pipeline: multi-pass code review (GPT+Gemini), UX regression testing (Playwright), deployment, cloud learning store, and architectural memory indexing.**
...
_Domain has 308 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`escapeRegex`](../scripts/archive-completed-plans.mjs#L73) | function | `scripts/archive-completed-plans.mjs` | 73-75 | Escapes special regex characters in a string. | _(internal)_ |
| [`findAuditSummariesFor`](../scripts/archive-completed-plans.mjs#L65) | function | `scripts/archive-completed-plans.mjs` | 65-71 | Finds audit summary files matching a plan's filename pattern. | _(internal)_ |
| [`isComplete`](../scripts/archive-completed-plans.mjs#L55) | function | `scripts/archive-completed-plans.mjs` | 55-58 | Checks if a status string indicates plan completion. | _(internal)_ |
| [`parseStatus`](../scripts/archive-completed-plans.mjs#L43) | function | `scripts/archive-completed-plans.mjs` | 43-47 | Extracts the Status line from plan content using regex. | _(internal)_ |
| [`runArchive`](../scripts/archive-completed-plans.mjs#L87) | function | `scripts/archive-completed-plans.mjs` | 87-146 | Moves completed plans and audit summaries to an archive directory. | _(internal)_ |
...
| [`buildStepEnv`](../scripts/db-test-container.mjs#L96) | function | `scripts/db-test-container.mjs` | 96-106 | Constructs environment variables for a test container step, routing DB credentials to AUDIT_DB_TEST_URL for destructive steps. | _(internal)_ |
| [`classifyRunFailure`](../scripts/db-test-container.mjs#L148) | function | `scripts/db-test-container.mjs` | 148-160 | Diagnoses docker run failures and maps them to exit codes with actionable error messages. | _(internal)_ |
| [`createLifecycle`](../scripts/db-test-container.mjs#L243) | function | `scripts/db-test-container.mjs` | 243-465 | Factory creating a test-container lifecycle manager with setup, teardown, abort, and run orchestration. | _(internal)_ |
| [`defaultWaitForReady`](../scripts/db-test-container.mjs#L217) | function | `scripts/db-test-container.mjs` | 217-236 | Polls a Postgres connection until successful or timeout to verify database readiness. | _(internal)_ |
| [`main`](../scripts/db-test-container.mjs#L469) | function | `scripts/db-test-container.mjs` | 469-495 | CLI entry point orchestrating Docker ephemeral Postgres container lifecycle with signal handling. | _(internal)_ |
| [`parseArgs`](../scripts/db-test-container.mjs#L112) | function | `scripts/db-test-container.mjs` | 112-137 | Parses command-line arguments for db-test-container mode, port, and flags with type validation. | _(internal)_ |
| [`realExec`](../scripts/db-test-container.mjs#L173) | function | `scripts/db-test-container.mjs` | 173-203 | Spawns a subprocess with optional timeout, output capture, custom environment, and working directory. | _(internal)_ |
| [`sleep`](../scripts/db-test-container.mjs#L205) | function | `scripts/db-test-container.mjs` | 205-207 | Returns a promise that resolves after a specified delay in milliseconds. | _(internal)_ |
...
| [`git`](../scripts/install-git-hooks.mjs#L42) | function | `scripts/install-git-hooks.mjs` | 42-44 | Runs git with given arguments and returns trimmed stdout. | _(internal)_ |
| [`main`](../scripts/install-git-hooks.mjs#L46) | function | `scripts/install-git-hooks.mjs` | 46-70 | Configures git core.hooksPath to local hooks directory if not already set. | _(internal)_ |
| [`installInRepo`](../scripts/install-prepush-hook.mjs#L173) | function | `scripts/install-prepush-hook.mjs` | 173-223 | Installs, updates, or uninstalls the pre-push hook in a single git repository. | _(internal)_ |
| [`isManagedHook`](../scripts/install-prepush-hook.mjs#L41) | function | `scripts/install-prepush-hook.mjs` | 41-45 | Detects whether a pre-push hook file was managed and installed by this script. | _(internal)_ |
| [`main`](../scripts/install-prepush-hook.mjs#L227) | function | `scripts/install-prepush-hook.mjs` | 227-251 | Resolves target repos and installs/uninstalls pre-push hooks across them. | _(internal)_ |
| [`computeArchMemoryBandOutcome`](../scripts/learning/backfill-outcomes.mjs#L559) | function | `scripts/learning/backfill-outcomes.mjs` | 559-610 | Determines whether an arch-memory band recommendation led to code action. | `scripts/cross-skill.mjs` |
| [`computeConvergencePredictOutcome`](../scripts/learning/backfill-outcomes.mjs#L634) | function | `scripts/learning/backfill-outcomes.mjs` | 634-678 | Checks if an audit convergence prediction matched the actual run outcome. | `scripts/cross-skill.mjs` |
| [`computeFileFingerprint`](../scripts/learning/backfill-outcomes.mjs#L452) | function | `scripts/learning/backfill-outcomes.mjs` | 452-464 | Computes a SHA256 fingerprint of a file's first 256 bytes. | `scripts/cross-skill.mjs` |
| [`computeOutcomeFromFileState`](../scripts/learning/backfill-outcomes.mjs#L744) | function | `scripts/learning/backfill-outcomes.mjs` | 744-802 | Determines if a quickfix was made by checking whether the file still exists. | `scripts/cross-skill.mjs` |
| [`computePassSelectionOutcome`](../scripts/learning/backfill-outcomes.mjs#L699) | function | `scripts/learning/backfill-outcomes.mjs` | 699-725 | Scores a pass selection by the ratio of accepted to total findings. | `scripts/cross-skill.mjs` |
| [`defaultExecGit`](../scripts/learning/backfill-outcomes.mjs#L612) | function | `scripts/learning/backfill-outcomes.mjs` | 612-619 | Executes a git command with timeout and piped output. | `scripts/cross-skill.mjs` |
| [`drainFrictionFallback`](../scripts/learning/backfill-outcomes.mjs#L340) | function | `scripts/learning/backfill-outcomes.mjs` | 340-402 | Drains friction notes from local JSONL to cloud storage. | `scripts/cross-skill.mjs` |
| [`drainJsonlToCloud`](../scripts/learning/backfill-outcomes.mjs#L189) | function | `scripts/learning/backfill-outcomes.mjs` | 189-329 | Reads new lines from a hits JSONL file and sends them to cloud with cursor tracking. | `scripts/cross-skill.mjs` |
| [`readDrainCursor`](../scripts/learning/backfill-outcomes.mjs#L417) | function | `scripts/learning/backfill-outcomes.mjs` | 417-438 | Reads the drain cursor position and file fingerprint from a marker file. | `scripts/cross-skill.mjs` |
| [`resolveUnresolvedOutcomes`](../scripts/learning/backfill-outcomes.mjs#L468) | function | `scripts/learning/backfill-outcomes.mjs` | 468-533 | Resolves pending learning decisions by detecting their real-world outcomes. | `scripts/cross-skill.mjs` |
| [`runBackfill`](../scripts/learning/backfill-outcomes.mjs#L64) | function | `scripts/learning/backfill-outcomes.mjs` | 64-173 | Backfills learning outcomes from local JSONL to cloud and resolves pending decisions. | `scripts/cross-skill.mjs` |
| [`writeDrainCursor`](../scripts/learning/backfill-outcomes.mjs#L440) | function | `scripts/learning/backfill-outcomes.mjs` | 440-445 | Writes the drain cursor position and file fingerprint to a marker file. | `scripts/cross-skill.mjs` |
...
| [`hasNewlyEligibleCheck`](../scripts/maintenance-checks.mjs#L245) | function | `scripts/maintenance-checks.mjs` | 245-249 | Detects if a previously-skipped check now has its required environment variables set. | _(internal)_ |
| [`isOverdue`](../scripts/maintenance-checks.mjs#L224) | function | `scripts/maintenance-checks.mjs` | 224-229 | Checks whether maintenance checks are overdue based on the interval and last-run time. | _(internal)_ |
| [`loadHeartbeat`](../scripts/maintenance-checks.mjs#L203) | function | `scripts/maintenance-checks.mjs` | 203-214 | Reads the previous maintenance-check heartbeat file, validating its shape and timestamp. | _(internal)_ |
| [`main`](../scripts/maintenance-checks.mjs#L285) | function | `scripts/maintenance-checks.mjs` | 285-323 | Main entry point for maintenance checks; handles status reporting, opportunistic execution, and JSON output. | _(internal)_ |
| [`missingEnv`](../scripts/maintenance-checks.mjs#L144) | function | `scripts/maintenance-checks.mjs` | 144-146 | Filters environment variables that are required but unset. | _(internal)_ |
| [`positiveIntEnv`](../scripts/maintenance-checks.mjs#L151) | function | `scripts/maintenance-checks.mjs` | 151-160 | Reads and validates a positive-integer environment variable with a fallback default. | _(internal)_ |
| [`printHuman`](../scripts/maintenance-checks.mjs#L273) | function | `scripts/maintenance-checks.mjs` | 273-283 | Formats and prints maintenance-check results to stdout with status icons and output. | _(internal)_ |
| [`runCheck`](../scripts/maintenance-checks.mjs#L169) | function | `scripts/maintenance-checks.mjs` | 169-201 | Executes a maintenance check's script steps and collects pass/fail results with output. | _(internal)_ |
| [`runExclusive`](../scripts/maintenance-checks.mjs#L264) | function | `scripts/maintenance-checks.mjs` | 264-271 | Acquires an exclusive file lock with a zero timeout, returning null if already held. | _(internal)_ |
| [`writeHeartbeat`](../scripts/maintenance-checks.mjs#L216) | function | `scripts/maintenance-checks.mjs` | 216-222 | Writes maintenance-check results and timestamp to a heartbeat file for interval tracking. | _(internal)_ |
...
| [`buildPayload`](../scripts/model-eval-discovery.mjs#L118) | function | `scripts/model-eval-discovery.mjs` | 118-146 | Assembles LLM evaluation payload with code context, plan, and system prompt. | _(internal)_ |
| [`classifyOutcome`](../scripts/model-eval-discovery.mjs#L148) | function | `scripts/model-eval-discovery.mjs` | 148-155 | Categorizes LLM call results into outcome buckets (ok/stall/nonconformant/provider_error/other). | _(internal)_ |
| [`flag`](../scripts/model-eval-discovery.mjs#L64) | function | `scripts/model-eval-discovery.mjs` | 64-67 | Parses command-line flag value by name. | _(internal)_ |
| [`pct`](../scripts/model-eval-discovery.mjs#L96) | function | `scripts/model-eval-discovery.mjs` | 96-96 | Formats ratio as percentage string. | _(internal)_ |
| [`quantile`](../scripts/model-eval-discovery.mjs#L97) | function | `scripts/model-eval-discovery.mjs` | 97-97 | Retrieves element at quantile position from sorted array. | _(internal)_ |
| [`resolveArmModels`](../scripts/model-eval-discovery.mjs#L99) | function | `scripts/model-eval-discovery.mjs` | 99-115 | Matches model patterns against available API models and resolves unknowns. | _(internal)_ |
| [`runArm`](../scripts/model-eval-discovery.mjs#L196) | function | `scripts/model-eval-discovery.mjs` | 196-228 | Concurrently executes discovery tests against a single model arm. | _(internal)_ |
| [`summarizeArm`](../scripts/model-eval-discovery.mjs#L157) | function | `scripts/model-eval-discovery.mjs` | 157-172 | Summarizes arm test results into availability, latency, cost, and error statistics. | _(internal)_ |
...
| [`formatHumanReport`](../scripts/postgres-parity/check-non-core-references.mjs#L190) | function | `scripts/postgres-parity/check-non-core-references.mjs` | 190-214 | Formats schema violation findings into a human-readable report with remediation guidance. | _(internal)_ |
| [`main`](../scripts/postgres-parity/check-non-core-references.mjs#L218) | function | `scripts/postgres-parity/check-non-core-references.mjs` | 218-245 | CLI for checking migrations; outputs results as JSON or text, exits non-zero if strict violations found. | _(internal)_ |
| [`pathToFileUrl`](../scripts/postgres-parity/check-non-core-references.mjs#L249) | function | `scripts/postgres-parity/check-non-core-references.mjs` | 249-249 | Converts a file path to a `file://` URL string. | _(internal)_ |
| [`readMigrations`](../scripts/postgres-parity/check-non-core-references.mjs#L84) | function | `scripts/postgres-parity/check-non-core-references.mjs` | 84-93 | Reads and sorts SQL migration files from the migrations directory. | _(internal)_ |
| [`scanForFindings`](../scripts/postgres-parity/check-non-core-references.mjs#L95) | function | `scripts/postgres-parity/check-non-core-references.mjs` | 95-186 | Scans SQL migrations for unallowed schema references (auth, roles, extensions, public) via regex. | _(internal)_ |
| [`main`](../scripts/postgres-parity/generate-expected-schema.mjs#L183) | function | `scripts/postgres-parity/generate-expected-schema.mjs` | 183-222 | CLI entry point that validates Postgres setup, connects via AUDIT_DB_URL, runs catalog queries, and writes schema snapshot to JSON. | _(internal)_ |
...
| [`cmdExtract`](../scripts/requirements.mjs#L57) | function | `scripts/requirements.mjs` | 57-99 | Extracts requirements from specified files using LLM and stores candidates and gap assessments. | _(internal)_ |
| [`cmdIndex`](../scripts/requirements.mjs#L158) | function | `scripts/requirements.mjs` | 158-166 | Loads the requirements ledger and outputs a human-readable or JSON index of all requirements. | _(internal)_ |
| [`cmdReconcile`](../scripts/requirements.mjs#L101) | function | `scripts/requirements.mjs` | 101-156 | Merges extracted requirements candidates with gap assessments and manual overrides into a final ledger. | _(internal)_ |
| [`cmdRender`](../scripts/requirements.mjs#L169) | function | `scripts/requirements.mjs` | 169-179 | Generates a markdown map of the requirements ledger and writes it to a file. | _(internal)_ |
| [`flag`](../scripts/requirements.mjs#L52) | function | `scripts/requirements.mjs` | 52-55 | Extracts a CLI flag's value from argv by position after the flag name. | _(internal)_ |
| [`gitSha`](../scripts/requirements.mjs#L44) | function | `scripts/requirements.mjs` | 44-50 | Retrieves the current HEAD commit hash via `git rev-parse`. | _(internal)_ |
| [`main`](../scripts/requirements.mjs#L181) | function | `scripts/requirements.mjs` | 181-198 | Main dispatch for requirements subcommands: extract, reconcile, index, render with help text. | _(internal)_ |
...
| [`applyBootstrap`](../scripts/setup-postgres.mjs#L272) | function | `scripts/setup-postgres.mjs` | 272-279 | Reads and applies the compatibility bootstrap SQL to set up Supabase-like stub roles, or logs what would happen in dry-run mode. | `scripts/db-test-container.mjs` |
| [`applyMigration`](../scripts/setup-postgres.mjs#L260) | function | `scripts/setup-postgres.mjs` | 260-270 | Reads a migration SQL file, computes its hash, applies it to the database (or logs in dry-run mode), and returns the hash. | `scripts/db-test-container.mjs` |
| [`canonicalise`](../scripts/setup-postgres.mjs#L331) | function | `scripts/setup-postgres.mjs` | 331-342 | Recursively normalizes a data structure by sorting arrays and object keys for deterministic comparison. | `scripts/db-test-container.mjs` |
| [`captureLiveSchema`](../scripts/setup-postgres.mjs#L291) | function | `scripts/setup-postgres.mjs` | 291-303 | Runs a set of catalog queries against the live database and returns the current schema state keyed by query category. | `scripts/db-test-container.mjs` |
| [`diffSchemas`](../scripts/setup-postgres.mjs#L305) | function | `scripts/setup-postgres.mjs` | 305-328 | Compares an expected schema snapshot against the live database schema and returns a list of differences by category with item-level details. | `scripts/db-test-container.mjs` |
| [`ensureLedger`](../scripts/setup-postgres.mjs#L229) | function | `scripts/setup-postgres.mjs` | 229-232 | Creates the `audit_loop_migrations` ledger table and applies its row-level security policy. | `scripts/db-test-container.mjs` |
| [`isSupabaseManaged`](../scripts/setup-postgres.mjs#L197) | function | `scripts/setup-postgres.mjs` | 197-209 | Queries the `auth` schema's owner to determine if the database is managed by Supabase (owned by supabase_admin or supabase_auth_admin). | `scripts/db-test-container.mjs` |
| [`listMigrations`](../scripts/setup-postgres.mjs#L249) | function | `scripts/setup-postgres.mjs` | 249-252 | Reads the migrations directory, filters for `.sql` files, and returns them sorted. | `scripts/db-test-container.mjs` |
| [`main`](../scripts/setup-postgres.mjs#L712) | function | `scripts/setup-postgres.mjs` | 712-788 | CLI entry point that parses setup-mode arguments, handles ensure-local/migrate/adopt/check-drift workflows, and dispatches to the appropriate function. | `scripts/db-test-container.mjs` |
| [`parseArgs`](../scripts/setup-postgres.mjs#L68) | function | `scripts/setup-postgres.mjs` | 68-109 | Parses command-line arguments to extract setup mode (migrate/adopt/check-drift) and flag-value pairs using an indexed loop. | `scripts/db-test-container.mjs` |
| [`preflight`](../scripts/setup-postgres.mjs#L124) | function | `scripts/setup-postgres.mjs` | 124-147 | Queries the database to check whether the current user has CREATEROLE privilege and inventories required Postgres extension availability. | `scripts/db-test-container.mjs` |
| [`readLedger`](../scripts/setup-postgres.mjs#L234) | function | `scripts/setup-postgres.mjs` | 234-237 | Queries and returns the `audit_loop_migrations` table as a Map of filenames to their applied SHA256 hashes. | `scripts/db-test-container.mjs` |
| [`recordApplied`](../scripts/setup-postgres.mjs#L239) | function | `scripts/setup-postgres.mjs` | 239-245 | Inserts or updates an `audit_loop_migrations` row to record that a migration file has been applied with its SHA256 hash. | `scripts/db-test-container.mjs` |
| [`renderHumanDriftReport`](../scripts/setup-postgres.mjs#L632) | function | `scripts/setup-postgres.mjs` | 632-653 | Formats and prints migration drift check results (unapplied, SHA mismatches, orphaned entries) to stderr in human-readable form with color codes. | `scripts/db-test-container.mjs` |
| [`reportPreflight`](../scripts/setup-postgres.mjs#L149) | function | `scripts/setup-postgres.mjs` | 149-183 | Displays preflight check results (CREATEROLE and extension status) and exits with an error if strict mode finds missing privileges or extensions. | `scripts/db-test-container.mjs` |
| [`runAdopt`](../scripts/setup-postgres.mjs#L509) | function | `scripts/setup-postgres.mjs` | 509-558 | Verifies that the live database schema matches an expected-schema manifest; if so, seeds the ledger without replaying DDL. | `scripts/db-test-container.mjs` |
| [`runCheckDrift`](../scripts/setup-postgres.mjs#L579) | function | `scripts/setup-postgres.mjs` | 579-630 | Compares the migration ledger against source files to detect unapplied, edited (SHA mismatch), or orphaned migrations and returns a drift summary. | `scripts/db-test-container.mjs` |
...
| [`runMigrate`](../scripts/setup-postgres.mjs#L468) | function | `scripts/setup-postgres.mjs` | 468-507 | Orchestrates the migration workflow: applies bootstrap DDL (skipping on Supabase-managed DBs), ensures the ledger exists, then applies unapplied or changed migrations. | `scripts/db-test-container.mjs` |
| [`sha256`](../scripts/setup-postgres.mjs#L254) | function | `scripts/setup-postgres.mjs` | 254-258 | Computes and returns the SHA256 hash of a file's binary contents. | `scripts/db-test-container.mjs` |
...
| [`argOption`](../scripts/solo-control-audit.mjs#L132) | function | `scripts/solo-control-audit.mjs` | 132-135 | Retrieves the value following a named CLI flag, or returns a default if absent. | _(internal)_ |
| [`armLabelFor`](../scripts/solo-control-audit.mjs#L119) | function | `scripts/solo-control-audit.mjs` | 119-126 | Maps a model name to an arm label (S-fable/S-sonnet/S-opus/S-haiku) for solo-control test tracking. | _(internal)_ |
| [`chunkDiff`](../scripts/solo-control-audit.mjs#L223) | function | `scripts/solo-control-audit.mjs` | 223-244 | Splits a large diff into smaller chunks per file, handling multipart continuations | _(internal)_ |
| [`clampField`](../scripts/solo-control-audit.mjs#L289) | function | `scripts/solo-control-audit.mjs` | 289-294 | Truncates a string to max length, breaking at word boundaries when possible | _(internal)_ |
| [`clampToSchema`](../scripts/solo-control-audit.mjs#L295) | function | `scripts/solo-control-audit.mjs` | 295-306 | Recursively caps output field lengths to schema-defined character limits | _(internal)_ |
| [`cmdApparatus`](../scripts/solo-control-audit.mjs#L620) | function | `scripts/solo-control-audit.mjs` | 620-697 | Orchestrates the A arm (GPT + Gemini) solo audit run for specified commits | _(internal)_ |
| [`cmdApparatusBC`](../scripts/solo-control-audit.mjs#L742) | function | `scripts/solo-control-audit.mjs` | 742-856 | Orchestrates audit runs for arms B and C using OSS models plus GPT/Gemini | _(internal)_ |
| [`cmdJudgeGpt`](../scripts/solo-control-audit.mjs#L1125) | function | `scripts/solo-control-audit.mjs` | 1125-1228 | Grades all blind findings in a CSV by invoking GPT in batches with resumable progress | _(internal)_ |
| [`cmdMerge`](../scripts/solo-control-audit.mjs#L1256) | function | `scripts/solo-control-audit.mjs` | 1256-1477 | Merges solo-run findings with external arms and prepares them for blind scoring | _(internal)_ |
| [`cmdRun`](../scripts/solo-control-audit.mjs#L363) | function | `scripts/solo-control-audit.mjs` | 363-534 | Main entry point for solo-control audits across commits with configurable multi-sampling per pass | _(internal)_ |
| [`cmdScore`](../scripts/solo-control-audit.mjs#L1479) | function | `scripts/solo-control-audit.mjs` | 1479-1568 | Analyzes graded blind findings to compute precision/recall/effectiveness metrics per arm | _(internal)_ |
| [`cmdSoloPassRetro`](../scripts/solo-control-audit.mjs#L940) | function | `scripts/solo-control-audit.mjs` | 940-1023 | Re-runs a specific audit pass (GPT or Gemini) in isolation for debugging | _(internal)_ |
| [`cmdSonnetGeminiRetro`](../scripts/solo-control-audit.mjs#L870) | function | `scripts/solo-control-audit.mjs` | 870-927 | Computes Gemini-only net-new findings relative to a prior Sonnet baseline | _(internal)_ |
| [`continuationMarker`](../scripts/solo-control-audit.mjs#L247) | function | `scripts/solo-control-audit.mjs` | 247-250 | Generates a continuation header comment for diff file chunks | _(internal)_ |
| [`csvField`](../scripts/solo-control-audit.mjs#L153) | function | `scripts/solo-control-audit.mjs` | 153-156 | Escapes a value for CSV by quoting if it contains special characters | _(internal)_ |
| [`dedupeFindings`](../scripts/solo-control-audit.mjs#L713) | function | `scripts/solo-control-audit.mjs` | 713-723 | Removes findings with duplicate category/section/detail combinations | _(internal)_ |
| [`discoverCommits`](../scripts/solo-control-audit.mjs#L162) | function | `scripts/solo-control-audit.mjs` | 162-172 | Queries the database for distinct commit SHAs with audit findings in arms B or C | _(internal)_ |
| [`dupHash`](../scripts/solo-control-audit.mjs#L149) | function | `scripts/solo-control-audit.mjs` | 149-152 | Generates a 10-character hash from category/file/detail for duplicate identification. | _(internal)_ |
| [`extractDiff`](../scripts/solo-control-audit.mjs#L192) | function | `scripts/solo-control-audit.mjs` | 192-209 | Retrieves a commit's full diff, filters sensitive paths, and redacts secrets | _(internal)_ |
| [`fetchExternalFindings`](../scripts/solo-control-audit.mjs#L1240) | function | `scripts/solo-control-audit.mjs` | 1240-1254 | Queries arms A/B/C findings from Supabase for comparison analysis | _(internal)_ |
| [`git`](../scripts/solo-control-audit.mjs#L137) | function | `scripts/solo-control-audit.mjs` | 137-141 | Executes a git command with output capture, raising on failure. | _(internal)_ |
| [`hasFlag`](../scripts/solo-control-audit.mjs#L136) | function | `scripts/solo-control-audit.mjs` | 136-136 | Checks if a named CLI flag is present in process.argv. | _(internal)_ |
| [`listSFindings`](../scripts/solo-control-audit.mjs#L115) | function | `scripts/solo-control-audit.mjs` | 115-115 | Lists all S-findings JSON files in the output directory | _(internal)_ |
| [`locateCommit`](../scripts/solo-control-audit.mjs#L175) | function | `scripts/solo-control-audit.mjs` | 175-181 | Searches provided repo roots to find which contains a given git commit | _(internal)_ |
| [`log`](../scripts/solo-control-audit.mjs#L131) | function | `scripts/solo-control-audit.mjs` | 131-131 | <no body> | _(internal)_ |
| [`main`](../scripts/solo-control-audit.mjs#L1572) | function | `scripts/solo-control-audit.mjs` | 1572-1590 | Dispatches solo-control-audit subcommands (run, apparatus, merge, score, etc.) | _(internal)_ |
| [`parseCsvLine`](../scripts/solo-control-audit.mjs#L1085) | function | `scripts/solo-control-audit.mjs` | 1085-1089 | Parses a CSV line respecting quoted field boundaries | _(internal)_ |
| [`parseJsonLoose`](../scripts/solo-control-audit.mjs#L308) | function | `scripts/solo-control-audit.mjs` | 308-317 | Extracts and parses JSON from text that may contain markdown fences or padding | _(internal)_ |
| [`readBlindSheet`](../scripts/solo-control-audit.mjs#L1091) | function | `scripts/solo-control-audit.mjs` | 1091-1101 | Loads and parses a CSV blind-rating sheet into structured row objects | _(internal)_ |
| [`runGeminiPass`](../scripts/solo-control-audit.mjs#L599) | function | `scripts/solo-control-audit.mjs` | 599-617 | Executes an audit pass using Gemini with structured JSON output | _(internal)_ |
| [`runGeminiReview`](../scripts/solo-control-audit.mjs#L571) | function | `scripts/solo-control-audit.mjs` | 571-590 | Runs a final-gate Gemini review returning only net-new findings not already raised | _(internal)_ |
| [`runGptJudgeBatch`](../scripts/solo-control-audit.mjs#L1104) | function | `scripts/solo-control-audit.mjs` | 1104-1123 | Sends a batch of findings to GPT for blind grading against known-defect rubrics | _(internal)_ |
| [`runGptPass`](../scripts/solo-control-audit.mjs#L552) | function | `scripts/solo-control-audit.mjs` | 552-568 | Executes an audit pass using GPT with structured output validation | _(internal)_ |
| [`runOssPass`](../scripts/solo-control-audit.mjs#L727) | function | `scripts/solo-control-audit.mjs` | 727-740 | Runs an audit pass using an OSS-accessible model via structured output routing | _(internal)_ |
| [`runPass`](../scripts/solo-control-audit.mjs#L323) | function | `scripts/solo-control-audit.mjs` | 323-359 | Runs an audit pass against a code diff using Claude, with retry on JSON parse failure | _(internal)_ |
| [`sFindingsPath`](../scripts/solo-control-audit.mjs#L114) | function | `scripts/solo-control-audit.mjs` | 114-114 | Constructs the output file path for a labeled findings JSON file | _(internal)_ |
| [`tryGit`](../scripts/solo-control-audit.mjs#L142) | function | `scripts/solo-control-audit.mjs` | 142-144 | Executes a git command, returning null on failure without raising. | _(internal)_ |
...
| [`argOption`](../scripts/tiered-shadow-report.mjs#L43) | function | `scripts/tiered-shadow-report.mjs` | 43-47 | Extracts optional command-line argument value following a flag. | _(internal)_ |
| [`main`](../scripts/tiered-shadow-report.mjs#L49) | function | `scripts/tiered-shadow-report.mjs` | 49-93 | Reports tiered-pipeline shadow observations from cloud or local log. | _(internal)_ |
| [`reportLocal`](../scripts/tiered-shadow-report.mjs#L95) | function | `scripts/tiered-shadow-report.mjs` | 95-98 | Reads and reports tiered shadow records from a local log file. | _(internal)_ |
| [`reportRows`](../scripts/tiered-shadow-report.mjs#L100) | function | `scripts/tiered-shadow-report.mjs` | 100-203 | Formats and outputs tiered shadow summary (JSON or terminal). | _(internal)_ |
...
> Modularized library supporting the CLI skills: LLM client routing (Anthropic/OpenAI/Gemini, SDK/CLI backends), audit-loop coordination (multi-pass analysis, suppression, Gemini adjudication), secret redaction, and PostgreSQL storage.
...
_Domain has 569 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L562) | function | `scripts/lib/config.mjs` | 562-631 | Builds Azure OpenAI config from environment variables or returns an inert snapshot if disabled. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +50 more |
| [`clampConfigNumber`](../scripts/lib/config.mjs#L76) | function | `scripts/lib/config.mjs` | 76-96 | Parses, validates, and clamps numeric env var to range | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +50 more |
| [`clampFpReadLimit`](../scripts/lib/config.mjs#L352) | function | `scripts/lib/config.mjs` | 352-364 | Constrains a false-positive read limit between minimum and maximum bounds. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +50 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L253) | function | `scripts/lib/config.mjs` | 253-266 | Maps language names to normalized identifiers (js, ts, py, go, other). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +50 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Validates enum env var against allowed set with warnings | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +50 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L59) | function | `scripts/lib/file-io.mjs` | 59-61 | Write file atomically with optional permission bits. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`atomicWriteFileSyncImpl`](../scripts/lib/file-io.mjs#L23) | function | `scripts/lib/file-io.mjs` | 23-57 | Write a file atomically via temp file + rename, preserving symlinks and optional permission bits. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L72) | function | `scripts/lib/file-io.mjs` | 72-76 | Normalize paths to lowercase, forward-slash format relative to cwd for case-insensitive comparison. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-95 | Read file contents or exit the process with error if not found. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L81) | function | `scripts/lib/file-io.mjs` | 81-84 | Parse a string to integer with safe fallback value. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L105) | function | `scripts/lib/file-io.mjs` | 105-116 | Persist results as JSON to a file or stdout depending on --out flag. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +67 more |
| [`forceRelease`](../scripts/lib/file-lock.mjs#L123) | function | `scripts/lib/file-lock.mjs` | 123-191 | Force-releases a stale or orphaned lock after verifying owner PID death and lock age. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`inspectLock`](../scripts/lib/file-lock.mjs#L91) | function | `scripts/lib/file-lock.mjs` | 91-107 | Inspects a lock file and classifies its state as owned, corrupted, or unreadable. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`isPidAlive`](../scripts/lib/file-lock.mjs#L52) | function | `scripts/lib/file-lock.mjs` | 52-59 | Checks whether a process ID is alive by attempting to send signal 0. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`LockTimeoutError`](../scripts/lib/file-lock.mjs#L34) | class | `scripts/lib/file-lock.mjs` | 34-41 | Exception thrown when file-lock acquisition times out, carrying the lock path and owner PID. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`readLockOwnerRaw`](../scripts/lib/file-lock.mjs#L194) | function | `scripts/lib/file-lock.mjs` | 194-200 | Parses a lock file's JSON to extract the owner's pid and token, returning null on invalid data. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`safeRelease`](../scripts/lib/file-lock.mjs#L208) | function | `scripts/lib/file-lock.mjs` | 208-225 | Releases a lock file if we own it, logging a warning if ownership has been lost. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`sleep`](../scripts/lib/file-lock.mjs#L43) | function | `scripts/lib/file-lock.mjs` | 43-43 | <no body> | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`tryAcquireLock`](../scripts/lib/file-lock.mjs#L69) | function | `scripts/lib/file-lock.mjs` | 69-79 | Attempts to acquire an exclusive file lock via atomic exclusive-write, returning a random token on success. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`withFileLock`](../scripts/lib/file-lock.mjs#L238) | function | `scripts/lib/file-lock.mjs` | 238-310 | Acquires an exclusive file lock with exponential backoff, stale-lock recovery, and configurable timeout. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +4 more |
| [`_acquireLockSync`](../scripts/lib/file-store.mjs#L38) | function | `scripts/lib/file-store.mjs` | 38-70 | Acquires a file-based lock with stale-lock detection and exponential backoff retry. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`_quarantineRecord`](../scripts/lib/file-store.mjs#L18) | function | `scripts/lib/file-store.mjs` | 18-34 | Quarantines corrupted data to a timestamped JSON file in a quarantine directory. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`_releaseLock`](../scripts/lib/file-store.mjs#L72) | function | `scripts/lib/file-store.mjs` | 72-74 | Deletes a lock file. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`acquireLock`](../scripts/lib/file-store.mjs#L80) | function | `scripts/lib/file-store.mjs` | 80-82 | Public wrapper acquiring a file lock. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`AppendOnlyStore`](../scripts/lib/file-store.mjs#L208) | class | `scripts/lib/file-store.mjs` | 208-243 | Append-only JSONL log store with optional schema validation and quarantine on failure. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`MutexFileStore`](../scripts/lib/file-store.mjs#L117) | class | `scripts/lib/file-store.mjs` | 117-200 | Atomic read-modify-write store using file-based mutex lock and optional Zod validation. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`readJsonlFile`](../scripts/lib/file-store.mjs#L94) | function | `scripts/lib/file-store.mjs` | 94-109 | Reads a JSONL file, parsing each line and skipping invalid JSON. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
| [`releaseLock`](../scripts/lib/file-store.mjs#L84) | function | `scripts/lib/file-store.mjs` | 84-86 | Public wrapper releasing a file lock. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/lib/audit/cost-budget.mjs`, +6 more |
...
| [`collectFsImportBindings`](../scripts/lib/find-rmsync-sites.mjs#L30) | function | `scripts/lib/find-rmsync-sites.mjs` | 30-53 | Extracts imported filesystem module identifiers from an AST to track `fs.rmSync` references. | _(internal)_ |
| [`extractOptionsInfo`](../scripts/lib/find-rmsync-sites.mjs#L60) | function | `scripts/lib/find-rmsync-sites.mjs` | 60-79 | Parses the options object of an `rmSync` call and extracts property names and values. | _(internal)_ |
| [`findEnclosingCall`](../scripts/lib/find-rmsync-sites.mjs#L90) | function | `scripts/lib/find-rmsync-sites.mjs` | 90-126 | Detects whether an `rmSync` call is wrapped inside an arrow function passed as a single argument. | _(internal)_ |
| [`findRmSyncCallSites`](../scripts/lib/find-rmsync-sites.mjs#L162) | function | `scripts/lib/find-rmsync-sites.mjs` | 162-203 | Locates all `fs.rmSync` calls in source code and extracts details about options and enclosing context. | _(internal)_ |
| [`walkAst`](../scripts/lib/find-rmsync-sites.mjs#L128) | function | `scripts/lib/find-rmsync-sites.mjs` | 128-144 | Recursively traverses an AST, visiting each node while maintaining an ancestor chain. | _(internal)_ |
...
| [`batchWriteLedger`](../scripts/lib/ledger.mjs#L226) | function | `scripts/lib/ledger.mjs` | 226-250 | Batch-upserts ledger entries and updates associated metadata. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`buildR2SystemPrompt`](../scripts/lib/ledger.mjs#L648) | function | `scripts/lib/ledger.mjs` | 648-650 | Assembles R2+ system prompt from round modifier, rulings block, and pass rubric. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`buildRulingsBlock`](../scripts/lib/ledger.mjs#L499) | function | `scripts/lib/ledger.mjs` | 499-618 | Formats prior rulings (dismissed/adjusted/fixed) as a system-prompt block for R2+. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`byDismissalPriority`](../scripts/lib/ledger.mjs#L473) | function | `scripts/lib/ledger.mjs` | 473-476 | Comparator sorting entries by resolution round then topic ID. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`computeImpactSet`](../scripts/lib/ledger.mjs#L660) | function | `scripts/lib/ledger.mjs` | 660-682 | Identifies files that depend on (import) the changed files. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`finalizeLedgerOutcomes`](../scripts/lib/ledger.mjs#L710) | function | `scripts/lib/ledger.mjs` | 710-724 | Converts adjudication outcomes into ledger update actions. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`generateTopicId`](../scripts/lib/ledger.mjs#L43) | function | `scripts/lib/ledger.mjs` | 43-53 | Generates a deterministic 12-hex-char ID for a ledger entry from file/principle/category/hash. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`getFileRegex`](../scripts/lib/ledger.mjs#L34) | function | `scripts/lib/ledger.mjs` | 34-34 | Returns a regex pattern for matching file references in audit findings. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`mergeMetaLocked`](../scripts/lib/ledger.mjs#L205) | function | `scripts/lib/ledger.mjs` | 205-224 | Locks a metadata file and merges new metadata into it. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`omissionMarkerMaxLen`](../scripts/lib/ledger.mjs#L465) | function | `scripts/lib/ledger.mjs` | 465-468 | Calculates the maximum character width of an omission-marker message. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`populateFindingMetadata`](../scripts/lib/ledger.mjs#L260) | function | `scripts/lib/ledger.mjs` | 260-278 | Extracts file paths from finding text and enriches the finding with derived metadata. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`readLedgerJson`](../scripts/lib/ledger.mjs#L163) | function | `scripts/lib/ledger.mjs` | 163-175 | Reads a ledger JSON file, returning an empty ledger if missing. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`renderOmissionMarker`](../scripts/lib/ledger.mjs#L452) | function | `scripts/lib/ledger.mjs` | 452-456 | Renders a message listing dismissed items with sample topic IDs. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`shortTopicId`](../scripts/lib/ledger.mjs#L437) | function | `scripts/lib/ledger.mjs` | 437-437 | Truncates a topic ID to fixed width. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`suppressReRaises`](../scripts/lib/ledger.mjs#L292) | function | `scripts/lib/ledger.mjs` | 292-423 | Suppresses previously dismissed/fixed findings via fuzzy matching, unless touched by changed files. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`truncateAtWord`](../scripts/lib/ledger.mjs#L444) | function | `scripts/lib/ledger.mjs` | 444-450 | Truncates text at word boundary with ellipsis. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`upsertEntry`](../scripts/lib/ledger.mjs#L178) | function | `scripts/lib/ledger.mjs` | 178-202 | Inserts a new ledger entry or updates an existing one while preserving adjudication decisions. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeLedgerEntry`](../scripts/lib/ledger.mjs#L122) | function | `scripts/lib/ledger.mjs` | 122-124 | Writes a validated ledger entry to disk. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeSingleLedgerEntry`](../scripts/lib/ledger.mjs#L66) | function | `scripts/lib/ledger.mjs` | 66-115 | Writes or updates a single ledger entry in a JSON file with automatic backup on corruption. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeStage1MechanicalLedgerEntry`](../scripts/lib/ledger.mjs#L136) | function | `scripts/lib/ledger.mjs` | 136-138 | Writes a stage-1 mechanical ledger entry to disk. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
...
| [`azureBaseUrl`](../scripts/lib/openai-client.mjs#L69) | function | `scripts/lib/openai-client.mjs` | 69-79 | Constructs Azure OpenAI base URL, routing foundry-claude requests separately from standard endpoints. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`createOpenAIClient`](../scripts/lib/openai-client.mjs#L91) | function | `scripts/lib/openai-client.mjs` | 91-160 | Factory function creating and caching OpenAI client with support for public, Azure, and OSS (OpenRouter) providers. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`keyDigest`](../scripts/lib/openai-client.mjs#L60) | function | `scripts/lib/openai-client.mjs` | 60-62 | Generates 16-character SHA256 digest of API key for cache/logging purposes. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`normalizeApiPath`](../scripts/lib/openai-client.mjs#L53) | function | `scripts/lib/openai-client.mjs` | 53-57 | Normalizes API paths to `/openai/v1` default format (leading slash, no trailing slash). | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`trimTrailingSlash`](../scripts/lib/openai-client.mjs#L48) | function | `scripts/lib/openai-client.mjs` | 48-50 | Removes trailing slashes from URL strings. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +10 more |
...
| [`describeProviderError`](../scripts/lib/oss-structured-output.mjs#L129) | function | `scripts/lib/oss-structured-output.mjs` | 129-133 | Formats an API error with HTTP status and provider message. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`extractRawJson`](../scripts/lib/oss-structured-output.mjs#L96) | function | `scripts/lib/oss-structured-output.mjs` | 96-105 | Extracts raw JSON from an API response (tool-call or text mode). | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`isResponseFormatUnsupported`](../scripts/lib/oss-structured-output.mjs#L119) | function | `scripts/lib/oss-structured-output.mjs` | 119-126 | Detects if an error indicates unsupported structured output format. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`normaliseUsage`](../scripts/lib/oss-structured-output.mjs#L57) | function | `scripts/lib/oss-structured-output.mjs` | 57-78 | Validates and normalizes LLM API usage metrics, catching invalid/missing token counts. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`ossStructuredCall`](../scripts/lib/oss-structured-output.mjs#L179) | function | `scripts/lib/oss-structured-output.mjs` | 179-343 | Orchestrates LLM calls with structured JSON output, retry logic, and timeouts. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`sanitizeSchemaName`](../scripts/lib/oss-structured-output.mjs#L108) | function | `scripts/lib/oss-structured-output.mjs` | 108-111 | Cleans schema names to alphanumeric/dash, max 64 chars. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`stripJsonMarkdownFence`](../scripts/lib/oss-structured-output.mjs#L90) | function | `scripts/lib/oss-structured-output.mjs` | 90-93 | Strips markdown code fences from JSON strings. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +2 more |
| [`computeOutcomeReward`](../scripts/lib/outcome-sync.mjs#L238) | function | `scripts/lib/outcome-sync.mjs` | 238-244 | Computes bandit reward based on finding severity and whether it was accepted or severity-adjusted. | `scripts/lib/finalize-outcomes.mjs` |
| [`computePassCounts`](../scripts/lib/outcome-sync.mjs#L114) | function | `scripts/lib/outcome-sync.mjs` | 114-126 | Tallies audit findings by pass and adjudication outcome (accepted/dismissed/severity-adjusted). | `scripts/lib/finalize-outcomes.mjs` |
| [`dbRuling`](../scripts/lib/outcome-sync.mjs#L139) | function | `scripts/lib/outcome-sync.mjs` | 139-144 | Maps adjudication outcome to a cloud-store ruling label for persistence. | `scripts/lib/finalize-outcomes.mjs` |
| [`enrichFindings`](../scripts/lib/outcome-sync.mjs#L92) | function | `scripts/lib/outcome-sync.mjs` | 92-107 | Merges ledger adjudication state into findings, populating outcome and remediation status. | `scripts/lib/finalize-outcomes.mjs` |
| [`readFinalizedKeys`](../scripts/lib/outcome-sync.mjs#L30) | function | `scripts/lib/outcome-sync.mjs` | 30-35 | Loads the set of finalized outcome batch IDs to prevent duplicate syncs. | `scripts/lib/finalize-outcomes.mjs` |
| [`recordTriageOutcomes`](../scripts/lib/outcome-sync.mjs#L202) | function | `scripts/lib/outcome-sync.mjs` | 202-229 | Records finding adjudication outcomes to both cloud and local ledgers with graceful degradation. | `scripts/lib/finalize-outcomes.mjs` |
| [`writeCloudOutcomes`](../scripts/lib/outcome-sync.mjs#L155) | function | `scripts/lib/outcome-sync.mjs` | 155-188 | Writes adjudication events, pass stats, and run metadata to the learning store. | `scripts/lib/finalize-outcomes.mjs` |
| [`writeLocalOutcomesOnce`](../scripts/lib/outcome-sync.mjs#L48) | function | `scripts/lib/outcome-sync.mjs` | 48-84 | Persists settled audit findings to a local outcomes log, idempotent per batch key. | `scripts/lib/finalize-outcomes.mjs` |
...
| [`_transitionState`](../scripts/lib/prompt-registry.mjs#L140) | function | `scripts/lib/prompt-registry.mjs` | 140-151 | Updates a revision's lifecycle state with timestamps. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`abandonRevision`](../scripts/lib/prompt-registry.mjs#L161) | function | `scripts/lib/prompt-registry.mjs` | 161-176 | Marks a revision abandoned, refusing if active bandit arms reference it. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`bootstrapFromConstants`](../scripts/lib/prompt-registry.mjs#L207) | function | `scripts/lib/prompt-registry.mjs` | 207-227 | Seeds the prompt registry with built-in prompts on first run, auto-promoting if missing. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
...
| [`getActiveRevisionId`](../scripts/lib/prompt-registry.mjs#L88) | function | `scripts/lib/prompt-registry.mjs` | 88-97 | Looks up the currently-active revision ID for a pass. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`listRevisions`](../scripts/lib/prompt-registry.mjs#L71) | function | `scripts/lib/prompt-registry.mjs` | 71-79 | Enumerates all saved revisions for a given pass. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`loadRevision`](../scripts/lib/prompt-registry.mjs#L58) | function | `scripts/lib/prompt-registry.mjs` | 58-64 | Reads a prompt revision from disk by pass and revision ID. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`promoteRevision`](../scripts/lib/prompt-registry.mjs#L117) | function | `scripts/lib/prompt-registry.mjs` | 117-136 | Marks a revision active and retires the previous one. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`revisionId`](../scripts/lib/prompt-registry.mjs#L24) | function | `scripts/lib/prompt-registry.mjs` | 24-27 | Generates a content-addressed revision ID from prompt text hash. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`saveRevision`](../scripts/lib/prompt-registry.mjs#L38) | function | `scripts/lib/prompt-registry.mjs` | 38-50 | Writes a prompt revision to disk with lifecycle metadata. | `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`buildClassificationRubric`](../scripts/lib/prompt-seeds.mjs#L175) | function | `scripts/lib/prompt-seeds.mjs` | 175-195 | Generates prompt instructions for finding classification (sonarType, effort, source). | `scripts/gemini-review.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`buildV2PassPrompt`](../scripts/lib/prompt-seeds.mjs#L262) | function | `scripts/lib/prompt-seeds.mjs` | 262-268 | Combines a base pass prompt with evidence and obligation blocks. | `scripts/gemini-review.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
...
| [`getVerifiableArtifacts`](../scripts/lib/release-artifacts.mjs#L56) | function | `scripts/lib/release-artifacts.mjs` | 56-58 | Return the manifest of release-packaged artifacts (skills, scripts, metadata). | _(internal)_ |
...
| [`canonicaliseRemoteUrl`](../scripts/lib/repo-identity.mjs#L61) | function | `scripts/lib/repo-identity.mjs` | 61-78 | Normalizes a git remote URL (SSH or HTTPS) to lowercase canonical form "host/path". | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`deriveName`](../scripts/lib/repo-identity.mjs#L108) | function | `scripts/lib/repo-identity.mjs` | 108-116 | Extracts a repo name from canonical remote URL (last two path segments) or directory basename. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`gitOriginUrl`](../scripts/lib/repo-identity.mjs#L80) | function | `scripts/lib/repo-identity.mjs` | 80-89 | Reads the origin URL from git config. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`gitTopLevel`](../scripts/lib/repo-identity.mjs#L91) | function | `scripts/lib/repo-identity.mjs` | 91-100 | Gets the git repository root directory. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`persistRepoIdentity`](../scripts/lib/repo-identity.mjs#L171) | function | `scripts/lib/repo-identity.mjs` | 171-179 | Writes the repo UUID to .repo-id file if it doesn't already exist. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`resolveRepoIdentity`](../scripts/lib/repo-identity.mjs#L122) | function | `scripts/lib/repo-identity.mjs` | 122-162 | Resolves repo identity via committed .repo-id file, origin URL, or path fallback, returning UUID and name. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
| [`uuidv5`](../scripts/lib/repo-identity.mjs#L37) | function | `scripts/lib/repo-identity.mjs` | 37-48 | Computes a SHA1-based UUIDv5 for a name within a namespace per RFC 4122. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +15 more |
...
| [`detectPythonEnvironmentManager`](../scripts/lib/repo-stack.mjs#L205) | function | `scripts/lib/repo-stack.mjs` | 205-211 | Identifies Python environment manager (poetry/uv/pipenv/venv) from lock files and directories. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`detectPythonFramework`](../scripts/lib/repo-stack.mjs#L182) | function | `scripts/lib/repo-stack.mjs` | 182-197 | Identifies Python framework (Django/FastAPI/Flask) from dependency files and manage.py marker. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`detectRepoStack`](../scripts/lib/repo-stack.mjs#L41) | function | `scripts/lib/repo-stack.mjs` | 41-86 | Detects programming language stack (JS/Python/Java/Postgres) from file markers and dependency content. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`hasJavaSources`](../scripts/lib/repo-stack.mjs#L156) | function | `scripts/lib/repo-stack.mjs` | 156-172 | Checks for .java files via git ls-files (with 64 MiB buffer for large monorepos). | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`hasPostgresSources`](../scripts/lib/repo-stack.mjs#L110) | function | `scripts/lib/repo-stack.mjs` | 110-140 | Checks for Postgres SQL files and distinctive Postgres syntax patterns (bounded file/byte sample). | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`blockingSleep`](../scripts/lib/retry-transient-fs.mjs#L14) | function | `scripts/lib/retry-transient-fs.mjs` | 14-18 | Blocks the current thread for a specified duration using `Atomics.wait`. | `scripts/archive-completed-plans.mjs`, `scripts/audit-clean.mjs`, `scripts/learning/backfill-outcomes.mjs`, +3 more |
| [`isFiniteNonNegative`](../scripts/lib/retry-transient-fs.mjs#L32) | function | `scripts/lib/retry-transient-fs.mjs` | 32-34 | Validates that a value is a finite, non-negative number. | `scripts/archive-completed-plans.mjs`, `scripts/audit-clean.mjs`, `scripts/learning/backfill-outcomes.mjs`, +3 more |
| [`isNonNegativeInteger`](../scripts/lib/retry-transient-fs.mjs#L36) | function | `scripts/lib/retry-transient-fs.mjs` | 36-38 | Validates that a value is a non-negative integer. | `scripts/archive-completed-plans.mjs`, `scripts/audit-clean.mjs`, `scripts/learning/backfill-outcomes.mjs`, +3 more |
| [`isStringArray`](../scripts/lib/retry-transient-fs.mjs#L40) | function | `scripts/lib/retry-transient-fs.mjs` | 40-42 | Validates that a value is an array of strings. | `scripts/archive-completed-plans.mjs`, `scripts/audit-clean.mjs`, `scripts/learning/backfill-outcomes.mjs`, +3 more |
| [`retrySync`](../scripts/lib/retry-transient-fs.mjs#L44) | function | `scripts/lib/retry-transient-fs.mjs` | 44-86 | Retries a synchronous operation with exponential backoff when it throws specific error codes. | `scripts/archive-completed-plans.mjs`, `scripts/audit-clean.mjs`, `scripts/learning/backfill-outcomes.mjs`, +3 more |
...
| [`clampToJsonSchemaLimits`](../scripts/lib/schemas.mjs#L414) | function | `scripts/lib/schemas.mjs` | 414-458 | Truncates strings/arrays to schema max-length/items limits, handling anyOf branches. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +20 more |
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L765) | function | `scripts/lib/schemas.mjs` | 765-781 | Validates that deferred findings carry required metadata based on deferral reason. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +20 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L250) | function | `scripts/lib/schemas.mjs` | 250-260 | Validates and extracts evidence from a finding (commission or omission). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +20 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L355) | function | `scripts/lib/schemas.mjs` | 355-372 | Removes Gemini-incompatible JSON Schema keywords. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +20 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L381) | function | `scripts/lib/schemas.mjs` | 381-384 | Converts a Zod schema to JSON Schema, stripping Gemini-unsupported keys. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +20 more |
...
| [`assertEgressSafe`](../scripts/lib/sensitive-egress-gate.mjs#L151) | function | `scripts/lib/sensitive-egress-gate.mjs` | 151-161 | Throws if payload contains secrets; gates before sending to external providers. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +18 more |
| [`containsSecrets`](../scripts/lib/sensitive-egress-gate.mjs#L58) | function | `scripts/lib/sensitive-egress-gate.mjs` | 58-68 | Detects if text body contains secret patterns. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +18 more |
...
| [`isExtensionAllowlisted`](../scripts/lib/sensitive-egress-gate.mjs#L47) | function | `scripts/lib/sensitive-egress-gate.mjs` | 47-51 | Checks if a file extension is on the egress allowlist. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +18 more |
| [`isPathSensitive`](../scripts/lib/sensitive-egress-gate.mjs#L38) | function | `scripts/lib/sensitive-egress-gate.mjs` | 38-40 | Checks if a file path matches the sensitive-path denylist. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +18 more |
...
| [`lintSkill`](../scripts/lib/skill-refs-parser.mjs#L142) | function | `scripts/lib/skill-refs-parser.mjs` | 142-215 | Validates skill directory structure, SKILL.md format, reference/example files, and frontmatter. | `scripts/check-skill-refs.mjs` |
| [`locateReferenceSection`](../scripts/lib/skill-refs-parser.mjs#L31) | function | `scripts/lib/skill-refs-parser.mjs` | 31-44 | Locates the "## Reference files" section start and end lines in SKILL.md markdown. | `scripts/check-skill-refs.mjs` |
| [`parseReferenceFrontmatter`](../scripts/lib/skill-refs-parser.mjs#L112) | function | `scripts/lib/skill-refs-parser.mjs` | 112-130 | Extracts and validates the `summary:` YAML frontmatter value from a reference file. | `scripts/check-skill-refs.mjs` |
| [`parseReferenceTable`](../scripts/lib/skill-refs-parser.mjs#L56) | function | `scripts/lib/skill-refs-parser.mjs` | 56-105 | Extracts File/Summary/Read-when rows from a reference-files markdown table with validation. | `scripts/check-skill-refs.mjs` |
...
| [`applyCloudFpSuppression`](../scripts/lib/suppression-policy.mjs#L292) | function | `scripts/lib/suppression-policy.mjs` | 292-316 | Filters findings through a cloud FP policy, returning kept findings and suppression records. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`buildCloudFpPolicy`](../scripts/lib/suppression-policy.mjs#L242) | function | `scripts/lib/suppression-policy.mjs` | 242-273 | Constructs a cloud FP suppression policy from loaded data with lifecycle state. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`buildLedgerExclusions`](../scripts/lib/suppression-policy.mjs#L24) | function | `scripts/lib/suppression-policy.mjs` | 24-36 | Extracts dismissed ledger entries into a suppression format. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`matchesFinding`](../scripts/lib/suppression-policy.mjs#L122) | function | `scripts/lib/suppression-policy.mjs` | 122-129 | Tests whether a false-positive pattern matches a finding by category, severity, and principle. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`resolveFpPatterns`](../scripts/lib/suppression-policy.mjs#L49) | function | `scripts/lib/suppression-policy.mjs` | 49-117 | Merges local and cloud false-positive patterns, applies decay-at-read, and preps for matching. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`resolveSuppressionPolicy`](../scripts/lib/suppression-policy.mjs#L154) | function | `scripts/lib/suppression-policy.mjs` | 154-158 | Combines ledger exclusions and false-positive patterns into a unified suppression policy. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`runCloudFpPass`](../scripts/lib/suppression-policy.mjs#L338) | function | `scripts/lib/suppression-policy.mjs` | 338-349 | Applies cloud false-positive suppression to findings with logging. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`scopeCompleteness`](../scripts/lib/suppression-policy.mjs#L206) | function | `scripts/lib/suppression-policy.mjs` | 206-213 | Assesses whether a cloud FP scope loaded successfully and is complete (not truncated/failed). | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
| [`shouldSuppressFinding`](../scripts/lib/suppression-policy.mjs#L167) | function | `scripts/lib/suppression-policy.mjs` | 167-201 | Decides whether to suppress a finding by checking FP patterns hierarchically, then ledger. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/shared.mjs` |
...
| [`bannerTokenFor`](../scripts/lib/sync-banner.mjs#L42) | function | `scripts/lib/sync-banner.mjs` | 42-47 | Returns the comment-token syntax (e.g., `#` or `//`) for a relocated file by extension. | `scripts/sync-to-repos.mjs` |
| [`firstContentLine`](../scripts/lib/sync-banner.mjs#L50) | function | `scripts/lib/sync-banner.mjs` | 50-62 | Extracts the first non-shebang line from file content (used for idempotency checks). | `scripts/sync-to-repos.mjs` |
| [`injectUpstreamBanner`](../scripts/lib/sync-banner.mjs#L72) | function | `scripts/lib/sync-banner.mjs` | 72-94 | Prepends an upstream-warning banner to a synced file if not already present (idempotent). | `scripts/sync-to-repos.mjs` |
...
| [`buildCopilotPromptFiles`](../scripts/lib/sync-inventory.mjs#L165) | function | `scripts/lib/sync-inventory.mjs` | 165-173 | Lists all `.prompt.md` files in `.github/prompts/` for Copilot consumption. | `scripts/check-isolation-inventory.mjs` |
| [`buildFileUniverse`](../scripts/lib/sync-inventory.mjs#L190) | function | `scripts/lib/sync-inventory.mjs` | 190-207 | Walks `scripts/` and `.claude/` directories to enumerate all source files as a cache. | `scripts/check-isolation-inventory.mjs` |
| [`buildSkillFiles`](../scripts/lib/sync-inventory.mjs#L151) | function | `scripts/lib/sync-inventory.mjs` | 151-163 | Builds the list of synced skill files (`.claude/skills/**` and optionally `.github/skills/**`). | `scripts/check-isolation-inventory.mjs` |
| [`bundleForRepo`](../scripts/lib/sync-inventory.mjs#L229) | function | `scripts/lib/sync-inventory.mjs` | 229-241 | Assembles the full sync bundle for a consumer repo (entry points + skills + migrations + assets). | `scripts/check-isolation-inventory.mjs` |
| [`getAllConsumerInventories`](../scripts/lib/sync-inventory.mjs#L263) | function | `scripts/lib/sync-inventory.mjs` | 263-270 | Returns sync bundles for all known consumer repositories. | `scripts/check-isolation-inventory.mjs` |
| [`getFileUniverse`](../scripts/lib/sync-inventory.mjs#L210) | function | `scripts/lib/sync-inventory.mjs` | 210-213 | Returns cached file universe, computing it on first call via buildFileUniverse. | `scripts/check-isolation-inventory.mjs` |
| [`getSyncInventoryForRepo`](../scripts/lib/sync-inventory.mjs#L250) | function | `scripts/lib/sync-inventory.mjs` | 250-255 | Resolves a consumer repo by alias/name and returns its complete sync bundle. | `scripts/check-isolation-inventory.mjs` |
| [`readSource`](../scripts/lib/sync-inventory.mjs#L215) | function | `scripts/lib/sync-inventory.mjs` | 215-218 | Reads a source file by relative repo path, returning null on error. | `scripts/check-isolation-inventory.mjs` |
| [`resolveBundle`](../scripts/lib/sync-inventory.mjs#L220) | function | `scripts/lib/sync-inventory.mjs` | 220-227 | Collects the complete import closure of entry points plus additional assets. | `scripts/check-isolation-inventory.mjs` |
| [`syncMigrations`](../scripts/lib/sync-inventory.mjs#L139) | function | `scripts/lib/sync-inventory.mjs` | 139-149 | Lists all `.sql` migration files in `supabase/migrations/` in alphabetical order. | `scripts/check-isolation-inventory.mjs` |
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L490) | function | `scripts/lib/sync-isolation-verify.mjs` | 490-503 | Formats gate results as human-readable text with status icons (✓/✗) and error details. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L434) | function | `scripts/lib/sync-isolation-verify.mjs` | 434-449 | Reports uncommitted git changes (read-only status check) to surface working-tree state for operator review. | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L165) | function | `scripts/lib/sync-isolation-verify.mjs` | 165-226 | Verifies that `scripts/.claude-skills/` is neither tracked nor uncommitted in git. | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L228) | function | `scripts/lib/sync-isolation-verify.mjs` | 228-260 | Verifies all manifest-recorded files exist and match their stored SHA-256 hashes. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L262) | function | `scripts/lib/sync-isolation-verify.mjs` | 262-291 | Scans command-bearing files for stale invocations of owned-source paths outside isolation. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L293) | function | `scripts/lib/sync-isolation-verify.mjs` | 293-357 | Runs `--selfcheck-relocation` smoke tests on CLI entry points and validates library imports. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L359) | function | `scripts/lib/sync-isolation-verify.mjs` | 359-406 | Verifies that `package.json` npm run scripts don't invoke non-isolated synced paths. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L408) | function | `scripts/lib/sync-isolation-verify.mjs` | 408-415 | Validates that the consumer manifest's layout is set to "isolated". | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L417) | function | `scripts/lib/sync-isolation-verify.mjs` | 417-432 | Checks that the consumer's .gitignore has a properly-formed managed block with one begin and end marker in order. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L147) | function | `scripts/lib/sync-isolation-verify.mjs` | 147-157 | Enumerates command-bearing files (scripts, CI configs, shells) that may reference tooling. | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L104) | function | `scripts/lib/sync-isolation-verify.mjs` | 104-123 | Reads and Zod-validates a consumer's `.claude/sync-manifest.json` against schema. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L505) | function | `scripts/lib/sync-isolation-verify.mjs` | 505-531 | CLI entry point that parses arguments, runs gates, and outputs results in JSON or text format with appropriate exit codes. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L84) | function | `scripts/lib/sync-isolation-verify.mjs` | 84-102 | Parses command-line arguments for the sync-isolation-verify script. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L159) | function | `scripts/lib/sync-isolation-verify.mjs` | 159-161 | Converts an absolute path to a repo-relative forward-slash path. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L453) | function | `scripts/lib/sync-isolation-verify.mjs` | 453-480 | Runs a sequence of validation gates against a consumer repo and collects pass/fail results. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L482) | function | `scripts/lib/sync-isolation-verify.mjs` | 482-488 | Prints error message that --selfcheck-inventory is source-side only. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L125) | function | `scripts/lib/sync-isolation-verify.mjs` | 125-145 | Recursively yields all file paths under a directory (fail-closed on read errors). | _(internal)_ |
...
| [`normalizeWhitespace`](../scripts/lib/text-normalize.mjs#L19) | function | `scripts/lib/text-normalize.mjs` | 19-21 | Normalizes a string by collapsing whitespace and trimming. | `scripts/lib/audit/evidence-triage.mjs` |
...
| [`canonicalizeForOccurrenceMatch`](../scripts/lib/vcs.mjs#L325) | function | `scripts/lib/vcs.mjs` | 325-331 | Normalizes text for matching by removing carriage returns and trimming each line. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`classifyChildError`](../scripts/lib/vcs.mjs#L101) | function | `scripts/lib/vcs.mjs` | 101-124 | Classifies subprocess/execSync errors into structured VCS error codes via stderr pattern matching. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`contentExistsAtMappedRange`](../scripts/lib/vcs.mjs#L296) | function | `scripts/lib/vcs.mjs` | 296-307 | Checks if a quoted string exists within a specific line range of a file at a git revision. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`exitCodeFor`](../scripts/lib/vcs.mjs#L68) | function | `scripts/lib/vcs.mjs` | 68-77 | Maps VCS error codes to Unix exit codes (127 for missing git, 5 for bad repo/revision, 1 for other failures). | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`gitCommitSha`](../scripts/lib/vcs.mjs#L134) | function | `scripts/lib/vcs.mjs` | 134-147 | Retrieves the HEAD commit SHA using git rev-parse, returning {ok, sha} or {ok:false, error}. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`gitDiffWithWorkingTree`](../scripts/lib/vcs.mjs#L160) | function | `scripts/lib/vcs.mjs` | 160-217 | Lists added/modified/deleted/untracked/renamed files since a commit via git diff and ls-files. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`gitShowFileAtRevision`](../scripts/lib/vcs.mjs#L235) | function | `scripts/lib/vcs.mjs` | 235-265 | Retrieves file content at a specific git revision with path-existence checking and size limits. | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`isRetryableVcsError`](../scripts/lib/vcs.mjs#L57) | function | `scripts/lib/vcs.mjs` | 57-59 | Checks if a VCS error code is retryable (only EXEC_FAILED is retryable; others are fatal). | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
| [`isSafeGitRevision`](../scripts/lib/vcs.mjs#L88) | function | `scripts/lib/vcs.mjs` | 88-91 | Validates that a string is a safe git revision reference (200 chars max, alphanumeric + safe punctuation). | `scripts/lib/audit/duplication-detector.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, +1 more |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`err`](../scripts/ship-commit.mjs#L41) | function | `scripts/ship-commit.mjs` | 41-41 | <no body> | _(internal)_ |
| [`git`](../scripts/ship-commit.mjs#L43) | function | `scripts/ship-commit.mjs` | 43-45 | Spawns a git subprocess with arguments in a specified directory and returns captured output. | _(internal)_ |
| [`main`](../scripts/ship-commit.mjs#L78) | function | `scripts/ship-commit.mjs` | 78-281 | CLI entry point that parses arguments, resolves commit parameters, constructs git trailers, and commits with signature. | _(internal)_ |
| [`resolveSkillNames`](../scripts/ship-commit.mjs#L51) | function | `scripts/ship-commit.mjs` | 51-76 | Discovers skill directory names by reading both skills/ and .claude/skills/ layouts, with error handling. | _(internal)_ |
...
> Manages Postgres connection pooling, validates safe DSN configuration (rejecting transaction poolers and production endpoints), and tracks transaction context via AsyncLocalStorage for the audit-loop Supabase store.
...
_Domain has 255 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`copyForwardImports`](../scripts/lib/store/arch/imports.mjs#L39) | function | `scripts/lib/store/arch/imports.mjs` | 39-70 | Copies untouched file-import edges from one refresh run to the next. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
| [`getImportersForFiles`](../scripts/lib/store/arch/imports.mjs#L123) | function | `scripts/lib/store/arch/imports.mjs` | 123-144 | Batches file paths and returns a map of which files import each target file. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
| [`getImportGraphPopulated`](../scripts/lib/store/arch/imports.mjs#L105) | function | `scripts/lib/store/arch/imports.mjs` | 105-116 | Checks if a refresh run's import graph has been populated. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
| [`listFileImportsForSnapshot`](../scripts/lib/store/arch/imports.mjs#L79) | function | `scripts/lib/store/arch/imports.mjs` | 79-94 | Returns all import edges for a refresh run as (importer, imported) pairs. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
| [`markImportGraphPopulated`](../scripts/lib/store/arch/imports.mjs#L96) | function | `scripts/lib/store/arch/imports.mjs` | 96-103 | Flags a refresh run's import graph as complete. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
| [`recordSymbolFileImports`](../scripts/lib/store/arch/imports.mjs#L17) | function | `scripts/lib/store/arch/imports.mjs` | 17-37 | Batches and upserts file-level import edges into symbol_file_imports. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/lib/store/arch-memory.mjs` |
...
| [`buildFpPatternRows`](../scripts/lib/store/bandit-fp.mjs#L186) | function | `scripts/lib/store/bandit-fp.mjs` | 186-222 | Transforms local false-positive patterns into database row format for cloud upload. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`buildFpReadQuery`](../scripts/lib/store/bandit-fp.mjs#L159) | function | `scripts/lib/store/bandit-fp.mjs` | 159-171 | Constructs a SQL query to fetch false-positive patterns with optional auto-suppress filtering. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`fpPatternReadColumns`](../scripts/lib/store/bandit-fp.mjs#L127) | function | `scripts/lib/store/bandit-fp.mjs` | 127-129 | Returns the list of column names for the false_positive_patterns table. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getFalsePositivePatterns`](../scripts/lib/store/bandit-fp.mjs#L362) | function | `scripts/lib/store/bandit-fp.mjs` | 362-374 | Fetches auto-suppress-eligible false-positive patterns for a repo from the cloud. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getPassEffectiveness`](../scripts/lib/store/bandit-fp.mjs#L438) | function | `scripts/lib/store/bandit-fp.mjs` | 438-455 | Queries per-pass finding statistics (raised, accepted, dismissed) for a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`isSyncableRepoId`](../scripts/lib/store/bandit-fp.mjs#L241) | function | `scripts/lib/store/bandit-fp.mjs` | 241-243 | Validates that a repo ID is a UUID and safe to sync to the cloud. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`loadBanditArms`](../scripts/lib/store/bandit-fp.mjs#L57) | function | `scripts/lib/store/bandit-fp.mjs` | 57-80 | Retrieves previously synced bandit arm state from the cloud. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`loadFalsePositivePatterns`](../scripts/lib/store/bandit-fp.mjs#L330) | function | `scripts/lib/store/bandit-fp.mjs` | 330-357 | Retrieves both repo and global false-positive patterns from the cloud with fallbacks. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readFpScope`](../scripts/lib/store/bandit-fp.mjs#L293) | function | `scripts/lib/store/bandit-fp.mjs` | 293-307 | Fetches false-positive patterns from a specific scope (repo or global). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`syncBanditArms`](../scripts/lib/store/bandit-fp.mjs#L28) | function | `scripts/lib/store/bandit-fp.mjs` | 28-49 | Uploads Thompson Sampling bandit arm state (alpha, beta, pulls) to the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`syncExperiments`](../scripts/lib/store/bandit-fp.mjs#L381) | function | `scripts/lib/store/bandit-fp.mjs` | 381-407 | Persists prompt experiment results and bandit metadata to the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`syncFalsePositivePatterns`](../scripts/lib/store/bandit-fp.mjs#L255) | function | `scripts/lib/store/bandit-fp.mjs` | 255-287 | Uploads local false-positive patterns to the cloud with identity validation. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`syncPromptRevision`](../scripts/lib/store/bandit-fp.mjs#L414) | function | `scripts/lib/store/bandit-fp.mjs` | 414-429 | Writes a prompt revision and its SHA-256 checksum to the cloud. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`upsertPromptVariant`](../scripts/lib/store/bandit-fp.mjs#L87) | function | `scripts/lib/store/bandit-fp.mjs` | 87-103 | Writes or updates prompt variant performance statistics to the cloud. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
...
| [`buildDebtEntry`](../scripts/lib/debt-capture.mjs#L84) | function | `scripts/lib/debt-capture.mjs` | 84-158 | Constructs a persisted debt entry with secret redaction and sensitivity classification. | `scripts/debt-auto-capture.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/shared.mjs` |
| [`computeSensitivity`](../scripts/lib/debt-capture.mjs#L32) | function | `scripts/lib/debt-capture.mjs` | 32-54 | Detects if a finding contains sensitive data in paths or content. | `scripts/debt-auto-capture.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/shared.mjs` |
| [`suggestDeferralCandidate`](../scripts/lib/debt-capture.mjs#L171) | function | `scripts/lib/debt-capture.mjs` | 171-183 | Determines if a finding is eligible for deferral based on scope and severity. | `scripts/debt-auto-capture.mjs`, `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/shared.mjs` |
...
| [`findDebtByAlias`](../scripts/lib/debt-ledger.mjs#L273) | function | `scripts/lib/debt-ledger.mjs` | 273-280 | Looks up a debt entry by topic ID or content-alias match. | `scripts/audit-loop.mjs`, `scripts/debt-auto-capture.mjs`, `scripts/debt-backfill.mjs`, +7 more |
| [`mergeLedgers`](../scripts/lib/debt-ledger.mjs#L252) | function | `scripts/lib/debt-ledger.mjs` | 252-262 | Merges debt and session ledgers, with session entries winning collisions. | `scripts/audit-loop.mjs`, `scripts/debt-auto-capture.mjs`, `scripts/debt-backfill.mjs`, +7 more |
| [`readDebtLedger`](../scripts/lib/debt-ledger.mjs#L42) | function | `scripts/lib/debt-ledger.mjs` | 42-89 | Loads the debt ledger and enriches entries with event-derived metrics. | `scripts/audit-loop.mjs`, `scripts/debt-auto-capture.mjs`, `scripts/debt-backfill.mjs`, +7 more |
| [`removeDebtEntry`](../scripts/lib/debt-ledger.mjs#L207) | function | `scripts/lib/debt-ledger.mjs` | 207-236 | Removes a debt entry by topic ID from the ledger. | `scripts/audit-loop.mjs`, `scripts/debt-auto-capture.mjs`, `scripts/debt-backfill.mjs`, +7 more |
| [`writeDebtEntries`](../scripts/lib/debt-ledger.mjs#L107) | function | `scripts/lib/debt-ledger.mjs` | 107-197 | Persists new and updated debt entries to the ledger file with file locking. | `scripts/audit-loop.mjs`, `scripts/debt-auto-capture.mjs`, `scripts/debt-backfill.mjs`, +7 more |
...
> Test infrastructure for deterministic seams (file I/O, schemas, VCS contracts, cloud store mutations) plus fixture builders for parser and config validation across the audit-loop pipeline.
...
_Domain has 473 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`writeTree`](../tests/arch-intent-adapter-java.test.mjs#L22) | function | `tests/arch-intent-adapter-java.test.mjs` | 22-29 | Creates a temporary directory and writes test fixture files to it. | _(internal)_ |
| [`parse`](../tests/arch-intent-adapter-postgres.test.mjs#L29) | function | `tests/arch-intent-adapter-postgres.test.mjs` | 29-31 | Parses SQL after stripping comments and strings. | _(internal)_ |
| [`writeTree`](../tests/arch-intent-adapter-postgres.test.mjs#L19) | function | `tests/arch-intent-adapter-postgres.test.mjs` | 19-26 | Creates a temporary directory and writes SQL test fixture files to it. | _(internal)_ |
| [`writeTree`](../tests/arch-intent-adapter-python.test.mjs#L26) | function | `tests/arch-intent-adapter-python.test.mjs` | 26-33 | Creates a temporary directory and writes Python test fixture files to it. | _(internal)_ |
| [`mkDoc`](../tests/arch-intent-doc-parser.test.mjs#L9) | function | `tests/arch-intent-doc-parser.test.mjs` | 9-14 | Creates a temporary markdown document for testing parser logic. | _(internal)_ |
| [`mkRepo`](../tests/arch-intent-load-config.test.mjs#L10) | function | `tests/arch-intent-load-config.test.mjs` | 10-17 | Creates a temporary repository directory structure with an .audit-loop folder and domain-map.json. | _(internal)_ |
...
| [`assertAllSitesRetrySyncWrapped`](../tests/atomic-write-adoption-guard.test.mjs#L198) | function | `tests/atomic-write-adoption-guard.test.mjs` | 198-220 | Asserts that all fs.renameSync and fs.unlinkSync calls in a file are wrapped in retrySync(). | _(internal)_ |
| [`collectFsMethodBindings`](../tests/atomic-write-adoption-guard.test.mjs#L47) | function | `tests/atomic-write-adoption-guard.test.mjs` | 47-62 | Collects local binding names for fs module methods and namespace imports. | _(internal)_ |
| [`collectNamedImportBindings`](../tests/atomic-write-adoption-guard.test.mjs#L30) | function | `tests/atomic-write-adoption-guard.test.mjs` | 30-44 | Collects all local binding names for a named import from a specific module. | _(internal)_ |
| [`findEnclosingCall`](../tests/atomic-write-adoption-guard.test.mjs#L81) | function | `tests/atomic-write-adoption-guard.test.mjs` | 81-103 | Finds the enclosing function call wrapping a given AST node (e.g., retrySync wrapper). | _(internal)_ |
| [`findFsMethodSites`](../tests/atomic-write-adoption-guard.test.mjs#L106) | function | `tests/atomic-write-adoption-guard.test.mjs` | 106-126 | Finds all call sites of specified fs methods (renameSync, unlinkSync) in an AST. | _(internal)_ |
| [`findNamedFunctionRange`](../tests/atomic-write-adoption-guard.test.mjs#L129) | function | `tests/atomic-write-adoption-guard.test.mjs` | 129-147 | Locates the start/end positions of a named function or arrow function in an AST. | _(internal)_ |
| [`functionCallsAtomicWriteFileSync`](../tests/atomic-write-adoption-guard.test.mjs#L150) | function | `tests/atomic-write-adoption-guard.test.mjs` | 150-160 | Checks whether a named function body contains a call to atomicWriteFileSync. | _(internal)_ |
| [`parseFile`](../tests/atomic-write-adoption-guard.test.mjs#L23) | function | `tests/atomic-write-adoption-guard.test.mjs` | 23-27 | Parses a JavaScript file into an AST. | _(internal)_ |
| [`walkAst`](../tests/atomic-write-adoption-guard.test.mjs#L64) | function | `tests/atomic-write-adoption-guard.test.mjs` | 64-78 | Recursively traverses an AST tree, invoking a visitor function on each node with its ancestor chain. | _(internal)_ |
| [`agedFile`](../tests/audit-clean-traversal.test.mjs#L50) | function | `tests/audit-clean-traversal.test.mjs` | 50-55 | Creates file with mtime set to 14+ days ago. | _(internal)_ |
| [`CUTOFF`](../tests/audit-clean-traversal.test.mjs#L82) | function | `tests/audit-clean-traversal.test.mjs` | 82-82 | Calculates timestamp for 14 days before now. | _(internal)_ |
| [`mkTmp`](../tests/audit-clean-traversal.test.mjs#L31) | function | `tests/audit-clean-traversal.test.mjs` | 31-35 | Creates temporary directory and tracks it for cleanup. | _(internal)_ |
| [`spy`](../tests/audit-clean-traversal.test.mjs#L44) | function | `tests/audit-clean-traversal.test.mjs` | 44-47 | Creates spy logger that collects warn() calls. | _(internal)_ |
| [`trySymlink`](../tests/audit-clean-traversal.test.mjs#L70) | function | `tests/audit-clean-traversal.test.mjs` | 70-76 | Attempts to create symlink, returning false if not supported. | _(internal)_ |
| [`runCli`](../tests/audit-plan-rebuttal-split-smoke.test.mjs#L44) | function | `tests/audit-plan-rebuttal-split-smoke.test.mjs` | 44-56 | Spawns openai-audit.mjs as a child process, captures output, and returns exit code and combined stdout/stderr. | _(internal)_ |
| [`mkdtemp`](../tests/audit-scope-egress.test.mjs#L38) | function | `tests/audit-scope-egress.test.mjs` | 38-40 | Creates a temporary directory with a prefix for test isolation. | _(internal)_ |
...
| [`mkTmp`](../tests/brainstorm-session-store.test.mjs#L12) | function | `tests/brainstorm-session-store.test.mjs` | 12-14 | Creates a temporary directory for brainstorm session tests. | _(internal)_ |
| [`mkV2Envelope`](../tests/brainstorm-session-store.test.mjs#L16) | function | `tests/brainstorm-session-store.test.mjs` | 16-27 | Constructs a mock brainstorm V2 session envelope with test defaults. | _(internal)_ |
...
| [`validFinding`](../tests/clamp-json-schema-limits.test.mjs#L20) | function | `tests/clamp-json-schema-limits.test.mjs` | 20-40 | Creates a test code audit finding with all typical fields (severity, category, classification). | _(internal)_ |
| [`mkTmpRepo`](../tests/claudemd/autofix.test.mjs#L9) | function | `tests/claudemd/autofix.test.mjs` | 9-13 | Creates a temporary directory for autofix tests. | _(internal)_ |
...
| [`writeStub`](../tests/code-analysis.test.mjs#L336) | function | `tests/code-analysis.test.mjs` | 336-339 | Writes a file filled with repeated characters to create a specific byte size. | _(internal)_ |
| [`EV_PATH`](../tests/commit-trailers.test.mjs#L136) | function | `tests/commit-trailers.test.mjs` | 136-139 | Factory that creates a temporary directory and evidence file path for storing audit run metadata. | _(internal)_ |
| [`validInput`](../tests/commit-trailers.test.mjs#L28) | function | `tests/commit-trailers.test.mjs` | 28-37 | Returns a template audit-event object with default values for testing commit trailers. | _(internal)_ |
| [`mkdtemp`](../tests/config-shared-env.test.mjs#L21) | function | `tests/config-shared-env.test.mjs` | 21-23 | Creates a temporary directory with a prefix for shared config testing. | _(internal)_ |
| [`runChild`](../tests/config-shared-env.test.mjs#L29) | function | `tests/config-shared-env.test.mjs` | 29-45 | Spawns a child process with a clean environment (HOME override) to test cross-repo config loading. | _(internal)_ |
...
| [`runCrossSkill`](../tests/cross-skill-target-domains.test.mjs#L13) | function | `tests/cross-skill-target-domains.test.mjs` | 13-18 | Spawns cross-skill.mjs with a JSON payload and returns the process result. | _(internal)_ |
...
| [`mkScriptsDir`](../tests/dashboard-cli.test.mjs#L35) | function | `tests/dashboard-cli.test.mjs` | 35-37 | Creates the scripts subdirectory in a test fixture tree. | _(internal)_ |
| [`withTmp`](../tests/dashboard-cli.test.mjs#L19) | function | `tests/dashboard-cli.test.mjs` | 19-23 | Creates a temporary directory, runs a callback function, then cleans up. | _(internal)_ |
| [`writeCatalog`](../tests/dashboard-cli.test.mjs#L30) | function | `tests/dashboard-cli.test.mjs` | 30-33 | Writes a CLI catalog JSON file listing available commands. | _(internal)_ |
| [`writePkg`](../tests/dashboard-cli.test.mjs#L25) | function | `tests/dashboard-cli.test.mjs` | 25-28 | Writes a minimal package.json file to a test directory. | _(internal)_ |
| [`fixture`](../tests/dashboard-purpose-health.test.mjs#L18) | function | `tests/dashboard-purpose-health.test.mjs` | 18-29 | Returns a test dashboard health fixture with purpose badges and repo-wide metrics. | _(internal)_ |
| [`fixtureRoot`](../tests/dashboard-purpose.test.mjs#L20) | function | `tests/dashboard-purpose.test.mjs` | 20-29 | Creates a temporary directory with a mock `.audit-loop/domain-map.json` for testing. | _(internal)_ |
| [`renderFixture`](../tests/dashboard-purpose.test.mjs#L163) | function | `tests/dashboard-purpose.test.mjs` | 163-174 | Returns a mock dashboard render with escaped HTML, domains, and requirements nodes. | _(internal)_ |
...
| [`makeEntry`](../tests/debt-budget-check-cli.test.mjs#L17) | function | `tests/debt-budget-check-cli.test.mjs` | 17-28 | Constructs a test debt ledger entry with severity, category, and deferral metadata. | _(internal)_ |
| [`runCli`](../tests/debt-budget-check-cli.test.mjs#L35) | function | `tests/debt-budget-check-cli.test.mjs` | 35-37 | Spawns the debt budget check CLI script as a subprocess. | _(internal)_ |
| [`seedLedger`](../tests/debt-budget-check-cli.test.mjs#L30) | function | `tests/debt-budget-check-cli.test.mjs` | 30-33 | Writes a debt ledger JSON file with entries and optional budget constraints. | _(internal)_ |
| [`git`](../tests/debt-git-history.test.mjs#L25) | function | `tests/debt-git-history.test.mjs` | 25-36 | Executes a git command in a test directory, optionally allowing failure. | _(internal)_ |
| [`makeEntry`](../tests/debt-git-history.test.mjs#L43) | function | `tests/debt-git-history.test.mjs` | 43-54 | Constructs a test debt entry with topic ID, semantic hash, and deferral state. | _(internal)_ |
| [`writeLedger`](../tests/debt-git-history.test.mjs#L38) | function | `tests/debt-git-history.test.mjs` | 38-41 | Writes a debt ledger JSON to `.audit/tech-debt.json`. | _(internal)_ |
| [`makeEntry`](../tests/debt-ledger.test.mjs#L23) | function | `tests/debt-ledger.test.mjs` | 23-43 | Constructs a fully-populated test debt entry with all audit metadata fields. | _(internal)_ |
| [`makeEntry`](../tests/debt-pr-comment-cli.test.mjs#L18) | function | `tests/debt-pr-comment-cli.test.mjs` | 18-29 | Constructs a test debt entry with topic-based category naming. | _(internal)_ |
...
| [`makeEntry`](../tests/debt-resolve-cli.test.mjs#L20) | function | `tests/debt-resolve-cli.test.mjs` | 20-29 | Constructs a test debt entry for resolution CLI testing. | _(internal)_ |
...
| [`mkdtemp`](../tests/diff-annotation-egress.test.mjs#L23) | function | `tests/diff-annotation-egress.test.mjs` | 23-25 | Creates a temporary directory with a given prefix. | _(internal)_ |
| [`commit`](../tests/diff-scope-resolver.test.mjs#L48) | function | `tests/diff-scope-resolver.test.mjs` | 48-52 | Stages all changes and commits them to a test repository. | _(internal)_ |
| [`newRepo`](../tests/diff-scope-resolver.test.mjs#L35) | function | `tests/diff-scope-resolver.test.mjs` | 35-46 | Initializes a temporary git repository with minimal config and a package.json. | _(internal)_ |
| [`sh`](../tests/diff-scope-resolver.test.mjs#L24) | function | `tests/diff-scope-resolver.test.mjs` | 24-26 | Executes a git command in a repository directory. | _(internal)_ |
| [`writeFile`](../tests/diff-scope-resolver.test.mjs#L28) | function | `tests/diff-scope-resolver.test.mjs` | 28-32 | Writes a file to a test repository, creating parent directories. | _(internal)_ |
...
| [`commitAll`](../tests/drift-stale-pragma.test.mjs#L27) | function | `tests/drift-stale-pragma.test.mjs` | 27-30 | Stages all changes and commits them with a message. | _(internal)_ |
| [`mkGitRepo`](../tests/drift-stale-pragma.test.mjs#L19) | function | `tests/drift-stale-pragma.test.mjs` | 19-25 | Creates and configures a temporary git repository with user identity. | _(internal)_ |
...
| [`baseAdapters`](../tests/duplication-egress.test.mjs#L35) | function | `tests/duplication-egress.test.mjs` | 35-47 | Returns a mock adapter with repo, embedding, and egress gate methods. | _(internal)_ |
| [`mkRepo`](../tests/duplication-egress.test.mjs#L30) | function | `tests/duplication-egress.test.mjs` | 30-32 | Creates a temporary directory for duplication egress testing. | _(internal)_ |
...
| [`rule`](../tests/efficacy-lints.test.mjs#L24) | function | `tests/efficacy-lints.test.mjs` | 24-24 | Extracts a rule result from linter output by ID. | _(internal)_ |
| [`tmpRepo`](../tests/efficacy-lints.test.mjs#L15) | function | `tests/efficacy-lints.test.mjs` | 15-23 | Creates a temporary directory populated with test files from a map. | _(internal)_ |
...
| [`makeDiffMap`](../tests/file-io.test.mjs#L16) | function | `tests/file-io.test.mjs` | 16-20 | Converts diff entries into a Map for file-IO testing. | _(internal)_ |
| [`mkEnvelope`](../tests/final-adjudication-egress.test.mjs#L53) | function | `tests/final-adjudication-egress.test.mjs` | 53-66 | Constructs a test finding envelope with optional anchor file metadata. | _(internal)_ |
| [`neverCallExecFile`](../tests/final-adjudication-egress.test.mjs#L47) | function | `tests/final-adjudication-egress.test.mjs` | 47-51 | Returns a function that throws if called, blocking subprocess egress of sensitive content. | _(internal)_ |
| [`captureExecFileDir`](../tests/final-adjudication-subprocess-adapter.test.mjs#L49) | function | `tests/final-adjudication-subprocess-adapter.test.mjs` | 49-54 | Wraps execFile to capture the working directory of subprocess invocations. | _(internal)_ |
| [`mkEnvelope`](../tests/final-adjudication-subprocess-adapter.test.mjs#L75) | function | `tests/final-adjudication-subprocess-adapter.test.mjs` | 75-85 | Constructs a test finding envelope with severity and anchor metadata. | _(internal)_ |
| [`noKeyEnv`](../tests/final-adjudication-subprocess-adapter.test.mjs#L59) | function | `tests/final-adjudication-subprocess-adapter.test.mjs` | 59-66 | Returns a test environment with all API keys and cloud services cleared. | _(internal)_ |
...
| [`outcomesLines`](../tests/finalize-outcomes.test.mjs#L51) | function | `tests/finalize-outcomes.test.mjs` | 51-54 | Reads and splits the outcomes JSONL file into lines or returns an empty array. | _(internal)_ |
| [`ruledPair`](../tests/finalize-outcomes.test.mjs#L39) | function | `tests/finalize-outcomes.test.mjs` | 39-49 | Returns a finding and ledger entry pair with adjudication outcome and remediation state. | _(internal)_ |
...
| [`git`](../tests/git-hooks-wiring.test.mjs#L27) | function | `tests/git-hooks-wiring.test.mjs` | 27-27 | Executes git command in test repo directory. | _(internal)_ |
...
| [`extractSnippet`](../tests/hook-snippet-behaviour.test.mjs#L36) | function | `tests/hook-snippet-behaviour.test.mjs` | 36-46 | Extracts a bash code snippet from a markdown document bounded by fence markers. | _(internal)_ |
| [`runSnippet`](../tests/hook-snippet-behaviour.test.mjs#L52) | function | `tests/hook-snippet-behaviour.test.mjs` | 52-87 | Runs a bash snippet in an isolated temporary environment with mocked executables to verify hook behavior. | _(internal)_ |
...
| [`mkRepo`](../tests/install/gitignore.test.mjs#L34) | function | `tests/install/gitignore.test.mjs` | 34-40 | Creates a temporary test repository directory with optional package.json. | _(internal)_ |
| [`backdateLock`](../tests/install/global-journal-placement.test.mjs#L121) | function | `tests/install/global-journal-placement.test.mjs` | 121-126 | Artificially ages a process lock file by rewriting its timestamp to test expiration. | _(internal)_ |
| [`crashMidGlobalRename`](../tests/install/global-journal-placement.test.mjs#L66) | function | `tests/install/global-journal-placement.test.mjs` | 66-92 | Tests crash recovery by intercepting renames and exiting mid-transaction at the global skills surface. | _(internal)_ |
| [`globalTarget`](../tests/install/global-journal-placement.test.mjs#L53) | function | `tests/install/global-journal-placement.test.mjs` | 53-53 | Constructs the full path to a skill file within the global skills hierarchy. | _(internal)_ |
| [`homeEnv`](../tests/install/global-journal-placement.test.mjs#L50) | function | `tests/install/global-journal-placement.test.mjs` | 50-50 | Returns an environment object with HOME and USERPROFILE pointing to a test directory. | _(internal)_ |
| [`mkTmp`](../tests/install/global-journal-placement.test.mjs#L35) | function | `tests/install/global-journal-placement.test.mjs` | 35-41 | Creates a temporary directory with symlink resolution for containment verification. | _(internal)_ |
| [`reconcileThenInstall`](../tests/install/global-journal-placement.test.mjs#L95) | function | `tests/install/global-journal-placement.test.mjs` | 95-113 | Tests journal reconciliation followed by executing a transaction to write global skill files. | _(internal)_ |
| [`recoverFromJournalIn`](../tests/install/global-journal-placement.test.mjs#L116) | function | `tests/install/global-journal-placement.test.mjs` | 116-118 | Recovers from a crashed install transaction stored in a repo's journal file. | _(internal)_ |
| [`runNode`](../tests/install/global-journal-placement.test.mjs#L55) | function | `tests/install/global-journal-placement.test.mjs` | 55-59 | Spawns a Node.js process to execute inline ESM code with a custom environment. | _(internal)_ |
| [`skillsRoot`](../tests/install/global-journal-placement.test.mjs#L52) | function | `tests/install/global-journal-placement.test.mjs` | 52-52 | Constructs the path to ~/.claude/skills within a home folder. | _(internal)_ |
| [`journalPath`](../tests/install/lifecycle.test.mjs#L14) | function | `tests/install/lifecycle.test.mjs` | 14-14 | Returns path to install transaction journal file. | _(internal)_ |
| [`sha12`](../tests/install/lifecycle.test.mjs#L13) | function | `tests/install/lifecycle.test.mjs` | 13-13 | Computes SHA256 hash and returns first 12 hex characters. | _(internal)_ |
| [`mkTmp`](../tests/install/receipt-scope-seam.test.mjs#L33) | function | `tests/install/receipt-scope-seam.test.mjs` | 33-37 | Creates temporary directory with real path resolution and tracking. | _(internal)_ |
| [`receiptOf`](../tests/install/receipt-scope-seam.test.mjs#L45) | function | `tests/install/receipt-scope-seam.test.mjs` | 45-47 | Builds install receipt object from managed files list. | _(internal)_ |
| [`mkRepo`](../tests/install/reconcile-journals.test.mjs#L25) | function | `tests/install/reconcile-journals.test.mjs` | 25-29 | Creates a temporary directory to serve as a mock repository. | _(internal)_ |
| [`runReconcile`](../tests/install/reconcile-journals.test.mjs#L47) | function | `tests/install/reconcile-journals.test.mjs` | 47-63 | Spawns a Node process to test the reconcileJournals function in isolation. | _(internal)_ |
| [`journalIn`](../tests/install/transaction-hardening.test.mjs#L39) | function | `tests/install/transaction-hardening.test.mjs` | 39-39 | Constructs the path to an install transaction journal within a repo. | _(internal)_ |
| [`mkTmp`](../tests/install/transaction-hardening.test.mjs#L27) | function | `tests/install/transaction-hardening.test.mjs` | 27-31 | Creates a temporary directory with a labeled prefix for transaction hardening tests. | _(internal)_ |
| [`writeRawJournal`](../tests/install/transaction-hardening.test.mjs#L41) | function | `tests/install/transaction-hardening.test.mjs` | 41-45 | Writes a raw (possibly malformed) JSON object to an install transaction journal. | _(internal)_ |
...
| [`makeMockStore`](../tests/learning-decision-logger.test.mjs#L21) | function | `tests/learning-decision-logger.test.mjs` | 21-38 | Creates a mock learning store for testing with configurable failure injection. | _(internal)_ |
| [`tmpOutbox`](../tests/learning-decision-logger.test.mjs#L40) | function | `tests/learning-decision-logger.test.mjs` | 40-42 | Creates a temporary directory for learning outbox tests. | _(internal)_ |
...
| [`blockingSleep`](../tests/maintenance-hook-snippet.test.mjs#L153) | function | `tests/maintenance-hook-snippet.test.mjs` | 153-155 | Blocks thread for specified milliseconds using Atomics.wait. | _(internal)_ |
| [`extractFullHookBody`](../tests/maintenance-hook-snippet.test.mjs#L58) | function | `tests/maintenance-hook-snippet.test.mjs` | 58-69 | Extracts shell hook body from JS template source, unescaping backticks. | _(internal)_ |
| [`extractSnippet`](../tests/maintenance-hook-snippet.test.mjs#L71) | function | `tests/maintenance-hook-snippet.test.mjs` | 71-84 | Extracts maintenance-check snippet from pre-push hook source. | _(internal)_ |
| [`readLog`](../tests/maintenance-hook-snippet.test.mjs#L158) | function | `tests/maintenance-hook-snippet.test.mjs` | 158-163 | Reads maintenance log file and returns content if marker found. | _(internal)_ |
| [`runSnippet`](../tests/maintenance-hook-snippet.test.mjs#L95) | function | `tests/maintenance-hook-snippet.test.mjs` | 95-147 | Executes hook snippet in isolated environment and captures output. | _(internal)_ |
| [`waitForLog`](../tests/maintenance-hook-snippet.test.mjs#L173) | function | `tests/maintenance-hook-snippet.test.mjs` | 173-181 | Polls for maintenance log appearance with timeout and retry loop. | _(internal)_ |
| [`mkTmp`](../tests/memory-health.test.mjs#L9) | function | `tests/memory-health.test.mjs` | 9-13 | Creates a temporary directory for memory-health tests. | _(internal)_ |
...
| [`fakeClient`](../tests/model-ab-egress.test.mjs#L33) | function | `tests/model-ab-egress.test.mjs` | 33-47 | Returns a mock OpenAI client that records calls or throws errors as configured. | _(internal)_ |
| [`ev`](../tests/nav-bootstrap-draft.test.mjs#L12) | function | `tests/nav-bootstrap-draft.test.mjs` | 12-14 | Constructs an event object with target and container candidates for nav testing. | _(internal)_ |
...
| [`result`](../tests/nav-verify-store.test.mjs#L21) | function | `tests/nav-verify-store.test.mjs` | 21-29 | Returns a mock nav-audit verify result with version, states, and live attribution data. | _(internal)_ |
...
| [`backdate`](../tests/orphan-preimage-sweep.test.mjs#L26) | function | `tests/orphan-preimage-sweep.test.mjs` | 26-29 | Sets a file's modification time to a past timestamp offset by hours. | _(internal)_ |
| [`git`](../tests/orphan-preimage-sweep.test.mjs#L21) | function | `tests/orphan-preimage-sweep.test.mjs` | 21-21 | Executes a git command in a directory. | _(internal)_ |
...
| [`fakeScheduler`](../tests/oss-structured-output.test.mjs#L27) | function | `tests/oss-structured-output.test.mjs` | 27-38 | Creates a mock scheduler that records setTimeout/setInterval calls without actually scheduling. | _(internal)_ |
| [`fencedClient`](../tests/oss-structured-output.test.mjs#L281) | function | `tests/oss-structured-output.test.mjs` | 281-286 | Creates a mock OpenAI client that returns JSON wrapped in optional code fences. | _(internal)_ |
| [`successClient`](../tests/oss-structured-output.test.mjs#L40) | function | `tests/oss-structured-output.test.mjs` | 40-42 | Creates a mock OpenAI client that returns a successful JSON completion. | _(internal)_ |
| [`seed`](../tests/owner-resolver.test.mjs#L21) | function | `tests/owner-resolver.test.mjs` | 21-25 | Writes a CODEOWNERS file to a test directory. | _(internal)_ |
...
| [`journalExists`](../tests/persona-consistency-promote.test.mjs#L69) | function | `tests/persona-consistency-promote.test.mjs` | 69-71 | Checks if a journal entry file exists for a given spec ID. | _(internal)_ |
| [`writeJournalEntry`](../tests/persona-consistency-promote.test.mjs#L63) | function | `tests/persona-consistency-promote.test.mjs` | 63-67 | Writes a JSON journal entry to the persona-consistency test journal directory. | _(internal)_ |
| [`writeCanary`](../tests/persona-consistency-run-args.test.mjs#L71) | function | `tests/persona-consistency-run-args.test.mjs` | 71-77 | Creates and writes a JSON canary file to `.persona-test/canaries/`. | _(internal)_ |
| [`writeManifest`](../tests/persona-consistency-run-args.test.mjs#L64) | function | `tests/persona-consistency-run-args.test.mjs` | 64-70 | Writes a surfaces.json manifest to the `.persona-test` directory. | _(internal)_ |
...
| [`c`](../tests/persona-test-canary.test.mjs#L268) | function | `tests/persona-test-canary.test.mjs` | 268-279 | Returns a fixture value-mismatch consistency finding with DOM and engine state. | _(internal)_ |
| [`writeCanary`](../tests/persona-test-canary.test.mjs#L44) | function | `tests/persona-test-canary.test.mjs` | 44-50 | Creates a canaries directory, writes a JSON canary file, and returns its path. | _(internal)_ |
...
| [`baseStep`](../tests/persona-test-ledger.test.mjs#L39) | function | `tests/persona-test-ledger.test.mjs` | 39-58 | Returns a template persona test step with witness, contradictions, and freshness fields. | _(internal)_ |
...
| [`countAll`](../tests/postgres-parity-non-core-lint.test.mjs#L25) | function | `tests/postgres-parity-non-core-lint.test.mjs` | 25-27 | Counts all lint findings across categories, optionally filtering by coupling. | _(internal)_ |
| [`mig`](../tests/postgres-parity-non-core-lint.test.mjs#L23) | function | `tests/postgres-parity-non-core-lint.test.mjs` | 23-23 | Wraps migration data into {name, path, content} object. | _(internal)_ |
...
| [`freshRegistry`](../tests/prompt-registry-bootstrap.test.mjs#L36) | function | `tests/prompt-registry-bootstrap.test.mjs` | 36-39 | Dynamically imports prompt registry with cache-busting query string. | _(internal)_ |
| [`mkCwd`](../tests/prompt-registry-bootstrap.test.mjs#L30) | function | `tests/prompt-registry-bootstrap.test.mjs` | 30-35 | Creates temp dir, registers for cleanup, and changes into it. | _(internal)_ |
...
| [`gitInit`](../tests/refresh-cli-contract.test.mjs#L37) | function | `tests/refresh-cli-contract.test.mjs` | 37-43 | Initializes a git repository with config and an empty commit. | _(internal)_ |
...
| [`mkdtemp`](../tests/refresh-cli-contract.test.mjs#L33) | function | `tests/refresh-cli-contract.test.mjs` | 33-35 | Creates a temporary directory in the system temp folder. | _(internal)_ |
...
| [`assertSelfcheckOk`](../tests/relocation-selfcheck-smoke.test.mjs#L57) | function | `tests/relocation-selfcheck-smoke.test.mjs` | 57-79 | Runs a script with `--selfcheck-relocation`, verifies it exits 0 with "OK", and checks for credential leaks. | _(internal)_ |
| [`hermeticEnv`](../tests/relocation-selfcheck-smoke.test.mjs#L38) | function | `tests/relocation-selfcheck-smoke.test.mjs` | 38-44 | Creates a minimal environment object with only essential system variables. | _(internal)_ |
...
| [`write`](../tests/repo-stack.test.mjs#L16) | function | `tests/repo-stack.test.mjs` | 16-19 | Creates directories and writes file content to a test directory. | _(internal)_ |
...
| [`collectRetrySyncBindings`](../tests/rmsync-retry-guard.test.mjs#L42) | function | `tests/rmsync-retry-guard.test.mjs` | 42-58 | Identifies local binding names for `retrySync` imported from the retry module in a given file. | _(internal)_ |
| [`discoverTargetFiles`](../tests/rmsync-retry-guard.test.mjs#L29) | function | `tests/rmsync-retry-guard.test.mjs` | 29-34 | Finds all `.mjs` files in the tests and scripts directories. | _(internal)_ |
| [`isCompliantInline`](../tests/rmsync-retry-guard.test.mjs#L60) | function | `tests/rmsync-retry-guard.test.mjs` | 60-65 | Checks if an `rmSync` call has inline retry options (recursive=true, maxRetries=3, retryDelay=50). | _(internal)_ |
| [`isCompliantWrapped`](../tests/rmsync-retry-guard.test.mjs#L67) | function | `tests/rmsync-retry-guard.test.mjs` | 67-71 | Checks if an `rmSync` call is wrapped inside a `retrySync` invocation. | _(internal)_ |
| [`walkMjsFiles`](../tests/rmsync-retry-guard.test.mjs#L17) | function | `tests/rmsync-retry-guard.test.mjs` | 17-27 | Recursively scans a directory for all `.mjs` files, skipping `node_modules` and `.git`. | _(internal)_ |
| [`section`](../tests/rulings-block-guard.test.mjs#L114) | function | `tests/rulings-block-guard.test.mjs` | 114-120 | Extracts markdown section by heading from text block. | _(internal)_ |
| [`wellFormed`](../tests/rulings-block-guard.test.mjs#L24) | function | `tests/rulings-block-guard.test.mjs` | 24-36 | Factory creating a well-formed ledger entry with optional overrides. | _(internal)_ |
| [`writeLedger`](../tests/rulings-block-guard.test.mjs#L20) | function | `tests/rulings-block-guard.test.mjs` | 20-22 | Writes ledger JSON to file. | _(internal)_ |
...
| [`defaultResponses`](../tests/run-multi-pass-code-audit-harness.test.mjs#L136) | function | `tests/run-multi-pass-code-audit-harness.test.mjs` | 136-146 | Returns stub responses for all five audit passes (structure, wiring, backend, frontend, sustainability). | _(internal)_ |
| [`makeStubClient`](../tests/run-multi-pass-code-audit-harness.test.mjs#L111) | function | `tests/run-multi-pass-code-audit-harness.test.mjs` | 111-134 | Creates a mock OpenAI client that responds with stubbed results for each audit pass type. | _(internal)_ |
| [`mkFinding`](../tests/run-multi-pass-code-audit-harness.test.mjs#L87) | function | `tests/run-multi-pass-code-audit-harness.test.mjs` | 87-95 | Returns a fixture audit finding with test severity, category, and location data. | _(internal)_ |
| [`mkTmpFile`](../tests/run-multi-pass-code-audit-harness.test.mjs#L148) | function | `tests/run-multi-pass-code-audit-harness.test.mjs` | 148-153 | Creates a temporary file in a new directory and returns its path. | _(internal)_ |
...
| [`mkdtemp`](../tests/sensitive-paths-canonical.test.mjs#L18) | function | `tests/sensitive-paths-canonical.test.mjs` | 18-20 | Creates a temporary directory. | _(internal)_ |
| [`collectStream`](../tests/setup-postgres-check-drift.test.mjs#L57) | function | `tests/setup-postgres-check-drift.test.mjs` | 57-67 | Creates a Writable stream that collects output chunks for assertion in tests. | _(internal)_ |
| [`mkdtemp`](../tests/setup-postgres-check-drift.test.mjs#L27) | function | `tests/setup-postgres-check-drift.test.mjs` | 27-29 | Creates a temporary directory for test isolation. | _(internal)_ |
| [`sha256OfString`](../tests/setup-postgres-check-drift.test.mjs#L71) | function | `tests/setup-postgres-check-drift.test.mjs` | 71-74 | Computes the SHA-256 hash of a string. | _(internal)_ |
| [`spawnNode`](../tests/setup-postgres-check-drift.test.mjs#L446) | function | `tests/setup-postgres-check-drift.test.mjs` | 446-463 | Spawns the setup-postgres.mjs script in a subprocess with configurable environment variables for testing. | _(internal)_ |
| [`stubPool`](../tests/setup-postgres-check-drift.test.mjs#L43) | function | `tests/setup-postgres-check-drift.test.mjs` | 43-55 | Provides a mock Postgres pool stub that responds to schema-check and migration-ledger queries. | _(internal)_ |
...
| [`collectStream`](../tests/shared-cloud-config.test.mjs#L26) | function | `tests/shared-cloud-config.test.mjs` | 26-31 | Creates a writable stream that collects output as text. | _(internal)_ |
| [`makeSourceRepo`](../tests/shared-cloud-config.test.mjs#L35) | function | `tests/shared-cloud-config.test.mjs` | 35-41 | Creates a fixture source repo with scripts directory and optional `.env` file. | _(internal)_ |
| [`mkdtemp`](../tests/shared-cloud-config.test.mjs#L22) | function | `tests/shared-cloud-config.test.mjs` | 22-24 | Creates a temporary directory. | _(internal)_ |
| [`freshTmp`](../tests/shared-env-loading.test.mjs#L44) | function | `tests/shared-env-loading.test.mjs` | 44-49 | Creates a unique temporary directory with PID and sequence number in the name. | _(internal)_ |
| [`hermeticEnv`](../tests/shared-env-loading.test.mjs#L61) | function | `tests/shared-env-loading.test.mjs` | 61-67 | Creates an isolated environment with HOME/USERPROFILE redirected and all DB env vars cleared. | _(internal)_ |
| [`resolveInChild`](../tests/shared-env-loading.test.mjs#L83) | function | `tests/shared-env-loading.test.mjs` | 83-92 | Tests AUDIT_DB_URL resolution in a hermetic child process with optional shared config. | _(internal)_ |
| [`runChild`](../tests/shared-env-loading.test.mjs#L69) | function | `tests/shared-env-loading.test.mjs` | 69-76 | Spawns a Node process with inline script, asserts success, and returns parsed JSON output. | _(internal)_ |
| [`makeLedgerEntry`](../tests/shared.test.mjs#L299) | function | `tests/shared.test.mjs` | 299-318 | Returns a fixture adjudication ledger entry with standard fields and metadata. | _(internal)_ |
| [`arrange`](../tests/ship-commit-cli.test.mjs#L41) | function | `tests/ship-commit-cli.test.mjs` | 41-50 | Creates test files and a message file for commit testing. | _(internal)_ |
...
| [`commitCount`](../tests/ship-commit-cli.test.mjs#L35) | function | `tests/ship-commit-cli.test.mjs` | 35-38 | Returns the number of commits in a repository using git rev-list. | _(internal)_ |
| [`git`](../tests/ship-commit-cli.test.mjs#L20) | function | `tests/ship-commit-cli.test.mjs` | 20-24 | Runs a git command in a directory and returns the output. | _(internal)_ |
| [`runCli`](../tests/ship-commit-cli.test.mjs#L26) | function | `tests/ship-commit-cli.test.mjs` | 26-33 | Spawns the ship CLI with arguments in a hermetic environment (no real DB URL or cloud config). | _(internal)_ |
| [`write`](../tests/skill-packaging.test.mjs#L12) | function | `tests/skill-packaging.test.mjs` | 12-16 | Creates directories and writes file content to a test directory. | _(internal)_ |
...
| [`write`](../tests/skill-refs-parser.test.mjs#L14) | function | `tests/skill-refs-parser.test.mjs` | 14-18 | Creates directories and writes file content to a test directory. | _(internal)_ |
| [`scriptsIn`](../tests/skills-artifact-freshness-wiring.test.mjs#L35) | function | `tests/skills-artifact-freshness-wiring.test.mjs` | 35-37 | Extracts script file paths from npm command text via regex. | _(internal)_ |
| [`copyDir`](../tests/skills-fit-check.test.mjs#L326) | function | `tests/skills-fit-check.test.mjs` | 326-334 | Recursively copies a directory tree, handling subdirectories and files. | _(internal)_ |
| [`verdictFor`](../tests/skills-fit-check.test.mjs#L24) | function | `tests/skills-fit-check.test.mjs` | 24-26 | Finds and returns a verdict object matching a given skill name. | _(internal)_ |
...
| [`mkdtemp`](../tests/stage1-triage-dto.test.mjs#L29) | function | `tests/stage1-triage-dto.test.mjs` | 29-31 | Creates a temporary directory. | _(internal)_ |
...
| [`declaredFpPatternColumns`](../tests/store-bandit-fp.test.mjs#L166) | function | `tests/store-bandit-fp.test.mjs` | 166-196 | Parses SQL migrations to extract the column schema of the false_positive_patterns table. | _(internal)_ |
| [`makeTracker`](../tests/store-bandit-fp.test.mjs#L380) | function | `tests/store-bandit-fp.test.mjs` | 380-384 | Factory function creating a FalsePositiveTracker with a mock file store for tests. | _(internal)_ |
...
| [`cloudRow`](../tests/suppression-policy.test.mjs#L37) | function | `tests/suppression-policy.test.mjs` | 37-53 | Mocks a cloud-suppressed finding for testing | _(internal)_ |
| [`envelope`](../tests/suppression-policy.test.mjs#L59) | function | `tests/suppression-policy.test.mjs` | 59-62 | Wraps suppression patterns with default metadata | _(internal)_ |
| [`finding`](../tests/suppression-policy.test.mjs#L55) | function | `tests/suppression-policy.test.mjs` | 55-57 | Mocks a minimal finding for testing | _(internal)_ |
| [`iso`](../tests/suppression-policy.test.mjs#L32) | function | `tests/suppression-policy.test.mjs` | 32-32 | Converts milliseconds to ISO date string | _(internal)_ |
| [`suppressingPolicy`](../tests/suppression-policy.test.mjs#L161) | function | `tests/suppression-policy.test.mjs` | 161-163 | Resolves suppression policy from cloud patterns | _(internal)_ |
...
| [`insertRefreshRun`](../tests/symbol-index-drift-justification.test.mjs#L31) | function | `tests/symbol-index-drift-justification.test.mjs` | 31-37 | Inserts a test refresh run record into the database and returns its ID. | _(internal)_ |
| [`makeSymbol`](../tests/symbol-index-drift-justification.test.mjs#L39) | function | `tests/symbol-index-drift-justification.test.mjs` | 39-46 | Creates a test symbol definition and index entry in the database, returning the definition ID. | _(internal)_ |
| [`mkTmp`](../tests/symbol-index-drift.test.mjs#L13) | function | `tests/symbol-index-drift.test.mjs` | 13-17 | Creates a temporary directory for drift tests. | _(internal)_ |
| [`mkdtemp`](../tests/sync-manifest-idempotency.test.mjs#L18) | function | `tests/sync-manifest-idempotency.test.mjs` | 18-20 | Creates a temporary directory. | _(internal)_ |
| [`setupRepo`](../tests/sync-manifest-idempotency.test.mjs#L22) | function | `tests/sync-manifest-idempotency.test.mjs` | 22-28 | Creates a test repository with sample text files. | _(internal)_ |
| [`setupRepo`](../tests/sync-shared-audit-refs.test.mjs#L11) | function | `tests/sync-shared-audit-refs.test.mjs` | 11-16 | Creates a temporary directory with nested docs/audit/shared-references and skills folders. | _(internal)_ |
| [`teardown`](../tests/sync-shared-audit-refs.test.mjs#L18) | function | `tests/sync-shared-audit-refs.test.mjs` | 18-21 | Deletes the temporary test directory with retry logic. | _(internal)_ |
| [`collectStream`](../tests/sync-shared-env-trigger.test.mjs#L34) | function | `tests/sync-shared-env-trigger.test.mjs` | 34-39 | Creates a writable stream that collects chunks and exposes them as text via `.text()`. | _(internal)_ |
| [`makeSourceRepo`](../tests/sync-shared-env-trigger.test.mjs#L41) | function | `tests/sync-shared-env-trigger.test.mjs` | 41-47 | Creates a temporary directory with a scripts folder and optional `.env` file to simulate a source repo. | _(internal)_ |
| [`mkdtemp`](../tests/sync-shared-env-trigger.test.mjs#L30) | function | `tests/sync-shared-env-trigger.test.mjs` | 30-32 | Creates a temporary directory. | _(internal)_ |
| [`git`](../tests/sync-untrack.test.mjs#L15) | function | `tests/sync-untrack.test.mjs` | 15-15 | Executes a git command in the test repo and returns the output. | _(internal)_ |
| [`isTracked`](../tests/sync-untrack.test.mjs#L16) | function | `tests/sync-untrack.test.mjs` | 16-18 | Checks whether a file path is tracked by git in the repo. | _(internal)_ |
| [`write`](../tests/sync-untrack.test.mjs#L28) | function | `tests/sync-untrack.test.mjs` | 28-33 | Writes content to a file at a relative path within a repo, creating parent directories as needed. | _(internal)_ |
| [`commit`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L51) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 51-56 | Writes, stages, and commits a file to a test repository, returning its commit SHA. | _(internal)_ |
| [`gitInit`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L43) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 43-48 | Initializes a Git repository with email, user, and GPG settings for testing. | _(internal)_ |
| [`HEAD_ANCHOR`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L68) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 68-72 | Returns a template git HEAD anchor object with customizable field overrides. | _(internal)_ |
| [`mkdtemp`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L38) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 38-40 | Creates a temporary directory with a fixed test prefix. | _(internal)_ |
| [`mkEnvelope`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L74) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 74-83 | Builds a test evidence envelope with a fingerprint, canonical finding, and HEAD anchor. | _(internal)_ |
| [`withCwd`](../tests/tiered-pipeline-stage0-wiring.test.mjs#L58) | function | `tests/tiered-pipeline-stage0-wiring.test.mjs` | 58-66 | Temporarily changes the working directory during function execution, then restores it. | _(internal)_ |
| [`mkFinding`](../tests/tiered-shadow-compare.test.mjs#L34) | function | `tests/tiered-shadow-compare.test.mjs` | 34-40 | Factory creating a test finding with optional field overrides. | _(internal)_ |
...
| [`commit`](../tests/vcs-blame.test.mjs#L31) | function | `tests/vcs-blame.test.mjs` | 31-36 | Creates a git commit with given file content and returns the commit SHA. | _(internal)_ |
| [`gitInit`](../tests/vcs-blame.test.mjs#L24) | function | `tests/vcs-blame.test.mjs` | 24-29 | Initializes a git repo and configures basic git settings for testing. | _(internal)_ |
| [`mkdtemp`](../tests/vcs-blame.test.mjs#L20) | function | `tests/vcs-blame.test.mjs` | 20-22 | Creates a temporary directory for vcs-blame tests. | _(internal)_ |
| [`gitInit`](../tests/vcs.test.mjs#L33) | function | `tests/vcs.test.mjs` | 33-39 | Initializes a git repository with basic config and an empty initial commit. | _(internal)_ |
| [`mkdtemp`](../tests/vcs.test.mjs#L29) | function | `tests/vcs.test.mjs` | 29-31 | Creates a temporary directory for testing with a predictable prefix. | _(internal)_ |
...
| [`run`](../tests/visual-theme-safety-cli.test.mjs#L25) | function | `tests/visual-theme-safety-cli.test.mjs` | 25-27 | Executes a Node CLI script and returns the result. | _(internal)_ |
