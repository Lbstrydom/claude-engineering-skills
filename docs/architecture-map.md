...
- [shared-lib](#shared-lib) — 717 symbols
...
> Orchestrates the multi-pass code audit workflow by spawning OpenAI and Gemini processes in sequence, parsing findings, tracking convergence thresholds (HIGH=0, MEDIUM≤2), and managing subprocess lifecycle with optional final-review skips.
...
_Domain has 186 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`_collectMaxLengths`](../scripts/gemini-review.mjs#L116) | function | `scripts/gemini-review.mjs` | 116-134 | Recursively extracts maxLength constraints from a JSON schema by path. | _(internal)_ |
| [`addSemanticIds`](../scripts/gemini-review.mjs#L1450) | function | `scripts/gemini-review.mjs` | 1450-1458 | Assigns ID, semantic hash, and source metadata to findings. | _(internal)_ |
| [`applyDebtSuppression`](../scripts/gemini-review.mjs#L1383) | function | `scripts/gemini-review.mjs` | 1383-1418 | Removes findings from result that fuzzy-match pre-filtered debt envelope signatures. | _(internal)_ |
| [`applyProviderSetting`](../scripts/gemini-review.mjs#L1258) | function | `scripts/gemini-review.mjs` | 1258-1276 | Updates or removes the FINAL_REVIEW_PROVIDER line in .env text. | _(internal)_ |
| [`applyScopeFilter`](../scripts/gemini-review.mjs#L1420) | function | `scripts/gemini-review.mjs` | 1420-1448 | Removes findings whose file locations don't match the changed_files list. | _(internal)_ |
| [`assertAzureClaudeReady`](../scripts/gemini-review.mjs#L1309) | function | `scripts/gemini-review.mjs` | 1309-1320 | Validates that required Azure env vars (AZURE_AI_ENDPOINT, AZURE_FOUNDRY_CLAUDE_DEPLOYMENT) are set. | _(internal)_ |
| [`buildClient`](../scripts/gemini-review.mjs#L1322) | function | `scripts/gemini-review.mjs` | 1322-1336 | Factory that creates a client for the selected provider (Gemini SDK, Azure Claude, or public Claude). | _(internal)_ |
| [`buildShadowClient`](../scripts/gemini-review.mjs#L955) | function | `scripts/gemini-review.mjs` | 955-960 | Creates a client for the shadow reviewer (Gemini SDK or Anthropic). | _(internal)_ |
| [`callAzureClaude`](../scripts/gemini-review.mjs#L584) | function | `scripts/gemini-review.mjs` | 584-654 | Calls Claude via Azure Foundry, supporting both anthropic and openai API shapes. | _(internal)_ |
| [`callClaudeOpus`](../scripts/gemini-review.mjs#L495) | function | `scripts/gemini-review.mjs` | 495-573 | Calls Claude Opus with streaming, timeout guarding, and JSON schema validation. | _(internal)_ |
| [`callGemini`](../scripts/gemini-review.mjs#L348) | function | `scripts/gemini-review.mjs` | 348-445 | Calls Gemini 3.1 Pro with streaming JSON, timeout protection, and full transcript accumulation. | _(internal)_ |
| [`dedupByHash`](../scripts/gemini-review.mjs#L986) | function | `scripts/gemini-review.mjs` | 986-994 | Deduplicates findings by semantic hash/ID. | _(internal)_ |
| [`diffFindingBuckets`](../scripts/gemini-review.mjs#L1001) | function | `scripts/gemini-review.mjs` | 1001-1017 | Buckets findings into primary-only, shadow-only, or both categories. | _(internal)_ |
| [`emitReviewOutput`](../scripts/gemini-review.mjs#L1460) | function | `scripts/gemini-review.mjs` | 1460-1475 | Outputs review result as JSON to file/stdout or as formatted markdown. | _(internal)_ |
| [`formatReviewResult`](../scripts/gemini-review.mjs#L830) | function | `scripts/gemini-review.mjs` | 830-893 | Formats a final review result as markdown with verdict, deliberation quality, and findings. | _(internal)_ |
| [`getReviewPrompt`](../scripts/gemini-review.mjs#L328) | function | `scripts/gemini-review.mjs` | 328-331 | Returns the active gemini-review system prompt, optionally with role addendum. | _(internal)_ |
| [`isJsonTruncationError`](../scripts/gemini-review.mjs#L1338) | function | `scripts/gemini-review.mjs` | 1338-1342 | Checks if an error message indicates JSON truncation/parsing failure. | _(internal)_ |
| [`main`](../scripts/gemini-review.mjs#L1602) | function | `scripts/gemini-review.mjs` | 1602-1669 | Entry point: parses args, selects mode (review/set-provider/ping), validates, and dispatches. | _(internal)_ |
| [`parseReviewArgs`](../scripts/gemini-review.mjs#L1160) | function | `scripts/gemini-review.mjs` | 1160-1179 | Parses CLI arguments to extract plan/transcript files and optional flags (--json, --out, --provider, etc.). | _(internal)_ |
| [`recordGeminiOutcomes`](../scripts/gemini-review.mjs#L1522) | function | `scripts/gemini-review.mjs` | 1522-1544 | Aggregates outcome recording: new findings, wrongly dismissed, and bandit reward updates. | _(internal)_ |
| [`recordNewFindings`](../scripts/gemini-review.mjs#L1477) | function | `scripts/gemini-review.mjs` | 1477-1496 | Records new findings to outcomes log and false-positive tracker. | _(internal)_ |
| [`recordWronglyDismissed`](../scripts/gemini-review.mjs#L1498) | function | `scripts/gemini-review.mjs` | 1498-1520 | Records wrongly dismissed findings to outcomes log. | _(internal)_ |
| [`refreshCatalogAndWarn`](../scripts/gemini-review.mjs#L1101) | function | `scripts/gemini-review.mjs` | 1101-1122 | Refreshes model catalog and upgrades Gemini/Opus sentinels if newer versions exist. | _(internal)_ |
| [`resolveProviderSetting`](../scripts/gemini-review.mjs#L1241) | function | `scripts/gemini-review.mjs` | 1241-1244 | Reads the FINAL_REVIEW_PROVIDER env var or returns null. | _(internal)_ |
| [`resolveShadow`](../scripts/gemini-review.mjs#L926) | function | `scripts/gemini-review.mjs` | 926-952 | Resolves shadow reviewer config (provider, model, readiness state) based on env and settings. | _(internal)_ |
| [`runAdjudicatorOnlyReview`](../scripts/gemini-review.mjs#L1374) | function | `scripts/gemini-review.mjs` | 1374-1381 | Runs review with adjudicator-only role addendum, then clears the addendum. | _(internal)_ |
| [`runFinalReview`](../scripts/gemini-review.mjs#L667) | function | `scripts/gemini-review.mjs` | 667-826 | Orchestrates final review: reads code context, applies debt/scope filters, invokes the provider. | _(internal)_ |
| [`runFixtureReview`](../scripts/gemini-review.mjs#L1559) | function | `scripts/gemini-review.mjs` | 1559-1600 | Returns a canned Gemini result for testing (test-only under NODE_ENV=test). | _(internal)_ |
| [`runPing`](../scripts/gemini-review.mjs#L1153) | function | `scripts/gemini-review.mjs` | 1153-1158 | Attempts to ping Gemini, then Claude, exiting with error if neither key is set. | _(internal)_ |
| [`runPingClaude`](../scripts/gemini-review.mjs#L1136) | function | `scripts/gemini-review.mjs` | 1136-1151 | Tests Claude Opus connectivity with a simple prompt. | _(internal)_ |
| [`runPingGemini`](../scripts/gemini-review.mjs#L1124) | function | `scripts/gemini-review.mjs` | 1124-1134 | Tests Gemini connectivity with a simple prompt. | _(internal)_ |
| [`runReviewWithRetry`](../scripts/gemini-review.mjs#L1344) | function | `scripts/gemini-review.mjs` | 1344-1361 | Runs final review with automatic retry on JSON truncation, adding conciseness instruction. | _(internal)_ |
| [`runSetProvider`](../scripts/gemini-review.mjs#L1283) | function | `scripts/gemini-review.mjs` | 1283-1303 | CLI handler to persist a provider choice to .env with comment annotation. | _(internal)_ |
| [`runShadowAndPersist`](../scripts/gemini-review.mjs#L1039) | function | `scripts/gemini-review.mjs` | 1039-1095 | Runs shadow review if ready, buckets results, persists metadata to primary result. | _(internal)_ |
| [`runShadowReview`](../scripts/gemini-review.mjs#L967) | function | `scripts/gemini-review.mjs` | 967-977 | Runs the shadow reviewer blind, applies post-processing filters, returns findings. | _(internal)_ |
| [`selectProvider`](../scripts/gemini-review.mjs#L1201) | function | `scripts/gemini-review.mjs` | 1201-1238 | Selects the final review provider using priority (explicit choice → auto-detect) and availability. | _(internal)_ |
| [`shadowModelMatchesFamily`](../scripts/gemini-review.mjs#L912) | function | `scripts/gemini-review.mjs` | 912-917 | Checks if a model ID belongs to a provider family (gemini or claude). | _(internal)_ |
| [`shadowSkipBlock`](../scripts/gemini-review.mjs#L1020) | function | `scripts/gemini-review.mjs` | 1020-1025 | Returns a no-op shadow result block with skip state and metadata. | _(internal)_ |
| [`streamAnthropicMessage`](../scripts/gemini-review.mjs#L475) | function | `scripts/gemini-review.mjs` | 475-493 | Streams an Anthropic message and accumulates text + token usage from the event stream. | _(internal)_ |
| [`truncateToSchema`](../scripts/gemini-review.mjs#L148) | function | `scripts/gemini-review.mjs` | 148-168 | Truncates object fields to their schema-declared maxLength, tracking what was truncated. | _(internal)_ |
...
| [`applyExclusions`](../scripts/openai-audit.mjs#L167) | function | `scripts/openai-audit.mjs` | 167-176 | Filters files by exclusion patterns and logs count of excluded files. | _(internal)_ |
| [`loadExcludePatterns`](../scripts/openai-audit.mjs#L148) | function | `scripts/openai-audit.mjs` | 148-159 | Loads audit exclusion patterns from CLI --exclude-paths and .auditignore file. | _(internal)_ |
| [`main`](../scripts/openai-audit.mjs#L446) | function | `scripts/openai-audit.mjs` | 446-1040 | Entry point for openai-audit.mjs: refreshes model catalog, parses CLI args, runs audit. | _(internal)_ |
| [`printAuditResult`](../scripts/openai-audit.mjs#L342) | function | `scripts/openai-audit.mjs` | 342-397 | Formats and prints audit verdict, finding counts, and timing. | _(internal)_ |
| [`printCostPreflight`](../scripts/openai-audit.mjs#L104) | function | `scripts/openai-audit.mjs` | 104-122 | Logs estimated cost and token budget before audit execution. | _(internal)_ |
| [`resolveDiffBase`](../scripts/openai-audit.mjs#L439) | function | `scripts/openai-audit.mjs` | 439-442 | Determines git base commit for diff comparison (HEAD if working tree dirty, else HEAD~1). | _(internal)_ |
| [`runMultiPassCodeAudit`](../scripts/openai-audit.mjs#L407) | function | `scripts/openai-audit.mjs` | 407-418 | Orchestrates multi-pass code audit (legacy or tiered pipeline) and outputs results. | _(internal)_ |
...
> Routes Claude API calls through SDK or CLI backend based on environment, transparently redacts secrets from requests, and caches clients per backend configuration.
...
_Domain has 717 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`_resetClientCache`](../scripts/lib/anthropic-client.mjs#L353) | function | `scripts/lib/anthropic-client.mjs` | 353-356 | Clears cached Anthropic clients and resets CLI warning state. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`applyRedactor`](../scripts/lib/anthropic-client.mjs#L318) | function | `scripts/lib/anthropic-client.mjs` | 318-347 | Recursively redacts sensitive content from Claude API request parameters. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`assertOneShotTextMessages`](../scripts/lib/anthropic-client.mjs#L447) | function | `scripts/lib/anthropic-client.mjs` | 447-476 | Validates that messages are plain-text, user-role-only (no multi-turn) for CLI backend. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`buildPromptFromMessages`](../scripts/lib/anthropic-client.mjs#L484) | function | `scripts/lib/anthropic-client.mjs` | 484-501 | Concatenates text blocks from a messages array into a single prompt string. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`createAnthropicClient`](../scripts/lib/anthropic-client.mjs#L183) | function | `scripts/lib/anthropic-client.mjs` | 183-251 | Factory that creates or returns a cached Anthropic client with backend routing and redaction. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`createCliAdapter`](../scripts/lib/anthropic-client.mjs#L368) | function | `scripts/lib/anthropic-client.mjs` | 368-438 | Creates an Anthropic-compatible adapter wrapping the `claude -p` CLI subprocess. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`getDefaultRedactor`](../scripts/lib/anthropic-client.mjs#L255) | function | `scripts/lib/anthropic-client.mjs` | 255-273 | Creates a redactor function using shape-based secret pattern matching to sanitize prompts. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`isClaudeAvailable`](../scripts/lib/anthropic-client.mjs#L150) | function | `scripts/lib/anthropic-client.mjs` | 150-152 | Returns true if Claude is available (cli backend active or ANTHROPIC_API_KEY present). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`keyDigest`](../scripts/lib/anthropic-client.mjs#L50) | function | `scripts/lib/anthropic-client.mjs` | 50-52 | Returns first 16 hex chars of SHA256 hash of a key string. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`normaliseCliOutput`](../scripts/lib/anthropic-client.mjs#L676) | function | `scripts/lib/anthropic-client.mjs` | 676-724 | Parses claude CLI JSON output and maps it to SDK response shape with usage/cost fields. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`quoteWinArg`](../scripts/lib/anthropic-client.mjs#L750) | function | `scripts/lib/anthropic-client.mjs` | 750-755 | Escapes and quotes command-line arguments for Windows shell execution. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`resolveBackend`](../scripts/lib/anthropic-client.mjs#L120) | function | `scripts/lib/anthropic-client.mjs` | 120-133 | Parses and validates CLAUDE_BACKEND env var, rejecting invalid values with hard error. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`resolveTimeoutMs`](../scripts/lib/anthropic-client.mjs#L93) | function | `scripts/lib/anthropic-client.mjs` | 93-104 | Validates and returns timeout from options or env var, enforcing min/max bounds. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`runClaudeCli`](../scripts/lib/anthropic-client.mjs#L522) | function | `scripts/lib/anthropic-client.mjs` | 522-636 | Spawns the claude CLI with stdin prompt piping, timeout handling, and process-tree cleanup. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
| [`wrapSdkClient`](../scripts/lib/anthropic-client.mjs#L289) | function | `scripts/lib/anthropic-client.mjs` | 289-308 | Wraps the Anthropic SDK client with diagnostic passthrough and per-request redaction. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +10 more |
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L513) | function | `scripts/lib/config.mjs` | 513-582 | Constructs Azure AI Foundry configuration from environment variables or returns inert snapshot. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +41 more |
| [`clampConfigNumber`](../scripts/lib/config.mjs#L76) | function | `scripts/lib/config.mjs` | 76-96 | Parses a numeric environment variable with min/max bounds and warns on invalid input. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +41 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L253) | function | `scripts/lib/config.mjs` | 253-266 | Converts a language name to canonical lowercase code (js, ts, py, go, etc.). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +41 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Validates and returns an enum environment variable with warning on invalid input. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +41 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Writes file contents atomically using temp file + rename, following symlinks to avoid breaking dotfile managers. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +50 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a file path to lowercase with forward slashes and removes working-directory prefix. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +50 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file synchronously or exits the process with an error message if not found. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +50 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Parses a string to integer, returning a fallback value on NaN. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +50 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Writes JSON output to a file (creating directories as needed) or stdout with a summary message. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +50 more |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L563) | function | `scripts/lib/model-resolver.mjs` | 563-611 | CLI entry point resolving sentinels or displaying live vs static model pools. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L379) | function | `scripts/lib/model-resolver.mjs` | 379-384 | Clears all cached model catalogs and deprecation warnings. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L279) | function | `scripts/lib/model-resolver.mjs` | 279-289 | Compares two parsed model versions for sorting, preferring newer/GA/undated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L334) | function | `scripts/lib/model-resolver.mjs` | 334-349 | Maps deprecated model IDs to current ones with optional warning. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L257) | function | `scripts/lib/model-resolver.mjs` | 257-275 | Returns a description object with provider, family, tier, and concrete model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L438) | function | `scripts/lib/model-resolver.mjs` | 438-445 | Fetches Anthropic's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L426) | function | `scripts/lib/model-resolver.mjs` | 426-436 | Fetches Google Generative AI model list, stripping the `models/` prefix. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L417) | function | `scripts/lib/model-resolver.mjs` | 417-424 | Fetches OpenAI's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L404) | function | `scripts/lib/model-resolver.mjs` | 404-415 | Fetches a URL with abort timeout. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L393) | function | `scripts/lib/model-resolver.mjs` | 393-398 | Returns cached live models for a provider if within TTL. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L97) | function | `scripts/lib/model-resolver.mjs` | 97-99 | Checks if a model ID is a sentinel like `latest-gpt` or `latest-opus`. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L199) | function | `scripts/lib/model-resolver.mjs` | 199-205 | Maps a parsed model object to its logical tier string (unknown/economy/standard/frontier). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L357) | function | `scripts/lib/model-resolver.mjs` | 357-363 | Merges live cached model catalog with static fallback pool, deduplicated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L195) | function | `scripts/lib/model-resolver.mjs` | 195-197 | Attempts to parse a model ID as Claude, Gemini, or OpenAI, returning the first match. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L104) | function | `scripts/lib/model-resolver.mjs` | 104-117 | Parses a Claude model ID (e.g., claude-opus-4-6-20250101) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L120) | function | `scripts/lib/model-resolver.mjs` | 120-152 | Parses a Gemini model ID (e.g., gemini-2.0-flash-preview) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L155) | function | `scripts/lib/model-resolver.mjs` | 155-172 | Parses an OpenAI model ID (e.g., gpt-5.5-pro, o1-mini) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L302) | function | `scripts/lib/model-resolver.mjs` | 302-308 | Selects the newest Claude model from a pool for a given tier. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L291) | function | `scripts/lib/model-resolver.mjs` | 291-300 | Selects the newest Gemini model from a pool for a tier, preferring Google's alias. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L314) | function | `scripts/lib/model-resolver.mjs` | 314-324 | Selects the newest OpenAI model from a pool for a tier and variant. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L548) | function | `scripts/lib/model-resolver.mjs` | 548-556 | Returns a simplified pricing tier key for a model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L455) | function | `scripts/lib/model-resolver.mjs` | 455-481 | Fetches live model catalogs from all three providers in parallel, caching results. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L495) | function | `scripts/lib/model-resolver.mjs` | 495-527 | Resolves a sentinel or concrete model ID to concrete form, with static pool fallback. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L240) | function | `scripts/lib/model-resolver.mjs` | 240-248 | Returns a sentinel model ID string for a given logical tier and provider. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L371) | function | `scripts/lib/model-resolver.mjs` | 371-376 | Stores a provider's live model list in cache with fetch timestamp. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L535) | function | `scripts/lib/model-resolver.mjs` | 535-542 | Checks if a model is an o-series or GPT-5+ (reasoning capable). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L212) | function | `scripts/lib/model-resolver.mjs` | 212-233 | Classifies a model ID into a logical tier by parsing and remapping deprecated IDs first. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +22 more |
...
| [`azureBaseUrl`](../scripts/lib/openai-client.mjs#L69) | function | `scripts/lib/openai-client.mjs` | 69-79 | Constructs the Azure base URL for either Foundry Claude or Azure OpenAI GPT. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +5 more |
| [`createOpenAIClient`](../scripts/lib/openai-client.mjs#L91) | function | `scripts/lib/openai-client.mjs` | 91-160 | Factory that creates an OpenAI client with Azure/OSS/public routing and redaction. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +5 more |
| [`keyDigest`](../scripts/lib/openai-client.mjs#L60) | function | `scripts/lib/openai-client.mjs` | 60-62 | Computes a 16-char hex SHA-256 hash of a string for cache keys. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +5 more |
| [`normalizeApiPath`](../scripts/lib/openai-client.mjs#L53) | function | `scripts/lib/openai-client.mjs` | 53-57 | Normalizes an API path to /openai/v1 format with leading slash. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +5 more |
| [`trimTrailingSlash`](../scripts/lib/openai-client.mjs#L48) | function | `scripts/lib/openai-client.mjs` | 48-50 | Removes trailing slashes from a string. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +5 more |
...
| [`redact`](../scripts/lib/redact.mjs#L28) | function | `scripts/lib/redact.mjs` | 28-38 | Redacts secrets from a string and returns the redacted text plus count and pattern names. | `scripts/cross-skill.mjs`, `scripts/lib/audit/stage1-triage.mjs`, `scripts/lib/persona-test/semantic-compare.mjs`, +2 more |
| [`redactObject`](../scripts/lib/redact.mjs#L56) | function | `scripts/lib/redact.mjs` | 56-136 | <no body> | `scripts/cross-skill.mjs`, `scripts/lib/audit/stage1-triage.mjs`, `scripts/lib/persona-test/semantic-compare.mjs`, +2 more |
...
| [`LlmError`](../scripts/lib/robustness.mjs#L32) | class | `scripts/lib/robustness.mjs` | 32-40 | Custom error class for LLM-specific failures with category, usage, and retryability metadata. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, `scripts/lib/oss-structured-output.mjs`, +2 more |
| [`normalizeFindingsForOutput`](../scripts/lib/robustness.mjs#L108) | function | `scripts/lib/robustness.mjs` | 108-122 | Deduplicates findings by semantic hash and sorts by severity and ID. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, `scripts/lib/oss-structured-output.mjs`, +2 more |
| [`resolveLedgerPath`](../scripts/lib/robustness.mjs#L182) | function | `scripts/lib/robustness.mjs` | 182-212 | Resolves the ledger file path based on session ID, explicit config, or round number. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, `scripts/lib/oss-structured-output.mjs`, +2 more |
...
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L605) | function | `scripts/lib/schemas.mjs` | 605-621 | Validates that deferred findings include all required fields based on their deferral reason. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +18 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L223) | function | `scripts/lib/schemas.mjs` | 223-233 | Validates and normalizes evidence fields from a finding (commission/omission anchor/chain). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +18 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L304) | function | `scripts/lib/schemas.mjs` | 304-313 | Recursively removes Gemini-unsupported JSON schema keys from an object. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +18 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L322) | function | `scripts/lib/schemas.mjs` | 322-325 | Converts a Zod schema to a Gemini-compatible JSON schema via stdlib conversion. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +18 more |
...
| [`_resetDebugBanner`](../scripts/lib/sensitive-paths.mjs#L426) | function | `scripts/lib/sensitive-paths.mjs` | 426-428 | Resets the debug banner warning flag to allow it to display again on next run. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
| [`classifyPath`](../scripts/lib/sensitive-paths.mjs#L125) | function | `scripts/lib/sensitive-paths.mjs` | 125-131 | Tests a normalized path against sensitive and generated-noise pattern lists, returning the matching category or null. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
| [`defaultHash`](../scripts/lib/sensitive-paths.mjs#L365) | function | `scripts/lib/sensitive-paths.mjs` | 365-367 | Generates an 8-character SHA256 hash of the input string for path obfuscation. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
| [`emptyDiff`](../scripts/lib/sensitive-paths.mjs#L275) | function | `scripts/lib/sensitive-paths.mjs` | 275-277 | Returns an empty diff structure with all action arrays initialized. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
| [`filterDiffFiles`](../scripts/lib/sensitive-paths.mjs#L291) | function | `scripts/lib/sensitive-paths.mjs` | 291-356 | <no body> | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
...
| [`resolveAndClassify`](../scripts/lib/sensitive-paths.mjs#L179) | function | `scripts/lib/sensitive-paths.mjs` | 179-245 | <no body> | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/final-adjudication.mjs`, +13 more |
...
| [`buildContrarianStratifiedWorksheet`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L284) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 284-333 | Stratifies rows into buckets (contrarian, known-defect, high-dismissal, omission-dismissal) and shuffles a tail sample for review. | _(internal)_ |
| [`computeDatasetHash`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L417) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 417-419 | Generates SHA-256 hash of Claude CSV and blind-map for dataset identification. | _(internal)_ |
| [`computeTwoJudgeConsensus`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L177) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 177-207 | Deduplicates and cross-references Claude/GPT grading rows by blind_id, computing consensus tier agreement. | _(internal)_ |
| [`computeValidationManifest`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L362) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 362-388 | Aggregates graded strata into a validation report checking false-dismissal rates against thresholds. | _(internal)_ |
| [`labelTier`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L151) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 151-154 | Returns 'valid' or 'dismissed' based on whether a label's factor is positive in LABEL_FACTORS. | _(internal)_ |
| [`mulberry32`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L239) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 239-247 | Seeded pseudorandom number generator using the Mulberry32 algorithm. | _(internal)_ |
| [`parseBlindCsv`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L108) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 108-141 | Parses a complete CSV text into validated data records, validating headers and record structure. | _(internal)_ |
| [`parseCsvRecord`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L56) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 56-84 | Parses a single CSV record from text, handling quoted fields, escaping, and malformed input detection. | _(internal)_ |
| [`renderValidationMarkdown`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L392) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 392-411 | Renders a validation manifest as a markdown table with pass/fail status and confidence intervals. | _(internal)_ |
| [`retrofitEvidenceType`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L231) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 231-234 | Classifies evidence as 'omission' or 'commission' based on text pattern matching against OMISSION_SIGNAL. | _(internal)_ |
| [`runCandidateTriage`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L436) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 436-448 | Runs a candidate triager on rows and collects 'valid'/'dismissed' verdicts by blind_id. | _(internal)_ |
| [`seededShuffleCopy`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L249) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 249-256 | Returns a shuffled array copy using Fisher-Yates with a seeded RNG. | _(internal)_ |
| [`wilsonScoreInterval`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L343) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 343-350 | Computes the 95% Wilson score confidence interval for a binomial proportion. | _(internal)_ |
...
| [`bestLabel`](../scripts/lib/solo-control/scoring.mjs#L21) | function | `scripts/lib/solo-control/scoring.mjs` | 21-21 | Returns the label with higher priority rank. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`bootstrapCI`](../scripts/lib/solo-control/scoring.mjs#L140) | function | `scripts/lib/solo-control/scoring.mjs` | 140-153 | Estimates 95% confidence interval via bootstrap resampling. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`htAcceptedRate`](../scripts/lib/solo-control/scoring.mjs#L130) | function | `scripts/lib/solo-control/scoring.mjs` | 130-138 | Computes Horvitz-Thompson weighted acceptance rate from findings with inclusion probabilities. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`mulberry32`](../scripts/lib/solo-control/scoring.mjs#L117) | function | `scripts/lib/solo-control/scoring.mjs` | 117-125 | Seeded pseudorandom number generator (Mulberry32 algorithm). | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`scoreArms`](../scripts/lib/solo-control/scoring.mjs#L32) | function | `scripts/lib/solo-control/scoring.mjs` | 32-105 | Collapses audit rows by (commit, arm, cluster), computes per-arm acceptance rates and value. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`scoreMediumSampleWeighted`](../scripts/lib/solo-control/scoring.mjs#L165) | function | `scripts/lib/solo-control/scoring.mjs` | 165-178 | Computes per-arm acceptance-rate estimates with bootstrap confidence intervals. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`sevWeight`](../scripts/lib/solo-control/scoring.mjs#L15) | function | `scripts/lib/solo-control/scoring.mjs` | 15-15 | Returns numeric weight for a severity level (HIGH/MEDIUM/LOW). | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
...
| [`makeLedgerEntry`](../tests/shared.test.mjs#L174) | function | `tests/shared.test.mjs` | 174-193 | <no body> | _(internal)_ |
