...
- Generated: 2026-07-16T15:00:54.043Z   commit: 83d26fc39e12   refresh_id: c23e819d-8064-46fa-ad3b-9827fb78abbe
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L3014) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 3014-3122 | Assemble the complete runtime context for an audit run including providers and tiered-pipeline options. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L243) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 243-254 | Atomically writes a single pass result to the cache directory as JSON. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L369) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 369-417 | Determine if OpenAI prefix cache seeding is eligible and select the smallest unit as the warm-up seed. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L991) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 991-1061 | Extract violations and unmapped files from architecture validation report into Finding objects. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L923) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 923-972 | Render architecture violations, unmapped files, and dead intent as markdown prompt context. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L233) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 233-241 | Initializes a temporary cache directory for audit pass results with atomic write support. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L270) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 270-272 | Delegates to _normalizeFindingsForOutput to prepare findings for output with semantic ID mapping. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L796) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 796-818 | Convert an orphan code finding into a standard Finding object with schema compliance. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L651) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 651-786 | Validate architecture intent and domain map exist, then detect forbidden cross-domain dependencies. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1091) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1091-2978 | Execute the full 5-pass code audit with state persistence, ledger suppression, and cloud sync. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L451) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 451-633 | Orchestrate parallel audit units with concurrency control, optional cache seeding, and result reconstruction. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L422) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 422-449 | Execute a single code audit unit by sending its context to GPT with schema validation. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L837) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 837-916 | Detect unreachable code that was introduced orphaned or became orphaned by the diff. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L174) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 174-178 | Determines whether a file set requires map-reduce parallelization based on file count or character volume. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L185) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 185-189 | Determines whether a file set requires map-reduce for high-reasoning passes using higher count/character thresholds. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L352) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 352-358 | Re-throw configuration errors from settled promises so programmer bugs surface immediately. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L292) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 292-324 | Validates R2+ adjudication ledger JSON structure and entry schemas, logging warnings for corruption or schema mismatches. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`completePlanAuditRun`](../scripts/lib/audit/plan-audit-cloud.mjs#L91) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 91-116 | Persist plan audit findings and completion metadata to Supabase. | `scripts/openai-audit.mjs` |
| [`gitAnchor`](../scripts/lib/audit/plan-audit-cloud.mjs#L33) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 33-41 | Retrieve the current git commit SHA and branch name for provenance tracking. | `scripts/openai-audit.mjs` |
| [`registerPlanAuditRun`](../scripts/lib/audit/plan-audit-cloud.mjs#L52) | function | `scripts/lib/audit/plan-audit-cloud.mjs` | 52-79 | Register a plan audit run in Supabase and link it to its plan artifact for cross-skill tracing. | `scripts/openai-audit.mjs` |
...
| [`generateAllPromptFiles`](../scripts/lib/install/copilot-prompts.mjs#L214) | function | `scripts/lib/install/copilot-prompts.mjs` | 214-245 | Generate Copilot .prompt.md files for all registered skills. | `scripts/regenerate-skill-copies.mjs` |
| [`generatePromptFile`](../scripts/lib/install/copilot-prompts.mjs#L165) | function | `scripts/lib/install/copilot-prompts.mjs` | 165-203 | Generate a Copilot .prompt.md file for a single skill with usage guidance. | `scripts/regenerate-skill-copies.mjs` |
| [`parseSkillFrontmatter`](../scripts/lib/install/copilot-prompts.mjs#L125) | function | `scripts/lib/install/copilot-prompts.mjs` | 125-154 | Extract skill name and description from SKILL.md YAML frontmatter. | `scripts/regenerate-skill-copies.mjs` |
| [`shaOfManagedBlock`](../scripts/lib/install/copilot-prompts.mjs#L255) | function | `scripts/lib/install/copilot-prompts.mjs` | 255-263 | Compute a 16-character SHA256 hash of a managed prompt block's content. | `scripts/regenerate-skill-copies.mjs` |
| [`yamlQuote`](../scripts/lib/install/copilot-prompts.mjs#L114) | function | `scripts/lib/install/copilot-prompts.mjs` | 114-116 | Escape a string for safe inclusion in YAML double-quoted form. | `scripts/regenerate-skill-copies.mjs` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`criterionHash`](../scripts/lib/plan-criteria-parser.mjs#L45) | function | `scripts/lib/plan-criteria-parser.mjs` | 45-48 | Compute a stable hash for a single acceptance criterion. | `scripts/ux-lock-run.mjs` |
| [`locateAcceptanceSection`](../scripts/lib/plan-criteria-parser.mjs#L56) | function | `scripts/lib/plan-criteria-parser.mjs` | 56-77 | Locate the "Acceptance Criteria" heading and extract its content lines. | `scripts/ux-lock-run.mjs` |
| [`parseAcceptanceCriteria`](../scripts/lib/plan-criteria-parser.mjs#L96) | function | `scripts/lib/plan-criteria-parser.mjs` | 96-152 | Parse P0–P3 criteria with setup/assertion blocks from the Acceptance Criteria section. | `scripts/ux-lock-run.mjs` |
| [`summariseCriteria`](../scripts/lib/plan-criteria-parser.mjs#L158) | function | `scripts/lib/plan-criteria-parser.mjs` | 158-166 | Count acceptance criteria by severity and category. | `scripts/ux-lock-run.mjs` |
...
| [`ask`](../setup.mjs#L26) | function | `setup.mjs` | 26-26 | Creates a readline question promise for interactive user prompts. | _(internal)_ |
| [`checkPrereqs`](../setup.mjs#L35) | function | `setup.mjs` | 35-44 | Verifies that Node.js 18+ and npm are installed. | _(internal)_ |
| [`fail`](../setup.mjs#L31) | function | `setup.mjs` | 31-31 | Prints a failure message with a red X. | _(internal)_ |
| [`installDeps`](../setup.mjs#L183) | function | `setup.mjs` | 183-190 | Runs npm install to fetch project dependencies. | _(internal)_ |
| [`installGitHook`](../setup.mjs#L194) | function | `setup.mjs` | 194-222 | Creates or updates a post-merge git hook that auto-regenerates and installs skills after pulling changes. | _(internal)_ |
| [`installSkills`](../setup.mjs#L165) | function | `setup.mjs` | 165-179 | Builds the skills manifest and installs skills globally to ~/.claude/skills/ for use across all repositories. | _(internal)_ |
| [`main`](../setup.mjs#L226) | function | `setup.mjs` | 226-291 | Orchestrates multi-step first-time setup: prerequisites, API keys, database, dependencies, skills installation, and git hooks. | _(internal)_ |
| [`ok`](../setup.mjs#L29) | function | `setup.mjs` | 29-29 | Prints a success message with a green checkmark. | _(internal)_ |
| [`setupApiKeys`](../setup.mjs#L55) | function | `setup.mjs` | 55-82 | Interactively prompts the user for API keys (OpenAI, Gemini, Anthropic) and saves them to .env. | _(internal)_ |
| [`setupDatabase`](../setup.mjs#L91) | function | `setup.mjs` | 91-127 | Guides the user through database options (cloud Postgres or local-only mode) and saves the selection to .env. | _(internal)_ |
| [`setupMaintenance`](../setup.mjs#L136) | function | `setup.mjs` | 136-161 | Optionally enables weekly maintenance checks to run via the pre-push hook. | _(internal)_ |
| [`warn`](../setup.mjs#L30) | function | `setup.mjs` | 30-30 | Prints a warning message with a yellow caution symbol. | _(internal)_ |
...
| [`detectPythonEnvironmentManager`](../scripts/lib/repo-stack.mjs#L205) | function | `scripts/lib/repo-stack.mjs` | 205-211 | Determines which Python environment manager (Poetry, uv, Pipenv, venv) is in use by looking for lock and configuration files. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`detectPythonFramework`](../scripts/lib/repo-stack.mjs#L182) | function | `scripts/lib/repo-stack.mjs` | 182-197 | Identifies which Python web framework (Django, FastAPI, Flask) a project uses by scanning dependency and configuration files. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`detectRepoStack`](../scripts/lib/repo-stack.mjs#L41) | function | `scripts/lib/repo-stack.mjs` | 41-86 | Detect the tech stack (JS/TS, Python, Java, Postgres, mixed) from filesystem markers and contents. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`hasJavaSources`](../scripts/lib/repo-stack.mjs#L156) | function | `scripts/lib/repo-stack.mjs` | 156-172 | Checks if a repository contains Java source files by scanning for root markers or enumerating git-tracked *.java files with a large buffer. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
| [`hasPostgresSources`](../scripts/lib/repo-stack.mjs#L110) | function | `scripts/lib/repo-stack.mjs` | 110-140 | Detect if the repo contains Postgres by checking strong directories and sampling SQL file contents. | `scripts/arch-intent-bootstrap.mjs`, `scripts/cross-skill.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +3 more |
...
| [`clampToJsonSchemaLimits`](../scripts/lib/schemas.mjs#L414) | function | `scripts/lib/schemas.mjs` | 414-439 | Truncates strings and arrays to respect JSON schema maxLength and maxItems constraints, recursively on nested objects. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L746) | function | `scripts/lib/schemas.mjs` | 746-762 | Validates that deferred findings include all required fields based on their deferral reason category. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L250) | function | `scripts/lib/schemas.mjs` | 250-260 | Normalizes audit finding evidence into a consistent object structure with status, anchor, trigger, and causal-chain fields. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L355) | function | `scripts/lib/schemas.mjs` | 355-372 | Recursively removes Gemini-unsupported JSON Schema keywords and flattens name-mapped sub-schemas. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L381) | function | `scripts/lib/schemas.mjs` | 381-384 | Converts a Zod schema to a Gemini-compatible JSON schema by exporting to JSON and stripping unsupported keys. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
