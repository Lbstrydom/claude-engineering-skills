...
- Generated: 2026-07-13T18:54:46.179Z   commit: ef8aa581029e   refresh_id: 3a845ed9-6566-4a20-beb5-c7853e67ddec
- Drift score: 54 / threshold 20   status: `RED`
- Domains: 24   Symbols: 2825   Layering violations: 0
...
- [dashboard](#dashboard) — 118 symbols
...
- [shared-lib](#shared-lib) — 807 symbols
- [stores](#stores) — 193 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 343 symbols
...
> Manages the sequential orchestration of multi-round code audits by spawning GPT and Gemini passes as subprocesses, parsing their results, and gating convergence based on severity thresholds (no HIGH findings, ≤2 MEDIUM to advance).
...
| [`anchorFileCandidates`](../scripts/lib/audit/final-adjudication.mjs#L333) | function | `scripts/lib/audit/final-adjudication.mjs` | 333-336 | Returns new and old file paths from an evidence anchor pair. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildAlternativeEvidenceLines`](../scripts/lib/audit/final-adjudication.mjs#L378) | function | `scripts/lib/audit/final-adjudication.mjs` | 378-387 | Formats alternative evidence lines, filtering out sensitive-path references and unverified anchors. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildFindingDetail`](../scripts/lib/audit/final-adjudication.mjs#L390) | function | `scripts/lib/audit/final-adjudication.mjs` | 390-394 | Combines canonical finding detail with formatted alternative evidence lines. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`createGeminiReviewSubprocessAdapters`](../scripts/lib/audit/final-adjudication.mjs#L498) | function | `scripts/lib/audit/final-adjudication.mjs` | 498-588 | Creates reviewCall and cleanRegionCall adapters wrapping gemini-review subprocess for Stage 2 adjudication. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
...
| [`envelopeReferencedFiles`](../scripts/lib/audit/final-adjudication.mjs#L345) | function | `scripts/lib/audit/final-adjudication.mjs` | 345-348 | Extracts all referenced files from a finding envelope's canonical and trigger anchors. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`interpretVerdict`](../scripts/lib/audit/final-adjudication.mjs#L184) | function | `scripts/lib/audit/final-adjudication.mjs` | 184-213 | Maps Gemini verdict response to adjudication outcome (reversed/confirmed/dismissed), accounting for prior dismissal state. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`invokeGeminiReviewSubprocess`](../scripts/lib/audit/final-adjudication.mjs#L425) | function | `scripts/lib/audit/final-adjudication.mjs` | 425-468 | Spawns gemini-review.mjs subprocess with transcript and plan, awaits result file, parses JSON output. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`isPathSensitive`](../scripts/lib/audit/final-adjudication.mjs#L357) | function | `scripts/lib/audit/final-adjudication.mjs` | 357-364 | Classifies file path as sensitive (credentials, keys, env files) with fail-closed error handling. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`nowIso`](../scripts/lib/audit/final-adjudication.mjs#L67) | function | `scripts/lib/audit/final-adjudication.mjs` | 67-69 | Returns current ISO timestamp, optionally using provided clock function for testing. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`primaryFile`](../scripts/lib/audit/final-adjudication.mjs#L397) | function | `scripts/lib/audit/final-adjudication.mjs` | 397-402 | Extracts primary file path from a finding's section, file, or anchor fields with cascading fallbacks. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`runFinalAdjudication`](../scripts/lib/audit/final-adjudication.mjs#L233) | function | `scripts/lib/audit/final-adjudication.mjs` | 233-324 | Runs Gemini review on mandatory and sampled candidates, accumulating outcomes and handling security-flagged evidence. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectAdjudicationSample`](../scripts/lib/audit/final-adjudication.mjs#L87) | function | `scripts/lib/audit/final-adjudication.mjs` | 87-115 | Selects mandatory escalated candidates plus sampled tail and clean-region items for adjudication review. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectFinalAdjudicationWorkItems`](../scripts/lib/audit/final-adjudication.mjs#L154) | function | `scripts/lib/audit/final-adjudication.mjs` | 154-169 | Applies budget caps to sampled candidates and returns work items for adjudication. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L2933) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 2933-3004 | Assembles the complete audit context including config, providers, tiered-pipeline handles, and auth. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L236) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 236-247 | Writes a single pass result to disk cache using atomic file operations. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L249) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 249-254 | Caches multiple pass results and logs completion to stderr. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L256) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 256-259 | Removes the temporary pass-result cache directory. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L362) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 362-407 | Decides whether to warm OpenAI's prefix cache by running the smallest audit unit first. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L981) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 981-1051 | Converts architecture report violations into properly-structured findings with IDs and recommendations. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`finalizePriorRoundOutcomes`](../scripts/lib/audit/legacy-production-audit.mjs#L1062) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1062-1100 | Captures prior-round outcomes to a ledger and syncs learning data to Supabase. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L913) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 913-962 | Formats architecture violations and unmapped files for inclusion in the LLM audit prompt. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L226) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 226-234 | Creates a temporary directory for caching audit pass results. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L263) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 263-265 | Normalizes findings using a semantic ID. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L786) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 786-808 | Converts an orphaned-file detection into a standard finding with ID and risk assessment. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L641) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 641-776 | Validates architecture intent against domain maps and reports rule violations as findings. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1126) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1126-2897 | Main orchestrator for the 5-pass GPT audit (structure, wiring, backend, frontend, sustainability) with R2+ suppression and result caching. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L441) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 441-623 | Orchestrates the map-reduce audit pass: splits files into units, runs them in parallel, reduces results. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L412) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 412-439 | Executes a single audit unit with OpenAI, managing concurrency slots and retries. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L827) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 827-906 | Detects files orphaned by the diff, classifying them as born-orphan or killed-orphan. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L167) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 167-171 | Decides whether to use map-reduce parallelization based on file count or total character size. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L178) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 178-182 | Decides whether to use map-reduce for high-reasoning mode with different token thresholds. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L345) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 345-351 | Throws a config error from a settled promise result. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L285) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 285-317 | Validates that a prior-round ledger file exists and contains valid entries for R2+ suppression. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`buildStage1TriagerPrompt`](../scripts/lib/audit/tiered-pipeline.mjs#L86) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 86-97 | Constructs system/user prompt for Stage 1 cheap triage, emphasizing evidence-based dismissal only. | `scripts/openai-audit.mjs` |
| [`defaultTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L111) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 111-124 | Calls GPT Stage 1 triager with structured schema for dismissal/escalation decision. | `scripts/openai-audit.mjs` |
| [`runTieredAuditPipeline`](../scripts/lib/audit/tiered-pipeline.mjs#L154) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 154-436 | Runs full tiered-recall pipeline: discovery → Stage 0 triage → Stage 1 cheap-triager → Stage 2 Gemini adjudication. | `scripts/openai-audit.mjs` |
| [`validatedTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L138) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 138-148 | Calls Stage 1 triager via OSS provider (validated/expensive model) with same decision schema. | `scripts/openai-audit.mjs` |
| [`appendShadowLog`](../scripts/lib/audit/tiered-shadow-compare.mjs#L171) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 171-178 | Appends a JSON record to the shadow-comparison log file, creating parent directories as needed. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`buildShadowCtx`](../scripts/lib/audit/tiered-shadow-compare.mjs#L73) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 73-85 | Clones an audit context for shadow comparison, stripping ledger and debt-persistence flags. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`compareAuditRunResults`](../scripts/lib/audit/tiered-shadow-compare.mjs#L111) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 111-129 | Compares legacy vs tiered audit findings by semantic ID overlap, cost, latency, and status. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`parseTotalSeconds`](../scripts/lib/audit/tiered-shadow-compare.mjs#L94) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 94-98 | Parses a timing string like "123.45s" to a float. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runShadowTieredPipeline`](../scripts/lib/audit/tiered-shadow-compare.mjs#L141) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 141-161 | Runs the tiered pipeline with timeout protection, clearing the timer to prevent event-loop hangs. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runTieredShadowComparison`](../scripts/lib/audit/tiered-shadow-compare.mjs#L191) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 191-212 | Orchestrates parallel legacy audit + shadow tiered pipeline, logging comparison results when both succeed. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
...
| [`applyExclusions`](../scripts/openai-audit.mjs#L168) | function | `scripts/openai-audit.mjs` | 168-177 | Filters files using glob patterns via micromatch. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`loadExcludePatterns`](../scripts/openai-audit.mjs#L149) | function | `scripts/openai-audit.mjs` | 149-160 | Reads .auditignore file and merges CLI patterns to build a file-exclusion list. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`main`](../scripts/openai-audit.mjs#L483) | function | `scripts/openai-audit.mjs` | 483-1079 | CLI entry point that refreshes model catalog, validates sync status, and orchestrates the full audit. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`printAuditResult`](../scripts/openai-audit.mjs#L343) | function | `scripts/openai-audit.mjs` | 343-398 | Prints a formatted audit result summary (verdict, finding counts, timing) to stdout or JSON file. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`printCostPreflight`](../scripts/openai-audit.mjs#L105) | function | `scripts/openai-audit.mjs` | 105-123 | Prints estimated GPT cost and token usage before running the audit. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`resolveDiffBase`](../scripts/openai-audit.mjs#L476) | function | `scripts/openai-audit.mjs` | 476-479 | Determines whether to diff against HEAD or HEAD~1 based on working-tree state. | `scripts/lib/model-eval/arm-generation.mjs` |
| [`runMultiPassCodeAudit`](../scripts/openai-audit.mjs#L428) | function | `scripts/openai-audit.mjs` | 428-455 | Routes to tiered or legacy audit pipeline; runs optional shadow validation alongside legacy path. | `scripts/lib/model-eval/arm-generation.mjs` |
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`argAll`](../scripts/cross-skill.mjs#L153) | function | `scripts/cross-skill.mjs` | 153-159 | Collects all values following multiple instances of a named flag into an array. | _(internal)_ |
| [`argList`](../scripts/cross-skill.mjs#L147) | function | `scripts/cross-skill.mjs` | 147-150 | Splits a comma-separated flag value into a trimmed array of strings. | _(internal)_ |
| [`argOption`](../scripts/cross-skill.mjs#L140) | function | `scripts/cross-skill.mjs` | 140-144 | Returns the value following a named CLI flag. | _(internal)_ |
| [`cmdAbortRefreshRun`](../scripts/cross-skill.mjs#L1836) | function | `scripts/cross-skill.mjs` | 1836-1846 | Cancels an in-progress refresh run with an optional reason | _(internal)_ |
| [`cmdAddPersona`](../scripts/cross-skill.mjs#L1072) | function | `scripts/cross-skill.mjs` | 1072-1084 | Creates or updates a persona record with name and description | _(internal)_ |
| [`cmdArmEvalAdjudicate`](../scripts/cross-skill.mjs#L810) | function | `scripts/cross-skill.mjs` | 810-834 | Lists blinded arm-eval outputs for human ranking or records a human ranking. | _(internal)_ |
| [`cmdArmEvalDecision`](../scripts/cross-skill.mjs#L776) | function | `scripts/cross-skill.mjs` | 776-793 | Evaluates arm-eval sessions to produce a recommendation on which arm to adopt. | _(internal)_ |
| [`cmdArmEvalExport`](../scripts/cross-skill.mjs#L842) | function | `scripts/cross-skill.mjs` | 842-860 | Exports an arm-eval session to a committed JSON file, optionally in batch. | _(internal)_ |
| [`cmdArmEvalMaybeCapture`](../scripts/cross-skill.mjs#L901) | function | `scripts/cross-skill.mjs` | 901-917 | Runs an arm-eval session if the toggle is enabled, designed for use as a skill hook. | _(internal)_ |
| [`cmdArmEvalRun`](../scripts/cross-skill.mjs#L754) | function | `scripts/cross-skill.mjs` | 754-773 | Runs an arm-eval session (plan-authoring or brainstorm) with an optional budget cap. | _(internal)_ |
| [`cmdArmEvalStats`](../scripts/cross-skill.mjs#L796) | function | `scripts/cross-skill.mjs` | 796-807 | Returns the leaderboard of arm-eval arms with win/loss/tie counts. | _(internal)_ |
| [`cmdArmEvalToggle`](../scripts/cross-skill.mjs#L868) | function | `scripts/cross-skill.mjs` | 868-893 | Enables/disables arm-eval capture for this repo or reports the current toggle state. | _(internal)_ |
| [`cmdAuditEffectiveness`](../scripts/cross-skill.mjs#L584) | function | `scripts/cross-skill.mjs` | 584-591 | Queries precision/recall audit-effectiveness metrics for a repo. | _(internal)_ |
| [`cmdComputeDriftScore`](../scripts/cross-skill.mjs#L1940) | function | `scripts/cross-skill.mjs` | 1940-1951 | Calculates the architectural drift magnitude between two snapshots | _(internal)_ |
| [`cmdComputeTargetDomains`](../scripts/cross-skill.mjs#L1695) | function | `scripts/cross-skill.mjs` | 1695-1707 | Resolves which architectural domains the target file paths belong to | _(internal)_ |
| [`cmdDetectStack`](../scripts/cross-skill.mjs#L1541) | function | `scripts/cross-skill.mjs` | 1541-1558 | Detects the tech stack (framework, language, environment manager) of a repo | _(internal)_ |
| [`cmdFinalizeOutcomes`](../scripts/cross-skill.mjs#L972) | function | `scripts/cross-skill.mjs` | 972-1042 | Completes an audit run by applying ledger adjudications, suppressions, and persisting outcomes. | _(internal)_ |
| [`cmdFinalReviewAdjudicate`](../scripts/cross-skill.mjs#L630) | function | `scripts/cross-skill.mjs` | 630-644 | Records a human judgment (accepted/dismissed) on a shadow final-reviewer finding. | _(internal)_ |
| [`cmdFinalReviewStats`](../scripts/cross-skill.mjs#L595) | function | `scripts/cross-skill.mjs` | 595-628 | Returns shadow final-reviewer findings and optionally renders them as a human adjudication worksheet. | _(internal)_ |
| [`cmdFrictionLog`](../scripts/cross-skill.mjs#L2065) | function | `scripts/cross-skill.mjs` | 2065-2070 | Routes to friction-log CLI operations | _(internal)_ |
| [`cmdGetActiveRefreshId`](../scripts/cross-skill.mjs#L1578) | function | `scripts/cross-skill.mjs` | 1578-1594 | Looks up the active symbol-index snapshot and embedding model for a repo | _(internal)_ |
| [`cmdGetCallersForFile`](../scripts/cross-skill.mjs#L1709) | function | `scripts/cross-skill.mjs` | 1709-1772 | Lists call sites and their domains that import a target file | _(internal)_ |
| [`cmdGetFrictionNeighbourhood`](../scripts/cross-skill.mjs#L1684) | function | `scripts/cross-skill.mjs` | 1684-1693 | Finds similar friction items in the learning store by semantic similarity | _(internal)_ |
| [`cmdGetIncidentNeighbourhood`](../scripts/cross-skill.mjs#L1596) | function | `scripts/cross-skill.mjs` | 1596-1626 | Queries security-incident memory for related past incidents matching target paths | _(internal)_ |
| [`cmdGetNavFirstSeen`](../scripts/cross-skill.mjs#L536) | function | `scripts/cross-skill.mjs` | 536-551 | Returns the first-seen timestamp for each nav-audit drift key in the repo's history. | _(internal)_ |
| [`cmdGetNeighbourhood`](../scripts/cross-skill.mjs#L1774) | function | `scripts/cross-skill.mjs` | 1774-1802 | Queries the symbol-embedding index for architecturally similar existing symbols | _(internal)_ |
| [`cmdGetPersonaSessionsByRepo`](../scripts/cross-skill.mjs#L1325) | function | `scripts/cross-skill.mjs` | 1325-1353 | Retrieves persona test sessions by repo with optional filtering and field selection | _(internal)_ |
| [`cmdGetPersonaSessionsByUrl`](../scripts/cross-skill.mjs#L1513) | function | `scripts/cross-skill.mjs` | 1513-1539 | Retrieves persona sessions for a deployed app URL with optional filtering | _(internal)_ |
| [`cmdGetReachabilityEvidence`](../scripts/cross-skill.mjs#L1360) | function | `scripts/cross-skill.mjs` | 1360-1394 | Fetches click-path evidence from persona sessions grouped by persona | _(internal)_ |
| [`cmdGetRecentFindings`](../scripts/cross-skill.mjs#L1475) | function | `scripts/cross-skill.mjs` | 1475-1505 | Fetches recent audit findings by repo and severity from the cloud store | _(internal)_ |
| [`cmdLearningBackfillOutcomes`](../scripts/cross-skill.mjs#L2049) | function | `scripts/cross-skill.mjs` | 2049-2059 | Backfills missing outcome labels on decisions and rebuilds learning statistics | _(internal)_ |
| [`cmdLearningQuickfixStats`](../scripts/cross-skill.mjs#L2092) | function | `scripts/cross-skill.mjs` | 2092-2118 | Reads or rebuilds the quick-fix pattern cache and skip rules | _(internal)_ |
| [`cmdLearningRecord`](../scripts/cross-skill.mjs#L1968) | function | `scripts/cross-skill.mjs` | 1968-2007 | Records a decision point (audit/brainstorm) with context and outcome for learning | _(internal)_ |
| [`cmdLearningReplay`](../scripts/cross-skill.mjs#L2077) | function | `scripts/cross-skill.mjs` | 2077-2085 | Replays historical learning decisions for analysis or audit-effectiveness simulation | _(internal)_ |
| [`cmdLearningStats`](../scripts/cross-skill.mjs#L2014) | function | `scripts/cross-skill.mjs` | 2014-2025 | Fetches learning telemetry stats for a repo (decision frequency, convergence rates) | _(internal)_ |
| [`cmdLearningWeeklyReview`](../scripts/cross-skill.mjs#L2033) | function | `scripts/cross-skill.mjs` | 2033-2041 | Generates a weekly digest of learning outcomes and findings for a repo | _(internal)_ |
| [`cmdListConsistencyCandidates`](../scripts/cross-skill.mjs#L343) | function | `scripts/cross-skill.mjs` | 343-356 | Lists persona consistency candidate specs from the cloud store with optional filtering. | _(internal)_ |
| [`cmdListLayeringViolationsForSnapshot`](../scripts/cross-skill.mjs#L1927) | function | `scripts/cross-skill.mjs` | 1927-1938 | Retrieves architectural violations found in a refresh run | _(internal)_ |
| [`cmdListPersonas`](../scripts/cross-skill.mjs#L1050) | function | `scripts/cross-skill.mjs` | 1050-1061 | Lists personas for a given app URL from the cloud store | _(internal)_ |
| [`cmdListPersonaTestCandidates`](../scripts/cross-skill.mjs#L396) | function | `scripts/cross-skill.mjs` | 396-408 | Lists persona-test finding candidates from the cloud store with optional age and severity filters. | _(internal)_ |
| [`cmdListSymbolsForSnapshot`](../scripts/cross-skill.mjs#L1914) | function | `scripts/cross-skill.mjs` | 1914-1925 | Lists all indexed symbols for a given refresh snapshot | _(internal)_ |
| [`cmdListUnlockedFixes`](../scripts/cross-skill.mjs#L576) | function | `scripts/cross-skill.mjs` | 576-582 | Returns HIGH audit findings that lack corresponding ux-lock regression specs. | _(internal)_ |
| [`cmdMarkPersonaTestCandidateProposed`](../scripts/cross-skill.mjs#L410) | function | `scripts/cross-skill.mjs` | 410-422 | Marks a persona-test candidate as proposed to prevent re-suggestion. | _(internal)_ |
| [`cmdModelAbAdjudicate`](../scripts/cross-skill.mjs#L655) | function | `scripts/cross-skill.mjs` | 655-726 | Lists blinded model-A/B findings for human adjudication or records a human ranking. | _(internal)_ |
| [`cmdModelAbDecision`](../scripts/cross-skill.mjs#L929) | function | `scripts/cross-skill.mjs` | 929-950 | Evaluates model-A/B findings to produce a recommendation with per-arm frontier and budget status. | _(internal)_ |
| [`cmdModelAbStats`](../scripts/cross-skill.mjs#L729) | function | `scripts/cross-skill.mjs` | 729-747 | Returns per-arm efficiency frontiers and cumulative spend for the model-A/B experiment. | _(internal)_ |
| [`cmdOpenRefreshRun`](../scripts/cross-skill.mjs#L1804) | function | `scripts/cross-skill.mjs` | 1804-1822 | Creates a new symbol-index refresh run in the cloud store | _(internal)_ |
| [`cmdPersonaOutcomes`](../scripts/cross-skill.mjs#L1233) | function | `scripts/cross-skill.mjs` | 1233-1307 | Generates actionable persona outcome items for labeling or a batch worksheet | _(internal)_ |
| [`cmdPlanSatisfaction`](../scripts/cross-skill.mjs#L495) | function | `scripts/cross-skill.mjs` | 495-505 | Queries the latest plan-verify run and any persistent criterion failures for a plan. | _(internal)_ |
| [`cmdPreviewGate`](../scripts/cross-skill.mjs#L1449) | function | `scripts/cross-skill.mjs` | 1449-1457 | Evaluates and emits the preview gate decision (halt/warn/ok) | _(internal)_ |
| [`cmdPromoteRegressionSpec`](../scripts/cross-skill.mjs#L358) | function | `scripts/cross-skill.mjs` | 358-371 | Marks a regression spec candidate as promoted to a locked spec file. | _(internal)_ |
| [`cmdPublishRefreshRun`](../scripts/cross-skill.mjs#L1824) | function | `scripts/cross-skill.mjs` | 1824-1834 | Finalizes and publishes a completed symbol-index refresh run | _(internal)_ |
| [`cmdQuality`](../scripts/cross-skill.mjs#L1633) | function | `scripts/cross-skill.mjs` | 1633-1682 | Routes to friction-tracking subcommands (add/mirror/digest/link/session-review) | _(internal)_ |
| [`cmdRecommendSkills`](../scripts/cross-skill.mjs#L1404) | function | `scripts/cross-skill.mjs` | 1404-1442 | Suggests follow-up skills (UX lenses) based on audit findings and changed files | _(internal)_ |
| [`cmdRecordCorrelation`](../scripts/cross-skill.mjs#L442) | function | `scripts/cross-skill.mjs` | 442-460 | Records a link between a persona-test finding and an audit-loop finding for learning. | _(internal)_ |
| [`cmdRecordLayeringViolations`](../scripts/cross-skill.mjs#L1888) | function | `scripts/cross-skill.mjs` | 1888-1900 | Records architectural layering violations (forbidden imports) from a refresh run | _(internal)_ |
| [`cmdRecordNavAuditRun`](../scripts/cross-skill.mjs#L509) | function | `scripts/cross-skill.mjs` | 509-534 | Logs a nav-audit run with drift keys, finding counts, verify summary, and tool version. | _(internal)_ |
| [`cmdRecordPersonaSession`](../scripts/cross-skill.mjs#L1118) | function | `scripts/cross-skill.mjs` | 1118-1144 | Records a persona test session and auto-correlates P0/P1 findings to audit matches | _(internal)_ |
| [`cmdRecordPlanVerifyItems`](../scripts/cross-skill.mjs#L484) | function | `scripts/cross-skill.mjs` | 484-493 | Records the per-criterion results of a plan-verify run. | _(internal)_ |
| [`cmdRecordPlanVerifyRun`](../scripts/cross-skill.mjs#L462) | function | `scripts/cross-skill.mjs` | 462-482 | Logs a ux-lock plan-verify run with criterion pass/fail counts and duration. | _(internal)_ |
| [`cmdRecordRegressionSpec`](../scripts/cross-skill.mjs#L273) | function | `scripts/cross-skill.mjs` | 273-341 | Records a regression spec to the cloud store with pre-egress redaction of sensitive data. | _(internal)_ |
| [`cmdRecordRegressionSpecRun`](../scripts/cross-skill.mjs#L424) | function | `scripts/cross-skill.mjs` | 424-440 | Logs the pass/fail result of a regression spec run with optional error details. | _(internal)_ |
| [`cmdRecordShipEvent`](../scripts/cross-skill.mjs#L553) | function | `scripts/cross-skill.mjs` | 553-574 | Logs a ship event with outcome, block reasons, P0/P1 counts, and metadata. | _(internal)_ |
| [`cmdRecordSymbolDefinitions`](../scripts/cross-skill.mjs#L1848) | function | `scripts/cross-skill.mjs` | 1848-1858 | Stores symbol metadata (name, type, location) into the learning store | _(internal)_ |
| [`cmdRecordSymbolEmbedding`](../scripts/cross-skill.mjs#L1874) | function | `scripts/cross-skill.mjs` | 1874-1886 | Stores semantic embeddings for a symbol definition | _(internal)_ |
| [`cmdRecordSymbolIndex`](../scripts/cross-skill.mjs#L1860) | function | `scripts/cross-skill.mjs` | 1860-1872 | Persists the symbol inventory and cross-file import graph to the cloud | _(internal)_ |
| [`cmdResolveRepoIdentity`](../scripts/cross-skill.mjs#L1953) | function | `scripts/cross-skill.mjs` | 1953-1959 | Derives and optionally persists the canonical repo UUID for the current directory | _(internal)_ |
| [`cmdSetActiveEmbeddingModel`](../scripts/cross-skill.mjs#L1902) | function | `scripts/cross-skill.mjs` | 1902-1912 | Updates the active embedding model and dimension for a repo's vectors | _(internal)_ |
| [`cmdUpdatePlanStatus`](../scripts/cross-skill.mjs#L264) | function | `scripts/cross-skill.mjs` | 264-271 | Updates a plan's status in the cloud store. | _(internal)_ |
| [`cmdUpsertPersonaTestCandidate`](../scripts/cross-skill.mjs#L375) | function | `scripts/cross-skill.mjs` | 375-394 | Records or updates a persona-test finding candidate with deduplication by fingerprint. | _(internal)_ |
| [`cmdUpsertPlan`](../scripts/cross-skill.mjs#L234) | function | `scripts/cross-skill.mjs` | 234-262 | Upserts a plan to the cloud store and optionally triggers arm-eval capture if task text is provided. | _(internal)_ |
| [`cmdWhoami`](../scripts/cross-skill.mjs#L1560) | function | `scripts/cross-skill.mjs` | 1560-1574 | Emits diagnostic cloud connectivity, commit SHA, and branch info | _(internal)_ |
| [`currentBranch`](../scripts/cross-skill.mjs#L183) | function | `scripts/cross-skill.mjs` | 183-188 | Returns the current branch name via git rev-parse, or null if not in a git repo. | _(internal)_ |
| [`currentCommitSha`](../scripts/cross-skill.mjs#L176) | function | `scripts/cross-skill.mjs` | 176-181 | Returns the HEAD commit SHA via git rev-parse, or null if not in a git repo. | _(internal)_ |
| [`emitError`](../scripts/cross-skill.mjs#L169) | function | `scripts/cross-skill.mjs` | 169-172 | Outputs a JSON error object to stdout and exits with a specified code. | _(internal)_ |
| [`gitChangedFiles`](../scripts/cross-skill.mjs#L1460) | function | `scripts/cross-skill.mjs` | 1460-1468 | Returns deduplicated list of modified and untracked files in git | _(internal)_ |
| [`hasFlag`](../scripts/cross-skill.mjs#L162) | function | `scripts/cross-skill.mjs` | 162-162 | Checks whether a named flag is present in CLI arguments. | _(internal)_ |
| [`main`](../scripts/cross-skill.mjs#L2203) | function | `scripts/cross-skill.mjs` | 2203-2227 | Entry point that dispatches subcommands, handles help, and catches exceptions | _(internal)_ |
| [`parsePayload`](../scripts/cross-skill.mjs#L123) | function | `scripts/cross-skill.mjs` | 123-138 | Extracts JSON payload from CLI via --json flag, --stdin, or trailing bare JSON string. | _(internal)_ |
| [`resolveRepoId`](../scripts/cross-skill.mjs#L208) | function | `scripts/cross-skill.mjs` | 208-230 | Resolves a repo ID from explicit payload fields, explicit UUID, or the current repo. | _(internal)_ |
| [`resolveRepoIdentityQuiet`](../scripts/cross-skill.mjs#L920) | function | `scripts/cross-skill.mjs` | 920-926 | Attempts to resolve the current repo's UUID, returning null silently on error. | _(internal)_ |
| [`runAutoCorrelate`](../scripts/cross-skill.mjs#L1156) | function | `scripts/cross-skill.mjs` | 1156-1224 | Matches persona findings against audit findings to ground-truth label them | _(internal)_ |

---

## dashboard

> Generates HTML dashboard pages (reference, telemetry, per-audit-run reports) from the Supabase learning store, rendering charts and finding summaries while tracking data-source health and git commit provenance.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`buildAuditRun`](../scripts/build-dashboard.mjs#L157) | function | `scripts/build-dashboard.mjs` | 157-183 | Collects an audit run by ID, renders it to HTML, and saves to a per-run file. | _(internal)_ |
| [`buildReference`](../scripts/build-dashboard.mjs#L131) | function | `scripts/build-dashboard.mjs` | 131-137 | Collects reference data, renders it to HTML, and saves reference.html. | _(internal)_ |
| [`buildTelemetry`](../scripts/build-dashboard.mjs#L139) | function | `scripts/build-dashboard.mjs` | 139-145 | Collects telemetry data, renders it to HTML, and saves telemetry.html. | _(internal)_ |
| [`gitProvenance`](../scripts/build-dashboard.mjs#L113) | function | `scripts/build-dashboard.mjs` | 113-123 | Returns current git commit SHA and whether the working tree has uncommitted changes. | _(internal)_ |
| [`isDegraded`](../scripts/build-dashboard.mjs#L125) | function | `scripts/build-dashboard.mjs` | 125-129 | Checks if any data source has an invalid or error status. | _(internal)_ |
| [`main`](../scripts/build-dashboard.mjs#L198) | function | `scripts/build-dashboard.mjs` | 198-264 | Main entry point that parses CLI args and routes to build subcommands (reference/telemetry/audit-run). | _(internal)_ |
| [`parseArgs`](../scripts/build-dashboard.mjs#L57) | function | `scripts/build-dashboard.mjs` | 57-97 | Parses build-dashboard CLI arguments, validating subcommand, port range, and run ID. | _(internal)_ |
| [`reportDegraded`](../scripts/build-dashboard.mjs#L185) | function | `scripts/build-dashboard.mjs` | 185-196 | Logs stderr warnings for each degraded data source. | _(internal)_ |
| [`slugifyRunId`](../scripts/build-dashboard.mjs#L103) | function | `scripts/build-dashboard.mjs` | 103-110 | Converts run ID to a safe filename slug by lowercasing and removing special characters. | _(internal)_ |
...
| [`canonicalRepoId`](../scripts/lib/dashboard/collect-nav.mjs#L39) | function | `scripts/lib/dashboard/collect-nav.mjs` | 39-53 | Resolves the repo's UUID and looks up its canonical database ID | `scripts/lib/dashboard/collect-reference.mjs` |
| [`collectNav`](../scripts/lib/dashboard/collect-nav.mjs#L59) | function | `scripts/lib/dashboard/collect-nav.mjs` | 59-163 | Extracts the nav-audit scorecard (personas and destinations) for the dashboard | `scripts/lib/dashboard/collect-reference.mjs` |
| [`readEnvelope`](../scripts/lib/dashboard/collect-nav.mjs#L165) | function | `scripts/lib/dashboard/collect-nav.mjs` | 165-179 | Loads and validates the nav-audit observed envelope with config digest verification | `scripts/lib/dashboard/collect-reference.mjs` |
| [`wrap`](../scripts/lib/dashboard/collect-nav.mjs#L181) | function | `scripts/lib/dashboard/collect-nav.mjs` | 181-183 | Returns the finalized nav-audit dashboard data structure | `scripts/lib/dashboard/collect-reference.mjs` |
...
| [`collectArchitecture`](../scripts/lib/dashboard/collect-reference.mjs#L286) | function | `scripts/lib/dashboard/collect-reference.mjs` | 286-327 | Reads architecture-map.md to extract domain names and summaries for the reference dashboard. | `scripts/build-dashboard.mjs` |
| [`collectFlows`](../scripts/lib/dashboard/collect-reference.mjs#L340) | function | `scripts/lib/dashboard/collect-reference.mjs` | 340-367 | Loads flows.json manifest and validates all referenced skill names. | `scripts/build-dashboard.mjs` |
| [`collectReference`](../scripts/lib/dashboard/collect-reference.mjs#L374) | function | `scripts/lib/dashboard/collect-reference.mjs` | 374-499 | Collects skills, plans, architecture, and navigation metadata into a unified reference dataset. | `scripts/build-dashboard.mjs` |
| [`discoverPlans`](../scripts/lib/dashboard/collect-reference.mjs#L47) | function | `scripts/lib/dashboard/collect-reference.mjs` | 47-126 | Scans for plan markdown files in docs/plans and docs/completed with metadata extraction | `scripts/build-dashboard.mjs` |
| [`readDomainDeps`](../scripts/lib/dashboard/collect-reference.mjs#L225) | function | `scripts/lib/dashboard/collect-reference.mjs` | 225-245 | Merges observed and manual domain dependencies, computing edge-count statistics | `scripts/build-dashboard.mjs` |
| [`readManualAllowedDeps`](../scripts/lib/dashboard/collect-reference.mjs#L180) | function | `scripts/lib/dashboard/collect-reference.mjs` | 180-205 | Extracts the allowedDeps block from domain-map.json for manual architectural rules | `scripts/build-dashboard.mjs` |
| [`readObservedEnvelope`](../scripts/lib/dashboard/collect-reference.mjs#L137) | function | `scripts/lib/dashboard/collect-reference.mjs` | 137-166 | Loads the domain-dependencies observed envelope with staleness and schema validation | `scripts/build-dashboard.mjs` |
| [`readRequirementsLedger`](../scripts/lib/dashboard/collect-reference.mjs#L257) | function | `scripts/lib/dashboard/collect-reference.mjs` | 257-275 | Loads the committed requirements ledger.json for dashboard rendering | `scripts/build-dashboard.mjs` |
| [`aggregatePasses`](../scripts/lib/dashboard/collect-telemetry.mjs#L48) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 48-60 | Aggregates audit pass statistics (runs, raised findings, accepted/dismissed counts) by pass name. | `scripts/build-dashboard.mjs` |
| [`attributeHighByFile`](../scripts/lib/dashboard/collect-telemetry.mjs#L609) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 609-626 | Distributes HIGH audit findings across purposes based on file-to-domain-to-purpose mapping. | `scripts/build-dashboard.mjs` |
| [`canonicalRepoId`](../scripts/lib/dashboard/collect-telemetry.mjs#L227) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 227-230 | Looks up the canonical repository ID by UUID from the cloud store. | `scripts/build-dashboard.mjs` |
| [`classifyPurposeBadges`](../scripts/lib/dashboard/collect-telemetry.mjs#L633) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 633-662 | Ranks purposes as at-risk/ok based on HIGH finding attribution and secret refusal signals. | `scripts/build-dashboard.mjs` |
| [`collectAuditEffectiveness`](../scripts/lib/dashboard/collect-telemetry.mjs#L420) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 420-448 | Fetches user-visible precision/recall and persona↔audit correlation counts for a repo. | `scripts/build-dashboard.mjs` |
| [`collectAuditRuns`](../scripts/lib/dashboard/collect-telemetry.mjs#L71) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 71-110 | Fetches audit run metrics from cloud storage with graceful fallback to local-only mode. | `scripts/build-dashboard.mjs` |
| [`collectAuthorTier`](../scripts/lib/dashboard/collect-telemetry.mjs#L350) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 350-361 | Aggregates author-tier observation statistics (suggested model, partition ladder) from cloud. | `scripts/build-dashboard.mjs` |
| [`collectLearning`](../scripts/lib/dashboard/collect-telemetry.mjs#L167) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 167-187 | Fetches adaptive-learning decision stats and pending-triage counts from the cloud store. | `scripts/build-dashboard.mjs` |
| [`collectModelAb`](../scripts/lib/dashboard/collect-telemetry.mjs#L376) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 376-412 | Aggregates model A/B finding scores, costs, and adjudication queue with decision status. | `scripts/build-dashboard.mjs` |
| [`collectPersonaTests`](../scripts/lib/dashboard/collect-telemetry.mjs#L286) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 286-337 | Fetches persona test session trends and persona↔audit correlations for a repo. | `scripts/build-dashboard.mjs` |
| [`collectPromptVariants`](../scripts/lib/dashboard/collect-telemetry.mjs#L194) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 194-224 | Loads bandit arms (Thompson Sampling parameters) and computes pull statistics. | `scripts/build-dashboard.mjs` |
| [`collectPurposeHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L520) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 520-597 | Evaluates domain-purpose health by attributing recent HIGH findings and counting refused secrets. | `scripts/build-dashboard.mjs` |
| [`collectRequirements`](../scripts/lib/dashboard/collect-telemetry.mjs#L113) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 113-154 | Reads the .requirements/ledger.json file and extracts requirement items with status. | `scripts/build-dashboard.mjs` |
| [`collectSecurity`](../scripts/lib/dashboard/collect-telemetry.mjs#L482) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 482-497 | Loads security incident metadata and recent events from cloud storage. | `scripts/build-dashboard.mjs` |
| [`collectShipHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L233) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 233-258 | Fetches ship event outcomes (shipped/blocked/warned/overridden) with recent history. | `scripts/build-dashboard.mjs` |
| [`collectTelemetry`](../scripts/lib/dashboard/collect-telemetry.mjs#L759) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 759-816 | Orchestrates parallel collection of all telemetry sections and assembles the complete dataset. | `scripts/build-dashboard.mjs` |
| [`collectTieredShadow`](../scripts/lib/dashboard/collect-telemetry.mjs#L676) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 676-752 | Aggregates tiered-audit shadow observations across this repo and sibling consumer repos. | `scripts/build-dashboard.mjs` |
| [`emptyAuthorTier`](../scripts/lib/dashboard/collect-telemetry.mjs#L340) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 340-342 | Returns a template object for empty author-tier observation data. | `scripts/build-dashboard.mjs` |
| [`emptyEffectiveness`](../scripts/lib/dashboard/collect-telemetry.mjs#L415) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 415-417 | Returns a template object for empty audit effectiveness (precision/recall) data. | `scripts/build-dashboard.mjs` |
| [`emptyModelAb`](../scripts/lib/dashboard/collect-telemetry.mjs#L364) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 364-366 | Returns a template object for empty model A/B testing status and arms. | `scripts/build-dashboard.mjs` |
| [`emptyPersonaTests`](../scripts/lib/dashboard/collect-telemetry.mjs#L263) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 263-265 | Returns a template object for empty persona test telemetry. | `scripts/build-dashboard.mjs` |
| [`emptyPurposeHealth`](../scripts/lib/dashboard/collect-telemetry.mjs#L504) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 504-511 | Returns a template object for empty purpose health assessment. | `scripts/build-dashboard.mjs` |
| [`emptySecurity`](../scripts/lib/dashboard/collect-telemetry.mjs#L451) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 451-456 | Returns a template object for empty security incident telemetry. | `scripts/build-dashboard.mjs` |
| [`repoName`](../scripts/lib/dashboard/collect-telemetry.mjs#L157) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 157-164 | Resolves the repository name from LEARNING_REPO_NAME env or package.json. | `scripts/build-dashboard.mjs` |
| [`securityData`](../scripts/lib/dashboard/collect-telemetry.mjs#L459) | function | `scripts/lib/dashboard/collect-telemetry.mjs` | 459-475 | Formats security stats (incidents, embedded count, events) into dashboard display structure. | `scripts/build-dashboard.mjs` |
...
| [`freshnessBanner`](../scripts/lib/dashboard/render.mjs#L141) | function | `scripts/lib/dashboard/render.mjs` | 141-153 | Renders an HTML banner showing data generation time, commit SHA, and collection mode. | `scripts/build-dashboard.mjs` |
| [`nav`](../scripts/lib/dashboard/render.mjs#L158) | function | `scripts/lib/dashboard/render.mjs` | 158-166 | Renders the dashboard navigation bar with Reference/Telemetry tabs and build hints. | `scripts/build-dashboard.mjs` |
| [`renderDocument`](../scripts/lib/dashboard/render.mjs#L178) | function | `scripts/lib/dashboard/render.mjs` | 178-271 | Generates the complete HTML dashboard document with validated data and tabbed sections. | `scripts/build-dashboard.mjs` |
| [`validateDashboardData`](../scripts/lib/dashboard/schema.mjs#L517) | function | `scripts/lib/dashboard/schema.mjs` | 517-522 | Parses and validates dashboard data against the appropriate Zod schema by kind. | `scripts/lib/dashboard/collect-purposes.mjs`, `scripts/lib/dashboard/collect-reference.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
...
| [`daysAgo`](../scripts/lib/dashboard/sections/persona-tests.mjs#L15) | function | `scripts/lib/dashboard/sections/persona-tests.mjs` | 15-20 | Computes the number of whole days between an ISO timestamp and now, or null if timestamp is invalid. | `scripts/lib/dashboard/render.mjs` |
| [`sectionPersonaTests`](../scripts/lib/dashboard/sections/persona-tests.mjs#L26) | function | `scripts/lib/dashboard/sections/persona-tests.mjs` | 26-73 | Renders a dashboard section for latest persona-test sessions, verdicts, and trend, degrading gracefully on missing/malformed data. | `scripts/lib/dashboard/render.mjs` |
...
| [`semanticId`](../scripts/lib/findings.mjs#L27) | function | `scripts/lib/findings.mjs` | 27-40 | Generates a short semantic hash of a finding based on linter rule/file or generic content. | `scripts/cross-skill.mjs`, `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, +15 more |
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L436) | function | `scripts/sync-to-repos.mjs` | 436-444 | Collects `.prompt.md` files from `.github/prompts/` for Copilot integration. | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L334) | function | `scripts/sync-to-repos.mjs` | 334-351 | Recursively scans `scripts/` and `.claude/` directories to collect all source files for import-closure dependency resolution. | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L397) | function | `scripts/sync-to-repos.mjs` | 397-409 | Enumerates skill Markdown and support files from each skill directory for dual deployment to `.claude/skills/` and optionally `.github/skills/`. | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L466) | function | `scripts/sync-to-repos.mjs` | 466-473 | Assembles the final sync bundle for a target repo by combining core, learning, arch, isolation, and optional debt entry points. | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L513) | function | `scripts/sync-to-repos.mjs` | 513-524 | Recursively merges a source object into a target, preserving nested object structures while replacing non-object values. | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L528) | function | `scripts/sync-to-repos.mjs` | 528-1057 | Orchestrates the full sync pipeline: regenerates the manifest, iterates consumer repos, copies and rewrites files, updates manifests, and prompts for cloud config updates. | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L1059) | function | `scripts/sync-to-repos.mjs` | 1059-1090 | Assesses the shared `.audit-loop.env` cloud config in the source repo and prompts to update it if needed before sync proceeds. | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L354) | function | `scripts/sync-to-repos.mjs` | 354-357 | Reads a file from the source repo root by relative path, returning null if the file is unreadable. | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L381) | function | `scripts/sync-to-repos.mjs` | 381-386 | Filters unresolved imports to actual missing relative-path files, excluding specs with variable interpolation or non-relative schemes. | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L366) | function | `scripts/sync-to-repos.mjs` | 366-371 | Computes the complete import closure (files + transitive dependencies) for a set of entry points via static analysis. | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L482) | function | `scripts/sync-to-repos.mjs` | 482-489 | Computes a file's SHA256 hash for change detection, returning null if the file cannot be read. | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L234) | function | `scripts/sync-to-repos.mjs` | 234-244 | Lists all SQL migration files from `supabase/migrations/` in the source repo for downstream copy. | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L491) | function | `scripts/sync-to-repos.mjs` | 491-504 | Generates a unified diff between two files via `git diff --no-index`, handling failures gracefully. | _(internal)_ |
...
| [`ageDivergences`](../scripts/lib/nav/drift.mjs#L60) | function | `scripts/lib/nav/drift.mjs` | 60-68 | Computes the age in days for each finding since it was first seen, using a lookup table or the head commit date. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`divergenceKey`](../scripts/lib/nav/drift.mjs#L18) | function | `scripts/lib/nav/drift.mjs` | 18-20 | Generates a deduplication key for a finding by combining its class and destination. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`firstSeenFromHistory`](../scripts/lib/nav/drift.mjs#L89) | function | `scripts/lib/nav/drift.mjs` | 89-101 | Builds a lookup function that returns the earliest observed timestamp for each drift key from historical rows, guarding against invalid timestamps. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`partitionFindings`](../scripts/lib/nav/drift.mjs#L27) | function | `scripts/lib/nav/drift.mjs` | 27-31 | Separates findings into gate-eligible and advisory categories based on their gateEligible property. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`readDriftLedger`](../scripts/lib/nav/drift.mjs#L71) | function | `scripts/lib/nav/drift.mjs` | 71-77 | Reads and parses the drift ledger JSON file to retrieve first-seen timestamps, returning an empty object if the file is missing or invalid. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`scopeToChanged`](../scripts/lib/nav/drift.mjs#L41) | function | `scripts/lib/nav/drift.mjs` | 41-50 | Filters gate-eligible findings to only those affected by file changes, or returns all if no files changed or contract was edited. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
| [`writeDriftLedger`](../scripts/lib/nav/drift.mjs#L81) | function | `scripts/lib/nav/drift.mjs` | 81-86 | Writes an updated drift ledger that preserves previously recorded first-seen dates for active findings and records new ones. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs`, `scripts/nav-audit.mjs` |
...
| [`collectRouteMeta`](../scripts/nav-audit.mjs#L266) | function | `scripts/nav-audit.mjs` | 266-283 | Binds nav metadata claims from docblocks to their discovered route destinations, matching one-destination-per-file cases unambiguously. | _(internal)_ |
| [`countBySeverity`](../scripts/nav-audit.mjs#L306) | function | `scripts/nav-audit.mjs` | 306-310 | Counts findings by severity level (P0/P1/P2/P3). | _(internal)_ |
| [`gitChangedFiles`](../scripts/nav-audit.mjs#L317) | function | `scripts/nav-audit.mjs` | 317-327 | Returns files changed between HEAD and its merge-base with origin/main (or HEAD alone as fallback). | _(internal)_ |
| [`gitHeadDate`](../scripts/nav-audit.mjs#L332) | function | `scripts/nav-audit.mjs` | 332-334 | Returns the ISO timestamp of the current HEAD commit, or null on error. | _(internal)_ |
| [`gitHeadSha`](../scripts/nav-audit.mjs#L329) | function | `scripts/nav-audit.mjs` | 329-331 | Returns the current git HEAD commit SHA, or null if repository is invalid. | _(internal)_ |
| [`gitIsDirty`](../scripts/nav-audit.mjs#L336) | function | `scripts/nav-audit.mjs` | 336-339 | Returns true if the working tree has uncommitted changes, false if clean, or true if git is unavailable. | _(internal)_ |
| [`listSourceFiles`](../scripts/nav-audit.mjs#L312) | function | `scripts/nav-audit.mjs` | 312-315 | Lists JavaScript/TypeScript source files tracked in git for the given root. | _(internal)_ |
| [`main`](../scripts/nav-audit.mjs#L31) | function | `scripts/nav-audit.mjs` | 31-264 | Main CLI entry point that extracts navigation structure, optionally reconciles with live app, and outputs audit findings/scorecards. | _(internal)_ |
| [`parseArgs`](../scripts/nav-audit.mjs#L285) | function | `scripts/nav-audit.mjs` | 285-304 | Parses CLI arguments into an options object with defaults for scope, format, verify URL, output path, etc. | _(internal)_ |
| [`recordNavAuditRunTelemetry`](../scripts/nav-audit.mjs#L351) | function | `scripts/nav-audit.mjs` | 351-361 | Records nav-audit run telemetry (drift keys, findings, tool version) to the cloud store via a cross-skill subprocess. | _(internal)_ |
| [`seedPersonaIntents`](../scripts/nav-audit.mjs#L372) | function | `scripts/nav-audit.mjs` | 372-385 | Queries persona test evidence for a repo and maps click-path findings to navigation intents for bootstrap seeding. | _(internal)_ |
...
| [`_extractPlanKeywords`](../scripts/lib/plan-paths.mjs#L112) | function | `scripts/lib/plan-paths.mjs` | 112-154 | Extracts keywords from plan (PascalCase, backtick identifiers, headings) for fuzzy file matching. | `scripts/lib/file-io.mjs`, `scripts/lib/requirements/context.mjs` |
| [`_scanRepoFiles`](../scripts/lib/plan-paths.mjs#L156) | function | `scripts/lib/plan-paths.mjs` | 156-182 | Walks the repo directory to enumerate code files by extension, skipping infrastructure directories. | `scripts/lib/file-io.mjs`, `scripts/lib/requirements/context.mjs` |
| [`extractPlanPaths`](../scripts/lib/plan-paths.mjs#L32) | function | `scripts/lib/plan-paths.mjs` | 32-108 | Extracts file paths from plan markdown using regex patterns (backticks, headings, inline paths). | `scripts/lib/file-io.mjs`, `scripts/lib/requirements/context.mjs` |
...
| [`ask`](../setup.mjs#L25) | function | `setup.mjs` | 25-25 | Prompts the user for input and resolves with their response. | _(internal)_ |
| [`checkPrereqs`](../setup.mjs#L34) | function | `setup.mjs` | 34-43 | Validates Node.js v18+ and npm availability. | _(internal)_ |
| [`fail`](../setup.mjs#L30) | function | `setup.mjs` | 30-30 | Prints a red failure message. | _(internal)_ |
| [`installDeps`](../setup.mjs#L148) | function | `setup.mjs` | 148-155 | Runs npm install with a timeout. | _(internal)_ |
| [`installGitHook`](../setup.mjs#L159) | function | `setup.mjs` | 159-187 | Creates or appends a post-merge git hook to auto-update skills on pull. | _(internal)_ |
| [`installSkills`](../setup.mjs#L130) | function | `setup.mjs` | 130-144 | Builds skill manifests and installs them to ~/.claude/skills/ globally. | _(internal)_ |
| [`main`](../setup.mjs#L191) | function | `setup.mjs` | 191-254 | First-time setup orchestrator: checks prerequisites, gathers API keys, configures database, installs deps and skills, sets up auto-update hook. | _(internal)_ |
| [`ok`](../setup.mjs#L28) | function | `setup.mjs` | 28-28 | Prints a green checkmark success message. | _(internal)_ |
| [`setupApiKeys`](../setup.mjs#L54) | function | `setup.mjs` | 54-81 | Prompts for API keys and saves them to .env if not already configured. | _(internal)_ |
| [`setupDatabase`](../setup.mjs#L90) | function | `setup.mjs` | 90-126 | Prompts for database option (cloud Supabase or local offline) and saves config. | _(internal)_ |
| [`warn`](../setup.mjs#L29) | function | `setup.mjs` | 29-29 | Prints a yellow warning message. | _(internal)_ |
...
> Abstracts Anthropic client creation with dual backends (SDK or CLI subprocess), caching, and automatic secret redaction to prevent API key/credential leakage.
...
_Domain has 807 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`_exec`](../scripts/lib/db/query.mjs#L393) | function | `scripts/lib/db/query.mjs` | 393-413 | Executes SQL queries through the active transaction client or connection pool, normalizing errors. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`buildDelete`](../scripts/lib/db/query.mjs#L373) | function | `scripts/lib/db/query.mjs` | 373-378 | Constructs a SQL DELETE statement with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`buildInsert`](../scripts/lib/db/query.mjs#L193) | function | `scripts/lib/db/query.mjs` | 193-207 | Constructs a parameterized INSERT SQL statement from a single-row object. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`buildUpdate`](../scripts/lib/db/query.mjs#L347) | function | `scripts/lib/db/query.mjs` | 347-367 | Constructs a SQL UPDATE statement from a patch object with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`buildUpsert`](../scripts/lib/db/query.mjs#L226) | function | `scripts/lib/db/query.mjs` | 226-297 | Constructs a parameterized INSERT ... ON CONFLICT UPDATE SQL statement from multiple rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`deleteWhere`](../scripts/lib/db/query.mjs#L516) | function | `scripts/lib/db/query.mjs` | 516-521 | Deletes rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`flattenWhere`](../scripts/lib/db/query.mjs#L314) | function | `scripts/lib/db/query.mjs` | 314-338 | Converts a WHERE clause object into SQL predicates and parameter bindings, rejecting undefined values. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`insertReturning`](../scripts/lib/db/query.mjs#L465) | function | `scripts/lib/db/query.mjs` | 465-473 | Inserts a row and optionally returns the inserted record. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`many`](../scripts/lib/db/query.mjs#L452) | function | `scripts/lib/db/query.mjs` | 452-455 | Executes a query and returns all rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`normalizeConflictTarget`](../scripts/lib/db/query.mjs#L130) | function | `scripts/lib/db/query.mjs` | 130-157 | Parses and validates an ON CONFLICT target (column list or constraint name). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`normalizeReturning`](../scripts/lib/db/query.mjs#L107) | function | `scripts/lib/db/query.mjs` | 107-116 | Validates and normalizes a RETURNING clause specification into SQL syntax. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`one`](../scripts/lib/db/query.mjs#L435) | function | `scripts/lib/db/query.mjs` | 435-442 | Executes a query and returns exactly one row or null, rejecting multiple results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`pgArray`](../scripts/lib/db/query.mjs#L55) | function | `scripts/lib/db/query.mjs` | 55-58 | Wraps a value to signal it should serialize as a Postgres ARRAY literal (not JSON). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`query`](../scripts/lib/db/query.mjs#L422) | function | `scripts/lib/db/query.mjs` | 422-424 | Executes a SQL query and returns raw row results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`quoteIdent`](../scripts/lib/db/query.mjs#L78) | function | `scripts/lib/db/query.mjs` | 78-86 | SQL-quotes an identifier to safely include it in SQL statements. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`serializeWriteParam`](../scripts/lib/db/query.mjs#L62) | function | `scripts/lib/db/query.mjs` | 62-66 | Converts a parameter value for safe binding in INSERT/UPDATE SQL, handling jsonb arrays specially. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`updateWhere`](../scripts/lib/db/query.mjs#L502) | function | `scripts/lib/db/query.mjs` | 502-507 | Updates rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`upsert`](../scripts/lib/db/query.mjs#L487) | function | `scripts/lib/db/query.mjs` | 487-492 | Inserts or updates multiple rows (UPSERT) and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
| [`withTx`](../scripts/lib/db/query.mjs#L539) | function | `scripts/lib/db/query.mjs` | 539-587 | Executes a function within a database transaction, supporting nested savepoints for partial rollback. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +30 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Writes file contents atomically using temp file + rename, following symlinks to avoid breaking dotfile managers. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a file path to lowercase with forward slashes and removes working-directory prefix. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file synchronously or exits the process with an error message if not found. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Parses a string to integer, returning a fallback value on NaN. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Writes JSON output to a file (creating directories as needed) or stdout with a summary message. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
...
| [`batchWriteLedger`](../scripts/lib/ledger.mjs#L213) | function | `scripts/lib/ledger.mjs` | 213-237 | Batch upserts multiple entries into a ledger and optionally merges metadata. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`buildR2SystemPrompt`](../scripts/lib/ledger.mjs#L547) | function | `scripts/lib/ledger.mjs` | 547-549 | Combines R2 round modifier, rulings block, and pass rubric into a system prompt. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`buildRulingsBlock`](../scripts/lib/ledger.mjs#L436) | function | `scripts/lib/ledger.mjs` | 436-517 | Formats prior adjudication rulings from ledger as a markdown block for R2+ prompts. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`computeImpactSet`](../scripts/lib/ledger.mjs#L559) | function | `scripts/lib/ledger.mjs` | 559-581 | Computes files transitively importing changed files for impact-scoped audit coverage. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`finalizeLedgerOutcomes`](../scripts/lib/ledger.mjs#L609) | function | `scripts/lib/ledger.mjs` | 609-623 | Maps adjudication results (reversed/confirmed) to ledger update actions. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`generateTopicId`](../scripts/lib/ledger.mjs#L30) | function | `scripts/lib/ledger.mjs` | 30-40 | Creates a stable 12-char hash topic ID from file, principle, category, pass, and content. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`getFileRegex`](../scripts/lib/ledger.mjs#L21) | function | `scripts/lib/ledger.mjs` | 21-21 | Returns a compiled regex for matching file paths in text. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`jaccardSimilarity`](../scripts/lib/ledger.mjs#L275) | function | `scripts/lib/ledger.mjs` | 275-283 | Computes token-based Jaccard similarity between two strings (0–1 range). | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`mergeMetaLocked`](../scripts/lib/ledger.mjs#L192) | function | `scripts/lib/ledger.mjs` | 192-211 | Merges metadata into a locked ledger file using file-based locking. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`populateFindingMetadata`](../scripts/lib/ledger.mjs#L247) | function | `scripts/lib/ledger.mjs` | 247-265 | Extracts file paths from finding and populates metadata (_primaryFile, affectedFiles, _hash). | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`readLedgerJson`](../scripts/lib/ledger.mjs#L150) | function | `scripts/lib/ledger.mjs` | 150-162 | Reads a ledger JSON file, returns empty ledger if missing. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`suppressReRaises`](../scripts/lib/ledger.mjs#L294) | function | `scripts/lib/ledger.mjs` | 294-425 | Fuzzy-matches and suppresses findings similar to dismissed ledger entries, with reopen-on-touch logic. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`upsertEntry`](../scripts/lib/ledger.mjs#L165) | function | `scripts/lib/ledger.mjs` | 165-189 | Upserts a batch ledger entry into an in-memory map by topicId. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeLedgerEntry`](../scripts/lib/ledger.mjs#L109) | function | `scripts/lib/ledger.mjs` | 109-111 | Writes a ledger entry with full schema validation. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeSingleLedgerEntry`](../scripts/lib/ledger.mjs#L53) | function | `scripts/lib/ledger.mjs` | 53-102 | Writes or updates a single ledger entry JSON file with upsert-by-topicId semantics. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
| [`writeStage1MechanicalLedgerEntry`](../scripts/lib/ledger.mjs#L123) | function | `scripts/lib/ledger.mjs` | 123-125 | Writes a stage1-mechanical ledger entry with its restricted schema. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/llm-helpers.mjs`, +8 more |
...
| [`auditFilePathTokens`](../scripts/lib/persona/audit-correlator.mjs#L136) | function | `scripts/lib/persona/audit-correlator.mjs` | 136-138 | Tokenizes an audit finding's primary file path for file-path similarity matching. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`auditKeywordTokens`](../scripts/lib/persona/audit-correlator.mjs#L140) | function | `scripts/lib/persona/audit-correlator.mjs` | 140-142 | Tokenizes an audit finding's detail and category for keyword similarity matching. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`buildStepUrlLookup`](../scripts/lib/persona/audit-correlator.mjs#L236) | function | `scripts/lib/persona/audit-correlator.mjs` | 236-245 | Builds a Map from step numbers to sanitized URLs from a persona session's click-path array. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`decideCorrelations`](../scripts/lib/persona/audit-correlator.mjs#L264) | function | `scripts/lib/persona/audit-correlator.mjs` | 264-324 | Matches persona P0/P1 findings against audit findings, emitting correlation records with tier (exact/fuzzy) and match scores. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isMalformedFinding`](../scripts/lib/persona/audit-correlator.mjs#L83) | function | `scripts/lib/persona/audit-correlator.mjs` | 83-86 | Returns true if a persona finding is missing required fields (element or observed description). | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isNewerOrHigherSeverity`](../scripts/lib/persona/audit-correlator.mjs#L218) | function | `scripts/lib/persona/audit-correlator.mjs` | 218-223 | Compares two audit findings by recency, then severity rank, returning true if the candidate is better. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isP0OrP1`](../scripts/lib/persona/audit-correlator.mjs#L70) | function | `scripts/lib/persona/audit-correlator.mjs` | 70-72 | Returns true if a finding's code is P0 or P1. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isSeverityUnderstated`](../scripts/lib/persona/audit-correlator.mjs#L226) | function | `scripts/lib/persona/audit-correlator.mjs` | 226-228 | Returns true if a persona P0 finding is matched to only LOW/MEDIUM audit severity (understated). | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
...
| [`overlapCoefficient`](../scripts/lib/persona/audit-correlator.mjs#L112) | function | `scripts/lib/persona/audit-correlator.mjs` | 112-119 | Computes the overlap ratio between two token sets, requiring both non-empty and informative. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaFilePathTokens`](../scripts/lib/persona/audit-correlator.mjs#L126) | function | `scripts/lib/persona/audit-correlator.mjs` | 126-129 | Tokenizes a persona finding's element and step URL for file-path similarity matching. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaFindingHash`](../scripts/lib/persona/audit-correlator.mjs#L62) | function | `scripts/lib/persona/audit-correlator.mjs` | 62-67 | Computes a semantic ID for a persona finding based on element, severity code, and observed description. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaKeywordTokens`](../scripts/lib/persona/audit-correlator.mjs#L131) | function | `scripts/lib/persona/audit-correlator.mjs` | 131-133 | Tokenizes a persona finding's observed description for keyword similarity matching. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`pickBest`](../scripts/lib/persona/audit-correlator.mjs#L214) | function | `scripts/lib/persona/audit-correlator.mjs` | 214-216 | Selects the newest or highest-severity audit finding from candidates with the same fingerprint. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`scoreMatch`](../scripts/lib/persona/audit-correlator.mjs#L153) | function | `scripts/lib/persona/audit-correlator.mjs` | 153-163 | Computes a weighted combined score (50/50 file + keyword) for persona-to-audit finding similarity. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`tokenize`](../scripts/lib/persona/audit-correlator.mjs#L94) | function | `scripts/lib/persona/audit-correlator.mjs` | 94-101 | Splits text into lowercase alphanumeric tokens of minimum length, returning a Set. | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
...
| [`canonicaliseRemoteUrl`](../scripts/lib/repo-identity.mjs#L61) | function | `scripts/lib/repo-identity.mjs` | 61-78 | Normalizes a Git remote URL (SSH or HTTPS) to a lowercase "host/path" canonical form. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`deriveName`](../scripts/lib/repo-identity.mjs#L108) | function | `scripts/lib/repo-identity.mjs` | 108-116 | Extracts a repository name from its canonical remote URL or falls back to directory basename. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`gitOriginUrl`](../scripts/lib/repo-identity.mjs#L80) | function | `scripts/lib/repo-identity.mjs` | 80-89 | Retrieves the git remote origin URL for a repository directory. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`gitTopLevel`](../scripts/lib/repo-identity.mjs#L91) | function | `scripts/lib/repo-identity.mjs` | 91-100 | Retrieves the top-level directory path of a git repository. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`persistRepoIdentity`](../scripts/lib/repo-identity.mjs#L171) | function | `scripts/lib/repo-identity.mjs` | 171-179 | Persists a repository UUID to a committed file in the git repository. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`resolveRepoIdentity`](../scripts/lib/repo-identity.mjs#L122) | function | `scripts/lib/repo-identity.mjs` | 122-162 | Resolves a repository's unique identity from git origin, committed file, or path fallback. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
| [`uuidv5`](../scripts/lib/repo-identity.mjs#L37) | function | `scripts/lib/repo-identity.mjs` | 37-48 | Generates a UUID v5 from a namespace UUID and name using SHA1 hashing per RFC 4122. | `scripts/cross-skill.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/audit/tiered-shadow-compare.mjs`, +13 more |
...
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L643) | function | `scripts/lib/schemas.mjs` | 643-659 | Validates that deferred findings include required approval fields based on their deferral reason. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L223) | function | `scripts/lib/schemas.mjs` | 223-233 | Normalizes finding evidence into commission (with anchor), omission (with trigger + causal chain), or missing categories. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L316) | function | `scripts/lib/schemas.mjs` | 316-333 | Recursively removes Gemini-incompatible JSON Schema keys from a schema object. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L342) | function | `scripts/lib/schemas.mjs` | 342-345 | Converts a Zod schema to Gemini-compatible JSON Schema format. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
...
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L494) | function | `scripts/lib/sync-isolation-verify.mjs` | 494-507 | Formats gate pass/fail results as human-readable text with checkmarks, error messages, and truncated detail JSON. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L438) | function | `scripts/lib/sync-isolation-verify.mjs` | 438-453 | Reports uncommitted changes in the consumer working tree via `git status --porcelain` (always passes; surfaces state for operator decision). | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L169) | function | `scripts/lib/sync-isolation-verify.mjs` | 169-230 | Verifies no synced files are uncommitted/staged or clean-tracked in consumer git tree. | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L232) | function | `scripts/lib/sync-isolation-verify.mjs` | 232-264 | Verifies all manifest files exist on disk and match recorded SHA256 hashes. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L266) | function | `scripts/lib/sync-isolation-verify.mjs` | 266-295 | Verifies that command-bearing files contain no stale references to upstream-owned scripts outside the isolated `.claude-skills/` directory. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L297) | function | `scripts/lib/sync-isolation-verify.mjs` | 297-361 | Validates relocation by spawning synced CLI scripts and lib modules with `--selfcheck-relocation` to confirm they run in the consumer tree. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L363) | function | `scripts/lib/sync-isolation-verify.mjs` | 363-410 | Reconciles npm script bodies against skill `.md` references to ensure no `node scripts/X` invocations point outside `.claude-skills/`. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L412) | function | `scripts/lib/sync-isolation-verify.mjs` | 412-419 | Confirms the consumer manifest declares `layout: 'isolated'` as required for isolation governance. | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L421) | function | `scripts/lib/sync-isolation-verify.mjs` | 421-436 | Validates that `.gitignore` contains a well-formed managed block with matching begin/end markers and correct marker order. | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L83) | function | `scripts/lib/sync-isolation-verify.mjs` | 83-86 | Computes SHA256 hash of file contents prefixed with 'sha256:'. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L151) | function | `scripts/lib/sync-isolation-verify.mjs` | 151-161 | Lists all files in designated command-bearing directories (scripts/, .claude/, .github/prompts/). | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L108) | function | `scripts/lib/sync-isolation-verify.mjs` | 108-127 | Loads and validates sync manifest from consumer root, returning schema-validated manifest or error. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L509) | function | `scripts/lib/sync-isolation-verify.mjs` | 509-535 | CLI entry point that parses arguments, runs isolation gates, formats output, and exits with gate-specific error codes. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L88) | function | `scripts/lib/sync-isolation-verify.mjs` | 88-106 | Parses CLI arguments for isolation-verification gates (root, manifest, gates, format, relocation checks). | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L163) | function | `scripts/lib/sync-isolation-verify.mjs` | 163-165 | Converts absolute file path to relative forward-slash form. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L457) | function | `scripts/lib/sync-isolation-verify.mjs` | 457-484 | Executes all seven isolation verification gates in sequence, loading the manifest once upfront and returning results from each. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L486) | function | `scripts/lib/sync-isolation-verify.mjs` | 486-492 | Directs users to run the inventory self-check from the source repo instead of a consumer repo. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L129) | function | `scripts/lib/sync-isolation-verify.mjs` | 129-149 | Recursively yields all files in directory tree, aborting (fail-closed) on unreadable directories. | _(internal)_ |
...
> Cloud persistence layer for the symbol index: upserting domain summaries, recording file import edges, and querying symbol neighborhoods for architecture-memory consultation.
...
_Domain has 193 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`driftKeysContentHash`](../scripts/lib/store/nav-audit.mjs#L27) | function | `scripts/lib/store/nav-audit.mjs` | 27-30 | Computes a 16-char hex SHA256 digest of sorted drift keys for deduplicating nav-audit runs. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs` |
| [`listNavAuditRunHistory`](../scripts/lib/store/nav-audit.mjs#L126) | function | `scripts/lib/store/nav-audit.mjs` | 126-158 | Queries nav-audit run history for a repo since N days ago, returning up to limit rows and a truncation flag. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs` |
| [`recordNavAuditRun`](../scripts/lib/store/nav-audit.mjs#L61) | function | `scripts/lib/store/nav-audit.mjs` | 61-95 | Inserts or ignores a nav-audit run record into the cloud store, returning recorded/deduplicated status. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-nav.mjs` |
| [`getActionablePersonaOutcomeItems`](../scripts/lib/store/persona-outcomes.mjs#L253) | function | `scripts/lib/store/persona-outcomes.mjs` | 253-321 | Queries recent persona sessions, dedupes findings by hash (keeping newest), enriches with outcomes, and returns actionable items. | `scripts/cross-skill.mjs` |
| [`getPersonaOutcomesSummary`](../scripts/lib/store/persona-outcomes.mjs#L165) | function | `scripts/lib/store/persona-outcomes.mjs` | 165-223 | Retrieves the latest persona session and its P0/P1 findings enriched with outcome labels, returning counts of closed/open/unlabeled. | `scripts/cross-skill.mjs` |
| [`isP0OrP1`](../scripts/lib/store/persona-outcomes.mjs#L137) | function | `scripts/lib/store/persona-outcomes.mjs` | 137-139 | Returns true if a finding's code is P0 or P1. | `scripts/cross-skill.mjs` |
| [`resolveLabelTarget`](../scripts/lib/store/persona-outcomes.mjs#L40) | function | `scripts/lib/store/persona-outcomes.mjs` | 40-57 | Validates a persona finding hash belongs to a session's P0/P1 findings and resolves its repo ID for outcome labeling. | `scripts/cross-skill.mjs` |
| [`upsertPersonaFindingOutcome`](../scripts/lib/store/persona-outcomes.mjs#L98) | function | `scripts/lib/store/persona-outcomes.mjs` | 98-134 | Inserts or updates a persona finding outcome label (fixed/stale/false-positive/false-negative) in the cloud store. | `scripts/cross-skill.mjs` |
...
| [`buildSanitizedClickPath`](../scripts/lib/store/persona.mjs#L134) | function | `scripts/lib/store/persona.mjs` | 134-157 | Parses and sanitizes a click path array, enforcing a cap and dropping invalid or sensitive steps. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`collapsePath`](../scripts/lib/store/persona.mjs#L81) | function | `scripts/lib/store/persona.mjs` | 81-85 | Collapses URL path segments, replacing secret-like or auth-protected segments with `:param`. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`getPersonaSessionsByRepo`](../scripts/lib/store/persona.mjs#L313) | function | `scripts/lib/store/persona.mjs` | 313-340 | Retrieves persona test sessions for a repo, optionally filtered to P0-only or with column selection. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`getPersonaSessionsByUrl`](../scripts/lib/store/persona.mjs#L419) | function | `scripts/lib/store/persona.mjs` | 419-437 | Retrieves persona test sessions by app URL from the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`getReachabilityEvidence`](../scripts/lib/store/persona.mjs#L353) | function | `scripts/lib/store/persona.mjs` | 353-381 | Aggregates click paths across persona test sessions by persona, extracting unique reached URLs and click context. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`isPersonaCloudEnabled`](../scripts/lib/store/persona.mjs#L165) | function | `scripts/lib/store/persona.mjs` | 165-167 | Returns whether the persona store is cloud-enabled. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`listPersonasForApp`](../scripts/lib/store/persona.mjs#L174) | function | `scripts/lib/store/persona.mjs` | 174-185 | Retrieves all persona configurations registered for a specific app URL from the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`looksSecret`](../scripts/lib/store/persona.mjs#L32) | function | `scripts/lib/store/persona.mjs` | 32-44 | Detects whether a string looks like a secret by checking for email, UUID, JWT, hex token, base64 token, or long digit patterns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`recordPersonaSession`](../scripts/lib/store/persona.mjs#L230) | function | `scripts/lib/store/persona.mjs` | 230-306 | Inserts or updates a persona test session with findings, verdict, steps, and optional click path preservation. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`redactParams`](../scripts/lib/store/persona.mjs#L69) | function | `scripts/lib/store/persona.mjs` | 69-77 | Sanitizes URL query parameters by redacting suspicious values to `:param` placeholder. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`sanitizeStepUrl`](../scripts/lib/store/persona.mjs#L87) | function | `scripts/lib/store/persona.mjs` | 87-125 | Normalizes and redacts URLs from persona click paths, handling hash routes and redacting OAuth fragments. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`unnestReachabilityRows`](../scripts/lib/store/persona.mjs#L391) | function | `scripts/lib/store/persona.mjs` | 391-413 | Transforms row-level click path aggregates into a per-persona reachability report. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`upsertPersona`](../scripts/lib/store/persona.mjs#L194) | function | `scripts/lib/store/persona.mjs` | 194-222 | Inserts or updates a persona definition and returns its ID plus whether it was newly created. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/persona/audit-correlator.mjs` |
| [`getCandidateAuditFindings`](../scripts/lib/store/plans-ship.mjs#L445) | function | `scripts/lib/store/plans-ship.mjs` | 445-472 | Fetches recent HIGH/MEDIUM audit findings for correlation against persona findings. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`getExistingCorrelationHashesForSession`](../scripts/lib/store/plans-ship.mjs#L484) | function | `scripts/lib/store/plans-ship.mjs` | 484-496 | Returns the set of persona finding hashes already correlated to a session. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`getUnlockedFixes`](../scripts/lib/store/plans-ship.mjs#L301) | function | `scripts/lib/store/plans-ship.mjs` | 301-315 | Retrieves recent HIGH audit findings without a corresponding /ux-lock spec. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`insertRunRowWithPolicyFallback`](../scripts/lib/store/plans-ship.mjs#L263) | function | `scripts/lib/store/plans-ship.mjs` | 263-274 | Inserts a row to a table, falling back to omit missing columns if a migration hasn't run. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`listConsistencyCandidates`](../scripts/lib/store/plans-ship.mjs#L177) | function | `scripts/lib/store/plans-ship.mjs` | 177-208 | Queries persona-consistency-candidate regression specs ordered by recency. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`promoteRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L215) | function | `scripts/lib/store/plans-ship.mjs` | 215-251 | Promotes a candidate spec to locked status by setting the spec path and promotion timestamp. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readAuditEffectiveness`](../scripts/lib/store/plans-ship.mjs#L521) | function | `scripts/lib/store/plans-ship.mjs` | 521-529 | Fetches audit precision/recall and correlation counts for a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readCorrelationCountsByType`](../scripts/lib/store/plans-ship.mjs#L540) | function | `scripts/lib/store/plans-ship.mjs` | 540-559 | Groups persona↔audit correlations by type and counts them per correlation type. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readCorrelationsForFinding`](../scripts/lib/store/plans-ship.mjs#L510) | function | `scripts/lib/store/plans-ship.mjs` | 510-518 | Loads all personas that reported a specific audit finding. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readCorrelationsForRun`](../scripts/lib/store/plans-ship.mjs#L499) | function | `scripts/lib/store/plans-ship.mjs` | 499-507 | Loads all persona↔audit correlations associated with an audit run. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readPersistentPlanFailures`](../scripts/lib/store/plans-ship.mjs#L654) | function | `scripts/lib/store/plans-ship.mjs` | 654-662 | Queries persistent plan failures from the cloud store for a plan ID, returning empty array on failure/unavailability. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readPlanSatisfaction`](../scripts/lib/store/plans-ship.mjs#L643) | function | `scripts/lib/store/plans-ship.mjs` | 643-651 | Fetches the latest plan satisfaction record from the cloud store for a plan ID, returning null on failure/unavailability. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`readShipEvents`](../scripts/lib/store/plans-ship.mjs#L701) | function | `scripts/lib/store/plans-ship.mjs` | 701-719 | Queries ship events grouped by outcome and fetches recent events for a repo from the cloud store. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordPersonaAuditCorrelation`](../scripts/lib/store/plans-ship.mjs#L328) | function | `scripts/lib/store/plans-ship.mjs` | 328-385 | Links a persona finding to an audit finding with correlation type, retiring stale "audit missed" rows. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordPlanVerificationItems`](../scripts/lib/store/plans-ship.mjs#L592) | function | `scripts/lib/store/plans-ship.mjs` | 592-640 | Bulk-inserts per-criterion verification results (status, error, duration) with fallback for missing schema columns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordPlanVerificationRun`](../scripts/lib/store/plans-ship.mjs#L566) | function | `scripts/lib/store/plans-ship.mjs` | 566-589 | Logs a /ux-lock verify execution with pass/fail/skipped criterion counts. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L85) | function | `scripts/lib/store/plans-ship.mjs` | 85-172 | Inserts a regression test specification (locked from /ux-lock or candidate from persona consistency). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordRegressionSpecRun`](../scripts/lib/store/plans-ship.mjs#L277) | function | `scripts/lib/store/plans-ship.mjs` | 277-295 | Logs a regression test execution (pass/fail/duration/error). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`recordShipEvent`](../scripts/lib/store/plans-ship.mjs#L669) | function | `scripts/lib/store/plans-ship.mjs` | 669-690 | Records a ship event (outcome, metrics, block reasons) to the cloud store when enabled. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`retireMissedCorrelationsForHash`](../scripts/lib/store/plans-ship.mjs#L408) | function | `scripts/lib/store/plans-ship.mjs` | 408-426 | Deletes stale "audit missed" rows (NULL audit_finding_id) for a persona finding after manual repair. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`updatePlanStatus`](../scripts/lib/store/plans-ship.mjs#L53) | function | `scripts/lib/store/plans-ship.mjs` | 53-71 | Updates a plan's status field (e.g., draft → active → completed). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`upsertPlan`](../scripts/lib/store/plans-ship.mjs#L22) | function | `scripts/lib/store/plans-ship.mjs` | 22-50 | Inserts or updates a plan record with metadata (principles, focus areas, status). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L298) | function | `scripts/lib/store/repo.mjs` | 298-313 | Retrieves a repo's row ID by name, preferring the most recently created match. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-243 | Looks up a repo's row ID by UUID with optional strict error re-throw for write callers. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Initializes cloud store connectivity and probes Supabase availability, logging success or configuration guidance. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks whether the cloud store is currently available and connected. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L323) | function | `scripts/lib/store/repo.mjs` | 323-332 | Retrieves all repo IDs from the cloud database in order. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`resolveRepoForStore`](../scripts/lib/store/repo.mjs#L142) | function | `scripts/lib/store/repo.mjs` | 142-203 | Resolves a repo to its canonical row ID using repo_uuid, upserting with profile metadata if needed. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`upsertRepo`](../scripts/lib/store/repo.mjs#L108) | function | `scripts/lib/store/repo.mjs` | 108-116 | Delegates to resolveRepoForStore for canonical repo identity resolution (deprecated direct path). | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`upsertRepoByUuid`](../scripts/lib/store/repo.mjs#L253) | function | `scripts/lib/store/repo.mjs` | 253-285 | Ensures a repo row exists for a given UUID+name, handling race conditions on concurrent inserts. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
...
> Node.js test-runner suite testing CLI script integration via subprocess, critical deterministic seams (schemas, VCS, sync/relocation contract, sensitive-path egress), temporary fixture generation, and empirical browser-based UX skill validation.
...
_Domain has 343 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`result`](../tests/nav-verify-store.test.mjs#L21) | function | `tests/nav-verify-store.test.mjs` | 21-29 | Constructs a mock nav-verify result object with contract digest, states, and live attribution for testing. | _(internal)_ |
...
| [`auditFinding`](../tests/persona-audit-correlator.test.mjs#L17) | function | `tests/persona-audit-correlator.test.mjs` | 17-23 | Test fixture factory creating a mock audit finding (HIGH severity crash in checkout.tsx) with merged overrides. | _(internal)_ |
| [`p0`](../tests/persona-audit-correlator.test.mjs#L15) | function | `tests/persona-audit-correlator.test.mjs` | 15-15 | Test fixture factory creating a P0 persona finding with defaults and merged overrides. | _(internal)_ |
| [`p1`](../tests/persona-audit-correlator.test.mjs#L16) | function | `tests/persona-audit-correlator.test.mjs` | 16-16 | Test fixture factory creating a P1 persona finding with defaults and merged overrides. | _(internal)_ |
