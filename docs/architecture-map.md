...
- Generated: 2026-07-09T18:34:56.468Z   commit: 4d30d7b4b22f   refresh_id: e3569fce-9a92-4c79-8895-e7f0c0023c0a
- Drift score: 32 / threshold 20   status: `RED`
- Domains: 24   Symbols: 2525   Layering violations: 0
...
- [scripts](#scripts) — 234 symbols
- [shared-lib](#shared-lib) — 698 symbols
- [stores](#stores) — 155 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 316 symbols
...
| [`cleanupTempRoot`](../scripts/lib/audit/diff-scope-resolver.mjs#L209) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 209-219 | Forcefully removes a temporary git worktree and falls back to recursive filesystem deletion if the worktree was never registered. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`computeEntryPoints`](../scripts/lib/audit/diff-scope-resolver.mjs#L308) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 308-377 | Extracts entry points from package.json and tsconfig.json, adding TypeScript source equivalents when compiled output paths are found. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`cruiseTempRoot`](../scripts/lib/audit/diff-scope-resolver.mjs#L231) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 231-293 | Runs dep-cruiser on materialized source files in a temporary directory, translates relative paths back to the temp root, and returns a map of callers to their dependencies. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`gitBuf`](../scripts/lib/audit/diff-scope-resolver.mjs#L73) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 73-85 | Executes a git command and returns the buffer output, or null on failure with stderr logging. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`materialisePreimages`](../scripts/lib/audit/diff-scope-resolver.mjs#L172) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 172-207 | Creates a temporary git worktree at baseRef, materialises eligible preimage files, and returns the temp root path. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`parseLsTreeZ`](../scripts/lib/audit/diff-scope-resolver.mjs#L153) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 153-156 | Parses `git ls-tree -z` output into a set of file paths. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`parseNameStatusZ`](../scripts/lib/audit/diff-scope-resolver.mjs#L100) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 100-145 | Parses `git diff --name-status -z` output into records with variable-width token handling for renames/copies. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`resolveDiffScope`](../scripts/lib/audit/diff-scope-resolver.mjs#L394) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 394-495 | Resolves git refs to commit SHAs, builds a list of changed files via git diff, extracts pre-edge information from the base commit, and returns the diff scope with optional partial-parse tracking. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`stripLeadingDotSlash`](../scripts/lib/audit/diff-scope-resolver.mjs#L27) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 27-29 | Removes a leading `./` prefix from a string if present. | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
| [`walkEntryPointDir`](../scripts/lib/audit/diff-scope-resolver.mjs#L49) | function | `scripts/lib/audit/diff-scope-resolver.mjs` | 49-63 | Walks a directory to discover source files matching specified extensions (non-recursive). | `scripts/audit-clean.mjs`, `scripts/openai-audit.mjs` |
...
| [`semanticId`](../scripts/lib/findings.mjs#L27) | function | `scripts/lib/findings.mjs` | 27-40 | Generates a short semantic hash of a finding based on linter rule/file or generic content. | `scripts/cross-skill.mjs`, `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, +12 more |
...
> Runs multi-pass code and plan audits via GPT and Gemini, manages cross-skill data pipelines to Supabase, and orchestrates bootstrap setup and artifact archival for the eight development-quality skills.
...
| [`argOption`](../scripts/solo-control-audit.mjs#L132) | function | `scripts/solo-control-audit.mjs` | 132-135 | Extracts a command-line option value by name. | _(internal)_ |
| [`armLabelFor`](../scripts/solo-control-audit.mjs#L119) | function | `scripts/solo-control-audit.mjs` | 119-126 | Derives arm label from model name (S-fable/S-sonnet/etc) or explicit override. | _(internal)_ |
| [`chunkDiff`](../scripts/solo-control-audit.mjs#L223) | function | `scripts/solo-control-audit.mjs` | 223-244 | Splits a large diff into smaller chunks, inserting continuation markers for multi-part files. | _(internal)_ |
| [`clampField`](../scripts/solo-control-audit.mjs#L289) | function | `scripts/solo-control-audit.mjs` | 289-294 | Truncates a string to a cap, breaking at word boundary and adding ellipsis if needed. | _(internal)_ |
| [`clampToSchema`](../scripts/solo-control-audit.mjs#L295) | function | `scripts/solo-control-audit.mjs` | 295-306 | Applies field-length caps to parsed findings to enforce schema size limits. | _(internal)_ |
| [`cmdApparatus`](../scripts/solo-control-audit.mjs#L620) | function | `scripts/solo-control-audit.mjs` | 620-697 | Command handler for apparatus arm: orchestrates Gemini+GPT review over known-defect commits. | _(internal)_ |
| [`cmdApparatusBC`](../scripts/solo-control-audit.mjs#L742) | function | `scripts/solo-control-audit.mjs` | 742-856 | Audits code commits via Cluster B+C with three models (OSS/GPT/Gemini) using configurable context windows. | _(internal)_ |
| [`cmdJudgeGpt`](../scripts/solo-control-audit.mjs#L1125) | function | `scripts/solo-control-audit.mjs` | 1125-1228 | Main coordinator for GPT-grading blind-labeled findings with incremental checkpointing for crash recovery. | _(internal)_ |
| [`cmdMerge`](../scripts/solo-control-audit.mjs#L1256) | function | `scripts/solo-control-audit.mjs` | 1256-1477 | Merges solo-model findings into a blind spreadsheet for human adjudication and filters by commit subset. | _(internal)_ |
| [`cmdRun`](../scripts/solo-control-audit.mjs#L363) | function | `scripts/solo-control-audit.mjs` | 363-534 | Main orchestrator for solo-control audit: discovers commits, chunks diffs, and runs multiple audit passes. | _(internal)_ |
| [`cmdScore`](../scripts/solo-control-audit.mjs#L1479) | function | `scripts/solo-control-audit.mjs` | 1479-1568 | Computes arm-comparison statistics (precision, confidence intervals) from labeled adjudication data. | _(internal)_ |
| [`cmdSoloPassRetro`](../scripts/solo-control-audit.mjs#L940) | function | `scripts/solo-control-audit.mjs` | 940-1023 | Generates single-engine (GPT-only or Gemini-only) findings for isolated model comparison. | _(internal)_ |
| [`cmdSonnetGeminiRetro`](../scripts/solo-control-audit.mjs#L870) | function | `scripts/solo-control-audit.mjs` | 870-927 | Runs Gemini audit on commits to identify findings not caught by prior Sonnet analysis. | _(internal)_ |
| [`continuationMarker`](../scripts/solo-control-audit.mjs#L247) | function | `scripts/solo-control-audit.mjs` | 247-250 | Generates a comment marker identifying diff chunks that belong to the same file across multiple parts. | _(internal)_ |
| [`csvField`](../scripts/solo-control-audit.mjs#L153) | function | `scripts/solo-control-audit.mjs` | 153-156 | Escapes a value for CSV output, quoting if it contains special characters. | _(internal)_ |
| [`dedupeFindings`](../scripts/solo-control-audit.mjs#L713) | function | `scripts/solo-control-audit.mjs` | 713-723 | Removes duplicate findings by dupHash, keeping only the first occurrence of each. | _(internal)_ |
| [`discoverCommits`](../scripts/solo-control-audit.mjs#L162) | function | `scripts/solo-control-audit.mjs` | 162-172 | Queries the database for distinct commits from audit findings in arms B or C. | _(internal)_ |
| [`dupHash`](../scripts/solo-control-audit.mjs#L149) | function | `scripts/solo-control-audit.mjs` | 149-152 | Generates a 10-character SHA256 hash from category/file/detail for finding deduplication. | _(internal)_ |
| [`extractDiff`](../scripts/solo-control-audit.mjs#L192) | function | `scripts/solo-control-audit.mjs` | 192-209 | Extracts git diff for a commit, filtering sensitive paths and redacting secrets. | _(internal)_ |
| [`fetchExternalFindings`](../scripts/solo-control-audit.mjs#L1240) | function | `scripts/solo-control-audit.mjs` | 1240-1254 | Fetches pre-computed audit findings for model arms A/B/C from Supabase by commit. | _(internal)_ |
| [`git`](../scripts/solo-control-audit.mjs#L137) | function | `scripts/solo-control-audit.mjs` | 137-141 | Runs a git command in a repo, capturing output and throwing on error. | _(internal)_ |
| [`hasFlag`](../scripts/solo-control-audit.mjs#L136) | function | `scripts/solo-control-audit.mjs` | 136-136 | Checks if a command-line flag is present in argv. | _(internal)_ |
| [`listSFindings`](../scripts/solo-control-audit.mjs#L115) | function | `scripts/solo-control-audit.mjs` | 115-115 | Lists all solo-findings JSON files matching the pattern `S-findings-*.json`. | _(internal)_ |
| [`locateCommit`](../scripts/solo-control-audit.mjs#L175) | function | `scripts/solo-control-audit.mjs` | 175-181 | Finds which repo root contains a given git commit SHA. | _(internal)_ |
...
| [`main`](../scripts/solo-control-audit.mjs#L1572) | function | `scripts/solo-control-audit.mjs` | 1572-1590 | CLI entry point dispatching to audit subcommands (run, merge, score, judge-gpt, etc.). | _(internal)_ |
| [`parseCsvLine`](../scripts/solo-control-audit.mjs#L1085) | function | `scripts/solo-control-audit.mjs` | 1085-1089 | Parses a CSV line while respecting quoted field boundaries. | _(internal)_ |
| [`parseJsonLoose`](../scripts/solo-control-audit.mjs#L308) | function | `scripts/solo-control-audit.mjs` | 308-317 | Extracts and parses JSON from text, handling markdown code fences and partial objects. | _(internal)_ |
| [`readBlindSheet`](../scripts/solo-control-audit.mjs#L1091) | function | `scripts/solo-control-audit.mjs` | 1091-1101 | Reads and structures a blind-audit CSV into rows with extracted column mappings. | _(internal)_ |
| [`runGeminiPass`](../scripts/solo-control-audit.mjs#L599) | function | `scripts/solo-control-audit.mjs` | 599-617 | Runs a single audit pass via Gemini's structured JSON output. | _(internal)_ |
| [`runGeminiReview`](../scripts/solo-control-audit.mjs#L571) | function | `scripts/solo-control-audit.mjs` | 571-590 | Runs Gemini as final reviewer to identify net-new issues missed by prior audit. | _(internal)_ |
| [`runGptJudgeBatch`](../scripts/solo-control-audit.mjs#L1104) | function | `scripts/solo-control-audit.mjs` | 1104-1123 | Grades a batch of audit findings with GPT using structured JSON output schema. | _(internal)_ |
| [`runGptPass`](../scripts/solo-control-audit.mjs#L552) | function | `scripts/solo-control-audit.mjs` | 552-568 | Runs a structured audit pass via OpenAI's response parsing API with optional reasoning effort. | _(internal)_ |
| [`runOssPass`](../scripts/solo-control-audit.mjs#L727) | function | `scripts/solo-control-audit.mjs` | 727-740 | Runs an audit pass via OSS model structured-output backend. | _(internal)_ |
| [`runPass`](../scripts/solo-control-audit.mjs#L323) | function | `scripts/solo-control-audit.mjs` | 323-359 | Runs a single audit pass via Claude API, parsing findings and retrying on schema validation failure. | _(internal)_ |
| [`sFindingsPath`](../scripts/solo-control-audit.mjs#L114) | function | `scripts/solo-control-audit.mjs` | 114-114 | Builds the filesystem path for a solo-findings JSON artifact. | _(internal)_ |
| [`tryGit`](../scripts/solo-control-audit.mjs#L142) | function | `scripts/solo-control-audit.mjs` | 142-144 | Runs a git command, returning null on error. | _(internal)_ |
...
> Abstracts Claude/GPT/Gemini clients (SDK/CLI backends, Azure endpoints, secret redaction) and provides audit infrastructure: file I/O, sensitive-path classification, diff annotation, scope assembly, finding semantics, and repo profiling.
...
_Domain has 698 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`_resetClientCache`](../scripts/lib/anthropic-client.mjs#L348) | function | `scripts/lib/anthropic-client.mjs` | 348-351 | Clears cached client instances and resets warning flags. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`applyRedactor`](../scripts/lib/anthropic-client.mjs#L313) | function | `scripts/lib/anthropic-client.mjs` | 313-342 | Recursively applies redaction to system prompts and all message content blocks. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`assertOneShotTextMessages`](../scripts/lib/anthropic-client.mjs#L442) | function | `scripts/lib/anthropic-client.mjs` | 442-471 | Validates that messages are user-role text content blocks (no images/tools/etc) for CLI backend. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`buildPromptFromMessages`](../scripts/lib/anthropic-client.mjs#L479) | function | `scripts/lib/anthropic-client.mjs` | 479-496 | Concatenates message content blocks into a single prompt string. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`createAnthropicClient`](../scripts/lib/anthropic-client.mjs#L183) | function | `scripts/lib/anthropic-client.mjs` | 183-251 | Factory that creates a cached Anthropic client supporting SDK/CLI backends, redaction, and Azure endpoints. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`createCliAdapter`](../scripts/lib/anthropic-client.mjs#L363) | function | `scripts/lib/anthropic-client.mjs` | 363-433 | Creates a messages.create() adapter wrapping the claude CLI subprocess, validating user-role text-only messages. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`getDefaultRedactor`](../scripts/lib/anthropic-client.mjs#L255) | function | `scripts/lib/anthropic-client.mjs` | 255-273 | Returns a secret-redaction function using shape-based pattern matching instead of blanket token length checks. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`isClaudeAvailable`](../scripts/lib/anthropic-client.mjs#L150) | function | `scripts/lib/anthropic-client.mjs` | 150-152 | Checks if Claude is available via CLI backend or ANTHROPIC_API_KEY. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`keyDigest`](../scripts/lib/anthropic-client.mjs#L50) | function | `scripts/lib/anthropic-client.mjs` | 50-52 | Generates a 16-character SHA256 hash of a key for cache identification. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`normaliseCliOutput`](../scripts/lib/anthropic-client.mjs#L671) | function | `scripts/lib/anthropic-client.mjs` | 671-719 | Parses and validates claude CLI's JSON output envelope, extracting text, usage, and cost metadata. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`quoteWinArg`](../scripts/lib/anthropic-client.mjs#L745) | function | `scripts/lib/anthropic-client.mjs` | 745-750 | Quotes a Windows command-line argument if it contains special characters or whitespace. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`resolveBackend`](../scripts/lib/anthropic-client.mjs#L120) | function | `scripts/lib/anthropic-client.mjs` | 120-133 | Resolves and validates the CLAUDE_BACKEND env var (sdk or cli), hard-failing on invalid values. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`resolveTimeoutMs`](../scripts/lib/anthropic-client.mjs#L93) | function | `scripts/lib/anthropic-client.mjs` | 93-104 | Validates and returns timeout milliseconds from options or environment, throwing if out of bounds. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`runClaudeCli`](../scripts/lib/anthropic-client.mjs#L517) | function | `scripts/lib/anthropic-client.mjs` | 517-631 | Spawns claude CLI subprocess with stdin prompt, handles timeouts/signals, and normalizes JSON output. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
| [`wrapSdkClient`](../scripts/lib/anthropic-client.mjs#L289) | function | `scripts/lib/anthropic-client.mjs` | 289-303 | Wraps the SDK client to apply redaction and normalize timeoutMs option to timeout. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/evolve-prompts.mjs`, +9 more |
...
| [`auditSubjectFileGuard`](../scripts/lib/audit-scope.mjs#L185) | function | `scripts/lib/audit-scope.mjs` | 185-191 | Generates an error message when audit scope matched zero implementation files. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
| [`classifyFiles`](../scripts/lib/audit-scope.mjs#L147) | function | `scripts/lib/audit-scope.mjs` | 147-166 | Categorizes file paths into backend, frontend, or shared categories by regex pattern. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
| [`isAuditInfraFile`](../scripts/lib/audit-scope.mjs#L60) | function | `scripts/lib/audit-scope.mjs` | 60-67 | Checks if a file is audit infrastructure code (scripts/lib/ files). | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
| [`isSensitiveFile`](../scripts/lib/audit-scope.mjs#L21) | function | `scripts/lib/audit-scope.mjs` | 21-23 | Checks if a relative path is classified as sensitive (credentials, keys, env files). | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
| [`readFilesAsContext`](../scripts/lib/audit-scope.mjs#L110) | function | `scripts/lib/audit-scope.mjs` | 110-138 | Reads multiple files into formatted markdown context with per-file and total size budgets. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
| [`safeReadFile`](../scripts/lib/audit-scope.mjs#L82) | function | `scripts/lib/audit-scope.mjs` | 82-96 | Reads a file safely with checks for sensitivity, symlink escape, and size constraints. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs`, +1 more |
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L326) | function | `scripts/lib/config.mjs` | 326-395 | Builds Azure AI Foundry configuration from environment variables when endpoint is set. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +37 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L127) | function | `scripts/lib/config.mjs` | 127-140 | Normalizes a language name to a canonical form (js, ts, py, go, other). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +37 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Reads and validates an environment variable against an allowed set with fallback. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +37 more |
...
| [`_exec`](../scripts/lib/db/query.mjs#L393) | function | `scripts/lib/db/query.mjs` | 393-413 | Executes SQL queries through the active transaction client or connection pool, normalizing errors. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`buildDelete`](../scripts/lib/db/query.mjs#L373) | function | `scripts/lib/db/query.mjs` | 373-378 | Constructs a SQL DELETE statement with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`buildInsert`](../scripts/lib/db/query.mjs#L193) | function | `scripts/lib/db/query.mjs` | 193-207 | Constructs a parameterized INSERT SQL statement from a single-row object. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`buildUpdate`](../scripts/lib/db/query.mjs#L347) | function | `scripts/lib/db/query.mjs` | 347-367 | Constructs a SQL UPDATE statement from a patch object with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`buildUpsert`](../scripts/lib/db/query.mjs#L226) | function | `scripts/lib/db/query.mjs` | 226-297 | Constructs a parameterized INSERT ... ON CONFLICT UPDATE SQL statement from multiple rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`deleteWhere`](../scripts/lib/db/query.mjs#L516) | function | `scripts/lib/db/query.mjs` | 516-521 | Deletes rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`flattenWhere`](../scripts/lib/db/query.mjs#L314) | function | `scripts/lib/db/query.mjs` | 314-338 | Converts a WHERE clause object into SQL predicates and parameter bindings, rejecting undefined values. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`insertReturning`](../scripts/lib/db/query.mjs#L465) | function | `scripts/lib/db/query.mjs` | 465-473 | Inserts a row and optionally returns the inserted record. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`many`](../scripts/lib/db/query.mjs#L452) | function | `scripts/lib/db/query.mjs` | 452-455 | Executes a query and returns all rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`normalizeConflictTarget`](../scripts/lib/db/query.mjs#L130) | function | `scripts/lib/db/query.mjs` | 130-157 | Parses and validates an ON CONFLICT target (column list or constraint name). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`normalizeReturning`](../scripts/lib/db/query.mjs#L107) | function | `scripts/lib/db/query.mjs` | 107-116 | Validates and normalizes a RETURNING clause specification into SQL syntax. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`one`](../scripts/lib/db/query.mjs#L435) | function | `scripts/lib/db/query.mjs` | 435-442 | Executes a query and returns exactly one row or null, rejecting multiple results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`pgArray`](../scripts/lib/db/query.mjs#L55) | function | `scripts/lib/db/query.mjs` | 55-58 | Wraps a value to signal it should serialize as a Postgres ARRAY literal (not JSON). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`query`](../scripts/lib/db/query.mjs#L422) | function | `scripts/lib/db/query.mjs` | 422-424 | Executes a SQL query and returns raw row results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`quoteIdent`](../scripts/lib/db/query.mjs#L78) | function | `scripts/lib/db/query.mjs` | 78-86 | SQL-quotes an identifier to safely include it in SQL statements. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`serializeWriteParam`](../scripts/lib/db/query.mjs#L62) | function | `scripts/lib/db/query.mjs` | 62-66 | Converts a parameter value for safe binding in INSERT/UPDATE SQL, handling jsonb arrays specially. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`updateWhere`](../scripts/lib/db/query.mjs#L502) | function | `scripts/lib/db/query.mjs` | 502-507 | Updates rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`upsert`](../scripts/lib/db/query.mjs#L487) | function | `scripts/lib/db/query.mjs` | 487-492 | Inserts or updates multiple rows (UPSERT) and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
| [`withTx`](../scripts/lib/db/query.mjs#L539) | function | `scripts/lib/db/query.mjs` | 539-587 | Executes a function within a database transaction, supporting nested savepoints for partial rollback. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +24 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Writes file contents atomically using temp file + rename, following symlinks to avoid breaking dotfile managers. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +48 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a file path to lowercase with forward slashes and removes working-directory prefix. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +48 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file synchronously or exits the process with an error message if not found. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +48 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Parses a string to integer, returning a fallback value on NaN. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +48 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Writes JSON output to a file (creating directories as needed) or stdout with a summary message. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +48 more |
...
| [`deriveSignals`](../scripts/lib/learning/author-tier-observation.mjs#L93) | function | `scripts/lib/learning/author-tier-observation.mjs` | 93-121 | Extracts file, domain, and sensitivity signals from changed files to inform LLM tier selection. | `scripts/openai-audit.mjs` |
| [`diffBucket`](../scripts/lib/learning/author-tier-observation.mjs#L68) | function | `scripts/lib/learning/author-tier-observation.mjs` | 68-71 | Categorizes a diff line count into predefined size buckets (s/m/l) for signals. | `scripts/openai-audit.mjs` |
| [`normalizeTierHint`](../scripts/lib/learning/author-tier-observation.mjs#L141) | function | `scripts/lib/learning/author-tier-observation.mjs` | 141-145 | Normalizes an author tier hint string to a logical tier or derives it from a model ID. | `scripts/openai-audit.mjs` |
| [`suggestTier`](../scripts/lib/learning/author-tier-observation.mjs#L128) | function | `scripts/lib/learning/author-tier-observation.mjs` | 128-133 | Recommends an LLM tier (economy/standard/frontier) based on file change signals. | `scripts/openai-audit.mjs` |
...
| [`batchWriteLedger`](../scripts/lib/ledger.mjs#L185) | function | `scripts/lib/ledger.mjs` | 185-209 | Writes multiple entries to a ledger file in batch, returning insert/update/reject counts. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`buildR2SystemPrompt`](../scripts/lib/ledger.mjs#L490) | function | `scripts/lib/ledger.mjs` | 490-492 | Combines the R2 round modifier, rulings block, and pass rubric into a single system prompt. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`buildRulingsBlock`](../scripts/lib/ledger.mjs#L395) | function | `scripts/lib/ledger.mjs` | 395-460 | Formats prior dismissals and severity adjustments as a system-prompt block for R2+ audits. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`computeImpactSet`](../scripts/lib/ledger.mjs#L502) | function | `scripts/lib/ledger.mjs` | 502-524 | Computes the transitive set of affected files by tracing imports from changed files. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`generateTopicId`](../scripts/lib/ledger.mjs#L30) | function | `scripts/lib/ledger.mjs` | 30-40 | Generates a stable 12-character hash ID for a finding based on file, principle, category, and pass. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`getFileRegex`](../scripts/lib/ledger.mjs#L21) | function | `scripts/lib/ledger.mjs` | 21-21 | Returns a regex pattern for extracting file paths from free-text findings. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`jaccardSimilarity`](../scripts/lib/ledger.mjs#L247) | function | `scripts/lib/ledger.mjs` | 247-255 | Computes Jaccard similarity between two strings using word-level tokenization. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`mergeMetaLocked`](../scripts/lib/ledger.mjs#L164) | function | `scripts/lib/ledger.mjs` | 164-183 | Atomically updates metadata in a locked ledger file using file-level locking. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`populateFindingMetadata`](../scripts/lib/ledger.mjs#L219) | function | `scripts/lib/ledger.mjs` | 219-237 | <no body> | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`readLedgerJson`](../scripts/lib/ledger.mjs#L122) | function | `scripts/lib/ledger.mjs` | 122-134 | Reads a JSON ledger file with automatic fallback to an empty ledger if missing or corrupted. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`suppressReRaises`](../scripts/lib/ledger.mjs#L266) | function | `scripts/lib/ledger.mjs` | 266-384 | Filters prior audit findings to exclude re-raises based on dismissal/fix/verification state. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`upsertEntry`](../scripts/lib/ledger.mjs#L137) | function | `scripts/lib/ledger.mjs` | 137-161 | Merges an entry into an in-memory ledger map, updating or inserting by topic ID. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
| [`writeLedgerEntry`](../scripts/lib/ledger.mjs#L47) | function | `scripts/lib/ledger.mjs` | 47-97 | Validates and persists an adjudication entry to a JSON ledger file, upserting by topic ID. | `scripts/gemini-review.mjs`, `scripts/lib/outcome-sync.mjs`, `scripts/lib/plan-fp-tracker.mjs`, +4 more |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L563) | function | `scripts/lib/model-resolver.mjs` | 563-611 | CLI entry point resolving sentinels or displaying live vs static model pools. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L379) | function | `scripts/lib/model-resolver.mjs` | 379-384 | Clears all cached model catalogs and deprecation warnings. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L279) | function | `scripts/lib/model-resolver.mjs` | 279-289 | Compares two parsed model versions for sorting, preferring newer/GA/undated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L334) | function | `scripts/lib/model-resolver.mjs` | 334-349 | Maps deprecated model IDs to current ones with optional warning. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L257) | function | `scripts/lib/model-resolver.mjs` | 257-275 | Returns a description object with provider, family, tier, and concrete model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L438) | function | `scripts/lib/model-resolver.mjs` | 438-445 | Fetches Anthropic's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L426) | function | `scripts/lib/model-resolver.mjs` | 426-436 | Fetches Google Generative AI model list, stripping the `models/` prefix. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L417) | function | `scripts/lib/model-resolver.mjs` | 417-424 | Fetches OpenAI's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L404) | function | `scripts/lib/model-resolver.mjs` | 404-415 | Fetches a URL with abort timeout. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L393) | function | `scripts/lib/model-resolver.mjs` | 393-398 | Returns cached live models for a provider if within TTL. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L97) | function | `scripts/lib/model-resolver.mjs` | 97-99 | Checks if a model ID is a sentinel like `latest-gpt` or `latest-opus`. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L199) | function | `scripts/lib/model-resolver.mjs` | 199-205 | Maps a parsed model object to its logical tier string (unknown/economy/standard/frontier). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L357) | function | `scripts/lib/model-resolver.mjs` | 357-363 | Merges live cached model catalog with static fallback pool, deduplicated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L195) | function | `scripts/lib/model-resolver.mjs` | 195-197 | Attempts to parse a model ID as Claude, Gemini, or OpenAI, returning the first match. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L104) | function | `scripts/lib/model-resolver.mjs` | 104-117 | Parses a Claude model ID (e.g., claude-opus-4-6-20250101) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L120) | function | `scripts/lib/model-resolver.mjs` | 120-152 | Parses a Gemini model ID (e.g., gemini-2.0-flash-preview) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L155) | function | `scripts/lib/model-resolver.mjs` | 155-172 | Parses an OpenAI model ID (e.g., gpt-5.5-pro, o1-mini) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L302) | function | `scripts/lib/model-resolver.mjs` | 302-308 | Selects the newest Claude model from a pool for a given tier. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L291) | function | `scripts/lib/model-resolver.mjs` | 291-300 | Selects the newest Gemini model from a pool for a tier, preferring Google's alias. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L314) | function | `scripts/lib/model-resolver.mjs` | 314-324 | Selects the newest OpenAI model from a pool for a tier and variant. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L548) | function | `scripts/lib/model-resolver.mjs` | 548-556 | Returns a simplified pricing tier key for a model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L455) | function | `scripts/lib/model-resolver.mjs` | 455-481 | Fetches live model catalogs from all three providers in parallel, caching results. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L495) | function | `scripts/lib/model-resolver.mjs` | 495-527 | Resolves a sentinel or concrete model ID to concrete form, with static pool fallback. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L240) | function | `scripts/lib/model-resolver.mjs` | 240-248 | Returns a sentinel model ID string for a given logical tier and provider. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L371) | function | `scripts/lib/model-resolver.mjs` | 371-376 | Stores a provider's live model list in cache with fetch timestamp. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L535) | function | `scripts/lib/model-resolver.mjs` | 535-542 | Checks if a model is an o-series or GPT-5+ (reasoning capable). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L212) | function | `scripts/lib/model-resolver.mjs` | 212-233 | Classifies a model ID into a logical tier by parsing and remapping deprecated IDs first. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +18 more |
...
| [`azureBaseUrl`](../scripts/lib/openai-client.mjs#L69) | function | `scripts/lib/openai-client.mjs` | 69-79 | Constructs the base URL for OpenAI or Azure API calls based on the deployment purpose and configuration. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +4 more |
| [`createOpenAIClient`](../scripts/lib/openai-client.mjs#L91) | function | `scripts/lib/openai-client.mjs` | 91-132 | Creates or retrieves a cached OpenAI client instance, using Azure or standard OpenAI credentials and endpoint configuration. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +4 more |
| [`keyDigest`](../scripts/lib/openai-client.mjs#L60) | function | `scripts/lib/openai-client.mjs` | 60-62 | Hashes a string key to a 16-character SHA256 hex digest for use as a cache identifier. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +4 more |
| [`normalizeApiPath`](../scripts/lib/openai-client.mjs#L53) | function | `scripts/lib/openai-client.mjs` | 53-57 | Normalizes an API path to always start with a slash and default to /openai/v1 if empty. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +4 more |
| [`trimTrailingSlash`](../scripts/lib/openai-client.mjs#L48) | function | `scripts/lib/openai-client.mjs` | 48-50 | Removes trailing slashes from a string. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/arm-eval/producers/model-call.mjs`, +4 more |
...
| [`buildClassificationRubric`](../scripts/lib/prompt-seeds.mjs#L129) | function | `scripts/lib/prompt-seeds.mjs` | 129-149 | Returns a template string documenting the required classification fields (sonarType, effort, sourceKind, sourceName) for audit findings. | `scripts/gemini-review.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/openai-audit.mjs`, +1 more |
...
| [`canonicaliseRemoteUrl`](../scripts/lib/repo-identity.mjs#L61) | function | `scripts/lib/repo-identity.mjs` | 61-78 | Normalizes a Git remote URL (SSH or HTTPS) to a lowercase "host/path" canonical form. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`deriveName`](../scripts/lib/repo-identity.mjs#L108) | function | `scripts/lib/repo-identity.mjs` | 108-116 | Extracts a repository name from its canonical remote URL or falls back to directory basename. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`gitOriginUrl`](../scripts/lib/repo-identity.mjs#L80) | function | `scripts/lib/repo-identity.mjs` | 80-89 | Retrieves the git remote origin URL for a repository directory. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`gitTopLevel`](../scripts/lib/repo-identity.mjs#L91) | function | `scripts/lib/repo-identity.mjs` | 91-100 | Retrieves the top-level directory path of a git repository. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`persistRepoIdentity`](../scripts/lib/repo-identity.mjs#L171) | function | `scripts/lib/repo-identity.mjs` | 171-179 | Persists a repository UUID to a committed file in the git repository. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`resolveRepoIdentity`](../scripts/lib/repo-identity.mjs#L122) | function | `scripts/lib/repo-identity.mjs` | 122-162 | Resolves a repository's unique identity from git origin, committed file, or path fallback. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
| [`uuidv5`](../scripts/lib/repo-identity.mjs#L37) | function | `scripts/lib/repo-identity.mjs` | 37-48 | Generates a UUID v5 from a namespace UUID and name using SHA1 hashing per RFC 4122. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/friction/commands.mjs`, +7 more |
...
| [`buildReducePayload`](../scripts/lib/robustness.mjs#L64) | function | `scripts/lib/robustness.mjs` | 64-100 | Builds a compact JSON payload of findings within a token budget by truncating and deduplicating. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`classifyLlmError`](../scripts/lib/robustness.mjs#L46) | function | `scripts/lib/robustness.mjs` | 46-55 | Classifies an LLM error as retryable or permanent with category and HTTP status mapping. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`computePassLimits`](../scripts/lib/robustness.mjs#L237) | function | `scripts/lib/robustness.mjs` | 237-265 | Computes token limits and timeout milliseconds for LLM calls based on reasoning level and input size. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`LlmError`](../scripts/lib/robustness.mjs#L32) | class | `scripts/lib/robustness.mjs` | 32-40 | Custom error class for LLM-specific failures with category, usage, and retryability metadata. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/robustness.mjs#L108) | function | `scripts/lib/robustness.mjs` | 108-122 | Deduplicates findings by semantic hash and sorts by severity and ID. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`resolveLedgerPath`](../scripts/lib/robustness.mjs#L182) | function | `scripts/lib/robustness.mjs` | 182-212 | Resolves the ledger file path based on session ID, explicit config, or round number. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
| [`tryRepairJson`](../scripts/lib/robustness.mjs#L134) | function | `scripts/lib/robustness.mjs` | 134-171 | Attempts to repair malformed JSON by closing unclosed brackets, strings, and handling edge cases. | `scripts/lib/oss-structured-output.mjs`, `scripts/lib/plan-fp-tracker.mjs`, `scripts/openai-audit.mjs` |
...
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L263) | function | `scripts/lib/schemas.mjs` | 263-279 | Validates that each deferred debt entry provides required supporting fields matching its deferredReason (blockedBy, followupPr, etc.). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +13 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L123) | function | `scripts/lib/schemas.mjs` | 123-132 | Recursively cleans an object by removing keys from a denylist, handling nested arrays and objects. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +13 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L141) | function | `scripts/lib/schemas.mjs` | 141-144 | Converts a Zod schema to a JSON Schema compatible with Gemini's `responseSchema` parameter. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +13 more |
...
| [`containsSecrets`](../scripts/lib/sensitive-egress-gate.mjs#L58) | function | `scripts/lib/sensitive-egress-gate.mjs` | 58-68 | Scans text for embedded secrets using pattern matching. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +8 more |
| [`gateSymbolForEgress`](../scripts/lib/sensitive-egress-gate.mjs#L142) | function | `scripts/lib/sensitive-egress-gate.mjs` | 142-193 | <no body> | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +8 more |
| [`isExtensionAllowlisted`](../scripts/lib/sensitive-egress-gate.mjs#L47) | function | `scripts/lib/sensitive-egress-gate.mjs` | 47-51 | Tests if a file extension is on the allowlist for egress to external systems. | `scripts/lib/arm-eval/judge.mjs`, `scripts/lib/arm-eval/producers/brainstorm.mjs`, `scripts/lib/arm-eval/producers/plan.mjs`, +8 more |
...
| [`_resetDebugBanner`](../scripts/lib/sensitive-paths.mjs#L426) | function | `scripts/lib/sensitive-paths.mjs` | 426-428 | Resets the debug banner warning flag to allow it to display again on next run. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`classifyPath`](../scripts/lib/sensitive-paths.mjs#L125) | function | `scripts/lib/sensitive-paths.mjs` | 125-131 | Tests a normalized path against sensitive and generated-noise pattern lists, returning the matching category or null. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`defaultHash`](../scripts/lib/sensitive-paths.mjs#L365) | function | `scripts/lib/sensitive-paths.mjs` | 365-367 | Generates an 8-character SHA256 hash of the input string for path obfuscation. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`emptyDiff`](../scripts/lib/sensitive-paths.mjs#L275) | function | `scripts/lib/sensitive-paths.mjs` | 275-277 | Returns an empty diff structure with all action arrays initialized. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`filterDiffFiles`](../scripts/lib/sensitive-paths.mjs#L291) | function | `scripts/lib/sensitive-paths.mjs` | 291-356 | <no body> | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`formatSkipLog`](../scripts/lib/sensitive-paths.mjs#L386) | function | `scripts/lib/sensitive-paths.mjs` | 386-423 | Formats skip events into debug or summary log lines, optionally redacting sensitive paths and using a custom hash function. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`matchingPattern`](../scripts/lib/sensitive-paths.mjs#L137) | function | `scripts/lib/sensitive-paths.mjs` | 137-140 | Returns the first regex pattern from a list that matches a normalized path, or null if none match. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`normalisePath`](../scripts/lib/sensitive-paths.mjs#L110) | function | `scripts/lib/sensitive-paths.mjs` | 110-116 | Normalizes a file path by lowercasing, removing drive letters and leading dots, and converting backslashes to forward slashes. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
| [`resolveAndClassify`](../scripts/lib/sensitive-paths.mjs#L179) | function | `scripts/lib/sensitive-paths.mjs` | 179-245 | <no body> | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +11 more |
...
| [`dupHash`](../scripts/lib/solo-control/cluster-propose.mjs#L46) | function | `scripts/lib/solo-control/cluster-propose.mjs` | 46-49 | Generates a 10-character SHA256 hash from category/file/detail for finding deduplication. | `scripts/solo-control-audit.mjs` |
| [`dupHashClusters`](../scripts/lib/solo-control/cluster-propose.mjs#L53) | function | `scripts/lib/solo-control/cluster-propose.mjs` | 53-60 | Groups rows by dupHash, returning a map from hash to array of original indices. | `scripts/solo-control-audit.mjs` |
| [`proposeChunk`](../scripts/lib/solo-control/cluster-propose.mjs#L87) | function | `scripts/lib/solo-control/cluster-propose.mjs` | 87-138 | Clusters findings via LLM with dupHash fallback, handling secrets and redaction. | `scripts/solo-control-audit.mjs` |
| [`proposeClusters`](../scripts/lib/solo-control/cluster-propose.mjs#L150) | function | `scripts/lib/solo-control/cluster-propose.mjs` | 150-182 | Batches findings into LLM-processable chunks, clustering non-sensitive rows and separately dupHash-clustering sensitive rows. | `scripts/solo-control-audit.mjs` |
| [`bestLabel`](../scripts/lib/solo-control/scoring.mjs#L21) | function | `scripts/lib/solo-control/scoring.mjs` | 21-21 | Returns the label with higher rank from two candidates. | `scripts/solo-control-audit.mjs` |
| [`bootstrapCI`](../scripts/lib/solo-control/scoring.mjs#L140) | function | `scripts/lib/solo-control/scoring.mjs` | 140-153 | Computes 95% confidence interval for acceptance rate via weighted bootstrap resampling. | `scripts/solo-control-audit.mjs` |
| [`htAcceptedRate`](../scripts/lib/solo-control/scoring.mjs#L130) | function | `scripts/lib/solo-control/scoring.mjs` | 130-138 | Calculates Horvitz-Thompson weighted acceptance rate accounting for inclusion probability. | `scripts/solo-control-audit.mjs` |
| [`mulberry32`](../scripts/lib/solo-control/scoring.mjs#L117) | function | `scripts/lib/solo-control/scoring.mjs` | 117-125 | Seedable 32-bit pseudo-random number generator using bitwise operations. | `scripts/solo-control-audit.mjs` |
| [`scoreArms`](../scripts/lib/solo-control/scoring.mjs#L32) | function | `scripts/lib/solo-control/scoring.mjs` | 32-105 | Computes per-arm weighted scores by collapsing duplicates and applying label and severity factors. | `scripts/solo-control-audit.mjs` |
| [`scoreMediumSampleWeighted`](../scripts/lib/solo-control/scoring.mjs#L165) | function | `scripts/lib/solo-control/scoring.mjs` | 165-178 | Scores arms from sampled labeled rows using Horvitz-Thompson weighting and bootstrap confidence intervals. | `scripts/solo-control-audit.mjs` |
| [`sevWeight`](../scripts/lib/solo-control/scoring.mjs#L15) | function | `scripts/lib/solo-control/scoring.mjs` | 15-15 | Maps severity level string to numeric weight. | `scripts/solo-control-audit.mjs` |
| [`matchesKnownDefect`](../scripts/lib/solo-control/stratified-sample.mjs#L32) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 32-42 | Checks if a finding belongs to a known-defect record by matching commit and file path. | `scripts/solo-control-audit.mjs` |
| [`mulberry32`](../scripts/lib/solo-control/stratified-sample.mjs#L46) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 46-54 | Creates a seeded Mulberry32 pseudo-random number generator. | `scripts/solo-control-audit.mjs` |
| [`seededShuffleCopy`](../scripts/lib/solo-control/stratified-sample.mjs#L57) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 57-64 | Returns a shuffled array copy using Fisher-Yates algorithm with a provided seeded RNG. | `scripts/solo-control-audit.mjs` |
| [`stratifiedMediumSample`](../scripts/lib/solo-control/stratified-sample.mjs#L81) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 81-154 | Stratified-samples clusters per-commit with caps and proportional allocation, rebalanced to exact target size. | `scripts/solo-control-audit.mjs` |
...
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L477) | function | `scripts/lib/sync-isolation-verify.mjs` | 477-490 | Formats gate results as human-readable text with checkmarks and error messages. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L421) | function | `scripts/lib/sync-isolation-verify.mjs` | 421-436 | Reports uncommitted git state to the operator (read-only, informational gate). | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L160) | function | `scripts/lib/sync-isolation-verify.mjs` | 160-221 | Verifies synced isolation-directory files aren't uncommitted or tracked in git. | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L223) | function | `scripts/lib/sync-isolation-verify.mjs` | 223-254 | Verifies all manifest-recorded synced files exist on disk with matching SHA-256 hashes. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L256) | function | `scripts/lib/sync-isolation-verify.mjs` | 256-281 | Checks that command-bearing files don't invoke source scripts that should be relocated. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L283) | function | `scripts/lib/sync-isolation-verify.mjs` | 283-347 | Verifies all CLI scripts pass their --selfcheck-relocation test and required imports work. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L349) | function | `scripts/lib/sync-isolation-verify.mjs` | 349-393 | Checks npm run scripts referenced in synced skill .md files don't invoke old script paths. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L395) | function | `scripts/lib/sync-isolation-verify.mjs` | 395-402 | Verifies the manifest layout is set to "isolated", the correct sync mode. | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L404) | function | `scripts/lib/sync-isolation-verify.mjs` | 404-419 | Checks the managed .gitignore block is properly formed with matching markers. | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L80) | function | `scripts/lib/sync-isolation-verify.mjs` | 80-83 | Computes SHA-256 hash of a file's contents for integrity verification. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L142) | function | `scripts/lib/sync-isolation-verify.mjs` | 142-152 | Returns all files in configured scan paths that might contain shell commands. | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L105) | function | `scripts/lib/sync-isolation-verify.mjs` | 105-124 | Reads and validates the consumer's sync manifest JSON against schema. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L492) | function | `scripts/lib/sync-isolation-verify.mjs` | 492-518 | Parses CLI arguments, runs verification gates, and exits with status codes matching the first failure or success. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L85) | function | `scripts/lib/sync-isolation-verify.mjs` | 85-103 | Parses command-line arguments into an options object with defaults. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L154) | function | `scripts/lib/sync-isolation-verify.mjs` | 154-156 | Converts an absolute path to forward-slash-separated relative path from consumer root. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L440) | function | `scripts/lib/sync-isolation-verify.mjs` | 440-467 | Orchestrates running a subset of verification gates and returns all results. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L469) | function | `scripts/lib/sync-isolation-verify.mjs` | 469-475 | Prints error message that --selfcheck-inventory is source-repo-only and exits. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L126) | function | `scripts/lib/sync-isolation-verify.mjs` | 126-140 | Generator yielding all file paths in a directory tree recursively. | _(internal)_ |
...
> Cloud persistence layer for architectural metadata—symbols, file imports, domain summaries—with queryable indices for neighbourhood search and import-graph dependency tracking.
...
_Domain has 155 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L298) | function | `scripts/lib/store/repo.mjs` | 298-313 | Retrieves a repo's row ID by name, preferring the most recently created match. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-243 | Looks up a repo's row ID by UUID with optional strict error re-throw for write callers. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Initializes cloud store connectivity and probes Supabase availability, logging success or configuration guidance. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks whether the cloud store is currently available and connected. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L323) | function | `scripts/lib/store/repo.mjs` | 323-332 | Retrieves all repo IDs from the cloud database in order. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`resolveRepoForStore`](../scripts/lib/store/repo.mjs#L142) | function | `scripts/lib/store/repo.mjs` | 142-203 | Resolves a repo to its canonical row ID using repo_uuid, upserting with profile metadata if needed. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`upsertRepo`](../scripts/lib/store/repo.mjs#L108) | function | `scripts/lib/store/repo.mjs` | 108-116 | Delegates to resolveRepoForStore for canonical repo identity resolution (deprecated direct path). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
| [`upsertRepoByUuid`](../scripts/lib/store/repo.mjs#L253) | function | `scripts/lib/store/repo.mjs` | 253-285 | Ensures a repo row exists for a given UUID+name, handling race conditions on concurrent inserts. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +19 more |
...
| [`_resetPassStatsRoundColumnCache`](../scripts/lib/store/runs-findings.mjs#L103) | function | `scripts/lib/store/runs-findings.mjs` | 103-105 | Resets the classification-columns cache to null. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`adjudicateFinalReviewFinding`](../scripts/lib/store/runs-findings.mjs#L434) | function | `scripts/lib/store/runs-findings.mjs` | 434-455 | Marks a shadow-only finding as accepted/dismissed with a user-action label. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`auditRunExists`](../scripts/lib/store/runs-findings.mjs#L465) | function | `scripts/lib/store/runs-findings.mjs` | 465-473 | Checks if an audit run exists in the database. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`columnExists`](../scripts/lib/store/runs-findings.mjs#L760) | function | `scripts/lib/store/runs-findings.mjs` | 760-784 | Checks if a table column exists, caching definitive answers but not transient errors. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`detectClassificationColumns`](../scripts/lib/store/runs-findings.mjs#L81) | function | `scripts/lib/store/runs-findings.mjs` | 81-93 | Checks if classification columns exist in audit_findings, caching definitive results and degrading on cloud-disabled. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`detectPassStatsRoundColumn`](../scripts/lib/store/runs-findings.mjs#L107) | function | `scripts/lib/store/runs-findings.mjs` | 107-119 | Checks if audit_pass_stats.round column exists, caching the result and warning on absences. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`getAuditRunConvergence`](../scripts/lib/store/runs-findings.mjs#L683) | function | `scripts/lib/store/runs-findings.mjs` | 683-700 | Fetches round convergence point and rigor-pressure data from an audit run. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`getFinalReviewStats`](../scripts/lib/store/runs-findings.mjs#L523) | function | `scripts/lib/store/runs-findings.mjs` | 523-572 | Aggregates final-review findings grouped by source model, bucket, and severity. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`getPassTimings`](../scripts/lib/store/runs-findings.mjs#L706) | function | `scripts/lib/store/runs-findings.mjs` | 706-734 | Computes average token usage and latency per audit pass across all runs. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`getRecentFindingsByRepo`](../scripts/lib/store/runs-findings.mjs#L859) | function | `scripts/lib/store/runs-findings.mjs` | 859-896 | Gets recent HIGH/MEDIUM findings for a repo, optionally filtered by repoId/name. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`getRunFindingOutcomeCounts`](../scripts/lib/store/runs-findings.mjs#L662) | function | `scripts/lib/store/runs-findings.mjs` | 662-681 | Retrieves adjudication summary (total, accepted/fixed, any adjudicated) for a run. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`getRunMeta`](../scripts/lib/store/runs-findings.mjs#L914) | function | `scripts/lib/store/runs-findings.mjs` | 914-940 | Fetches audit run metadata (plan file, verdict, rounds, commit, branch). | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`isUndefinedColumnError`](../scripts/lib/store/runs-findings.mjs#L38) | function | `scripts/lib/store/runs-findings.mjs` | 38-46 | Detects whether a database error indicates a definitively missing column or table (codes 42703 or 42P01). | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`markRunFindingsNeedsTriage`](../scripts/lib/store/runs-findings.mjs#L486) | function | `scripts/lib/store/runs-findings.mjs` | 486-507 | Sets findings to 'needs_triage' status when they lack user action and adjudication. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`normaliseBucket`](../scripts/lib/store/runs-findings.mjs#L286) | function | `scripts/lib/store/runs-findings.mjs` | 286-291 | Validates and coerces a bucket value to the known set or null. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`recordAdjudicationEvent`](../scripts/lib/store/runs-findings.mjs#L999) | function | `scripts/lib/store/runs-findings.mjs` | 999-1037 | Writes or updates an adjudication ruling and remediation state for a specific finding. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordFinalReviewFindings`](../scripts/lib/store/runs-findings.mjs#L389) | function | `scripts/lib/store/runs-findings.mjs` | 389-419 | Atomically replaces final-review findings, updating run metadata and recording primary and shadow passes. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordFindings`](../scripts/lib/store/runs-findings.mjs#L307) | function | `scripts/lib/store/runs-findings.mjs` | 307-363 | Writes audit findings with adaptive column selection for classification and model attribution. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordPassStats`](../scripts/lib/store/runs-findings.mjs#L584) | function | `scripts/lib/store/runs-findings.mjs` | 584-605 | Records per-pass statistics (tokens, latency, finding counts) to audit_pass_stats. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordRunComplete`](../scripts/lib/store/runs-findings.mjs#L200) | function | `scripts/lib/store/runs-findings.mjs` | 200-234 | Updates an audit run with final statistics (findings counts, verdicts, costs, cache metrics). | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordRunStart`](../scripts/lib/store/runs-findings.mjs#L127) | function | `scripts/lib/store/runs-findings.mjs` | 127-194 | Creates or reuses an audit run record with repo-scoped validation to prevent cross-repo row reuse. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`recordSuppressionEvents`](../scripts/lib/store/runs-findings.mjs#L947) | function | `scripts/lib/store/runs-findings.mjs` | 947-986 | Records suppression and reopening events to track ledger-based finding decisions. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`updatePassStatsPostDeliberation`](../scripts/lib/store/runs-findings.mjs#L611) | function | `scripts/lib/store/runs-findings.mjs` | 611-642 | Updates final adjudication counts across all rounds, scoped by pass and optional round. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`updateRunMeta`](../scripts/lib/store/runs-findings.mjs#L240) | function | `scripts/lib/store/runs-findings.mjs` | 240-278 | Partially updates audit run metadata (verdict, round, model) with column-existence guards. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
> Node.js unit test fixtures and builders: temporary filesystem helpers (`mkRepo`, `writeTree`), code/config parsers, and test-data factories for setting up isolated test environments across 40+ test modules.
...
_Domain has 316 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`allIndicesCoveredOnce`](../tests/cluster-propose.test.mjs#L5) | function | `tests/cluster-propose.test.mjs` | 5-9 | Asserts that clustered indices partition the input rows exactly once (no duplication). | _(internal)_ |
...
| [`fileDiff`](../tests/solo-control-chunk-diff.test.mjs#L19) | function | `tests/solo-control-chunk-diff.test.mjs` | 19-26 | Generates a unified diff format string for a file given hunk lines. | _(internal)_ |
