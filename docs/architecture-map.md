...
- Generated: 2026-07-13T05:13:09.182Z   commit: 7699662b9e52   refresh_id: fa7a3bb8-ae27-4469-a439-e586559684fb
...
> Coordinates the multi-round audit pipeline: spawns GPT code/plan audit passes as child processes, parses results between rounds, detects convergence when findings plateau, and orchestrates the mandatory Gemini final review gate.
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L2933) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 2933-2991 | Assembles audit context with provider handles, tiered-pipeline adapters, and runtime configuration. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L236) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 236-247 | Atomically writes single pass result to cache with atomic temp-file rename. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L249) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 249-254 | Caches all pass results in a wave and logs cache directory path. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L256) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 256-259 | Recursively removes temporary cache directory. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L362) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 362-407 | Decides whether to seed OpenAI prefix cache and selects smallest unit for warming. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L981) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 981-1051 | Converts architecture report violations and unmapped files into structured findings with FindingSchema. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`finalizePriorRoundOutcomes`](../scripts/lib/audit/legacy-production-audit.mjs#L1062) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1062-1100 | Captures outcomes and labels from prior audit round to Supabase before running round N. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L913) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 913-962 | Formats architecture violations, unmapped files, and dead intent sections for LLM analysis. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L226) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 226-234 | Creates temporary pass-result cache directory for crash-safe intermediate storage. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L263) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 263-265 | Normalizes findings for output display using semantic IDs for deduplication. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L786) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 786-808 | Converts orphan-introduced finding to standard Finding schema with ID, severity, and recommendation. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L641) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 641-776 | Runs architecture intent validation against domain-map rules, detecting violations and unmapped files. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1126) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1126-2897 | Main orchestrator: runs all audit passes, manages finding convergence, ledger updates, and cloud sync. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L441) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 441-623 | Orchestrates map phase with optional cache-seeding, concurrency limits, and result reconstruction. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L412) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 412-439 | Executes GPT audit on one map-reduce unit with slot-based concurrency control. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L827) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 827-906 | Detects files made unreachable by the diff (born-orphan or orphaned by code changes). | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L167) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 167-171 | Determines if file count or total context exceeds thresholds requiring map-reduce chunking. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L178) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 178-182 | Checks if context size warrants map-reduce for high-reasoning passes with higher thresholds. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L345) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 345-351 | Re-throws configuration errors from settled promises to surface programmer bugs immediately. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L285) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 285-317 | Validates ledger exists, is parseable JSON, and contains valid entries for round 2+. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L632) | function | `scripts/lib/schemas.mjs` | 632-648 | Validates deferred reason entries include required sub-fields (blockedBy, followupPr, approver, etc.). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`normalizeFindingEvidence`](../scripts/lib/schemas.mjs#L223) | function | `scripts/lib/schemas.mjs` | 223-233 | Extracts and normalizes evidence status (commission/omission/missing) and anchors from a finding. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L316) | function | `scripts/lib/schemas.mjs` | 316-333 | Removes Gemini-unsupported JSON Schema keywords and name-map nesting from JSON schema objects. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L342) | function | `scripts/lib/schemas.mjs` | 342-345 | Converts Zod schema to Gemini-compatible JSON Schema via zod.toJSONSchema plus keyword stripping. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +19 more |
