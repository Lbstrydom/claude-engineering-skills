...
- Generated: 2026-07-14T18:18:13.726Z   commit: 9dea8666f5f3   refresh_id: a4fd234f-812a-4664-a249-99a2da71c96f
...
> CLI dispatcher and cross-skill data bridge: parses subcommands, routes findings/plans/specs to the Supabase learning store, and coordinates state flow across the audit, test, and planning skills.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`argAll`](../scripts/cross-skill.mjs#L153) | function | `scripts/cross-skill.mjs` | 153-159 | Collects all values following a repeated named flag. | _(internal)_ |
| [`argList`](../scripts/cross-skill.mjs#L147) | function | `scripts/cross-skill.mjs` | 147-150 | Parses a comma-separated flag value into an array. | _(internal)_ |
| [`argOption`](../scripts/cross-skill.mjs#L140) | function | `scripts/cross-skill.mjs` | 140-144 | Retrieves the value immediately following a named flag. | _(internal)_ |
| [`cmdAbortRefreshRun`](../scripts/cross-skill.mjs#L1867) | function | `scripts/cross-skill.mjs` | 1867-1877 | Cancels an in-progress symbol-index refresh run. | _(internal)_ |
...
| [`cmdArmEvalAdjudicate`](../scripts/cross-skill.mjs#L810) | function | `scripts/cross-skill.mjs` | 810-834 | Records human ranking of blind arm-eval outputs and archives the result. | _(internal)_ |
| [`cmdArmEvalDecision`](../scripts/cross-skill.mjs#L776) | function | `scripts/cross-skill.mjs` | 776-793 | Evaluates arm-eval results to recommend a winner or inconclusive verdict. | _(internal)_ |
| [`cmdArmEvalExport`](../scripts/cross-skill.mjs#L842) | function | `scripts/cross-skill.mjs` | 842-860 | Exports arm-eval sessions to disk as committed archives. | _(internal)_ |
| [`cmdArmEvalMaybeCapture`](../scripts/cross-skill.mjs#L901) | function | `scripts/cross-skill.mjs` | 901-917 | Fires arm-eval capture if toggled on, reports toggle-off silently. | _(internal)_ |
| [`cmdArmEvalRun`](../scripts/cross-skill.mjs#L754) | function | `scripts/cross-skill.mjs` | 754-773 | Executes a single arm-eval experiment session with multiple candidate arms. | _(internal)_ |
| [`cmdArmEvalStats`](../scripts/cross-skill.mjs#L796) | function | `scripts/cross-skill.mjs` | 796-807 | Lists arm-eval leaderboard across experiments and repos. | _(internal)_ |
| [`cmdArmEvalToggle`](../scripts/cross-skill.mjs#L868) | function | `scripts/cross-skill.mjs` | 868-893 | Enables/disables arm-eval experiment capture per repo and displays status. | _(internal)_ |
| [`cmdAuditEffectiveness`](../scripts/cross-skill.mjs#L584) | function | `scripts/cross-skill.mjs` | 584-591 | Reads audit precision/recall metrics for a repo. | _(internal)_ |
| [`cmdComputeDriftScore`](../scripts/cross-skill.mjs#L1971) | function | `scripts/cross-skill.mjs` | 1971-1982 | Calculates architectural drift score between code and intent. | _(internal)_ |
| [`cmdComputeTargetDomains`](../scripts/cross-skill.mjs#L1711) | function | `scripts/cross-skill.mjs` | 1711-1723 | Tags file paths with architectural domain classifications from rules. | _(internal)_ |
| [`cmdDetectStack`](../scripts/cross-skill.mjs#L1546) | function | `scripts/cross-skill.mjs` | 1546-1563 | Detects repository tech stack (language, frameworks, environment manager). | _(internal)_ |
| [`cmdFinalizeOutcomes`](../scripts/cross-skill.mjs#L972) | function | `scripts/cross-skill.mjs` | 972-1042 | Persists audit findings and ledger entries to the learning store with graceful degrade. | _(internal)_ |
| [`cmdFinalReviewAdjudicate`](../scripts/cross-skill.mjs#L630) | function | `scripts/cross-skill.mjs` | 630-644 | Marks a final-review finding as accepted or dismissed. | _(internal)_ |
| [`cmdFinalReviewStats`](../scripts/cross-skill.mjs#L595) | function | `scripts/cross-skill.mjs` | 595-628 | Retrieves final-review findings and renders a human-grade worksheet queue. | _(internal)_ |
| [`cmdFrictionLog`](../scripts/cross-skill.mjs#L2096) | function | `scripts/cross-skill.mjs` | 2096-2101 | Manages friction/quality log entries. | _(internal)_ |
| [`cmdGetActiveRefreshId`](../scripts/cross-skill.mjs#L1583) | function | `scripts/cross-skill.mjs` | 1583-1599 | Retrieves the active symbol-index refresh ID for a repo. | _(internal)_ |
| [`cmdGetCallersForFile`](../scripts/cross-skill.mjs#L1725) | function | `scripts/cross-skill.mjs` | 1725-1788 | Retrieves callers of a file from the indexed symbol import graph. | _(internal)_ |
| [`cmdGetFrictionNeighbourhood`](../scripts/cross-skill.mjs#L1700) | function | `scripts/cross-skill.mjs` | 1700-1709 | Finds similar friction entries via prompt or intent description. | _(internal)_ |
| [`cmdGetIncidentNeighbourhood`](../scripts/cross-skill.mjs#L1601) | function | `scripts/cross-skill.mjs` | 1601-1642 | Queries security incident memory for similar prior incidents matching a code change. | _(internal)_ |
| [`cmdGetNavFirstSeen`](../scripts/cross-skill.mjs#L536) | function | `scripts/cross-skill.mjs` | 536-551 | Looks up when nav-audit drift keys were first observed in history. | _(internal)_ |
| [`cmdGetNeighbourhood`](../scripts/cross-skill.mjs#L1790) | function | `scripts/cross-skill.mjs` | 1790-1833 | Queries architectural memory for similar code symbols by intent. | _(internal)_ |
| [`cmdGetPersonaSessionsByRepo`](../scripts/cross-skill.mjs#L1325) | function | `scripts/cross-skill.mjs` | 1325-1353 | Retrieves persona-test sessions for a repo with optional filtering. | _(internal)_ |
| [`cmdGetPersonaSessionsByUrl`](../scripts/cross-skill.mjs#L1518) | function | `scripts/cross-skill.mjs` | 1518-1544 | Queries persona test sessions for a specified app URL. | _(internal)_ |
| [`cmdGetReachabilityEvidence`](../scripts/cross-skill.mjs#L1360) | function | `scripts/cross-skill.mjs` | 1360-1394 | Extracts navigation click paths from persona sessions and validates response structure. | _(internal)_ |
| [`cmdGetRecentFindings`](../scripts/cross-skill.mjs#L1475) | function | `scripts/cross-skill.mjs` | 1475-1510 | Fetches recent audit findings from cloud storage, filtered by repo/limit/severity. | _(internal)_ |
| [`cmdLearningBackfillOutcomes`](../scripts/cross-skill.mjs#L2080) | function | `scripts/cross-skill.mjs` | 2080-2090 | Backfills missing audit outcome labels for decision points. | _(internal)_ |
| [`cmdLearningQuickfixStats`](../scripts/cross-skill.mjs#L2123) | function | `scripts/cross-skill.mjs` | 2123-2149 | Reads or rebuilds quickfix pattern detection stats cache. | _(internal)_ |
| [`cmdLearningRecord`](../scripts/cross-skill.mjs#L1999) | function | `scripts/cross-skill.mjs` | 1999-2038 | Records an audit decision point (choice context outcome) to learning store. | _(internal)_ |
| [`cmdLearningReplay`](../scripts/cross-skill.mjs#L2108) | function | `scripts/cross-skill.mjs` | 2108-2116 | Replays past learning decisions for evaluation. | _(internal)_ |
| [`cmdLearningStats`](../scripts/cross-skill.mjs#L2045) | function | `scripts/cross-skill.mjs` | 2045-2056 | Retrieves learning decision stats for a repo. | _(internal)_ |
| [`cmdLearningWeeklyReview`](../scripts/cross-skill.mjs#L2064) | function | `scripts/cross-skill.mjs` | 2064-2072 | Runs weekly decision-point review and digests feedback. | _(internal)_ |
| [`cmdListConsistencyCandidates`](../scripts/cross-skill.mjs#L343) | function | `scripts/cross-skill.mjs` | 343-356 | Lists persona-consistency regression spec candidates for a repo with age/recurrence filters. | _(internal)_ |
| [`cmdListLayeringViolationsForSnapshot`](../scripts/cross-skill.mjs#L1958) | function | `scripts/cross-skill.mjs` | 1958-1969 | Lists layering violations found in a refresh snapshot. | _(internal)_ |
| [`cmdListPersonas`](../scripts/cross-skill.mjs#L1050) | function | `scripts/cross-skill.mjs` | 1050-1061 | Lists personas defined for an app URL. | _(internal)_ |
| [`cmdListPersonaTestCandidates`](../scripts/cross-skill.mjs#L396) | function | `scripts/cross-skill.mjs` | 396-408 | Lists persona-test finding candidates for a repo with optional filtering. | _(internal)_ |
| [`cmdListSymbolsForSnapshot`](../scripts/cross-skill.mjs#L1945) | function | `scripts/cross-skill.mjs` | 1945-1956 | Lists all symbols indexed in a given refresh snapshot. | _(internal)_ |
| [`cmdListUnlockedFixes`](../scripts/cross-skill.mjs#L576) | function | `scripts/cross-skill.mjs` | 576-582 | Lists HIGH fixes without corresponding /ux-lock specs. | _(internal)_ |
| [`cmdMarkPersonaTestCandidateProposed`](../scripts/cross-skill.mjs#L410) | function | `scripts/cross-skill.mjs` | 410-422 | Marks a persona-test candidate as already-proposed to prevent duplicate work. | _(internal)_ |
| [`cmdModelAbAdjudicate`](../scripts/cross-skill.mjs#L655) | function | `scripts/cross-skill.mjs` | 655-726 | Presents a blinded model-A/B comparison queue for human judgment with optional suggestions. | _(internal)_ |
| [`cmdModelAbDecision`](../scripts/cross-skill.mjs#L929) | function | `scripts/cross-skill.mjs` | 929-950 | Evaluates model-A/B results against decision constants and frontier analysis. | _(internal)_ |
| [`cmdModelAbStats`](../scripts/cross-skill.mjs#L729) | function | `scripts/cross-skill.mjs` | 729-747 | Summarizes model-A/B shadow findings, per-arm cost/recall, and budget consumption. | _(internal)_ |
| [`cmdOpenRefreshRun`](../scripts/cross-skill.mjs#L1835) | function | `scripts/cross-skill.mjs` | 1835-1853 | Opens a new symbol-index refresh run for a repo. | _(internal)_ |
| [`cmdPersonaOutcomes`](../scripts/cross-skill.mjs#L1233) | function | `scripts/cross-skill.mjs` | 1233-1307 | Labels persona findings as fixed/dismissed/wont_fix/stale with optional rationale. | _(internal)_ |
| [`cmdPlanSatisfaction`](../scripts/cross-skill.mjs#L495) | function | `scripts/cross-skill.mjs` | 495-505 | Reads plan verification status and criteria that failed multiple consecutive runs. | _(internal)_ |
| [`cmdPreviewGate`](../scripts/cross-skill.mjs#L1449) | function | `scripts/cross-skill.mjs` | 1449-1457 | Evaluates whether a live-app change passes the preview gate (halt/warn/ok). | _(internal)_ |
| [`cmdPromoteRegressionSpec`](../scripts/cross-skill.mjs#L358) | function | `scripts/cross-skill.mjs` | 358-371 | Promotes a consistency candidate to a locked regression spec. | _(internal)_ |
| [`cmdPublishRefreshRun`](../scripts/cross-skill.mjs#L1855) | function | `scripts/cross-skill.mjs` | 1855-1865 | Publishes/finalizes a completed symbol-index refresh run. | _(internal)_ |
| [`cmdQuality`](../scripts/cross-skill.mjs#L1649) | function | `scripts/cross-skill.mjs` | 1649-1698 | Manages friction/quality issues (add, mirror, digest, link, session review). | _(internal)_ |
| [`cmdRecommendSkills`](../scripts/cross-skill.mjs#L1404) | function | `scripts/cross-skill.mjs` | 1404-1442 | Suggests which UX-audit skills to run based on file changes and audit findings. | _(internal)_ |
| [`cmdRecordCorrelation`](../scripts/cross-skill.mjs#L442) | function | `scripts/cross-skill.mjs` | 442-460 | Links a persona finding to an audit finding with severity and match details. | _(internal)_ |
| [`cmdRecordLayeringViolations`](../scripts/cross-skill.mjs#L1919) | function | `scripts/cross-skill.mjs` | 1919-1931 | Records architectural layering violations detected in a refresh. | _(internal)_ |
| [`cmdRecordNavAuditRun`](../scripts/cross-skill.mjs#L509) | function | `scripts/cross-skill.mjs` | 509-534 | Records a nav-audit run with findings counts, metadata, and scope. | _(internal)_ |
| [`cmdRecordPersonaSession`](../scripts/cross-skill.mjs#L1118) | function | `scripts/cross-skill.mjs` | 1118-1144 | Stores a persona-test run session and auto-correlates P0/P1 findings to audit findings. | _(internal)_ |
| [`cmdRecordPlanVerifyItems`](../scripts/cross-skill.mjs#L484) | function | `scripts/cross-skill.mjs` | 484-493 | Records per-criterion pass/fail outcomes for a verify run. | _(internal)_ |
| [`cmdRecordPlanVerifyRun`](../scripts/cross-skill.mjs#L462) | function | `scripts/cross-skill.mjs` | 462-482 | Records a /ux-lock verify run's overall results (total, passed, failed, skipped). | _(internal)_ |
| [`cmdRecordRegressionSpec`](../scripts/cross-skill.mjs#L273) | function | `scripts/cross-skill.mjs` | 273-341 | Records a regression test specification (locked or candidate) with pre-egress redaction. | _(internal)_ |
| [`cmdRecordRegressionSpecRun`](../scripts/cross-skill.mjs#L424) | function | `scripts/cross-skill.mjs` | 424-440 | Records a test run result (pass/fail) for a regression spec. | _(internal)_ |
| [`cmdRecordShipEvent`](../scripts/cross-skill.mjs#L553) | function | `scripts/cross-skill.mjs` | 553-574 | Records a ship outcome (passed/blocked/warned) with context and override details. | _(internal)_ |
| [`cmdRecordSymbolDefinitions`](../scripts/cross-skill.mjs#L1879) | function | `scripts/cross-skill.mjs` | 1879-1889 | Stores symbol definition records in the cloud index. | _(internal)_ |
| [`cmdRecordSymbolEmbedding`](../scripts/cross-skill.mjs#L1905) | function | `scripts/cross-skill.mjs` | 1905-1917 | Stores vector embeddings for a symbol definition. | _(internal)_ |
| [`cmdRecordSymbolIndex`](../scripts/cross-skill.mjs#L1891) | function | `scripts/cross-skill.mjs` | 1891-1903 | Persists symbol index rows for a refresh snapshot. | _(internal)_ |
| [`cmdResolveRepoIdentity`](../scripts/cross-skill.mjs#L1984) | function | `scripts/cross-skill.mjs` | 1984-1990 | Resolves repo UUID from cwd, optionally persisting it locally. | _(internal)_ |
| [`cmdSetActiveEmbeddingModel`](../scripts/cross-skill.mjs#L1933) | function | `scripts/cross-skill.mjs` | 1933-1943 | Updates the active embedding model for a repo. | _(internal)_ |
| [`cmdUpdatePlanStatus`](../scripts/cross-skill.mjs#L264) | function | `scripts/cross-skill.mjs` | 264-271 | Updates a plan's status in the learning store. | _(internal)_ |
| [`cmdUpsertPersonaTestCandidate`](../scripts/cross-skill.mjs#L375) | function | `scripts/cross-skill.mjs` | 375-394 | Records or increments a persona-test finding candidate by severity and surface. | _(internal)_ |
| [`cmdUpsertPlan`](../scripts/cross-skill.mjs#L234) | function | `scripts/cross-skill.mjs` | 234-262 | Stores or updates a plan in the learning store with optional arm-eval capture. | _(internal)_ |
| [`cmdWhoami`](../scripts/cross-skill.mjs#L1565) | function | `scripts/cross-skill.mjs` | 1565-1579 | Returns authentication status, current commit SHA, and branch name. | _(internal)_ |
| [`currentBranch`](../scripts/cross-skill.mjs#L183) | function | `scripts/cross-skill.mjs` | 183-188 | Returns the current Git branch name. | _(internal)_ |
| [`currentCommitSha`](../scripts/cross-skill.mjs#L176) | function | `scripts/cross-skill.mjs` | 176-181 | Returns the current Git HEAD commit SHA. | _(internal)_ |
| [`emitError`](../scripts/cross-skill.mjs#L169) | function | `scripts/cross-skill.mjs` | 169-172 | Outputs an error JSON object and exits the process. | _(internal)_ |
| [`gitChangedFiles`](../scripts/cross-skill.mjs#L1460) | function | `scripts/cross-skill.mjs` | 1460-1468 | Retrieves modified and untracked files from git. | _(internal)_ |
| [`hasFlag`](../scripts/cross-skill.mjs#L162) | function | `scripts/cross-skill.mjs` | 162-162 | Checks if a named flag is present in arguments. | _(internal)_ |
| [`main`](../scripts/cross-skill.mjs#L2234) | function | `scripts/cross-skill.mjs` | 2234-2258 | Dispatches subcommands with relocation smoke test handler. | _(internal)_ |
| [`parsePayload`](../scripts/cross-skill.mjs#L123) | function | `scripts/cross-skill.mjs` | 123-138 | Extracts JSON from `--json`, `--stdin`, or bare JSON argument. | _(internal)_ |
| [`resolveRepoId`](../scripts/cross-skill.mjs#L208) | function | `scripts/cross-skill.mjs` | 208-230 | Resolves a repository ID from payload or current repo, failing closed on transient DB errors. | _(internal)_ |
| [`resolveRepoIdentityQuiet`](../scripts/cross-skill.mjs#L920) | function | `scripts/cross-skill.mjs` | 920-926 | Attempts to get the repo UUID with silent fallback to null. | _(internal)_ |
| [`runAutoCorrelate`](../scripts/cross-skill.mjs#L1156) | function | `scripts/cross-skill.mjs` | 1156-1224 | Matches persona findings to candidate audit findings by exact and fuzzy hash. | _(internal)_ |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L700) | function | `scripts/lib/model-resolver.mjs` | 700-754 | CLI tool that resolves model sentinels to concrete IDs or displays live-vs-static catalog comparison. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L506) | function | `scripts/lib/model-resolver.mjs` | 506-511 | Clears all cached model catalogs and deprecation warnings. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L378) | function | `scripts/lib/model-resolver.mjs` | 378-392 | Compares parsed models by version, preview status, and date for ranking. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L461) | function | `scripts/lib/model-resolver.mjs` | 461-476 | Remaps deprecated model IDs to current equivalents with optional warning. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L356) | function | `scripts/lib/model-resolver.mjs` | 356-374 | Returns structured description (provider/family/tier/concrete ID) of a model. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L565) | function | `scripts/lib/model-resolver.mjs` | 565-572 | Fetches available Claude models from Anthropic's API endpoint. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L553) | function | `scripts/lib/model-resolver.mjs` | 553-563 | Fetches available Gemini models from Google's API and normalizes their naming. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L544) | function | `scripts/lib/model-resolver.mjs` | 544-551 | Retrieves available model IDs from OpenAI's models API endpoint. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L531) | function | `scripts/lib/model-resolver.mjs` | 531-542 | Wraps a fetch request with an abort timeout. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L520) | function | `scripts/lib/model-resolver.mjs` | 520-525 | Returns cached model IDs for a provider if the cache is still fresh. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L185) | function | `scripts/lib/model-resolver.mjs` | 185-187 | Tests if a model ID matches a sentinel format (e.g., latest-gpt). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L298) | function | `scripts/lib/model-resolver.mjs` | 298-304 | Maps parsed model components to logical tier (economy/standard/frontier). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L484) | function | `scripts/lib/model-resolver.mjs` | 484-490 | Merges live-fetched model catalog with static fallback pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L294) | function | `scripts/lib/model-resolver.mjs` | 294-296 | Attempts parsing a model ID as Claude, Gemini, or OpenAI. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L192) | function | `scripts/lib/model-resolver.mjs` | 192-205 | Parses Claude model ID into version/tier/variant components. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L208) | function | `scripts/lib/model-resolver.mjs` | 208-240 | Parses Gemini model ID into version/tier/alias components. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L243) | function | `scripts/lib/model-resolver.mjs` | 243-271 | Parses OpenAI/GPT model ID into version/variant/SKU components. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L423) | function | `scripts/lib/model-resolver.mjs` | 423-429 | Selects the newest Claude model of a tier from the pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L394) | function | `scripts/lib/model-resolver.mjs` | 394-403 | Selects the newest Gemini model of a tier from the pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L440) | function | `scripts/lib/model-resolver.mjs` | 440-451 | Selects the newest OpenAI model of a tier/variant from the pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickOssModel`](../scripts/lib/model-resolver.mjs#L413) | function | `scripts/lib/model-resolver.mjs` | 413-421 | Returns OSS model from env override or fallback pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L685) | function | `scripts/lib/model-resolver.mjs` | 685-693 | Maps a model ID to a normalized pricing-tier key for cost tracking. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L582) | function | `scripts/lib/model-resolver.mjs` | 582-608 | Refreshes cached model lists from all providers in parallel, falling back to the static pool on failure. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L622) | function | `scripts/lib/model-resolver.mjs` | 622-664 | Resolves a model sentinel like "latest-gpt" to a concrete model ID using live and static catalogs. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L339) | function | `scripts/lib/model-resolver.mjs` | 339-347 | Returns the sentinel for a logical tier and provider. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L498) | function | `scripts/lib/model-resolver.mjs` | 498-503 | Caches fetched model IDs from a provider in memory. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L672) | function | `scripts/lib/model-resolver.mjs` | 672-679 | Checks whether a model supports the reasoning_effort parameter. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L311) | function | `scripts/lib/model-resolver.mjs` | 311-332 | Classifies a model ID string into a logical tier category. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
