...
| [`auditSubjectFileGuard`](../scripts/lib/audit-scope.mjs#L185) | function | `scripts/lib/audit-scope.mjs` | 185-191 | Generates an error message when audit scope matched zero implementation files. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
| [`classifyFiles`](../scripts/lib/audit-scope.mjs#L147) | function | `scripts/lib/audit-scope.mjs` | 147-166 | Categorizes file paths into backend, frontend, or shared categories by regex pattern. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
| [`isAuditInfraFile`](../scripts/lib/audit-scope.mjs#L60) | function | `scripts/lib/audit-scope.mjs` | 60-67 | Checks if a file is audit infrastructure code (scripts/lib/ files). | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
| [`isSensitiveFile`](../scripts/lib/audit-scope.mjs#L21) | function | `scripts/lib/audit-scope.mjs` | 21-23 | Checks if a relative path is classified as sensitive (credentials, keys, env files). | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
| [`readFilesAsContext`](../scripts/lib/audit-scope.mjs#L110) | function | `scripts/lib/audit-scope.mjs` | 110-138 | Reads multiple files into formatted markdown context with per-file and total size budgets. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
| [`safeReadFile`](../scripts/lib/audit-scope.mjs#L82) | function | `scripts/lib/audit-scope.mjs` | 82-96 | Reads a file safely with checks for sensitivity, symlink escape, and size constraints. | `scripts/lib/diff-annotation.mjs`, `scripts/lib/file-io.mjs`, `scripts/lib/plan-paths.mjs` |
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L326) | function | `scripts/lib/config.mjs` | 326-395 | Builds Azure AI Foundry configuration from environment variables when endpoint is set. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +32 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L127) | function | `scripts/lib/config.mjs` | 127-140 | Normalizes a language name to a canonical form (js, ts, py, go, other). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +32 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Reads and validates an environment variable against an allowed set with fallback. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +32 more |
...
| [`_exec`](../scripts/lib/db/query.mjs#L393) | function | `scripts/lib/db/query.mjs` | 393-413 | Executes SQL queries through the active transaction client or connection pool, normalizing errors. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`buildDelete`](../scripts/lib/db/query.mjs#L373) | function | `scripts/lib/db/query.mjs` | 373-378 | Constructs a SQL DELETE statement with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`buildInsert`](../scripts/lib/db/query.mjs#L193) | function | `scripts/lib/db/query.mjs` | 193-207 | Constructs a parameterized INSERT SQL statement from a single-row object. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`buildUpdate`](../scripts/lib/db/query.mjs#L347) | function | `scripts/lib/db/query.mjs` | 347-367 | Constructs a SQL UPDATE statement from a patch object with parameterized WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`buildUpsert`](../scripts/lib/db/query.mjs#L226) | function | `scripts/lib/db/query.mjs` | 226-297 | Constructs a parameterized INSERT ... ON CONFLICT UPDATE SQL statement from multiple rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`deleteWhere`](../scripts/lib/db/query.mjs#L516) | function | `scripts/lib/db/query.mjs` | 516-521 | Deletes rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`flattenWhere`](../scripts/lib/db/query.mjs#L314) | function | `scripts/lib/db/query.mjs` | 314-338 | Converts a WHERE clause object into SQL predicates and parameter bindings, rejecting undefined values. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`insertReturning`](../scripts/lib/db/query.mjs#L465) | function | `scripts/lib/db/query.mjs` | 465-473 | Inserts a row and optionally returns the inserted record. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`many`](../scripts/lib/db/query.mjs#L452) | function | `scripts/lib/db/query.mjs` | 452-455 | Executes a query and returns all rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`normalizeConflictTarget`](../scripts/lib/db/query.mjs#L130) | function | `scripts/lib/db/query.mjs` | 130-157 | Parses and validates an ON CONFLICT target (column list or constraint name). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`normalizeReturning`](../scripts/lib/db/query.mjs#L107) | function | `scripts/lib/db/query.mjs` | 107-116 | Validates and normalizes a RETURNING clause specification into SQL syntax. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`one`](../scripts/lib/db/query.mjs#L435) | function | `scripts/lib/db/query.mjs` | 435-442 | Executes a query and returns exactly one row or null, rejecting multiple results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`pgArray`](../scripts/lib/db/query.mjs#L55) | function | `scripts/lib/db/query.mjs` | 55-58 | Wraps a value to signal it should serialize as a Postgres ARRAY literal (not JSON). | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`query`](../scripts/lib/db/query.mjs#L422) | function | `scripts/lib/db/query.mjs` | 422-424 | Executes a SQL query and returns raw row results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`quoteIdent`](../scripts/lib/db/query.mjs#L78) | function | `scripts/lib/db/query.mjs` | 78-86 | SQL-quotes an identifier to safely include it in SQL statements. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`serializeWriteParam`](../scripts/lib/db/query.mjs#L62) | function | `scripts/lib/db/query.mjs` | 62-66 | Converts a parameter value for safe binding in INSERT/UPDATE SQL, handling jsonb arrays specially. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`updateWhere`](../scripts/lib/db/query.mjs#L502) | function | `scripts/lib/db/query.mjs` | 502-507 | Updates rows matching WHERE conditions and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`upsert`](../scripts/lib/db/query.mjs#L487) | function | `scripts/lib/db/query.mjs` | 487-492 | Inserts or updates multiple rows (UPSERT) and returns affected row count. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
| [`withTx`](../scripts/lib/db/query.mjs#L539) | function | `scripts/lib/db/query.mjs` | 539-587 | Executes a function within a database transaction, supporting nested savepoints for partial rollback. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +20 more |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L563) | function | `scripts/lib/model-resolver.mjs` | 563-611 | CLI entry point resolving sentinels or displaying live vs static model pools. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L379) | function | `scripts/lib/model-resolver.mjs` | 379-384 | Clears all cached model catalogs and deprecation warnings. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L279) | function | `scripts/lib/model-resolver.mjs` | 279-289 | Compares two parsed model versions for sorting, preferring newer/GA/undated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L334) | function | `scripts/lib/model-resolver.mjs` | 334-349 | Maps deprecated model IDs to current ones with optional warning. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L257) | function | `scripts/lib/model-resolver.mjs` | 257-275 | Returns a description object with provider, family, tier, and concrete model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L438) | function | `scripts/lib/model-resolver.mjs` | 438-445 | Fetches Anthropic's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L426) | function | `scripts/lib/model-resolver.mjs` | 426-436 | Fetches Google Generative AI model list, stripping the `models/` prefix. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L417) | function | `scripts/lib/model-resolver.mjs` | 417-424 | Fetches OpenAI's model list from their API. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L404) | function | `scripts/lib/model-resolver.mjs` | 404-415 | Fetches a URL with abort timeout. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L393) | function | `scripts/lib/model-resolver.mjs` | 393-398 | Returns cached live models for a provider if within TTL. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L97) | function | `scripts/lib/model-resolver.mjs` | 97-99 | Checks if a model ID is a sentinel like `latest-gpt` or `latest-opus`. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L199) | function | `scripts/lib/model-resolver.mjs` | 199-205 | Maps a parsed model object to its logical tier string (unknown/economy/standard/frontier). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L357) | function | `scripts/lib/model-resolver.mjs` | 357-363 | Merges live cached model catalog with static fallback pool, deduplicated. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L195) | function | `scripts/lib/model-resolver.mjs` | 195-197 | Attempts to parse a model ID as Claude, Gemini, or OpenAI, returning the first match. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L104) | function | `scripts/lib/model-resolver.mjs` | 104-117 | Parses a Claude model ID (e.g., claude-opus-4-6-20250101) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L120) | function | `scripts/lib/model-resolver.mjs` | 120-152 | Parses a Gemini model ID (e.g., gemini-2.0-flash-preview) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L155) | function | `scripts/lib/model-resolver.mjs` | 155-172 | Parses an OpenAI model ID (e.g., gpt-5.5-pro, o1-mini) into version/tier components. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L302) | function | `scripts/lib/model-resolver.mjs` | 302-308 | Selects the newest Claude model from a pool for a given tier. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L291) | function | `scripts/lib/model-resolver.mjs` | 291-300 | Selects the newest Gemini model from a pool for a tier, preferring Google's alias. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L314) | function | `scripts/lib/model-resolver.mjs` | 314-324 | Selects the newest OpenAI model from a pool for a tier and variant. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L548) | function | `scripts/lib/model-resolver.mjs` | 548-556 | Returns a simplified pricing tier key for a model ID. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L455) | function | `scripts/lib/model-resolver.mjs` | 455-481 | Fetches live model catalogs from all three providers in parallel, caching results. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L495) | function | `scripts/lib/model-resolver.mjs` | 495-527 | Resolves a sentinel or concrete model ID to concrete form, with static pool fallback. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L240) | function | `scripts/lib/model-resolver.mjs` | 240-248 | Returns a sentinel model ID string for a given logical tier and provider. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L371) | function | `scripts/lib/model-resolver.mjs` | 371-376 | Stores a provider's live model list in cache with fetch timestamp. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L535) | function | `scripts/lib/model-resolver.mjs` | 535-542 | Checks if a model is an o-series or GPT-5+ (reasoning capable). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L212) | function | `scripts/lib/model-resolver.mjs` | 212-233 | Classifies a model ID into a logical tier by parsing and remapping deprecated IDs first. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +11 more |
...
| [`buildClassificationRubric`](../scripts/lib/prompt-seeds.mjs#L129) | function | `scripts/lib/prompt-seeds.mjs` | 129-149 | Returns a template string documenting the required classification fields (sonarType, effort, sourceKind, sourceName) for audit findings. | `scripts/gemini-review.mjs`, `scripts/openai-audit.mjs` |
...
| [`enforceDeferredReasonRequiredFields`](../scripts/lib/schemas.mjs#L263) | function | `scripts/lib/schemas.mjs` | 263-279 | Validates that each deferred debt entry provides required supporting fields matching its deferredReason (blockedBy, followupPr, etc.). | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +11 more |
| [`stripJsonSchemaExtras`](../scripts/lib/schemas.mjs#L123) | function | `scripts/lib/schemas.mjs` | 123-132 | Recursively cleans an object by removing keys from a denylist, handling nested arrays and objects. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +11 more |
| [`zodToGeminiSchema`](../scripts/lib/schemas.mjs#L141) | function | `scripts/lib/schemas.mjs` | 141-144 | Converts a Zod schema to a JSON Schema compatible with Gemini's `responseSchema` parameter. | `scripts/cross-skill.mjs`, `scripts/debt-review.mjs`, `scripts/evolve-prompts.mjs`, +11 more |
| [`redactFields`](../scripts/lib/secret-patterns.mjs#L111) | function | `scripts/lib/secret-patterns.mjs` | 111-124 | Redacts specified object fields containing secrets and returns the modified object and matches. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +14 more |
| [`redactSecrets`](../scripts/lib/secret-patterns.mjs#L80) | function | `scripts/lib/secret-patterns.mjs` | 80-103 | Redacts secret patterns in text with placeholder labels, preserving context or capturing groups. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +14 more |
| [`scanForSecrets`](../scripts/lib/secret-patterns.mjs#L54) | function | `scripts/lib/secret-patterns.mjs` | 54-67 | Scans text for secret patterns and returns matched pattern names without modifying the text. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +14 more |
...
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L476) | function | `scripts/lib/sync-isolation-verify.mjs` | 476-489 | Entry point: parses CLI args, runs gates, formats output, exits with appropriate code. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L420) | function | `scripts/lib/sync-isolation-verify.mjs` | 420-435 | Orchestrates running selected verification gates and aggregates their results. | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L159) | function | `scripts/lib/sync-isolation-verify.mjs` | 159-220 | Detects uncommitted or staged synced files in git status or tracked-but-clean state. | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L222) | function | `scripts/lib/sync-isolation-verify.mjs` | 222-253 | Verifies every manifest entry file exists and matches its expected hash. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L255) | function | `scripts/lib/sync-isolation-verify.mjs` | 255-280 | Runs smoke-test commands on CLI scripts and probes library module imports. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L282) | function | `scripts/lib/sync-isolation-verify.mjs` | 282-346 | Scans synced skill markdown for stale ownership-confirmed node-scripts invocations. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L348) | function | `scripts/lib/sync-isolation-verify.mjs` | 348-392 | Validates that the sync manifest declares `layout: "isolated"`. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L394) | function | `scripts/lib/sync-isolation-verify.mjs` | 394-401 | Checks the .gitignore managed block is present, properly formed, and ordered. | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L403) | function | `scripts/lib/sync-isolation-verify.mjs` | 403-418 | Reports uncommitted git state entries (informational only, never blocks). | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L79) | function | `scripts/lib/sync-isolation-verify.mjs` | 79-82 | Computes SHA256 hash of a file. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L141) | function | `scripts/lib/sync-isolation-verify.mjs` | 141-151 | Scans configured paths for text files to check against command-pattern regex. | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L104) | function | `scripts/lib/sync-isolation-verify.mjs` | 104-123 | Loads and validates a sync manifest from the consumer root via Zod schema. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L491) | function | `scripts/lib/sync-isolation-verify.mjs` | 491-517 | Classifies a visual finding into a design-token family by property name pattern. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L84) | function | `scripts/lib/sync-isolation-verify.mjs` | 84-102 | Parses command-line arguments into an options object. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L153) | function | `scripts/lib/sync-isolation-verify.mjs` | 153-155 | Converts an absolute path to a relative path, normalizing backslashes to forward slashes. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L439) | function | `scripts/lib/sync-isolation-verify.mjs` | 439-466 | Prints an error message directing operators to use sync from the source repo only. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L468) | function | `scripts/lib/sync-isolation-verify.mjs` | 468-474 | Renders gate results as human-readable pass/fail lines with error details. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L125) | function | `scripts/lib/sync-isolation-verify.mjs` | 125-139 | Recursively yields all file paths in a directory tree. | _(internal)_ |
...
> Persists architectural metadata (symbol imports, domain summaries, similarity graphs) to the cloud database, supporting the symbol-index and architectural-memory systems with batch writes and contextual queries.
...
_Domain has 154 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`getUnlockedFixes`](../scripts/lib/store/plans-ship.mjs#L240) | function | `scripts/lib/store/plans-ship.mjs` | 240-254 | Retrieves recent HIGH-severity findings without a corresponding /ux-lock regression spec. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`listConsistencyCandidates`](../scripts/lib/store/plans-ship.mjs#L142) | function | `scripts/lib/store/plans-ship.mjs` | 142-173 | Retrieves candidate regression specs from the cloud database, optionally filtered by creation timestamp. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`promoteRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L180) | function | `scripts/lib/store/plans-ship.mjs` | 180-216 | Promotes a candidate regression spec to locked status, updating source_kind and recording promotion metadata. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readAuditEffectiveness`](../scripts/lib/store/plans-ship.mjs#L304) | function | `scripts/lib/store/plans-ship.mjs` | 304-312 | Retrieves audit effectiveness metrics (precision/recall) for a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readCorrelationsForFinding`](../scripts/lib/store/plans-ship.mjs#L293) | function | `scripts/lib/store/plans-ship.mjs` | 293-301 | Retrieves persona-audit correlations for a specific audit finding. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readCorrelationsForRun`](../scripts/lib/store/plans-ship.mjs#L282) | function | `scripts/lib/store/plans-ship.mjs` | 282-290 | Retrieves persona-audit correlations for a specific audit run. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readPersistentPlanFailures`](../scripts/lib/store/plans-ship.mjs#L393) | function | `scripts/lib/store/plans-ship.mjs` | 393-401 | Retrieves criteria that have failed in 2+ consecutive verification runs (persistent plan failures). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readPlanSatisfaction`](../scripts/lib/store/plans-ship.mjs#L382) | function | `scripts/lib/store/plans-ship.mjs` | 382-390 | Retrieves plan satisfaction metrics showing the latest verify run and failing P0/P1 criteria. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readShipEvents`](../scripts/lib/store/plans-ship.mjs#L440) | function | `scripts/lib/store/plans-ship.mjs` | 440-458 | Retrieves ship events for a repo, aggregated by outcome and as a time-series of recent events. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPersonaAuditCorrelation`](../scripts/lib/store/plans-ship.mjs#L262) | function | `scripts/lib/store/plans-ship.mjs` | 262-279 | Records a correlation between a persona finding and an audit finding for learning and bandit reward purposes. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPlanVerificationItems`](../scripts/lib/store/plans-ship.mjs#L342) | function | `scripts/lib/store/plans-ship.mjs` | 342-379 | Inserts individual verification items (per-criterion pass/fail results) for a verification run in batch. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPlanVerificationRun`](../scripts/lib/store/plans-ship.mjs#L319) | function | `scripts/lib/store/plans-ship.mjs` | 319-339 | Inserts a plan verification run record with criteria counts and returns its ID. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L69) | function | `scripts/lib/store/plans-ship.mjs` | 69-137 | Validates and inserts a regression spec (Playwright test candidate or locked) with witness snapshots and redaction tracking. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordRegressionSpecRun`](../scripts/lib/store/plans-ship.mjs#L219) | function | `scripts/lib/store/plans-ship.mjs` | 219-234 | Records a regression spec run result (pass/fail, duration, error) to the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordShipEvent`](../scripts/lib/store/plans-ship.mjs#L408) | function | `scripts/lib/store/plans-ship.mjs` | 408-429 | Records a /ship outcome (pushed/blocked/warned) with P0/P1 counts, missing specs, and override information. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`updatePlanStatus`](../scripts/lib/store/plans-ship.mjs#L45) | function | `scripts/lib/store/plans-ship.mjs` | 45-55 | Updates a plan's status field in the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`upsertPlan`](../scripts/lib/store/plans-ship.mjs#L22) | function | `scripts/lib/store/plans-ship.mjs` | 22-42 | Inserts or updates a plan record with skill, status, principles cited, and focus areas. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L298) | function | `scripts/lib/store/repo.mjs` | 298-313 | Retrieves a repo's row ID by name, preferring the most recently created match. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +17 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-243 | Looks up a repo's row ID by UUID with optional strict error re-throw for write callers. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +17 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Initializes cloud store connectivity and probes Supabase availability, logging success or configuration guidance. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +17 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks whether the cloud store is currently available and connected. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +17 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L323) | function | `scripts/lib/store/repo.mjs` | 323-332 | Retrieves all repo IDs from the cloud database in order. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +17 more |
