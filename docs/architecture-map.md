...
- Generated: 2026-07-14T06:59:02.514Z   commit: 0b1fb666c6c0   refresh_id: b4c6a331-1010-4b94-972b-20d5b997efd7
- Drift score: 43 / threshold 20   status: `RED`
- Domains: 23   Symbols: 3008   Layering violations: 0

## Contents
- [arch-memory](#arch-memory) — 54 symbols
- [audit-orchestration](#audit-orchestration) — 229 symbols
...
- [scripts](#scripts) — 280 symbols
- [shared-lib](#shared-lib) — 896 symbols
- [stores](#stores) — 208 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 378 symbols
...
> Orchestrates the fused audit pipeline—spawning GPT auditor, parsing results, enforcing mandatory Gemini final review—while managing artifact lifecycle (temp files, session IDs, stale cleanup).
...
_Domain has 229 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L3005) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 3005-3076 | Constructs the full context configuration for running a legacy audit, resolving models and tiered-pipeline flags. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L242) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 242-253 | Writes an audit pass result to disk cache atomically | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L255) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 255-260 | Caches audit pass results to disk and logs the count of cached passes. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L262) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 262-265 | Removes the cache directory and silently ignores any deletion errors. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L368) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 368-413 | Decides whether cache seeding is eligible based on env flag, unit count, and prefix size. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L987) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 987-1057 | Extracts violations, unmapped files, and dead intents into Finding objects with standard schemas. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L919) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 919-968 | Formats architecture violations and unmapped files into a markdown prompt block with clustering for large violation sets. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L232) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 232-240 | Initializes a temporary directory for caching audit pass results | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L269) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 269-271 | Delegates to a private normalization function with findings and semantic ID. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L792) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 792-814 | Converts an orphan-introduced finding to standard Finding schema format with justification. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L647) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 647-782 | Runs architecture audit using domain-map and intent files, returning violations and orphan findings. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1087) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1087-2969 | Main orchestrator that runs all five audit passes (structure, wiring, backend, frontend, sustainability) with multi-round R2+ support. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L447) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 447-629 | Orchestrates the parallel map phase of audit with concurrency control and optional cache-seed warm-up. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L418) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 418-445 | Acquires a concurrency slot, builds the audit context, calls GPT, and releases the slot. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L833) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 833-912 | Detects files orphaned by the diff by comparing against the head graph. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L173) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 173-177 | Decides if files should use map-reduce audit strategy based on count/size | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L184) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 184-188 | Decides if files should use map-reduce for high-reasoning audits | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L351) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 351-357 | Rethrows a config-category LlmError from a settled promise if present. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L291) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 291-323 | Validates the ledger file exists, parses its entries, and reports validity with entry counts. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`buildStage1TriagerPrompt`](../scripts/lib/audit/tiered-pipeline.mjs#L86) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 86-97 | Constructs system and user prompts for Stage 1 triager based on finding category/severity, evidence status, and quoted anchor text. | `scripts/openai-audit.mjs` |
| [`defaultTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L111) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 111-124 | Calls GPT (default triager) with Stage 1 triager prompt and returns the structured dismissal response. | `scripts/openai-audit.mjs` |
| [`runTieredAuditPipeline`](../scripts/lib/audit/tiered-pipeline.mjs#L154) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 154-436 | Orchestrates the full tiered pipeline: discovery → Stage 0 deterministic filter → Stage 1 cheap triage → Stage 2 Gemini adjudication with multi-phase scheduling. | `scripts/openai-audit.mjs` |
| [`validatedTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L138) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 138-148 | Calls a pre-validated cheap model (GLM, etc.) with Stage 1 triager prompt via OSS routing. | `scripts/openai-audit.mjs` |
...
> Orchestrates skill discovery, manifest building (with file-integrity verification via SHA hashing), and version alignment between the source repo and synced consumer deployments.
...
_Domain has 136 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L436) | function | `scripts/sync-to-repos.mjs` | 436-444 | Lists all .prompt.md files from .github/prompts. | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L334) | function | `scripts/sync-to-repos.mjs` | 334-351 | Recursively walks scripts/ and .claude/ to build a set of all project files. | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L397) | function | `scripts/sync-to-repos.mjs` | 397-409 | Enumerates skill files into .claude/skills/ (and optionally .github/skills/). | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L466) | function | `scripts/sync-to-repos.mjs` | 466-473 | Resolves the full file bundle for a specific consumer repo. | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L513) | function | `scripts/sync-to-repos.mjs` | 513-524 | Recursively merges a source object into a target, preserving nested structure. | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L528) | function | `scripts/sync-to-repos.mjs` | 528-1057 | Syncs audit-loop tooling to consumer repos with dry-run and check modes. | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L1059) | function | `scripts/sync-to-repos.mjs` | 1059-1090 | Prompts user to update or create shared cloud configuration after sync. | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L354) | function | `scripts/sync-to-repos.mjs` | 354-357 | Reads a file from source repo root, returning null if missing. | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L381) | function | `scripts/sync-to-repos.mjs` | 381-386 | Filters unresolved imports to find real missing relative-path dependencies. | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L366) | function | `scripts/sync-to-repos.mjs` | 366-371 | Collects the import closure of entry points to resolve all required files. | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L482) | function | `scripts/sync-to-repos.mjs` | 482-489 | Computes the SHA-256 hash of a file. | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L234) | function | `scripts/sync-to-repos.mjs` | 234-244 | Lists SQL migration files from supabase/migrations. | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L491) | function | `scripts/sync-to-repos.mjs` | 491-504 | Generates a unified diff between two files using git. | _(internal)_ |
...
> CLI entry points that orchestrate an LLM-powered development workflow spanning planning, code audit, UX testing, and deployment; plus tooling for architecture indexing, database operations, and consumer-repo synchronization.
...
_Domain has 280 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
> Utility and orchestration layer: Anthropic client factories (SDK/CLI backends with credential redaction and timeout handling), configuration resolution, text utilities, and adjudication-workflow rendering for the multi-pass audit pipeline.
...
_Domain has 896 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L525) | function | `scripts/lib/config.mjs` | 525-594 | Builds Azure AI Foundry configuration from environment variables with deployment and endpoint resolution. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +46 more |
| [`clampConfigNumber`](../scripts/lib/config.mjs#L76) | function | `scripts/lib/config.mjs` | 76-96 | Parses and clamps a numeric config value within specified bounds, with validation and fallback. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +46 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L253) | function | `scripts/lib/config.mjs` | 253-266 | Maps language names and aliases to normalized language codes. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +46 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Validates an enum environment variable against a set and returns it or a fallback value. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +46 more |
...
| [`embedText`](../scripts/lib/embed-text.mjs#L67) | function | `scripts/lib/embed-text.mjs` | 67-120 | Embeds text to a vector via Azure OpenAI or Gemini, with secret redaction. | `scripts/lib/neighbourhood-query.mjs`, `scripts/security-memory/refresh-incidents.mjs`, `scripts/symbol-index/embed.mjs` |
| [`providerTag`](../scripts/lib/embed-text.mjs#L50) | function | `scripts/lib/embed-text.mjs` | 50-54 | Returns a provider identifier (Azure deployment name or Gemini model name). | `scripts/lib/neighbourhood-query.mjs`, `scripts/security-memory/refresh-incidents.mjs`, `scripts/symbol-index/embed.mjs` |
| [`validateVector`](../scripts/lib/embed-text.mjs#L123) | function | `scripts/lib/embed-text.mjs` | 123-143 | Validates an embedding is correct dimension, finite, non-empty, and all-numeric. | `scripts/lib/neighbourhood-query.mjs`, `scripts/security-memory/refresh-incidents.mjs`, `scripts/symbol-index/embed.mjs` |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L673) | function | `scripts/lib/model-resolver.mjs` | 673-727 | CLI: resolves model sentinels and fetches/displays live model catalogs. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L479) | function | `scripts/lib/model-resolver.mjs` | 479-484 | Clears all cached model catalogs and deprecation-warning tracking. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L351) | function | `scripts/lib/model-resolver.mjs` | 351-365 | Compares two parsed models by major/minor version, then premium/preview/dated status for sorting. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L434) | function | `scripts/lib/model-resolver.mjs` | 434-449 | Remaps deprecated model IDs to current ones, optionally warning on first encounter. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L329) | function | `scripts/lib/model-resolver.mjs` | 329-347 | Returns provider, family, logical tier, and concrete model ID for any model identifier. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L538) | function | `scripts/lib/model-resolver.mjs` | 538-545 | Fetches available Anthropic model IDs from the API. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L526) | function | `scripts/lib/model-resolver.mjs` | 526-536 | Fetches available models from Google's /v1beta/models API and strips the models/ prefix. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L517) | function | `scripts/lib/model-resolver.mjs` | 517-524 | Fetches available models from OpenAI's /v1/models API. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L504) | function | `scripts/lib/model-resolver.mjs` | 504-515 | Fetches a URL with an abort-based timeout. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L493) | function | `scripts/lib/model-resolver.mjs` | 493-498 | Retrieves cached live model IDs if within the TTL window. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L158) | function | `scripts/lib/model-resolver.mjs` | 158-160 | Checks if a model ID is a logical sentinel (latest-gpt, latest-opus, etc.). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L271) | function | `scripts/lib/model-resolver.mjs` | 271-277 | Maps a parsed model's tier to a logical tier (economy/standard/frontier). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L457) | function | `scripts/lib/model-resolver.mjs` | 457-463 | Combines live-fetched catalog models with static fallback pool for a provider. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L267) | function | `scripts/lib/model-resolver.mjs` | 267-269 | Attempts to parse a model ID as Claude, Gemini, or OpenAI format, returning null if none match. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L165) | function | `scripts/lib/model-resolver.mjs` | 165-178 | Parses a Claude model ID into tier, major/minor version, and optional snapshot date. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L181) | function | `scripts/lib/model-resolver.mjs` | 181-213 | Parses a Gemini model ID including alias forms (gemini-pro-latest) and version/suffix variants. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L216) | function | `scripts/lib/model-resolver.mjs` | 216-244 | Parses an OpenAI model ID handling GPT variants (mini, pro, sol, terra, luna, o-series). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L396) | function | `scripts/lib/model-resolver.mjs` | 396-402 | Selects the newest Claude model of a given tier from a pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L367) | function | `scripts/lib/model-resolver.mjs` | 367-376 | Selects the newest Gemini model of a given tier from a pool, preferring the -latest alias. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L413) | function | `scripts/lib/model-resolver.mjs` | 413-424 | Selects the newest OpenAI model matching a variant (mini/plain/pro) from a pool. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pickOssModel`](../scripts/lib/model-resolver.mjs#L386) | function | `scripts/lib/model-resolver.mjs` | 386-394 | Selects an OSS model for a role with optional environment-variable override. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L658) | function | `scripts/lib/model-resolver.mjs` | 658-666 | Generates a pricing-tier key from a model ID for cost tracking. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L555) | function | `scripts/lib/model-resolver.mjs` | 555-581 | Refreshes cached model catalogs from providers, falling back to static pool on failure. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L595) | function | `scripts/lib/model-resolver.mjs` | 595-637 | Resolves a model sentinel or concrete ID by consulting live catalogs, with static pool fallback. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L312) | function | `scripts/lib/model-resolver.mjs` | 312-320 | Returns the sentinel model ID (e.g., latest-gpt) for a given logical tier and provider. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L471) | function | `scripts/lib/model-resolver.mjs` | 471-476 | Stores fetched model IDs in cache with timestamp, returning success/failure. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L645) | function | `scripts/lib/model-resolver.mjs` | 645-652 | Checks if a model supports reasoning-effort parameter (o1/o3 and GPT-5+). | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L284) | function | `scripts/lib/model-resolver.mjs` | 284-305 | Determines the logical tier (economy/standard/frontier) for any model ID with coarse OpenAI fallback. | `scripts/brainstorm-round.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/check-model-freshness.mjs`, +26 more |
...
| [`azureBaseUrl`](../scripts/lib/openai-client.mjs#L69) | function | `scripts/lib/openai-client.mjs` | 69-79 | Constructs the correct Azure API endpoint URL based on purpose. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +8 more |
| [`createOpenAIClient`](../scripts/lib/openai-client.mjs#L91) | function | `scripts/lib/openai-client.mjs` | 91-160 | Instantiates an OpenAI client with Azure/OSS/public routing. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +8 more |
| [`keyDigest`](../scripts/lib/openai-client.mjs#L60) | function | `scripts/lib/openai-client.mjs` | 60-62 | Creates a short SHA256 hash of an API key for cache keying. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +8 more |
| [`normalizeApiPath`](../scripts/lib/openai-client.mjs#L53) | function | `scripts/lib/openai-client.mjs` | 53-57 | Standardizes an API path to /openai/v1 format. | `scripts/azure-limits.mjs`, `scripts/cheap-triager-validate.mjs`, `scripts/gemini-review.mjs`, +8 more |
...
| [`_resetDebugBanner`](../scripts/lib/sensitive-paths.mjs#L472) | function | `scripts/lib/sensitive-paths.mjs` | 472-474 | Resets the debug-banner warning flag. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
| [`classifyPath`](../scripts/lib/sensitive-paths.mjs#L160) | function | `scripts/lib/sensitive-paths.mjs` | 160-166 | Classifies a path as sensitive, generated noise, or normal based on regex patterns. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
| [`defaultHash`](../scripts/lib/sensitive-paths.mjs#L404) | function | `scripts/lib/sensitive-paths.mjs` | 404-406 | Creates a truncated 8-character SHA256 hash of an input string. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
| [`emptyDiff`](../scripts/lib/sensitive-paths.mjs#L314) | function | `scripts/lib/sensitive-paths.mjs` | 314-316 | Returns an empty diff object with all action arrays initialized. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
| [`filterDiffFiles`](../scripts/lib/sensitive-paths.mjs#L330) | function | `scripts/lib/sensitive-paths.mjs` | 330-395 | Filters diff files to exclude sensitive paths, rewriting modified-to-sensitive entries as tombstones for cleanup. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
...
| [`matchingPattern`](../scripts/lib/sensitive-paths.mjs#L172) | function | `scripts/lib/sensitive-paths.mjs` | 172-175 | Returns the first regex pattern from a set that matches the given path. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
| [`normalisePath`](../scripts/lib/sensitive-paths.mjs#L145) | function | `scripts/lib/sensitive-paths.mjs` | 145-151 | Normalizes file paths to lowercase with forward slashes and removes leading directory prefixes. | `scripts/defect-harvest.mjs`, `scripts/lib/audit-scope.mjs`, `scripts/lib/audit/duplication-detector.mjs`, +16 more |
...
| [`collectDirectoryMd`](../scripts/lib/skill-packaging.mjs#L83) | function | `scripts/lib/skill-packaging.mjs` | 83-114 | Recursively collects Markdown files from a skill's references/ or examples/ subdirs up to one nesting level. | `scripts/build-manifest.mjs`, `scripts/lib/sync-inventory.mjs`, `scripts/regenerate-skill-copies.mjs`, +1 more |
| [`enumerateSkillFiles`](../scripts/lib/skill-packaging.mjs#L35) | function | `scripts/lib/skill-packaging.mjs` | 35-77 | Enumerates allowed files in a skill directory (SKILL.md, references/*, examples/*) and optionally strict-validates against unexpected entries. | `scripts/build-manifest.mjs`, `scripts/lib/sync-inventory.mjs`, `scripts/regenerate-skill-copies.mjs`, +1 more |
| [`isExcludedBasename`](../scripts/lib/skill-packaging.mjs#L116) | function | `scripts/lib/skill-packaging.mjs` | 116-118 | Checks if a filename matches exclusion patterns (e.g., .DS_Store). | `scripts/build-manifest.mjs`, `scripts/lib/sync-inventory.mjs`, `scripts/regenerate-skill-copies.mjs`, +1 more |
| [`listSkillNames`](../scripts/lib/skill-packaging.mjs#L125) | function | `scripts/lib/skill-packaging.mjs` | 125-132 | Lists all skill directories in the skills root that contain a SKILL.md file. | `scripts/build-manifest.mjs`, `scripts/lib/sync-inventory.mjs`, `scripts/regenerate-skill-copies.mjs`, +1 more |
...
| [`buildCopilotPromptFiles`](../scripts/lib/sync-inventory.mjs#L161) | function | `scripts/lib/sync-inventory.mjs` | 161-169 | Lists .prompt.md files from .github/prompts for Copilot integration. | `scripts/check-isolation-inventory.mjs` |
| [`buildFileUniverse`](../scripts/lib/sync-inventory.mjs#L186) | function | `scripts/lib/sync-inventory.mjs` | 186-203 | Recursively walks scripts/ and .claude/ directories to collect all file paths, excluding standard ignored directories. | `scripts/check-isolation-inventory.mjs` |
| [`buildSkillFiles`](../scripts/lib/sync-inventory.mjs#L147) | function | `scripts/lib/sync-inventory.mjs` | 147-159 | Enumerates skill source files under .claude/skills/ and optionally .github/skills/ for syncing. | `scripts/check-isolation-inventory.mjs` |
| [`bundleForRepo`](../scripts/lib/sync-inventory.mjs#L225) | function | `scripts/lib/sync-inventory.mjs` | 225-237 | Assembles the complete bundle of code, skills, prompts, and config files for a consumer repo. | `scripts/check-isolation-inventory.mjs` |
| [`getAllConsumerInventories`](../scripts/lib/sync-inventory.mjs#L259) | function | `scripts/lib/sync-inventory.mjs` | 259-266 | Generates sync inventories for all configured consumer repos. | `scripts/check-isolation-inventory.mjs` |
| [`getFileUniverse`](../scripts/lib/sync-inventory.mjs#L206) | function | `scripts/lib/sync-inventory.mjs` | 206-209 | Returns a cached copy of the complete file universe from buildFileUniverse. | `scripts/check-isolation-inventory.mjs` |
| [`getSyncInventoryForRepo`](../scripts/lib/sync-inventory.mjs#L246) | function | `scripts/lib/sync-inventory.mjs` | 246-251 | Looks up a consumer repo by name or alias and returns its sync inventory. | `scripts/check-isolation-inventory.mjs` |
| [`readSource`](../scripts/lib/sync-inventory.mjs#L211) | function | `scripts/lib/sync-inventory.mjs` | 211-214 | Safely reads a source file by relative path, returning null if missing. | `scripts/check-isolation-inventory.mjs` |
| [`resolveBundle`](../scripts/lib/sync-inventory.mjs#L216) | function | `scripts/lib/sync-inventory.mjs` | 216-223 | Collects the import closure of entry points and merges with additional assets. | `scripts/check-isolation-inventory.mjs` |
| [`syncMigrations`](../scripts/lib/sync-inventory.mjs#L135) | function | `scripts/lib/sync-inventory.mjs` | 135-145 | Lists SQL migration files from supabase/migrations directory in sorted order. | `scripts/check-isolation-inventory.mjs` |
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L494) | function | `scripts/lib/sync-isolation-verify.mjs` | 494-507 | Formats gate results as human-readable text showing pass/fail status and details. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L438) | function | `scripts/lib/sync-isolation-verify.mjs` | 438-453 | Reports uncommitted changes in git status (informational only, no enforcement). | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L169) | function | `scripts/lib/sync-isolation-verify.mjs` | 169-230 | Verifies that scripts/.claude-skills/ files are neither tracked nor staged in git. | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L232) | function | `scripts/lib/sync-isolation-verify.mjs` | 232-264 | Checks all manifest entries against their expected SHA256 hashes on disk. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L266) | function | `scripts/lib/sync-isolation-verify.mjs` | 266-295 | Scans command-bearing files for stale ownership-verified paths. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L297) | function | `scripts/lib/sync-isolation-verify.mjs` | 297-361 | Tests CLI smoke checks and verifies library imports function in the relocated context. | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L363) | function | `scripts/lib/sync-isolation-verify.mjs` | 363-410 | Reconciles npm run scripts referenced in manifests against package.json. | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L412) | function | `scripts/lib/sync-isolation-verify.mjs` | 412-419 | Validates the manifest's layout field equals "isolated". | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L421) | function | `scripts/lib/sync-isolation-verify.mjs` | 421-436 | Verifies the consumer's .gitignore contains the required managed block markers. | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L83) | function | `scripts/lib/sync-isolation-verify.mjs` | 83-86 | Computes the SHA256 hash of a file's raw bytes. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L151) | function | `scripts/lib/sync-isolation-verify.mjs` | 151-161 | Returns all files in the consumer repo that may contain shell commands (package.json, scripts, docs). | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L108) | function | `scripts/lib/sync-isolation-verify.mjs` | 108-127 | Loads and validates the .sync-manifest.json file, checking schema compliance. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L509) | function | `scripts/lib/sync-isolation-verify.mjs` | 509-535 | Entry point that parses arguments, runs verification gates, and exits with appropriate code. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L88) | function | `scripts/lib/sync-isolation-verify.mjs` | 88-106 | Parses command-line arguments for the sync-isolation-verify script. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L163) | function | `scripts/lib/sync-isolation-verify.mjs` | 163-165 | Converts an absolute path to a relative path from the consumer root. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L457) | function | `scripts/lib/sync-isolation-verify.mjs` | 457-484 | Executes a sequence of isolation-verification gates and returns their results. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L486) | function | `scripts/lib/sync-isolation-verify.mjs` | 486-492 | Prints an error directing the user to run inventory check from the source repo. | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L129) | function | `scripts/lib/sync-isolation-verify.mjs` | 129-149 | Recursively yields all file paths in a directory tree using a depth-first stack walk. | _(internal)_ |
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L298) | function | `scripts/lib/store/repo.mjs` | 298-313 | Looks up the most recently created audit_repos row by name. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-243 | Looks up an audit_repos row by uuid, optionally throwing on DB errors if strict mode is enabled. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Probes cloud connectivity via Supabase DSN from environment variables and logs the result. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks whether the cloud Postgres pool is available without throwing. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L323) | function | `scripts/lib/store/repo.mjs` | 323-332 | Returns all audit_repos ids in the cloud store. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`resolveRepoForStore`](../scripts/lib/store/repo.mjs#L142) | function | `scripts/lib/store/repo.mjs` | 142-203 | Resolves or creates an audit_repos row by uuid, updating profile if provided and returning repo id and identity. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`upsertRepo`](../scripts/lib/store/repo.mjs#L108) | function | `scripts/lib/store/repo.mjs` | 108-116 | Deprecated: delegates to resolveRepoForStore for unified repo identity management. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`upsertRepoByUuid`](../scripts/lib/store/repo.mjs#L253) | function | `scripts/lib/store/repo.mjs` | 253-285 | Inserts a new audit_repos row by uuid with race-condition handling or returns existing id. | `scripts/gemini-review.mjs`, `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +29 more |
| [`_resetClassificationColumnCache`](../scripts/lib/store/runs-findings.mjs#L52) | function | `scripts/lib/store/runs-findings.mjs` | 52-54 | Clears the cached classification column detection state. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
| [`_resetPassStatsRoundColumnCache`](../scripts/lib/store/runs-findings.mjs#L103) | function | `scripts/lib/store/runs-findings.mjs` | 103-105 | Clears the cached audit_pass_stats.round column detection state. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`auditRunExists`](../scripts/lib/store/runs-findings.mjs#L508) | function | `scripts/lib/store/runs-findings.mjs` | 508-516 | Checks if an audit_runs row with the given id exists. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`isUndefinedColumnError`](../scripts/lib/store/runs-findings.mjs#L38) | function | `scripts/lib/store/runs-findings.mjs` | 38-46 | Checks if a Postgres error indicates a missing column or table (42703 or 42P01). | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`normaliseBucket`](../scripts/lib/store/runs-findings.mjs#L313) | function | `scripts/lib/store/runs-findings.mjs` | 313-318 | Coerces a bucket value to a valid enum or null, logging unexpected values. | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
| [`recordRunComplete`](../scripts/lib/store/runs-findings.mjs#L200) | function | `scripts/lib/store/runs-findings.mjs` | 200-234 | Updates an audit_runs row with final stats (rounds, verdict, cost, findings counts). | `scripts/learning-store.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +1 more |
...
> Node.js test suite for deterministic seams (schemas, file-I/O, VCS, sync paths, bandit, ledger, anthropic-client) and hard-test gates (sensitive-path egress, consumer sync/relocation). Tests arch-intent parsing across languages, adjudication workflows, and provides ephemeral fixture builders (writeTree, mkRepo, makePlanFixture).
...
_Domain has 378 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`write`](../tests/skill-packaging.test.mjs#L12) | function | `tests/skill-packaging.test.mjs` | 12-16 | Writes a file at a relative path, creating parent directories as needed. | _(internal)_ |
