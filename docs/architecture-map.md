...
> Tags files with architectural domains using glob-pattern rules from domain-map.json, validates @duplicate-justification pragmas across the codebase, and identifies thin-wrapper functions to support symbol-deduplication detection.
...
| [`findStalePragmas`](../scripts/lib/symbol-index/stale-pragma-sweep.mjs#L49) | function | `scripts/lib/symbol-index/stale-pragma-sweep.mjs` | 49-91 | Scans the codebase for @duplicate-justification pragmas whose targets no longer exist. | `scripts/symbol-index/drift.mjs` |
| [`renderStalePragmaSection`](../scripts/lib/symbol-index/stale-pragma-sweep.mjs#L94) | function | `scripts/lib/symbol-index/stale-pragma-sweep.mjs` | 94-101 | Formats stale pragmas as a markdown table for inclusion in drift reports. | `scripts/symbol-index/drift.mjs` |
...
| [`atomicWrite`](../scripts/symbol-index/drift.mjs#L43) | function | `scripts/symbol-index/drift.mjs` | 43-49 | Atomically writes content to a file by creating a temp file and renaming it. | _(internal)_ |
| [`classify`](../scripts/symbol-index/drift.mjs#L51) | function | `scripts/symbol-index/drift.mjs` | 51-55 | Classifies a drift score into GREEN/AMBER/RED buckets based on threshold tiers. | _(internal)_ |
| [`main`](../scripts/symbol-index/drift.mjs#L76) | function | `scripts/symbol-index/drift.mjs` | 76-147 | CLI entry point that computes architectural drift score and renders a drift report. | _(internal)_ |
| [`parseArgs`](../scripts/symbol-index/drift.mjs#L34) | function | `scripts/symbol-index/drift.mjs` | 34-41 | Parses --out and --json CLI flags from argv. | _(internal)_ |
| [`renderMarkdownViaShared`](../scripts/symbol-index/drift.mjs#L61) | function | `scripts/symbol-index/drift.mjs` | 61-74 | Renders drift issue data as markdown via a shared helper function. | _(internal)_ |
...
| [`logErr`](../scripts/symbol-index/refresh.mjs#L83) | function | `scripts/symbol-index/refresh.mjs` | 83-83 | Writes an error message prefixed with [refresh] to stderr. | _(internal)_ |
| [`logOk`](../scripts/symbol-index/refresh.mjs#L84) | function | `scripts/symbol-index/refresh.mjs` | 84-84 | Writes a success message prefixed with [refresh] to stderr. | _(internal)_ |
| [`main`](../scripts/symbol-index/refresh.mjs#L121) | function | `scripts/symbol-index/refresh.mjs` | 121-478 | CLI entry point that refreshes the architectural symbol index from source code. | _(internal)_ |
| [`parseArgs`](../scripts/symbol-index/refresh.mjs#L71) | function | `scripts/symbol-index/refresh.mjs` | 71-81 | Parses --full, --since-commit, --force, and --include-delegates CLI flags. | _(internal)_ |
| [`runWithHeartbeat`](../scripts/symbol-index/refresh.mjs#L112) | function | `scripts/symbol-index/refresh.mjs` | 112-119 | Runs an async function while sending periodic heartbeat pings to the database. | _(internal)_ |
| [`sibling`](../scripts/symbol-index/refresh.mjs#L69) | function | `scripts/symbol-index/refresh.mjs` | 69-69 | Returns the absolute path to a sibling script file in the same directory. | _(internal)_ |
| [`throwVcsError`](../scripts/symbol-index/refresh.mjs#L95) | function | `scripts/symbol-index/refresh.mjs` | 95-102 | Formats and throws a structured VCS error with code, message, and optional cause. | _(internal)_ |
...
| [`defaultAdapters`](../scripts/lib/audit/duplication-detector.mjs#L71) | function | `scripts/lib/audit/duplication-detector.mjs` | 71-103 | Factory returning default implementations for symbol extraction, git access, embeddings, and database queries. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`extractViaSubprocess`](../scripts/lib/audit/duplication-detector.mjs#L111) | function | `scripts/lib/audit/duplication-detector.mjs` | 111-123 | Spawns a subprocess to extract symbols from a file list via symbol-index. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`findPragmaAbove`](../scripts/lib/audit/duplication-detector.mjs#L143) | function | `scripts/lib/audit/duplication-detector.mjs` | 143-151 | Scans lines above a symbol declaration for a `@duplicate-justification` pragma. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`isEligibleChange`](../scripts/lib/audit/duplication-detector.mjs#L153) | function | `scripts/lib/audit/duplication-detector.mjs` | 153-158 | Checks if a file change is eligible for duplication analysis (not deleted, not excluded, correct extension). | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`log`](../scripts/lib/audit/duplication-detector.mjs#L68) | function | `scripts/lib/audit/duplication-detector.mjs` | 68-68 | Writes a message to stderr prefixed with duplication-detector. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`runDuplicationAnalysis`](../scripts/lib/audit/duplication-detector.mjs#L168) | function | `scripts/lib/audit/duplication-detector.mjs` | 168-334 | Orchestrates the full duplication pipeline: pre-filter, extract, semantic match, and LLM adjudication. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`symKey`](../scripts/lib/audit/duplication-detector.mjs#L133) | function | `scripts/lib/audit/duplication-detector.mjs` | 133-135 | Generates a unique key from file path, symbol name, and kind. | `scripts/lib/audit/legacy-production-audit.mjs` |
| [`writeTempSource`](../scripts/lib/audit/duplication-detector.mjs#L126) | function | `scripts/lib/audit/duplication-detector.mjs` | 126-130 | Writes content to a temp file path, creating parent directories. | `scripts/lib/audit/legacy-production-audit.mjs` |
...
| [`extractFileDiffSection`](../scripts/lib/audit/evidence-triage.mjs#L37) | function | `scripts/lib/audit/evidence-triage.mjs` | 37-67 | Locates a specific file's diff section in unified diff output, handling git quoting and CRLF. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`normalizeWhitespace`](../scripts/lib/audit/evidence-triage.mjs#L24) | function | `scripts/lib/audit/evidence-triage.mjs` | 24-26 | Collapses multiple whitespace characters to single spaces and trims. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`nowIso`](../scripts/lib/audit/evidence-triage.mjs#L200) | function | `scripts/lib/audit/evidence-triage.mjs` | 200-202 | <no body> | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`quoteAppearsOnSide`](../scripts/lib/audit/evidence-triage.mjs#L102) | function | `scripts/lib/audit/evidence-triage.mjs` | 102-125 | Checks if a normalized quote string appears on the head or base side of a diff section. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`runStage0EvidenceTriage`](../scripts/lib/audit/evidence-triage.mjs#L255) | function | `scripts/lib/audit/evidence-triage.mjs` | 255-286 | Triages envelope findings via diff verification, producing verified and rejected sets with decision records. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`splitIntoHunks`](../scripts/lib/audit/evidence-triage.mjs#L73) | function | `scripts/lib/audit/evidence-triage.mjs` | 73-87 | Splits a diff section into `@@` hunks by parsing hunk headers. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`tagPreExisting`](../scripts/lib/audit/evidence-triage.mjs#L184) | function | `scripts/lib/audit/evidence-triage.mjs` | 184-190 | Marks findings as pre-existing independent if blame and impact checks both confirm. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`verifyAnchor`](../scripts/lib/audit/evidence-triage.mjs#L150) | function | `scripts/lib/audit/evidence-triage.mjs` | 150-161 | Validates an evidence anchor against diff text, returning verified/fabricated/unverifiable. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`verifyWithFallback`](../scripts/lib/audit/evidence-triage.mjs#L215) | function | `scripts/lib/audit/evidence-triage.mjs` | 215-230 | Verifies an evidence anchor against diff, falling back to alternative anchors on failure. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`anchorFileCandidates`](../scripts/lib/audit/final-adjudication.mjs#L333) | function | `scripts/lib/audit/final-adjudication.mjs` | 333-336 | Extracts candidate file paths (old and new) from an anchor object. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildAlternativeEvidenceLines`](../scripts/lib/audit/final-adjudication.mjs#L378) | function | `scripts/lib/audit/final-adjudication.mjs` | 378-387 | Builds markdown-formatted alternative evidence lines for a finding, filtering out sensitive paths. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildFindingDetail`](../scripts/lib/audit/final-adjudication.mjs#L390) | function | `scripts/lib/audit/final-adjudication.mjs` | 390-394 | Combines a finding's primary detail with alternative evidence if available. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`createGeminiReviewSubprocessAdapters`](../scripts/lib/audit/final-adjudication.mjs#L498) | function | `scripts/lib/audit/final-adjudication.mjs` | 498-588 | Creates adapter functions (reviewCall, interpretVerdict) for invoking Gemini review via subprocess. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`defaultGeminiReviewScriptPath`](../scripts/lib/audit/final-adjudication.mjs#L63) | function | `scripts/lib/audit/final-adjudication.mjs` | 63-65 | Returns the file path to gemini-review.mjs. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`envelopeReferencedFiles`](../scripts/lib/audit/final-adjudication.mjs#L345) | function | `scripts/lib/audit/final-adjudication.mjs` | 345-348 | Collects all file paths referenced in an envelope's canonical and trigger anchors. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`interpretVerdict`](../scripts/lib/audit/final-adjudication.mjs#L184) | function | `scripts/lib/audit/final-adjudication.mjs` | 184-213 | Maps a Gemini verdict to an outcome code, correctly treating escalated HIGH/omission dismissals as confirmed dismissals. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`invokeGeminiReviewSubprocess`](../scripts/lib/audit/final-adjudication.mjs#L425) | function | `scripts/lib/audit/final-adjudication.mjs` | 425-468 | Spawns gemini-review subprocess, passes transcript/plan, and parses the JSON result. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`isPathSensitive`](../scripts/lib/audit/final-adjudication.mjs#L357) | function | `scripts/lib/audit/final-adjudication.mjs` | 357-364 | Determines if a file path is classified as sensitive (e.g., .env, secrets). | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
...
| [`primaryFile`](../scripts/lib/audit/final-adjudication.mjs#L397) | function | `scripts/lib/audit/final-adjudication.mjs` | 397-402 | Extracts the primary file path from a finding using cascading fallbacks. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`runFinalAdjudication`](../scripts/lib/audit/final-adjudication.mjs#L233) | function | `scripts/lib/audit/final-adjudication.mjs` | 233-324 | Adjudicates reviewed findings into buckets (reversed/confirmed/verified/unresolved/pending-security-review) with sensitive-evidence gating before Gemini review. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectAdjudicationSample`](../scripts/lib/audit/final-adjudication.mjs#L87) | function | `scripts/lib/audit/final-adjudication.mjs` | 87-115 | Deterministically samples mandatory escalations, mechanical dismissals, and clean regions for Gemini review. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
| [`selectFinalAdjudicationWorkItems`](../scripts/lib/audit/final-adjudication.mjs#L154) | function | `scripts/lib/audit/final-adjudication.mjs` | 154-169 | Selects budget-limited final adjudication work items combining mandatory, tail, clean, and direct-queue sets. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/lib/audit/tiered-pipeline.mjs` |
...
| [`escapeRegex`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L42) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 42-44 | Escapes special regex characters to make a string literal for regex matching. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`isExplorationSample`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L154) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 154-160 | Uses seeded RNG to check if a commit falls into the exploration sample rate. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`keywordRegex`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L58) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 58-66 | Creates or retrieves a cached word-boundary regex for a keyword with optional stem matching. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`matchKeywordGroups`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L71) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 71-78 | Finds which keyword groups match within a text string. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`resolveGptTrigger`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L176) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 176-191 | Resolves GPT trigger decision via deterministic rules, exploration sampling, or bandit sentinel. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`shouldFireSentinel`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L132) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 132-138 | Uses Thompson Sampling (bandit) to decide if the GPT sentinel should fire. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`shouldTriggerGpt`](../scripts/lib/audit/gpt-sentinel-trigger.mjs#L104) | function | `scripts/lib/audit/gpt-sentinel-trigger.mjs` | 104-111 | Determines if GPT should fire based on diff size threshold, keyword triggers, or portfolio disagreement. | `scripts/lib/audit/tiered-pipeline.mjs` |
| [`buildAuditRunContext`](../scripts/lib/audit/legacy-production-audit.mjs#L3012) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 3012-3096 | Builds context object for audit run with providers, tiered pipeline config, and disclosure gating. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cachePassResult`](../scripts/lib/audit/legacy-production-audit.mjs#L243) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 243-254 | Atomically writes a pass result to cache file with atomic rename. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cacheWaveResults`](../scripts/lib/audit/legacy-production-audit.mjs#L256) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 256-261 | Caches multiple pass results and logs completion to stderr. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`cleanupCache`](../scripts/lib/audit/legacy-production-audit.mjs#L263) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 263-266 | Removes the cache directory and its contents. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`decideSeed`](../scripts/lib/audit/legacy-production-audit.mjs#L369) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 369-417 | Decides whether to use prefix-cache seeding and selects the smallest unit as seed. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`deriveFindingsFromReport`](../scripts/lib/audit/legacy-production-audit.mjs#L991) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 991-1061 | Derives audit findings from architecture report violations, unmapped files, and dead intent rules. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`formatViolationsForPrompt`](../scripts/lib/audit/legacy-production-audit.mjs#L923) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 923-972 | Formats architecture violations, unmapped files, and dead intent into a prompt-friendly markdown section. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`initResultCache`](../scripts/lib/audit/legacy-production-audit.mjs#L233) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 233-241 | Creates a temp directory for caching pass results during audit run. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`normalizeFindingsForOutput`](../scripts/lib/audit/legacy-production-audit.mjs#L270) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 270-272 | <no body> | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`orphanToStandardFinding`](../scripts/lib/audit/legacy-production-audit.mjs#L796) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 796-818 | Converts an orphan-introduced finding to standard Finding schema format. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runArchitecturePass`](../scripts/lib/audit/legacy-production-audit.mjs#L651) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 651-786 | Runs architecture boundary-violation detection using domain map and intent config. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runLegacyProductionAudit`](../scripts/lib/audit/legacy-production-audit.mjs#L1091) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 1091-2976 | Main audit orchestrator running 5 passes (structure/wiring/backend/frontend/sustainability) with map-reduce, caching, ledger, and R2+ support. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runMapReducePass`](../scripts/lib/audit/legacy-production-audit.mjs#L451) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 451-633 | Orchestrates map-reduce audit with parallel units, cache seeding, and concurrent execution limit. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOneMapUnit`](../scripts/lib/audit/legacy-production-audit.mjs#L422) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 422-449 | Runs GPT audit on one map-reduce unit with concurrency slot acquire/release. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`runOrphanIntroducedPass`](../scripts/lib/audit/legacy-production-audit.mjs#L837) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 837-916 | Detects newly-orphaned files in the diff by comparing HEAD call graph against baseline. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduce`](../scripts/lib/audit/legacy-production-audit.mjs#L174) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 174-178 | Decides whether to use map-reduce based on file count or total character threshold. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`shouldMapReduceHighReasoning`](../scripts/lib/audit/legacy-production-audit.mjs#L185) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 185-189 | Decides whether to use map-reduce for high-reasoning audit based on file count or character threshold. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`throwIfConfigError`](../scripts/lib/audit/legacy-production-audit.mjs#L352) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 352-358 | Throws if a settled promise contains a config-level LLM error. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
| [`validateLedgerForR2`](../scripts/lib/audit/legacy-production-audit.mjs#L292) | function | `scripts/lib/audit/legacy-production-audit.mjs` | 292-324 | Validates ledger JSON schema and reports valid/invalid entry counts for R2+ audit. | `scripts/lib/audit/tiered-pipeline.mjs`, `scripts/openai-audit.mjs` |
...
| [`defaultTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L111) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 111-124 | Calls GPT to triage a Stage-1 candidate finding. | `scripts/openai-audit.mjs` |
| [`runTieredAuditPipeline`](../scripts/lib/audit/tiered-pipeline.mjs#L154) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 154-451 | Orchestrates the three-stage tiered audit pipeline (discovery, Stage 1, Stage 2). | `scripts/openai-audit.mjs` |
| [`validatedTriagerCall`](../scripts/lib/audit/tiered-pipeline.mjs#L138) | function | `scripts/lib/audit/tiered-pipeline.mjs` | 138-148 | Calls a validated Stage-1 triager model (e.g. from validation manifest). | `scripts/openai-audit.mjs` |
| [`appendShadowLog`](../scripts/lib/audit/tiered-shadow-compare.mjs#L184) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 184-191 | Appends a shadow-comparison observation record to a local JSONL log. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`buildShadowCtx`](../scripts/lib/audit/tiered-shadow-compare.mjs#L81) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 81-93 | Constructs a context object for running the tiered pipeline as a shadow observer. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`compareAuditRunResults`](../scripts/lib/audit/tiered-shadow-compare.mjs#L119) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 119-142 | Compares legacy and tiered audit results (overlap, cost/latency deltas). | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`parseTotalSeconds`](../scripts/lib/audit/tiered-shadow-compare.mjs#L102) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 102-106 | Parses a duration string like "42.5s" into a float number of seconds. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`recordObservation`](../scripts/lib/audit/tiered-shadow-compare.mjs#L236) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 236-253 | Persists a tiered-shadow comparison observation to local log and cloud store. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runShadowTieredPipeline`](../scripts/lib/audit/tiered-shadow-compare.mjs#L154) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 154-174 | Runs the tiered pipeline as a shadow comparison with timeout and timer cleanup. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
| [`runTieredShadowComparison`](../scripts/lib/audit/tiered-shadow-compare.mjs#L204) | function | `scripts/lib/audit/tiered-shadow-compare.mjs` | 204-225 | Orchestrates running legacy and shadow tiered audits in parallel, recording results. | `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/openai-audit.mjs`, `scripts/tiered-shadow-report.mjs` |
...
| [`isPidAlive`](../scripts/lib/brainstorm/file-lock.mjs#L41) | function | `scripts/lib/brainstorm/file-lock.mjs` | 41-48 | Checks whether a process ID is still alive using a signal-0 test. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +3 more |
| [`LockTimeoutError`](../scripts/lib/brainstorm/file-lock.mjs#L23) | class | `scripts/lib/brainstorm/file-lock.mjs` | 23-30 | Custom error class signaling timeout while waiting to acquire a lock. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +3 more |
...
| [`safeRelease`](../scripts/lib/brainstorm/file-lock.mjs#L197) | function | `scripts/lib/brainstorm/file-lock.mjs` | 197-214 | Releases a lock file if the current process still owns it. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +3 more |
| [`sleep`](../scripts/lib/brainstorm/file-lock.mjs#L32) | function | `scripts/lib/brainstorm/file-lock.mjs` | 32-32 | Returns a promise that resolves after a specified delay in milliseconds. | `scripts/lib/brainstorm/insight-store.mjs`, `scripts/lib/brainstorm/session-store.mjs`, `scripts/lib/friction/breadcrumb.mjs`, +3 more |
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L441) | function | `scripts/sync-to-repos.mjs` | 441-449 | Collects .prompt.md files from .github/prompts/ for Copilot integration. | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L339) | function | `scripts/sync-to-repos.mjs` | 339-356 | Walks scripts/ and .claude/ to collect all file paths in the repo. | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L402) | function | `scripts/sync-to-repos.mjs` | 402-414 | Enumerates skill files from the source repo for syncing. | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L471) | function | `scripts/sync-to-repos.mjs` | 471-478 | Selects which files to bundle based on target repo name (wine-cellar-app gets extra debt files). | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L518) | function | `scripts/sync-to-repos.mjs` | 518-529 | Recursively merges a source object into a target object. | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L533) | function | `scripts/sync-to-repos.mjs` | 533-1062 | Syncs files from source to consumer repos, detecting conflicts and offering diffs. | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L1064) | function | `scripts/sync-to-repos.mjs` | 1064-1095 | Prompts to update shared cloud config during sync if configuration is out-of-sync or missing. | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L359) | function | `scripts/sync-to-repos.mjs` | 359-362 | Reads and returns a file from the source repo root, or null on error. | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L386) | function | `scripts/sync-to-repos.mjs` | 386-391 | Filters unresolved imports to find real missing dependencies (relative paths). | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L371) | function | `scripts/sync-to-repos.mjs` | 371-376 | Collects the full import closure for entry-point files. | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L487) | function | `scripts/sync-to-repos.mjs` | 487-494 | Computes and returns the SHA256 hash of a file, or null on error. | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L239) | function | `scripts/sync-to-repos.mjs` | 239-249 | Lists SQL migration files from supabase/migrations/. | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L496) | function | `scripts/sync-to-repos.mjs` | 496-509 | Generates a unified diff between two files using git diff --no-index. | _(internal)_ |
...
> One-time setup orchestration: repo cloning, Node.js prerequisite validation, interactive API-key and database-config prompts, and global skill installation.
...
| [`ask`](../setup.mjs#L25) | function | `setup.mjs` | 25-25 | Creates a readline question-answer function for interactive user prompts. | _(internal)_ |
| [`checkPrereqs`](../setup.mjs#L34) | function | `setup.mjs` | 34-43 | Verifies Node.js 18+ and npm are installed. | _(internal)_ |
| [`fail`](../setup.mjs#L30) | function | `setup.mjs` | 30-30 | Prints a red X with an error message. | _(internal)_ |
| [`installDeps`](../setup.mjs#L148) | function | `setup.mjs` | 148-155 | Runs `npm install` to install project dependencies. | _(internal)_ |
| [`installGitHook`](../setup.mjs#L159) | function | `setup.mjs` | 159-187 | Installs or updates a post-merge git hook that auto-updates skills on pull. | _(internal)_ |
| [`installSkills`](../setup.mjs#L130) | function | `setup.mjs` | 130-144 | Builds the skill manifest and installs skills globally to ~/.claude/skills/. | _(internal)_ |
| [`main`](../setup.mjs#L191) | function | `setup.mjs` | 191-254 | Orchestrates a multi-step setup flow: prerequisites, API keys, database, deps, skills, and git hook. | _(internal)_ |
| [`ok`](../setup.mjs#L28) | function | `setup.mjs` | 28-28 | Prints a green checkmark with a success message. | _(internal)_ |
| [`setupApiKeys`](../setup.mjs#L54) | function | `setup.mjs` | 54-81 | Prompts user for API keys (OpenAI, Gemini, Anthropic) and saves them to .env. | _(internal)_ |
| [`setupDatabase`](../setup.mjs#L90) | function | `setup.mjs` | 90-126 | Presents database options (local SQLite or cloud Postgres) and saves the selected configuration to .env. | _(internal)_ |
...
> Eight AI-pair-programming skill CLIs (plan, audit-code, ux-lock, persona-test, etc.) plus library modules for LLM orchestration, code analysis, Postgres persistence, and schema validation.
...
| [`installInRepo`](../scripts/install-prepush-hook.mjs#L142) | function | `scripts/install-prepush-hook.mjs` | 142-192 | Installs or uninstalls a pre-push hook in a repository, validating ownership and handling conflicts. | _(internal)_ |
| [`isManagedHook`](../scripts/install-prepush-hook.mjs#L41) | function | `scripts/install-prepush-hook.mjs` | 41-45 | Checks whether a pre-push hook file contains management markers indicating it's installer-controlled. | _(internal)_ |
| [`main`](../scripts/install-prepush-hook.mjs#L196) | function | `scripts/install-prepush-hook.mjs` | 196-220 | CLI entry point resolving target repos and applying hook install/uninstall operations. | _(internal)_ |
...
| [`argOption`](../scripts/model-eval-auditor.mjs#L110) | function | `scripts/model-eval-auditor.mjs` | 110-113 | Returns the CLI argument value following a flag name, or a default if absent. | _(internal)_ |
| [`hasFlag`](../scripts/model-eval-auditor.mjs#L114) | function | `scripts/model-eval-auditor.mjs` | 114-114 | Tests whether a CLI flag is present in the argument list. | _(internal)_ |
| [`main`](../scripts/model-eval-auditor.mjs#L288) | function | `scripts/model-eval-auditor.mjs` | 288-404 | CLI entry point for model-eval-auditor; parses args, loads corpus and thresholds, runs screen or promotion tier, and outputs result. | _(internal)_ |
| [`mulberry32`](../scripts/model-eval-auditor.mjs#L58) | function | `scripts/model-eval-auditor.mjs` | 58-66 | Implements the Mulberry32 seeded PRNG, returning a function that generates floats 0–1. | _(internal)_ |
| [`parseJsonArg`](../scripts/model-eval-auditor.mjs#L116) | function | `scripts/model-eval-auditor.mjs` | 116-119 | Parses a JSON string from a CLI argument, throwing a preflight error on parse failure. | _(internal)_ |
| [`RunPreflightError`](../scripts/model-eval-auditor.mjs#L48) | class | `scripts/model-eval-auditor.mjs` | 48-50 | <no body> | _(internal)_ |
| [`runPromotionTier`](../scripts/model-eval-auditor.mjs#L158) | function | `scripts/model-eval-auditor.mjs` | 158-284 | Runs a comparative promotion-tier evaluation, auditing candidate and baseline against a corpus and scoring both via a blind judge. | _(internal)_ |
| [`runScreenTier`](../scripts/model-eval-auditor.mjs#L141) | function | `scripts/model-eval-auditor.mjs` | 141-154 | Runs the quick screen-tier evaluation on a candidate model and returns verdict and metrics. | _(internal)_ |
| [`scoreArmTierC`](../scripts/model-eval-auditor.mjs#L125) | function | `scripts/model-eval-auditor.mjs` | 125-137 | Runs audit extraction on test cases and scores defect-localization accuracy (recall, false-positive rate, F1). | _(internal)_ |
| [`seedFromString`](../scripts/model-eval-auditor.mjs#L67) | function | `scripts/model-eval-auditor.mjs` | 67-69 | Generates a numeric seed from a string by SHA-256 hashing and extracting the first 4 bytes. | _(internal)_ |
| [`stratifiedSelectKDs`](../scripts/model-eval-auditor.mjs#L79) | function | `scripts/model-eval-auditor.mjs` | 79-106 | Partitions defects by severity, shuffles each group deterministically, then round-robin selects n items across groups. | _(internal)_ |
...
| [`main`](../scripts/postgres-parity/generate-expected-schema.mjs#L183) | function | `scripts/postgres-parity/generate-expected-schema.mjs` | 183-217 | Entry point that queries a Postgres database schema and writes it to a JSON artifact. | _(internal)_ |
...
| [`applyBootstrap`](../scripts/setup-postgres.mjs#L272) | function | `scripts/setup-postgres.mjs` | 272-279 | Applies the compatibility bootstrap SQL to create stub roles and functions (skipped on Supabase-managed DBs). | _(internal)_ |
| [`applyMigration`](../scripts/setup-postgres.mjs#L260) | function | `scripts/setup-postgres.mjs` | 260-270 | Reads a migration file, executes its SQL, and returns its SHA256 hash (or simulates in dry-run mode). | _(internal)_ |
| [`canonicalise`](../scripts/setup-postgres.mjs#L332) | function | `scripts/setup-postgres.mjs` | 332-343 | Recursively sorts all arrays and object keys to produce a canonical JSON representation for comparison. | _(internal)_ |
| [`captureLiveSchema`](../scripts/setup-postgres.mjs#L291) | function | `scripts/setup-postgres.mjs` | 291-303 | Queries the database and captures the current public schema structure as a normalized object. | _(internal)_ |
| [`diffSchemas`](../scripts/setup-postgres.mjs#L305) | function | `scripts/setup-postgres.mjs` | 305-329 | Compares expected and live schemas, returning a list of category-level differences with missing/extra items. | _(internal)_ |
| [`ensureLedger`](../scripts/setup-postgres.mjs#L229) | function | `scripts/setup-postgres.mjs` | 229-232 | Creates the audit_loop_migrations tracking table and enables row-level security. | _(internal)_ |
| [`isSupabaseManaged`](../scripts/setup-postgres.mjs#L197) | function | `scripts/setup-postgres.mjs` | 197-209 | Determines whether the database is Supabase-managed by checking if the auth schema is owned by supabase_admin. | _(internal)_ |
| [`listMigrations`](../scripts/setup-postgres.mjs#L249) | function | `scripts/setup-postgres.mjs` | 249-252 | Lists all .sql migration files in the migrations directory, sorted alphabetically. | _(internal)_ |
| [`main`](../scripts/setup-postgres.mjs#L713) | function | `scripts/setup-postgres.mjs` | 713-789 | CLI entry point that parses arguments, validates database connection, and dispatches to setup/migrate/drift-check modes. | _(internal)_ |
| [`parseArgs`](../scripts/setup-postgres.mjs#L68) | function | `scripts/setup-postgres.mjs` | 68-109 | Parses command-line arguments (--migrate, --adopt, --format, etc.) into a mode and options object. | _(internal)_ |
| [`preflight`](../scripts/setup-postgres.mjs#L124) | function | `scripts/setup-postgres.mjs` | 124-147 | Checks that the database user has CREATEROLE privilege and required extensions (pgcrypto, pg_trgm, vector) are available. | _(internal)_ |
| [`readLedger`](../scripts/setup-postgres.mjs#L234) | function | `scripts/setup-postgres.mjs` | 234-237 | Reads the migration ledger from the database and returns a map of filenames to SHA256 hashes. | _(internal)_ |
| [`recordApplied`](../scripts/setup-postgres.mjs#L239) | function | `scripts/setup-postgres.mjs` | 239-245 | Records a migration as applied in the ledger with its SHA256 hash, updating on conflict. | _(internal)_ |
| [`renderHumanDriftReport`](../scripts/setup-postgres.mjs#L633) | function | `scripts/setup-postgres.mjs` | 633-654 | Renders a human-readable migration drift report to stderr, showing categorized deviations in color-coded sections. | _(internal)_ |
| [`reportPreflight`](../scripts/setup-postgres.mjs#L149) | function | `scripts/setup-postgres.mjs` | 149-183 | Prints preflight results and returns false in strict mode if CREATEROLE or required extensions are missing. | _(internal)_ |
| [`runAdopt`](../scripts/setup-postgres.mjs#L510) | function | `scripts/setup-postgres.mjs` | 510-559 | Adopts a pre-provisioned database by validating schema match and seeding the migration ledger with all applied migration hashes. | _(internal)_ |
| [`runCheckDrift`](../scripts/setup-postgres.mjs#L580) | function | `scripts/setup-postgres.mjs` | 580-631 | Checks for migration drift between the ledger and source files, detecting unapplied, modified, or orphaned migrations. | _(internal)_ |
| [`runEnsureLocal`](../scripts/setup-postgres.mjs#L664) | function | `scripts/setup-postgres.mjs` | 664-711 | [SECRET_REDACTED] | _(internal)_ |
| [`runMigrate`](../scripts/setup-postgres.mjs#L469) | function | `scripts/setup-postgres.mjs` | 469-508 | Applies bootstrap and pending migrations, tracking progress and refusing to re-apply migrations with mismatched SHA256 hashes. | _(internal)_ |
| [`sha256`](../scripts/setup-postgres.mjs#L254) | function | `scripts/setup-postgres.mjs` | 254-258 | Computes and returns the SHA256 hash of a file. | _(internal)_ |
...
| [`buildJudgePrompt`](../scripts/lib/arm-eval/judge.mjs#L78) | function | `scripts/lib/arm-eval/judge.mjs` | 78-93 | Constructs the prompt for a blinded judge to score experiment outputs on rubric dimensions with optional repo context. | `scripts/lib/arm-eval/run.mjs` |
| [`callJudgeDefault`](../scripts/lib/arm-eval/judge.mjs#L185) | function | `scripts/lib/arm-eval/judge.mjs` | 185-224 | Calls Claude Opus to judge experiment outputs on rubric dimensions with egress safety gates and shape-based redaction. | `scripts/lib/arm-eval/run.mjs` |
| [`extractJsonObject`](../scripts/lib/arm-eval/judge.mjs#L154) | function | `scripts/lib/arm-eval/judge.mjs` | 154-170 | Extracts a JSON object from a string by finding balanced braces, handling escape sequences correctly. | `scripts/lib/arm-eval/run.mjs` |
| [`getShapeRedactor`](../scripts/lib/arm-eval/judge.mjs#L177) | function | `scripts/lib/arm-eval/judge.mjs` | 177-182 | Lazily loads and caches a shape-based secret redactor function for use in judge prompts. | `scripts/lib/arm-eval/run.mjs` |
| [`judgePassSchema`](../scripts/lib/arm-eval/judge.mjs#L59) | function | `scripts/lib/arm-eval/judge.mjs` | 59-71 | Creates a Zod schema that validates judge scoring output (all dimensions scored 1-5, all labels present exactly once). | `scripts/lib/arm-eval/run.mjs` |
| [`judgeSession`](../scripts/lib/arm-eval/judge.mjs#L110) | function | `scripts/lib/arm-eval/judge.mjs` | 110-148 | Runs a two-pass judging flow on randomized outputs with one bounded corrective retry on schema failure. | `scripts/lib/arm-eval/run.mjs` |
| [`mulberry32`](../scripts/lib/arm-eval/judge.mjs#L29) | function | `scripts/lib/arm-eval/judge.mjs` | 29-37 | A seeded pseudorandom number generator (Mulberry32 PRNG) implementation. | `scripts/lib/arm-eval/run.mjs` |
| [`scorableDimensions`](../scripts/lib/arm-eval/judge.mjs#L49) | function | `scripts/lib/arm-eval/judge.mjs` | 49-53 | Returns the rubric dimensions applicable to an experiment, optionally filtering out intent-specific ones. | `scripts/lib/arm-eval/run.mjs` |
| [`seededShuffle`](../scripts/lib/arm-eval/judge.mjs#L38) | function | `scripts/lib/arm-eval/judge.mjs` | 38-46 | Shuffles an array in-place using a seeded PRNG while preserving original array structure. | `scripts/lib/arm-eval/run.mjs` |
...
| [`callModelDefault`](../scripts/lib/arm-eval/producers/brainstorm.mjs#L75) | function | `scripts/lib/arm-eval/producers/brainstorm.mjs` | 75-78 | Default wrapper calling a model via the free-text interface with 8000 token limit. | `scripts/lib/arm-eval/run.mjs` |
| [`hashText`](../scripts/lib/arm-eval/producers/brainstorm.mjs#L15) | function | `scripts/lib/arm-eval/producers/brainstorm.mjs` | 15-15 | <no body> | `scripts/lib/arm-eval/run.mjs` |
| [`produceBrainstorm`](../scripts/lib/arm-eval/producers/brainstorm.mjs#L24) | function | `scripts/lib/arm-eval/producers/brainstorm.mjs` | 24-72 | Runs a dual-model brainstorm, validating that both legs produce non-empty output before returning results. | `scripts/lib/arm-eval/run.mjs` |
...
| [`callModelDefault`](../scripts/lib/arm-eval/producers/plan.mjs#L64) | function | `scripts/lib/arm-eval/producers/plan.mjs` | 64-67 | Default wrapper calling a model via the free-text interface. | `scripts/lib/arm-eval/run.mjs` |
| [`hashText`](../scripts/lib/arm-eval/producers/plan.mjs#L16) | function | `scripts/lib/arm-eval/producers/plan.mjs` | 16-16 | Generates a 16-character SHA256 hash of text. | `scripts/lib/arm-eval/run.mjs` |
| [`producePlan`](../scripts/lib/arm-eval/producers/plan.mjs#L24) | function | `scripts/lib/arm-eval/producers/plan.mjs` | 24-61 | Generates a plan from a task/topic, validating conformance via intent parsing (target paths and acceptance criteria). | `scripts/lib/arm-eval/run.mjs` |
...
| [`assertRepoRoot`](../scripts/lib/assert-repo-root.mjs#L54) | function | `scripts/lib/assert-repo-root.mjs` | 54-85 | Validates that the current working directory matches the script's repo root, exiting with error if not. | `scripts/bandit.mjs`, `scripts/build-dashboard.mjs`, `scripts/cache-hitrate-check.mjs`, +20 more |
| [`findExpectedRoot`](../scripts/lib/assert-repo-root.mjs#L30) | function | `scripts/lib/assert-repo-root.mjs` | 30-38 | Locates the repo root by walking up from a script path until finding the 'scripts' directory. | `scripts/bandit.mjs`, `scripts/build-dashboard.mjs`, `scripts/cache-hitrate-check.mjs`, +20 more |
| [`findRepoRootFromScript`](../scripts/lib/assert-repo-root.mjs#L99) | function | `scripts/lib/assert-repo-root.mjs` | 99-102 | Finds the repo root from a script's import.meta.url by searching for the 'scripts' directory. | `scripts/bandit.mjs`, `scripts/build-dashboard.mjs`, `scripts/cache-hitrate-check.mjs`, +20 more |
...
| [`callGeminiDefault`](../scripts/lib/audit-shadow.mjs#L622) | function | `scripts/lib/audit-shadow.mjs` | 622-660 | Calls Gemini for final-gate review, returning net-new findings over prior audit results. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`callModelDefault`](../scripts/lib/audit-shadow.mjs#L567) | function | `scripts/lib/audit-shadow.mjs` | 567-617 | Dispatches structured LLM calls to OpenRouter (OSS) or OpenAI (GPT) based on provider. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`classifyShadowFailure`](../scripts/lib/audit-shadow.mjs#L538) | function | `scripts/lib/audit-shadow.mjs` | 538-545 | Categorizes a shadow-run failure (egress refusal vs. other) for structured result handling. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`dedupByHash`](../scripts/lib/audit-shadow.mjs#L74) | function | `scripts/lib/audit-shadow.mjs` | 74-84 | Removes duplicate findings by semantic hash, keeping first occurrence. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`defaultDeps`](../scripts/lib/audit-shadow.mjs#L549) | function | `scripts/lib/audit-shadow.mjs` | 549-563 | Returns the default dependency-injection object for shadow-run functions. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`mulberry32`](../scripts/lib/audit-shadow.mjs#L51) | function | `scripts/lib/audit-shadow.mjs` | 51-59 | A seeded pseudorandom number generator (Mulberry32 algorithm). | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`persist`](../scripts/lib/audit-shadow.mjs#L297) | function | `scripts/lib/audit-shadow.mjs` | 297-340 | Records audit findings and per-pass statistics to the cloud store, grouped by stage. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`runGenerationShadow`](../scripts/lib/audit-shadow.mjs#L371) | function | `scripts/lib/audit-shadow.mjs` | 371-522 | Main orchestrator for the model-A/B shadow audit, managing arms, spend reservation, and execution flow. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`runStage`](../scripts/lib/audit-shadow.mjs#L187) | function | `scripts/lib/audit-shadow.mjs` | 187-283 | Executes all audit passes in a stage, managing spend reservations, timeouts, and findings collection. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`seededShuffle`](../scripts/lib/audit-shadow.mjs#L62) | function | `scripts/lib/audit-shadow.mjs` | 62-69 | Fisher-Yates array shuffle using seeded RNG for deterministic randomization. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`stageConfigFor`](../scripts/lib/audit-shadow.mjs#L145) | function | `scripts/lib/audit-shadow.mjs` | 145-162 | Returns configuration (passes, system prompts, reasoning effort) for an audit stage type. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
| [`withTimeout`](../scripts/lib/audit-shadow.mjs#L173) | function | `scripts/lib/audit-shadow.mjs` | 173-180 | Wraps a promise with a timeout deadline, rejecting if exceeded. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs`, `scripts/solo-control-audit.mjs` |
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L524) | function | `scripts/lib/config.mjs` | 524-593 | Constructs and validates Azure AI Foundry configuration from environment variables | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +47 more |
| [`clampConfigNumber`](../scripts/lib/config.mjs#L76) | function | `scripts/lib/config.mjs` | 76-96 | Parses and constrains a numeric environment variable to a min/max range with validation | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +47 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L253) | function | `scripts/lib/config.mjs` | 253-266 | Maps programming language names and aliases to canonical short codes (js, ts, py, etc.) | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +47 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L28) | function | `scripts/lib/config.mjs` | 28-35 | Validates an environment variable against an allowed set, defaulting with a warning if invalid | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +47 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Atomically writes data to a file via temp file + rename, preserving symlinks. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a path to lowercase relative path with forward slashes. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file or exits process with error message. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Safely parses a string to integer, returning fallback if invalid. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Writes JSON output to file or stdout with summary log. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +56 more |
...
| [`aggregateCost`](../scripts/lib/model-ab-decision.mjs#L203) | function | `scripts/lib/model-ab-decision.mjs` | 203-225 | Aggregates cost data by arm with USD totals, unknown flags, and conformance metrics across cost rows. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`buildClusters`](../scripts/lib/model-ab-decision.mjs#L100) | function | `scripts/lib/model-ab-decision.mjs` | 100-167 | Groups findings by (assignmentId, canonicalId) filtering prospective default-variant rows. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`distinctCodeUnits`](../scripts/lib/model-ab-decision.mjs#L176) | function | `scripts/lib/model-ab-decision.mjs` | 176-193 | Collects distinct code units (commit SHA × stage type) from finding and cost rows, excluding null commits. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`evaluateDecision`](../scripts/lib/model-ab-decision.mjs#L237) | function | `scripts/lib/model-ab-decision.mjs` | 237-356 | Evaluates a model-eval decision by checking code distinctness, pending adjudications, and arm scoring to return a ranking or status. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`normalizeSeverity`](../scripts/lib/model-ab-decision.mjs#L65) | function | `scripts/lib/model-ab-decision.mjs` | 65-71 | Normalizes severity strings (MED→MEDIUM, CRIT→CRITICAL) to valid set or default. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`normalizeSeverityBucketIsHigh`](../scripts/lib/model-ab-decision.mjs#L360) | function | `scripts/lib/model-ab-decision.mjs` | 360-362 | Returns whether a cluster's maximum severity weight reaches the HIGH threshold. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
| [`qualMult`](../scripts/lib/model-ab-decision.mjs#L83) | function | `scripts/lib/model-ab-decision.mjs` | 83-86 | Multiplies base quality by quick-fix multiplier if applicable. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
...
| [`sevW`](../scripts/lib/model-ab-decision.mjs#L74) | function | `scripts/lib/model-ab-decision.mjs` | 74-76 | Returns severity weight from lookup table. | `scripts/cross-skill.mjs`, `scripts/lib/audit/cost-budget.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +1 more |
...
| [`costForBudget`](../scripts/lib/model-pricing.mjs#L163) | function | `scripts/lib/model-pricing.mjs` | 163-184 | Calculates cost for budget tracking, flagging unmeterable or estimated cases for the reserve-then-reconcile ledger. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`costFromUsage`](../scripts/lib/model-pricing.mjs#L128) | function | `scripts/lib/model-pricing.mjs` | 128-149 | Computes the USD cost breakdown (input, output, total) from token usage and model ID. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`isPriced`](../scripts/lib/model-pricing.mjs#L113) | function | `scripts/lib/model-pricing.mjs` | 113-115 | Returns true if a model has known pricing, false otherwise. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`isValidCount`](../scripts/lib/model-pricing.mjs#L83) | function | `scripts/lib/model-pricing.mjs` | 83-85 | Checks if a value is a non-negative finite number suitable for token or usage counts. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`priceFor`](../scripts/lib/model-pricing.mjs#L105) | function | `scripts/lib/model-pricing.mjs` | 105-110 | Returns the pricing structure for a model, checking OSS pricing first then family-based lookups. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`sanitizeTokens`](../scripts/lib/model-pricing.mjs#L92) | function | `scripts/lib/model-pricing.mjs` | 92-96 | Converts a token count to a non-negative finite integer, flooring invalid values to 0. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
| [`toEur`](../scripts/lib/model-pricing.mjs#L187) | function | `scripts/lib/model-pricing.mjs` | 187-189 | Converts a USD cost to EUR using the stored exchange rate, returning null for invalid inputs. | `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/usage-event.mjs`, `scripts/lib/model-ab-decision.mjs`, +2 more |
...
| [`isValidCount`](../scripts/lib/oss-structured-output.mjs#L55) | function | `scripts/lib/oss-structured-output.mjs` | 55-57 | Validates a value as a finite non-negative integer for token/usage metrics. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +1 more |
| [`normaliseUsage`](../scripts/lib/oss-structured-output.mjs#L59) | function | `scripts/lib/oss-structured-output.mjs` | 59-80 | Sanitizes and normalizes token usage and cost fields, detecting missing/invalid metrics for spend-cap enforcement. | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +1 more |
| [`ossStructuredCall`](../scripts/lib/oss-structured-output.mjs#L146) | function | `scripts/lib/oss-structured-output.mjs` | 146-284 | Makes structured LLM call with schema validation, retries, and timeout | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +1 more |
| [`sanitizeSchemaName`](../scripts/lib/oss-structured-output.mjs#L95) | function | `scripts/lib/oss-structured-output.mjs` | 95-98 | Sanitizes schema name to max 64 alphanumeric/hyphen/underscore chars | `scripts/cheap-triager-validate.mjs`, `scripts/lib/audit-shadow.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, +1 more |
...
| [`auditFilePathTokens`](../scripts/lib/persona/audit-correlator.mjs#L136) | function | `scripts/lib/persona/audit-correlator.mjs` | 136-138 | Tokenizes primary file path from audit finding | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`auditKeywordTokens`](../scripts/lib/persona/audit-correlator.mjs#L140) | function | `scripts/lib/persona/audit-correlator.mjs` | 140-142 | Tokenizes detail and category from audit finding | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`buildStepUrlLookup`](../scripts/lib/persona/audit-correlator.mjs#L236) | function | `scripts/lib/persona/audit-correlator.mjs` | 236-245 | Builds Map of step numbers to sanitized URLs from persona click path | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`decideCorrelations`](../scripts/lib/persona/audit-correlator.mjs#L264) | function | `scripts/lib/persona/audit-correlator.mjs` | 264-324 | Correlates persona P0/P1 findings with audit findings, emitting correlations | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isMalformedFinding`](../scripts/lib/persona/audit-correlator.mjs#L83) | function | `scripts/lib/persona/audit-correlator.mjs` | 83-86 | Validates persona finding has non-empty element and observed fields | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isNewerOrHigherSeverity`](../scripts/lib/persona/audit-correlator.mjs#L218) | function | `scripts/lib/persona/audit-correlator.mjs` | 218-223 | Compares findings by recency then severity rank | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isP0OrP1`](../scripts/lib/persona/audit-correlator.mjs#L70) | function | `scripts/lib/persona/audit-correlator.mjs` | 70-72 | Checks if persona finding has P0 or P1 severity code | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`isSeverityUnderstated`](../scripts/lib/persona/audit-correlator.mjs#L226) | function | `scripts/lib/persona/audit-correlator.mjs` | 226-228 | Detects P0 persona finding understated as LOW/MEDIUM audit severity | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`matchFinding`](../scripts/lib/persona/audit-correlator.mjs#L183) | function | `scripts/lib/persona/audit-correlator.mjs` | 183-212 | Finds best audit finding for persona finding via exact then fuzzy matching | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`overlapCoefficient`](../scripts/lib/persona/audit-correlator.mjs#L112) | function | `scripts/lib/persona/audit-correlator.mjs` | 112-119 | Computes token overlap as intersection divided by smaller set size | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaFilePathTokens`](../scripts/lib/persona/audit-correlator.mjs#L126) | function | `scripts/lib/persona/audit-correlator.mjs` | 126-129 | Extracts tokens from persona finding element and step URL | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaFindingHash`](../scripts/lib/persona/audit-correlator.mjs#L62) | function | `scripts/lib/persona/audit-correlator.mjs` | 62-67 | Generates semantic hash for persona finding from section/category/detail | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`personaKeywordTokens`](../scripts/lib/persona/audit-correlator.mjs#L131) | function | `scripts/lib/persona/audit-correlator.mjs` | 131-133 | Tokenizes observed text from persona finding | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`pickBest`](../scripts/lib/persona/audit-correlator.mjs#L214) | function | `scripts/lib/persona/audit-correlator.mjs` | 214-216 | Selects most recent or highest-severity finding from candidates | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`scoreMatch`](../scripts/lib/persona/audit-correlator.mjs#L153) | function | `scripts/lib/persona/audit-correlator.mjs` | 153-163 | Scores persona-to-audit match using weighted file-path and keyword overlap | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
| [`tokenize`](../scripts/lib/persona/audit-correlator.mjs#L94) | function | `scripts/lib/persona/audit-correlator.mjs` | 94-101 | Splits text into lowercase alphanumeric tokens of minimum length | `scripts/cross-skill.mjs`, `scripts/lib/store/persona-outcomes.mjs` |
...
| [`buildT0`](../scripts/lib/repo-context.mjs#L61) | function | `scripts/lib/repo-context.mjs` | 61-65 | Builds repo inventory context with file list and SHA. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`buildT1`](../scripts/lib/repo-context.mjs#L67) | function | `scripts/lib/repo-context.mjs` | 67-104 | Builds adjacency context showing public exports of modules imported by changed files. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`buildT2`](../scripts/lib/repo-context.mjs#L106) | function | `scripts/lib/repo-context.mjs` | 106-118 | Loads a specific documentation section by intent name from repo docs. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`buildT3`](../scripts/lib/repo-context.mjs#L120) | function | `scripts/lib/repo-context.mjs` | 120-136 | Loads the checked-in architecture map file without a freshness stamp. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`commitSha`](../scripts/lib/repo-context.mjs#L45) | function | `scripts/lib/repo-context.mjs` | 45-53 | Gets the current HEAD commit SHA from git. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`estimateTokens`](../scripts/lib/repo-context.mjs#L43) | function | `scripts/lib/repo-context.mjs` | 43-43 | Estimates token count as string length divided by 4. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`getRepoContext`](../scripts/lib/repo-context.mjs#L166) | function | `scripts/lib/repo-context.mjs` | 166-214 | Assembles repo context via a degradation chain (T3→T2→T1→T0), truncating at line boundaries if exceeding token budget. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`stamp`](../scripts/lib/repo-context.mjs#L55) | function | `scripts/lib/repo-context.mjs` | 55-57 | Formats a commit SHA into a " generated-at=..." attribute for context block timestamps. | `scripts/gemini-review.mjs`, `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
...
| [`changedSince`](../scripts/lib/requirements/context.mjs#L33) | function | `scripts/lib/requirements/context.mjs` | 33-42 | Gets the set of files changed since a commit via git diff. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`estimateTokens`](../scripts/lib/requirements/context.mjs#L20) | function | `scripts/lib/requirements/context.mjs` | 20-20 | Estimates token count as string length divided by 4. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`getPlanRequirementsRubric`](../scripts/lib/requirements/context.mjs#L166) | function | `scripts/lib/requirements/context.mjs` | 166-170 | Extracts plan file paths and returns requirements context for those paths. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`getRequirementsContext`](../scripts/lib/requirements/context.mjs#L54) | function | `scripts/lib/requirements/context.mjs` | 54-134 | Assembles requirements context showing in-scope requirements, coverage, staleness, and uncovered targets. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`globMatch`](../scripts/lib/requirements/context.mjs#L23) | function | `scripts/lib/requirements/context.mjs` | 23-30 | Matches a file path against a glob pattern by converting glob syntax to regex. | `scripts/lib/audit/legacy-production-audit.mjs`, `scripts/openai-audit.mjs` |
| [`assignId`](../scripts/lib/requirements/extract.mjs#L59) | function | `scripts/lib/requirements/extract.mjs` | 59-65 | Computes a deterministic 8-character requirement ID from kind, assertion, and provenance files. | `scripts/requirements.mjs` |
| [`batchFiles`](../scripts/lib/requirements/extract.mjs#L113) | function | `scripts/lib/requirements/extract.mjs` | 113-125 | Batches file bodies into chunks respecting a token budget. | `scripts/requirements.mjs` |
| [`estimateTokens`](../scripts/lib/requirements/extract.mjs#L29) | function | `scripts/lib/requirements/extract.mjs` | 29-29 | Estimates token count from character length divided by 4. | `scripts/requirements.mjs` |
| [`extractOneRun`](../scripts/lib/requirements/extract.mjs#L134) | function | `scripts/lib/requirements/extract.mjs` | 134-186 | Runs the LLM extractor on file batches, validates JSON response shape and per-item schemas, and collects failed batches count. | `scripts/requirements.mjs` |
| [`extractRequirements`](../scripts/lib/requirements/extract.mjs#L198) | function | `scripts/lib/requirements/extract.mjs` | 198-281 | Extracts requirements from files after guarding against sensitive paths and escape attempts. | `scripts/requirements.mjs` |
| [`mergeRequirements`](../scripts/lib/requirements/extract.mjs#L77) | function | `scripts/lib/requirements/extract.mjs` | 77-110 | Clusters similar requirements across multiple extraction runs and merges them into deduplicated items with confidence levels. | `scripts/requirements.mjs` |
| [`normalizeAssertion`](../scripts/lib/requirements/extract.mjs#L54) | function | `scripts/lib/requirements/extract.mjs` | 54-56 | Normalizes a requirement assertion to lowercase, single-space-separated, without trailing punctuation. | `scripts/requirements.mjs` |
...
| [`createRNG`](../scripts/lib/rng.mjs#L43) | function | `scripts/lib/rng.mjs` | 43-66 | Creates an RNG object with optional seeding and beta distribution support. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/refine-prompts.mjs`, +1 more |
| [`randnWith`](../scripts/lib/rng.mjs#L10) | function | `scripts/lib/rng.mjs` | 10-15 | Generates a standard normal-distributed random number via Box-Muller transform. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/refine-prompts.mjs`, +1 more |
| [`randomBetaWith`](../scripts/lib/rng.mjs#L32) | function | `scripts/lib/rng.mjs` | 32-36 | Generates a beta-distributed random number by sampling two gamma variates. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/refine-prompts.mjs`, +1 more |
...
| [`reservoirSample`](../scripts/lib/rng.mjs#L75) | function | `scripts/lib/rng.mjs` | 75-86 | Selects k random items from an array using reservoir sampling. | `scripts/bandit.mjs`, `scripts/evolve-prompts.mjs`, `scripts/refine-prompts.mjs`, +1 more |
...
| [`buildContrarianStratifiedWorksheet`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L263) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 263-312 | Stratifies graded rows into buckets (contrarian, known-defect, high-dismissal, omission-dismissal) for targeted human review. | `scripts/cheap-triager-validate.mjs` |
| [`computeDatasetHash`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L396) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 396-398 | Generates a SHA-256 hash of combined Claude CSV and blind-map text for dataset integrity verification. | `scripts/cheap-triager-validate.mjs` |
| [`computeTwoJudgeConsensus`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L178) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 178-208 | Compares Claude and GPT gradings to compute consensus tiers, detecting duplicate rows and unrecognized labels. | `scripts/cheap-triager-validate.mjs` |
| [`computeValidationManifest`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L341) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 341-367 | Computes false-dismissal rates per stratum and determines whether a cheap-triager candidate passes validation thresholds. | `scripts/cheap-triager-validate.mjs` |
| [`labelTier`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L152) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 152-155 | Maps a grading label to a verdict tier (valid or dismissed) based on LABEL_FACTORS dictionary. | `scripts/cheap-triager-validate.mjs` |
| [`parseBlindCsv`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L109) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 109-142 | Parses a complete blind-coded CSV into row objects, validating headers and field counts per row. | `scripts/cheap-triager-validate.mjs` |
| [`parseCsvRecord`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L57) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 57-85 | Parses a single CSV record from text, handling quoted fields, escaped quotes, and line boundaries. | `scripts/cheap-triager-validate.mjs` |
| [`renderValidationMarkdown`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L371) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 371-390 | Renders a validation manifest as a markdown table showing strata, counts, false-dismissal rates, and 95% CIs. | `scripts/cheap-triager-validate.mjs` |
| [`retrofitEvidenceType`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L232) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 232-235 | Classifies a finding as an omission or commission based on signal keywords in its category and detail fields. | `scripts/cheap-triager-validate.mjs` |
| [`runCandidateTriage`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L415) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 415-427 | Runs a candidate model through a triaging adapter on each row and collects valid/dismissed verdicts. | `scripts/cheap-triager-validate.mjs` |
| [`wilsonScoreInterval`](../scripts/lib/solo-control/cheap-triager-validate.mjs#L322) | function | `scripts/lib/solo-control/cheap-triager-validate.mjs` | 322-329 | Computes a 95% confidence interval for a binomial proportion using the Wilson score method. | `scripts/cheap-triager-validate.mjs` |
...
| [`bestLabel`](../scripts/lib/solo-control/scoring.mjs#L28) | function | `scripts/lib/solo-control/scoring.mjs` | 28-28 | Returns the label with higher priority rank between two candidates. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`bootstrapCI`](../scripts/lib/solo-control/scoring.mjs#L137) | function | `scripts/lib/solo-control/scoring.mjs` | 137-150 | Generates 95% confidence interval for acceptance rate via bootstrap resampling with seeded PRNG. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`costPerKnownDefect`](../scripts/lib/solo-control/scoring.mjs#L196) | function | `scripts/lib/solo-control/scoring.mjs` | 196-204 | Divides total cost by matched known-defect count to produce cost-per-defect metric. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`htAcceptedRate`](../scripts/lib/solo-control/scoring.mjs#L127) | function | `scripts/lib/solo-control/scoring.mjs` | 127-135 | Computes Horvitz-Thompson weighted acceptance rate for findings using inclusion probabilities. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`scoreArms`](../scripts/lib/solo-control/scoring.mjs#L39) | function | `scripts/lib/solo-control/scoring.mjs` | 39-112 | Collapses multi-round finding rows into per-commit-arm-cluster items and computes acceptance rates + severity weights per arm. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`scoreMediumSampleWeighted`](../scripts/lib/solo-control/scoring.mjs#L162) | function | `scripts/lib/solo-control/scoring.mjs` | 162-175 | Samples findings stratified by arm and computes per-arm acceptance-rate estimates with bootstrap CI. | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`sevWeight`](../scripts/lib/solo-control/scoring.mjs#L22) | function | `scripts/lib/solo-control/scoring.mjs` | 22-22 | Maps severity string to numeric weight (HIGH=3, MEDIUM=2, LOW=1). | `scripts/lib/solo-control/cheap-triager-validate.mjs`, `scripts/solo-control-audit.mjs` |
| [`matchesKnownDefect`](../scripts/lib/solo-control/stratified-sample.mjs#L34) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 34-44 | Checks if a finding's commit and file match a known-defect entry, returning the defect ID if so. | `scripts/solo-control-audit.mjs` |
| [`stratifiedMediumSample`](../scripts/lib/solo-control/stratified-sample.mjs#L61) | function | `scripts/lib/solo-control/stratified-sample.mjs` | 61-134 | Samples clusters proportionally per commit with per-commit caps, using largest-remainder allocation and two-pass true-up. | `scripts/solo-control-audit.mjs` |
...
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L495) | function | `scripts/lib/sync-isolation-verify.mjs` | 495-508 | Formats gate results as human-readable pass/fail text | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L439) | function | `scripts/lib/sync-isolation-verify.mjs` | 439-454 | Reports uncommitted git state for operator decision (informational only) | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L170) | function | `scripts/lib/sync-isolation-verify.mjs` | 170-231 | Verifies scripts/.claude-skills/ is not tracked or staged in git | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L233) | function | `scripts/lib/sync-isolation-verify.mjs` | 233-265 | Validates manifest-declared files exist and match recorded SHA256 hashes | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L267) | function | `scripts/lib/sync-isolation-verify.mjs` | 267-296 | Detects stale source paths in command-bearing files | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L298) | function | `scripts/lib/sync-isolation-verify.mjs` | 298-362 | Runs CLI smoke tests and library import checks on synced tools | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L364) | function | `scripts/lib/sync-isolation-verify.mjs` | 364-411 | Reconciles npm run scripts against synced paths to find stale invocations | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L413) | function | `scripts/lib/sync-isolation-verify.mjs` | 413-420 | Verifies manifest.layout field equals "isolated" | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L422) | function | `scripts/lib/sync-isolation-verify.mjs` | 422-437 | Validates .gitignore managed block has matched begin/end markers in correct order | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L84) | function | `scripts/lib/sync-isolation-verify.mjs` | 84-87 | Computes SHA256 hash of a file | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L152) | function | `scripts/lib/sync-isolation-verify.mjs` | 152-162 | Lists files in specified paths that may contain npm command invocations | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L109) | function | `scripts/lib/sync-isolation-verify.mjs` | 109-128 | Loads and validates sync manifest from consumer repo | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L510) | function | `scripts/lib/sync-isolation-verify.mjs` | 510-536 | Entry point: parses args, runs gates, outputs results, exits with status code | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L89) | function | `scripts/lib/sync-isolation-verify.mjs` | 89-107 | Parses CLI args for consumer root, manifest, gates filter, output format | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L164) | function | `scripts/lib/sync-isolation-verify.mjs` | 164-166 | Converts absolute path to relative path with forward slashes | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L458) | function | `scripts/lib/sync-isolation-verify.mjs` | 458-485 | Executes specified isolation gates and returns results | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L487) | function | `scripts/lib/sync-isolation-verify.mjs` | 487-493 | Reports that --selfcheck-inventory only works on source side | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L130) | function | `scripts/lib/sync-isolation-verify.mjs` | 130-150 | Recursively walks directory yielding files, aborting on unreadable directories | _(internal)_ |
| [`compareToUpstream`](../scripts/lib/sync-manifest.mjs#L237) | function | `scripts/lib/sync-manifest.mjs` | 237-280 | Checks local files against upstream manifest hashes, categorizing as stale/missing/rejected | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`computeFileHashes`](../scripts/lib/sync-manifest.mjs#L101) | function | `scripts/lib/sync-manifest.mjs` | 101-125 | Computes hashes for files and collects validation errors | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`fetchUpstreamManifest`](../scripts/lib/sync-manifest.mjs#L292) | function | `scripts/lib/sync-manifest.mjs` | 292-356 | Fetches sync manifest from remote URL with timeout and maximum payload size | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`findRepoRoot`](../scripts/lib/sync-manifest.mjs#L147) | function | `scripts/lib/sync-manifest.mjs` | 147-157 | Locates git repository root from a starting directory | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`generateManifest`](../scripts/lib/sync-manifest.mjs#L166) | function | `scripts/lib/sync-manifest.mjs` | 166-185 | Generates sync manifest with file hashes, git metadata, and timestamp | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`getGitMeta`](../scripts/lib/sync-manifest.mjs#L127) | function | `scripts/lib/sync-manifest.mjs` | 127-139 | Extracts current git commit SHA and branch name | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`hashesEqual`](../scripts/lib/sync-manifest.mjs#L219) | function | `scripts/lib/sync-manifest.mjs` | 219-228 | Compares two file-hash maps for key-by-key equality | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`hashFile`](../scripts/lib/sync-manifest.mjs#L76) | function | `scripts/lib/sync-manifest.mjs` | 76-79 | Computes SHA256 hash of a file | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`isSourceRepo`](../scripts/lib/sync-manifest.mjs#L358) | function | `scripts/lib/sync-manifest.mjs` | 358-365 | Checks if repo is claude-engineering-skills by package.json name | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
| [`writeManifest`](../scripts/lib/sync-manifest.mjs#L187) | function | `scripts/lib/sync-manifest.mjs` | 187-217 | Writes manifest to disk atomically, skipping if content unchanged | `scripts/check-audit-tool-version.mjs`, `scripts/lib/remove-legacy-synced.mjs`, `scripts/lib/sync-isolation-verify.mjs`, +2 more |
...
> Persists architectural metadata to Postgres: domain summaries with LLM provenance, file-level import graphs for code dependency tracking, symbol embeddings, and neighbourhood queries to find similar symbols across the repo.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`chunk`](../scripts/lib/store/arch/_shared.mjs#L21) | function | `scripts/lib/store/arch/_shared.mjs` | 21-25 | Splits an array into chunks of size n. | `scripts/lib/store/arch/imports.mjs`, `scripts/lib/store/arch/symbols.mjs` |
...
| [`copyForwardUntouchedFiles`](../scripts/lib/store/arch/symbols.mjs#L233) | function | `scripts/lib/store/arch/symbols.mjs` | 233-292 | Copies symbol_index rows for unchanged files from one refresh to the next, optionally re-tagging domains. | `scripts/lib/store/arch-memory.mjs` |
| [`listLayeringViolationsForSnapshot`](../scripts/lib/store/arch/symbols.mjs#L206) | function | `scripts/lib/store/arch/symbols.mjs` | 206-226 | Retrieves all layering violations for a refresh run, ordered by rule name. | `scripts/lib/store/arch-memory.mjs` |
| [`listSymbolsForSnapshot`](../scripts/lib/store/arch/symbols.mjs#L154) | function | `scripts/lib/store/arch/symbols.mjs` | 154-204 | Queries symbol_index with optional filtering by kind/domain/path prefix, returning joined definition metadata. | `scripts/lib/store/arch-memory.mjs` |
| [`recordLayeringViolations`](../scripts/lib/store/arch/symbols.mjs#L123) | function | `scripts/lib/store/arch/symbols.mjs` | 123-147 | Batches and upserts architecture-layering-rule violations. | `scripts/lib/store/arch-memory.mjs` |
| [`recordSymbolDefinitions`](../scripts/lib/store/arch/symbols.mjs#L48) | function | `scripts/lib/store/arch/symbols.mjs` | 48-71 | Batches and upserts symbol-definition records (name, kind, path per repo). | `scripts/lib/store/arch-memory.mjs` |
| [`recordSymbolEmbedding`](../scripts/lib/store/arch/symbols.mjs#L101) | function | `scripts/lib/store/arch/symbols.mjs` | 101-121 | Inserts a symbol's embedding vector with pgvector::vector cast, handling model/dimension uniqueness. | `scripts/lib/store/arch-memory.mjs` |
| [`recordSymbolIndex`](../scripts/lib/store/arch/symbols.mjs#L73) | function | `scripts/lib/store/arch/symbols.mjs` | 73-99 | Batches and upserts symbol_index rows linking definitions to file locations and metadata. | `scripts/lib/store/arch-memory.mjs` |
| [`vectorLiteral`](../scripts/lib/store/arch/symbols.mjs#L28) | function | `scripts/lib/store/arch/symbols.mjs` | 28-42 | Validates a numeric vector and formats it as a pgvector SQL literal. | `scripts/lib/store/arch-memory.mjs` |
...
| [`getActionablePersonaOutcomeItems`](../scripts/lib/store/persona-outcomes.mjs#L253) | function | `scripts/lib/store/persona-outcomes.mjs` | 253-321 | Fetches actionable persona P0/P1 findings across recent sessions, deduped by hash, with labels and counts. | `scripts/cross-skill.mjs` |
| [`getPersonaOutcomesSummary`](../scripts/lib/store/persona-outcomes.mjs#L165) | function | `scripts/lib/store/persona-outcomes.mjs` | 165-223 | Summarizes the latest persona test session, counting P0/P1 findings and their outcome labels. | `scripts/cross-skill.mjs` |
| [`isP0OrP1`](../scripts/lib/store/persona-outcomes.mjs#L137) | function | `scripts/lib/store/persona-outcomes.mjs` | 137-139 | Returns true if a finding is coded P0 or P1. | `scripts/cross-skill.mjs` |
| [`resolveLabelTarget`](../scripts/lib/store/persona-outcomes.mjs#L40) | function | `scripts/lib/store/persona-outcomes.mjs` | 40-57 | Validates a persona finding hash matches a P0/P1 in a session and resolves its repo_id for durable labeling. | `scripts/cross-skill.mjs` |
| [`upsertPersonaFindingOutcome`](../scripts/lib/store/persona-outcomes.mjs#L98) | function | `scripts/lib/store/persona-outcomes.mjs` | 98-134 | Records or updates an outcome label (fixed/dismissed/stale) on a persona P0/P1 finding, retiring correlation data if dismissive. | `scripts/cross-skill.mjs` |
...
| [`callIncidentNeighbourhoodRpc`](../scripts/lib/store/security.mjs#L130) | function | `scripts/lib/store/security.mjs` | 130-152 | Calls the RPC to find security incidents near given paths/intent, returning scored results. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`chunk`](../scripts/lib/store/security.mjs#L20) | function | `scripts/lib/store/security.mjs` | 20-24 | Splits an array into size-n chunks. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`formatVectorOrNull`](../scripts/lib/store/security.mjs#L279) | function | `scripts/lib/store/security.mjs` | 279-285 | Formats a numeric embedding as a PostgreSQL vector literal or null. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getMaxIncidentRefreshAt`](../scripts/lib/store/security.mjs#L108) | function | `scripts/lib/store/security.mjs` | 108-123 | Returns the most recent update timestamp of any security incident in a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getSecurityEvents`](../scripts/lib/store/security.mjs#L198) | function | `scripts/lib/store/security.mjs` | 198-208 | Retrieves recent security events for a repo, ordered by recency. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getSecurityIncidentsByRepo`](../scripts/lib/store/security.mjs#L74) | function | `scripts/lib/store/security.mjs` | 74-83 | Retrieves security incidents for a repo with status and mitigation metadata. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`getSecurityStats`](../scripts/lib/store/security.mjs#L221) | function | `scripts/lib/store/security.mjs` | 221-270 | Aggregates security stats: incident counts by status, embedding coverage, event histograms. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`markIncidentsHistorical`](../scripts/lib/store/security.mjs#L90) | function | `scripts/lib/store/security.mjs` | 90-100 | Marks a set of security incidents as historical. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordSecurityEvents`](../scripts/lib/store/security.mjs#L169) | function | `scripts/lib/store/security.mjs` | 169-192 | Appends security-event audit-trail records (append-only, chunked). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordSecurityIncidents`](../scripts/lib/store/security.mjs#L41) | function | `scripts/lib/store/security.mjs` | 41-68 | Upserts batches of security incidents with embeddings and mitigation refs to the cloud store. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
...
| [`extractSnippet`](../tests/hook-snippet-behaviour.test.mjs#L35) | function | `tests/hook-snippet-behaviour.test.mjs` | 35-45 | Parses and extracts a bash code snippet from a markdown file between fence markers. | _(internal)_ |
...
| [`assertFixtureMatchesLive`](../tests/learning-store-contract.test.mjs#L160) | function | `tests/learning-store-contract.test.mjs` | 160-176 | Validates that test fixtures match live database behavior; currently a placeholder pending M3 implementation. | _(internal)_ |
...
| [`bootstrapContract`](../scripts/lib/visual/contract.mjs#L72) | function | `scripts/lib/visual/contract.mjs` | 72-97 | Generates a template visual contract with example surfaces, policy defaults, and placeholder token/theme declarations. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/visual-audit.mjs` |
| [`contractExists`](../scripts/lib/visual/contract.mjs#L61) | function | `scripts/lib/visual/contract.mjs` | 61-63 | Checks if a visual-contract.json file exists in the given directory. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/visual-audit.mjs` |
| [`readContract`](../scripts/lib/visual/contract.mjs#L23) | function | `scripts/lib/visual/contract.mjs` | 23-54 | Reads and validates a visual-contract.json file, returning the parsed contract or detailed error information. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/visual-audit.mjs` |
| [`writeContract`](../scripts/lib/visual/contract.mjs#L106) | function | `scripts/lib/visual/contract.mjs` | 106-118 | Writes a visual contract to disk after validation, refusing to overwrite by default. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/visual-audit.mjs` |
...
| [`ageDivergences`](../scripts/lib/visual/drift.mjs#L43) | function | `scripts/lib/visual/drift.mjs` | 43-51 | Calculates age in days for each visual finding from its first-seen date. | `scripts/visual-audit.mjs` |
| [`assessCaptureIntegrity`](../scripts/lib/visual/drift.mjs#L63) | function | `scripts/lib/visual/drift.mjs` | 63-74 | Assesses how many declared surfaces were successfully captured versus stalled/empty. | `scripts/visual-audit.mjs` |
| [`divergenceKey`](../scripts/lib/visual/drift.mjs#L12) | function | `scripts/lib/visual/drift.mjs` | 12-14 | Creates unique identifier for a visual finding based on class, surface, node, and property. | `scripts/visual-audit.mjs` |
| [`firstSeenFromHistory`](../scripts/lib/visual/drift.mjs#L103) | function | `scripts/lib/visual/drift.mjs` | 103-113 | Creates lookup function mapping finding keys to their first-seen dates from history. | `scripts/visual-audit.mjs` |
| [`gateUnverifiedReason`](../scripts/lib/visual/drift.mjs#L89) | function | `scripts/lib/visual/drift.mjs` | 89-100 | Returns explanation of why visual audit gate cannot run due to missing/degraded surfaces. | `scripts/visual-audit.mjs` |
| [`partitionFindings`](../scripts/lib/visual/drift.mjs#L21) | function | `scripts/lib/visual/drift.mjs` | 21-25 | Groups findings into gate-eligible and advisory buckets. | `scripts/visual-audit.mjs` |
| [`scopeToChanged`](../scripts/lib/visual/drift.mjs#L33) | function | `scripts/lib/visual/drift.mjs` | 33-35 | Filters gate-eligible findings to those in changed files. | `scripts/visual-audit.mjs` |
...
| [`arrSort`](../scripts/lib/visual/schema.mjs#L303) | function | `scripts/lib/visual/schema.mjs` | 303-305 | Sorts an array to strings or returns an empty array. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
| [`computeConfigDigest`](../scripts/lib/visual/schema.mjs#L299) | function | `scripts/lib/visual/schema.mjs` | 299-301 | Hashes the adapter version and contract digest together. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
| [`computeContractDigest`](../scripts/lib/visual/schema.mjs#L260) | function | `scripts/lib/visual/schema.mjs` | 260-291 | Hashes a normalized visual contract for staleness detection. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
