...
- Generated: 2026-07-16T20:11:26.301Z   commit: d9079931b205   refresh_id: 585078ec-c781-481d-8235-367f684e350a
- Drift score: 28 / threshold 20   status: `RED`
- Domains: 23   Symbols: 3132   Layering violations: 0
...
- [shared-lib](#shared-lib) — 942 symbols
- [stores](#stores) — 208 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 428 symbols
...
> Orchestrates multi-LLM audit execution via subprocess piping: GPT code/plan analysis followed by mandatory Gemini final review, supporting single-pass and iterative convergence modes. Manages result parsing and cleanup of transient audit artifacts (worktrees, caches).
...
> Manifests skills (per-file and bundle-version hashes, summaries), generates artifact copies to `.claude/skills/`, and validates that synced copies remain fresh via hash reconciliation.
...
_Domain has 139 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`cleanupJournal`](../scripts/lib/install/transaction.mjs#L201) | function | `scripts/lib/install/transaction.mjs` | 201-204 | Delete the transaction journal file. | `scripts/install-skills.mjs` |
| [`defaultJournalPath`](../scripts/lib/install/transaction.mjs#L246) | function | `scripts/lib/install/transaction.mjs` | 246-248 | Return the default path for the install transaction journal. | `scripts/install-skills.mjs` |
| [`executeTransaction`](../scripts/lib/install/transaction.mjs#L82) | function | `scripts/lib/install/transaction.mjs` | 82-177 | Execute atomic multi-file writes with snapshot backups, temp staging, and rollback support. | `scripts/install-skills.mjs` |
| [`fsyncFile`](../scripts/lib/install/transaction.mjs#L50) | function | `scripts/lib/install/transaction.mjs` | 50-52 | Call fsync on a file descriptor with graceful failure handling. | `scripts/install-skills.mjs` |
| [`recoverFromJournal`](../scripts/lib/install/transaction.mjs#L212) | function | `scripts/lib/install/transaction.mjs` | 212-244 | Resume or undo incomplete transactions by rolling forward staged renames or rolling back staged writes. | `scripts/install-skills.mjs` |
| [`rollbackPartialTransaction`](../scripts/lib/install/transaction.mjs#L179) | function | `scripts/lib/install/transaction.mjs` | 179-199 | Restore partially-completed writes by reverting them to their pre-transaction snapshots. | `scripts/install-skills.mjs` |
| [`shaShort`](../scripts/lib/install/transaction.mjs#L46) | function | `scripts/lib/install/transaction.mjs` | 46-48 | Compute a 12-character short SHA256 hash of file content. | `scripts/install-skills.mjs` |
| [`tmpSuffix`](../scripts/lib/install/transaction.mjs#L41) | function | `scripts/lib/install/transaction.mjs` | 41-44 | Generate a unique suffix for temporary files using PID, timestamp, and random bits. | `scripts/install-skills.mjs` |
| [`writeJournal`](../scripts/lib/install/transaction.mjs#L59) | function | `scripts/lib/install/transaction.mjs` | 59-71 | Write a transaction journal entry atomically for crash recovery tracking. | `scripts/install-skills.mjs` |
...
> CLI orchestration for AI pair-programming: multi-LLM code audit (GPT/Gemini/Claude), Playwright UX testing, deployment gates, and Postgres-backed learning across the planning-to-shipping lifecycle.
...
> Shared-lib provides the foundational layer for all audit-loop CLI tools: LLM client configuration (Anthropic SDK/CLI adapter + backend routing), secret redaction, and common utilities (config resolution, string formatting, sensitive-path filtering). Every CLI entry point and library module depends on these exports.
...
_Domain has 942 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
> Test-first coverage of deterministic seams: fixture builders, schema/config parsing (SQL/markdown/Python/Java), sensitive-path filtering, VCS contracts, DB integration, and consumer-repo relocation safety.
...
_Domain has 428 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`mkRepo`](../tests/install/gitignore.test.mjs#L34) | function | `tests/install/gitignore.test.mjs` | 34-40 | Creates a temporary directory optionally containing a package.json. | _(internal)_ |
...
| [`extractFullHookBody`](../tests/maintenance-hook-snippet.test.mjs#L42) | function | `tests/maintenance-hook-snippet.test.mjs` | 42-53 | Extracts the shell hook body template from the maintenance-checks source file. | _(internal)_ |
| [`extractSnippet`](../tests/maintenance-hook-snippet.test.mjs#L55) | function | `tests/maintenance-hook-snippet.test.mjs` | 55-68 | Extracts the weekly maintenance snippet from the hook source between marked regions. | _(internal)_ |
| [`runSnippet`](../tests/maintenance-hook-snippet.test.mjs#L70) | function | `tests/maintenance-hook-snippet.test.mjs` | 70-109 | Executes a bash snippet in a temporary environment, optionally with simulated delay. | _(internal)_ |
| [`waitForLog`](../tests/maintenance-hook-snippet.test.mjs#L114) | function | `tests/maintenance-hook-snippet.test.mjs` | 114-124 | Polls for a maintenance log file and returns its content before timeout. | _(internal)_ |
...
| [`wellFormed`](../tests/rulings-block-guard.test.mjs#L24) | function | `tests/rulings-block-guard.test.mjs` | 24-36 | Returns a fixture adjudication ledger entry with standard fields. | _(internal)_ |
| [`writeLedger`](../tests/rulings-block-guard.test.mjs#L20) | function | `tests/rulings-block-guard.test.mjs` | 20-22 | Writes a ledger object as JSON to a file. | _(internal)_ |
