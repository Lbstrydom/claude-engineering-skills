...
- Generated: 2026-06-27T06:42:14.048Z   commit: b3572405c96f   refresh_id: e926711a-4e21-4ed0-837b-baf739ea8f27
- Drift score: 30 / threshold 20   status: `RED`
- Domains: 24   Symbols: 2324   Layering violations: 0
...
- [cross-skill-bridge](#cross-skill-bridge) — 59 symbols
...
- [nav-audit](#nav-audit) — 118 symbols
...
- [stores](#stores) — 137 symbols
- [tech-debt](#tech-debt) — 71 symbols
- [tests](#tests) — 295 symbols
- [ux-lock](#ux-lock) — 20 symbols
- [visual-audit](#visual-audit) — 83 symbols
...
> The `audit-orchestration` domain orchestrates multi-stage security audits by sequencing child processes (OpenAI audit, Gemini review, optional final review), tracking convergence criteria (zero HIGH findings, ≤2 MEDIUM), and managing temporary files and session IDs for each audit run.
...
| [`_collectMaxLengths`](../scripts/gemini-review.mjs#L116) | function | `scripts/gemini-review.mjs` | 116-134 | Recursively traverses a JSON schema to collect maxLength constraints for all string fields. | _(internal)_ |
| [`addSemanticIds`](../scripts/gemini-review.mjs#L1375) | function | `scripts/gemini-review.mjs` | 1375-1383 | Assigns semantic IDs and hashes to review findings for deduplication and tracking. | _(internal)_ |
| [`applyDebtSuppression`](../scripts/gemini-review.mjs#L1308) | function | `scripts/gemini-review.mjs` | 1308-1343 | Suppresses new findings that match previously filtered debt items using similarity scoring. | _(internal)_ |
| [`applyProviderSetting`](../scripts/gemini-review.mjs#L1202) | function | `scripts/gemini-review.mjs` | 1202-1220 | Updates or removes the persistent provider setting in a .env file. | _(internal)_ |
| [`applyScopeFilter`](../scripts/gemini-review.mjs#L1345) | function | `scripts/gemini-review.mjs` | 1345-1373 | Filters new findings to only those citing files in the changed_files list. | _(internal)_ |
| [`assertAzureClaudeReady`](../scripts/gemini-review.mjs#L1253) | function | `scripts/gemini-review.mjs` | 1253-1264 | <no body> | _(internal)_ |
| [`buildClient`](../scripts/gemini-review.mjs#L1266) | function | `scripts/gemini-review.mjs` | 1266-1281 | Builds an LLM client for the selected provider (Gemini, Azure Claude, or Anthropic Claude). | _(internal)_ |
| [`buildShadowClient`](../scripts/gemini-review.mjs#L901) | function | `scripts/gemini-review.mjs` | 901-907 | <no body> | _(internal)_ |
| [`callAzureClaude`](../scripts/gemini-review.mjs#L535) | function | `scripts/gemini-review.mjs` | 535-600 | Calls Claude via Azure Foundry with support for both Anthropic and OpenAI-compatible API shapes. | _(internal)_ |
| [`callClaudeOpus`](../scripts/gemini-review.mjs#L455) | function | `scripts/gemini-review.mjs` | 455-524 | Calls Claude Opus via the Anthropic SDK with streaming, timeout, and Zod schema validation. | _(internal)_ |
| [`callGemini`](../scripts/gemini-review.mjs#L308) | function | `scripts/gemini-review.mjs` | 308-405 | Calls the Gemini API with streaming support, JSON schema validation, and timeout handling. | _(internal)_ |
| [`dedupByHash`](../scripts/gemini-review.mjs#L933) | function | `scripts/gemini-review.mjs` | 933-941 | Deduplicates findings by hash, keeping the first occurrence of each unique finding. | _(internal)_ |
| [`diffFindingBuckets`](../scripts/gemini-review.mjs#L948) | function | `scripts/gemini-review.mjs` | 948-964 | Compares primary and shadow findings to categorize them as shared, primary-only, or shadow-only. | _(internal)_ |
| [`emitReviewOutput`](../scripts/gemini-review.mjs#L1385) | function | `scripts/gemini-review.mjs` | 1385-1400 | Emits review results as JSON or formatted markdown depending on output mode. | _(internal)_ |
| [`formatReviewResult`](../scripts/gemini-review.mjs#L776) | function | `scripts/gemini-review.mjs` | 776-839 | Formats an LLM review result as markdown with verdict, deliberation quality, architecture scores, and findings. | _(internal)_ |
| [`getReviewPrompt`](../scripts/gemini-review.mjs#L289) | function | `scripts/gemini-review.mjs` | 289-291 | Returns the active gemini-review system prompt or a default review prompt. | _(internal)_ |
| [`isJsonTruncationError`](../scripts/gemini-review.mjs#L1283) | function | `scripts/gemini-review.mjs` | 1283-1287 | Checks if an error message indicates JSON parsing failure. | _(internal)_ |
| [`main`](../scripts/gemini-review.mjs#L1471) | function | `scripts/gemini-review.mjs` | 1471-1520 | Main entry point that routes to ping/set-provider/review modes and orchestrates the full review workflow. | _(internal)_ |
| [`parseReviewArgs`](../scripts/gemini-review.mjs#L1108) | function | `scripts/gemini-review.mjs` | 1108-1123 | Parses review CLI arguments to extract plan file, transcript file, output options, and mode flags. | _(internal)_ |
| [`recordGeminiOutcomes`](../scripts/gemini-review.mjs#L1447) | function | `scripts/gemini-review.mjs` | 1447-1469 | Updates learning bandit with verdict rewards and flushes outcome data to persistent storage. | _(internal)_ |
| [`recordNewFindings`](../scripts/gemini-review.mjs#L1402) | function | `scripts/gemini-review.mjs` | 1402-1421 | Records new findings to outcomes.jsonl and updates the fingerprint tracker for learning. | _(internal)_ |
| [`recordWronglyDismissed`](../scripts/gemini-review.mjs#L1423) | function | `scripts/gemini-review.mjs` | 1423-1445 | Records wrongly dismissed findings to outcomes.jsonl for auditing and learning. | _(internal)_ |
| [`refreshCatalogAndWarn`](../scripts/gemini-review.mjs#L1048) | function | `scripts/gemini-review.mjs` | 1048-1069 | Refreshes LLM model catalog and upgrades Gemini/Claude references to latest available versions. | _(internal)_ |
| [`resolveProviderSetting`](../scripts/gemini-review.mjs#L1185) | function | `scripts/gemini-review.mjs` | 1185-1188 | Retrieves the persistent provider setting from environment variables. | _(internal)_ |
| [`resolveShadow`](../scripts/gemini-review.mjs#L872) | function | `scripts/gemini-review.mjs` | 872-898 | Resolves shadow reviewer configuration to derive provider, model, and readiness state. | _(internal)_ |
| [`runFinalReview`](../scripts/gemini-review.mjs#L613) | function | `scripts/gemini-review.mjs` | 613-772 | Runs the final review by reading transcripts/code files, gathering context, and invoking an LLM reviewer. | _(internal)_ |
| [`runPing`](../scripts/gemini-review.mjs#L1101) | function | `scripts/gemini-review.mjs` | 1101-1106 | Runs connectivity checks for available LLM APIs (Gemini or Claude). | _(internal)_ |
| [`runPingClaude`](../scripts/gemini-review.mjs#L1083) | function | `scripts/gemini-review.mjs` | 1083-1099 | Pings Claude Opus API to verify connectivity and model availability. | _(internal)_ |
| [`runPingGemini`](../scripts/gemini-review.mjs#L1071) | function | `scripts/gemini-review.mjs` | 1071-1081 | Pings Gemini API to verify connectivity and model availability. | _(internal)_ |
| [`runReviewWithRetry`](../scripts/gemini-review.mjs#L1289) | function | `scripts/gemini-review.mjs` | 1289-1306 | Retries final review with truncation instructions if JSON parsing fails. | _(internal)_ |
| [`runSetProvider`](../scripts/gemini-review.mjs#L1227) | function | `scripts/gemini-review.mjs` | 1227-1247 | CLI command to set the default LLM provider for final reviews (gemini, azure-claude, anthropic, or default). | _(internal)_ |
| [`runShadowAndPersist`](../scripts/gemini-review.mjs#L986) | function | `scripts/gemini-review.mjs` | 986-1042 | Orchestrates shadow review execution, compares findings against primary, and records results. | _(internal)_ |
| [`runShadowReview`](../scripts/gemini-review.mjs#L914) | function | `scripts/gemini-review.mjs` | 914-924 | Runs a shadow (secondary) review with a configured model and applies post-processing filters. | _(internal)_ |
| [`selectProvider`](../scripts/gemini-review.mjs#L1145) | function | `scripts/gemini-review.mjs` | 1145-1182 | Selects the LLM provider based on explicit choice, environment settings, or auto-detection fallback. | _(internal)_ |
| [`shadowModelMatchesFamily`](../scripts/gemini-review.mjs#L858) | function | `scripts/gemini-review.mjs` | 858-863 | Determines if a model ID belongs to a specified LLM family (gemini or claude-like). | _(internal)_ |
| [`shadowSkipBlock`](../scripts/gemini-review.mjs#L967) | function | `scripts/gemini-review.mjs` | 967-972 | Returns a skip-block structure when shadow review is not ready. | _(internal)_ |
| [`streamAnthropicMessage`](../scripts/gemini-review.mjs#L435) | function | `scripts/gemini-review.mjs` | 435-453 | Adapts Anthropic streaming responses into a standard {content, usage} format for consistent parsing. | _(internal)_ |
| [`truncateToSchema`](../scripts/gemini-review.mjs#L148) | function | `scripts/gemini-review.mjs` | 148-168 | Recursively truncates object fields to match schema maxLength constraints and tracks what was truncated. | _(internal)_ |
...
| [`_callGPTOnce`](../scripts/openai-audit.mjs#L569) | function | `scripts/openai-audit.mjs` | 569-675 | Executes a single GPT API call with timeout, retries on failure, and usage tracking. | _(internal)_ |
| [`applyExclusions`](../scripts/openai-audit.mjs#L160) | function | `scripts/openai-audit.mjs` | 160-169 | Filters out files matching exclusion patterns and logs the count of excluded files. | _(internal)_ |
| [`buildCachePrompt`](../scripts/openai-audit.mjs#L440) | function | `scripts/openai-audit.mjs` | 440-457 | Builds a cache-compatible prompt combining system rubric, code, and prior rulings for an audit pass. | _(internal)_ |
| [`cachePassResult`](../scripts/openai-audit.mjs#L772) | function | `scripts/openai-audit.mjs` | 772-780 | Writes a single pass result to the cache directory as JSON. | _(internal)_ |
| [`cacheWaveResults`](../scripts/openai-audit.mjs#L782) | function | `scripts/openai-audit.mjs` | 782-787 | Caches multiple pass results to disk and logs completion. | _(internal)_ |
| [`callGPT`](../scripts/openai-audit.mjs#L681) | function | `scripts/openai-audit.mjs` | 681-722 | Wraps GPT calls with automatic retry logic, exponential backoff, and accumulated token usage tracking. | _(internal)_ |
| [`cleanupCache`](../scripts/openai-audit.mjs#L789) | function | `scripts/openai-audit.mjs` | 789-792 | Cleans up the temporary result cache directory. | _(internal)_ |
| [`decideSeed`](../scripts/openai-audit.mjs#L872) | function | `scripts/openai-audit.mjs` | 872-917 | Decides whether to use cache-seeding optimization by selecting the smallest audit unit and validating prefix size. | _(internal)_ |
| [`deriveFindingsFromReport`](../scripts/openai-audit.mjs#L1445) | function | `scripts/openai-audit.mjs` | 1445-1505 | Converts architecture report violations and unmapped files into audit findings with severity and recommendations. | _(internal)_ |
| [`formatViolationsForPrompt`](../scripts/openai-audit.mjs#L1389) | function | `scripts/openai-audit.mjs` | 1389-1438 | Renders mechanical architecture violations and dead intent as markdown report sections. | _(internal)_ |
| [`getPassPrompt`](../scripts/openai-audit.mjs#L369) | function | `scripts/openai-audit.mjs` | 369-373 | Retrieves a registered prompt for a pass, falling back to a built-in default. | _(internal)_ |
| [`initResultCache`](../scripts/openai-audit.mjs#L762) | function | `scripts/openai-audit.mjs` | 762-770 | Initializes a temporary cache directory for storing individual pass results during audit execution. | _(internal)_ |
| [`loadExcludePatterns`](../scripts/openai-audit.mjs#L141) | function | `scripts/openai-audit.mjs` | 141-152 | Loads exclusion patterns from CLI arguments and a `.auditignore` file. | _(internal)_ |
| [`main`](../scripts/openai-audit.mjs#L3118) | function | `scripts/openai-audit.mjs` | 3118-3643 | Main entry point that refreshes model catalog, validates audit-tool version staleness, and delegates to runAudit. | _(internal)_ |
| [`normalisePromptInput`](../scripts/openai-audit.mjs#L476) | function | `scripts/openai-audit.mjs` | 476-507 | Converts prompt input to standardized message format, supporting both legacy and structured modes. | _(internal)_ |
| [`normalizeFindingsForOutput`](../scripts/openai-audit.mjs#L796) | function | `scripts/openai-audit.mjs` | 796-798 | <no body> | _(internal)_ |
| [`orphanToStandardFinding`](../scripts/openai-audit.mjs#L1262) | function | `scripts/openai-audit.mjs` | 1262-1284 | Transforms a raw orphan-introduced finding into a standardized finding object with classification metadata. | _(internal)_ |
| [`parseStructured`](../scripts/openai-audit.mjs#L527) | function | `scripts/openai-audit.mjs` | 527-567 | Calls OpenAI's structured responses API with fallback to chat-completions with Zod schema formatting. | _(internal)_ |
| [`printCostPreflight`](../scripts/openai-audit.mjs#L97) | function | `scripts/openai-audit.mjs` | 97-115 | Estimates and logs the OpenAI API cost for an audit pass before execution. | _(internal)_ |
| [`resolveDiffBase`](../scripts/openai-audit.mjs#L3111) | function | `scripts/openai-audit.mjs` | 3111-3114 | Resolves the git base reference for diff comparison, using explicit base or HEAD/HEAD~1 based on working tree state. | _(internal)_ |
| [`runArchitecturePass`](../scripts/openai-audit.mjs#L1127) | function | `scripts/openai-audit.mjs` | 1127-1252 | Validates architecture intent and domain-map files, then runs architecture analysis via GPT. | _(internal)_ |
| [`runMapReducePass`](../scripts/openai-audit.mjs#L951) | function | `scripts/openai-audit.mjs` | 951-1109 | Orchestrates the map phase by building audit units, running them in parallel with optional cache-seeding, then the reduce phase. | _(internal)_ |
| [`runMultiPassCodeAudit`](../scripts/openai-audit.mjs#L1507) | function | `scripts/openai-audit.mjs` | 1507-3090 | Orchestrates the entire audit run: loads scope, runs passes (architecture, orphan, and audit passes), merges findings, and outputs results. | _(internal)_ |
| [`runOneMapUnit`](../scripts/openai-audit.mjs#L922) | function | `scripts/openai-audit.mjs` | 922-949 | Executes a single map-phase audit unit in parallel with concurrency control and slot management. | _(internal)_ |
| [`runOrphanIntroducedPass`](../scripts/openai-audit.mjs#L1303) | function | `scripts/openai-audit.mjs` | 1303-1382 | Detects orphaned files by comparing HEAD call-graph against diff scope, building findings with suppression support. | _(internal)_ |
| [`safeCallGPT`](../scripts/openai-audit.mjs#L733) | function | `scripts/openai-audit.mjs` | 733-750 | Safely calls GPT with graceful degradation to empty results on non-config errors. | _(internal)_ |
| [`shouldMapReduce`](../scripts/openai-audit.mjs#L190) | function | `scripts/openai-audit.mjs` | 190-194 | Determines whether to use map-reduce parallelization based on file count or total character size. | _(internal)_ |
| [`shouldMapReduceHighReasoning`](../scripts/openai-audit.mjs#L201) | function | `scripts/openai-audit.mjs` | 201-205 | <no body> | _(internal)_ |
| [`throwIfConfigError`](../scripts/openai-audit.mjs#L855) | function | `scripts/openai-audit.mjs` | 855-861 | Re-throws config-category LlmErrors from settled promises to surface programmer bugs immediately. | _(internal)_ |
| [`validateLedgerForR2`](../scripts/openai-audit.mjs#L808) | function | `scripts/openai-audit.mjs` | 808-827 | Validates a ledger file exists and contains valid JSON entries for R2+ suppression rules. | _(internal)_ |
| [`wireModel`](../scripts/openai-audit.mjs#L512) | function | `scripts/openai-audit.mjs` | 512-514 | Returns the active Azure GPT deployment name or falls back to the default MODEL. | _(internal)_ |
...
> The `cross-skill-bridge` domain provides CLI tooling to manage learning plans and witness records, including commands to create/update plans, log learning activities with sensitive data redaction, and query learning candidates from a repository.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`argOption`](../scripts/cross-skill.mjs#L122) | function | `scripts/cross-skill.mjs` | 122-126 | Extracts the value of a named command-line option (e.g., --foo returns the next argument). | _(internal)_ |
| [`cmdAbortRefreshRun`](../scripts/cross-skill.mjs#L1069) | function | `scripts/cross-skill.mjs` | 1069-1079 | Aborts an in-progress refresh run with an optional reason. | _(internal)_ |
| [`cmdAddPersona`](../scripts/cross-skill.mjs#L660) | function | `scripts/cross-skill.mjs` | 660-672 | Creates or retrieves a persona by name, description, and app URL. | _(internal)_ |
| [`cmdAuditEffectiveness`](../scripts/cross-skill.mjs#L502) | function | `scripts/cross-skill.mjs` | 502-509 | Fetches the latest fix-state summary for a given repository. | _(internal)_ |
| [`cmdComputeDriftScore`](../scripts/cross-skill.mjs#L1173) | function | `scripts/cross-skill.mjs` | 1173-1184 | Computes an architectural drift score comparing snapshots. | _(internal)_ |
| [`cmdComputeTargetDomains`](../scripts/cross-skill.mjs#L928) | function | `scripts/cross-skill.mjs` | 928-940 | Tags code paths with domain classifications based on loaded rules. | _(internal)_ |
| [`cmdDetectStack`](../scripts/cross-skill.mjs#L841) | function | `scripts/cross-skill.mjs` | 841-858 | Detects the tech stack in a directory and optionally includes the environment manager. | _(internal)_ |
| [`cmdFinalizeOutcomes`](../scripts/cross-skill.mjs#L558) | function | `scripts/cross-skill.mjs` | 558-630 | Finalizes audit outcomes by merging a ledger of user actions with audit results and writing to local/cloud storage. | _(internal)_ |
| [`cmdFinalReviewAdjudicate`](../scripts/cross-skill.mjs#L522) | function | `scripts/cross-skill.mjs` | 522-536 | Updates a finding's action status (accepted or dismissed) in a run by fingerprint. | _(internal)_ |
| [`cmdFinalReviewStats`](../scripts/cross-skill.mjs#L513) | function | `scripts/cross-skill.mjs` | 513-520 | Retrieves final review statistics for a repository with optional queue limit filtering. | _(internal)_ |
| [`cmdFrictionLog`](../scripts/cross-skill.mjs#L1298) | function | `scripts/cross-skill.mjs` | 1298-1303 | Executes friction log collection and analysis. | _(internal)_ |
| [`cmdGetActiveRefreshId`](../scripts/cross-skill.mjs#L878) | function | `scripts/cross-skill.mjs` | 878-894 | Retrieves the active snapshot refresh ID and embedding metadata for a given repository UUID. | _(internal)_ |
| [`cmdGetCallersForFile`](../scripts/cross-skill.mjs#L942) | function | `scripts/cross-skill.mjs` | 942-1005 | Fetches caller information and domain tags for a symbol from the import graph snapshot. | _(internal)_ |
| [`cmdGetIncidentNeighbourhood`](../scripts/cross-skill.mjs#L896) | function | `scripts/cross-skill.mjs` | 896-926 | Executes a neighbourhood graph query to find related symbols and architectural context. | _(internal)_ |
| [`cmdGetNeighbourhood`](../scripts/cross-skill.mjs#L1007) | function | `scripts/cross-skill.mjs` | 1007-1035 | Retrieves neighbourhood graph records and truncation status for a repository. | _(internal)_ |
| [`cmdGetPersonaSessionsByRepo`](../scripts/cross-skill.mjs#L740) | function | `scripts/cross-skill.mjs` | 740-768 | Queries audit findings for a repository with optional limit, P0-only filter, and column selection. | _(internal)_ |
| [`cmdGetPersonaSessionsByUrl`](../scripts/cross-skill.mjs#L813) | function | `scripts/cross-skill.mjs` | 813-839 | Queries an app URL and returns paginated rows with optional column selection. | _(internal)_ |
| [`cmdGetRecentFindings`](../scripts/cross-skill.mjs#L775) | function | `scripts/cross-skill.mjs` | 775-805 | Resolves repository identity and fetches security findings filtered by repo, limit, and severity. | _(internal)_ |
| [`cmdLearningBackfillOutcomes`](../scripts/cross-skill.mjs#L1282) | function | `scripts/cross-skill.mjs` | 1282-1292 | Backfills learning outcomes from audit decisions. | _(internal)_ |
| [`cmdLearningQuickfixStats`](../scripts/cross-skill.mjs#L1325) | function | `scripts/cross-skill.mjs` | 1325-1351 | Manages quickfix pattern stats via rebuild or stats query. | _(internal)_ |
| [`cmdLearningRecord`](../scripts/cross-skill.mjs#L1201) | function | `scripts/cross-skill.mjs` | 1201-1240 | Records a decision with context, choice, and optional outcome for learning. | _(internal)_ |
| [`cmdLearningReplay`](../scripts/cross-skill.mjs#L1310) | function | `scripts/cross-skill.mjs` | 1310-1318 | Runs learning decision replay with optional CLI output. | _(internal)_ |
| [`cmdLearningStats`](../scripts/cross-skill.mjs#L1247) | function | `scripts/cross-skill.mjs` | 1247-1258 | Retrieves learning statistics aggregated by repository. | _(internal)_ |
| [`cmdLearningWeeklyReview`](../scripts/cross-skill.mjs#L1266) | function | `scripts/cross-skill.mjs` | 1266-1274 | Runs a weekly learning review and outputs results in JSON or text format. | _(internal)_ |
| [`cmdListConsistencyCandidates`](../scripts/cross-skill.mjs#L295) | function | `scripts/cross-skill.mjs` | 295-308 | Queries learning candidates for a given repo since a timestamp with optional limit. | _(internal)_ |
| [`cmdListLayeringViolationsForSnapshot`](../scripts/cross-skill.mjs#L1160) | function | `scripts/cross-skill.mjs` | 1160-1171 | Retrieves violations recorded during a refresh run. | _(internal)_ |
| [`cmdListPersonas`](../scripts/cross-skill.mjs#L638) | function | `scripts/cross-skill.mjs` | 638-649 | Lists all personas configured for a given app URL. | _(internal)_ |
| [`cmdListPersonaTestCandidates`](../scripts/cross-skill.mjs#L348) | function | `scripts/cross-skill.mjs` | 348-360 | Queries token violation canaries for a repo with age and occurrence filters. | _(internal)_ |
| [`cmdListSymbolsForSnapshot`](../scripts/cross-skill.mjs#L1147) | function | `scripts/cross-skill.mjs` | 1147-1158 | Fetches symbol index rows recorded during a refresh. | _(internal)_ |
| [`cmdListUnlockedFixes`](../scripts/cross-skill.mjs#L494) | function | `scripts/cross-skill.mjs` | 494-500 | Fetches unlocked fixes available for a repository. | _(internal)_ |
| [`cmdMarkPersonaTestCandidateProposed`](../scripts/cross-skill.mjs#L362) | function | `scripts/cross-skill.mjs` | 362-374 | Dismisses a token violation canary by repo name and fingerprint. | _(internal)_ |
| [`cmdOpenRefreshRun`](../scripts/cross-skill.mjs#L1037) | function | `scripts/cross-skill.mjs` | 1037-1055 | Opens a new refresh run for architecture indexing and optionally creates the repo if missing. | _(internal)_ |
| [`cmdPlanSatisfaction`](../scripts/cross-skill.mjs#L446) | function | `scripts/cross-skill.mjs` | 446-456 | Fetches plan satisfaction row and persistent failures for a given plan ID. | _(internal)_ |
| [`cmdPromoteRegressionSpec`](../scripts/cross-skill.mjs#L310) | function | `scripts/cross-skill.mjs` | 310-323 | Promotes a learning candidate to a spec with path and promoting user metadata. | _(internal)_ |
| [`cmdPublishRefreshRun`](../scripts/cross-skill.mjs#L1057) | function | `scripts/cross-skill.mjs` | 1057-1067 | Publishes a completed refresh run to finalize architecture changes. | _(internal)_ |
| [`cmdRecordCorrelation`](../scripts/cross-skill.mjs#L394) | function | `scripts/cross-skill.mjs` | 394-411 | Correlates a persona finding with an audit finding via hash and severity matching. | _(internal)_ |
| [`cmdRecordLayeringViolations`](../scripts/cross-skill.mjs#L1121) | function | `scripts/cross-skill.mjs` | 1121-1133 | Records architecture constraint violations during a refresh run. | _(internal)_ |
| [`cmdRecordNavAuditRun`](../scripts/cross-skill.mjs#L458) | function | `scripts/cross-skill.mjs` | 458-469 | Records nav-audit run telemetry (currently a no-op in v1 with deferred v2 migration). | _(internal)_ |
| [`cmdRecordPersonaSession`](../scripts/cross-skill.mjs#L697) | function | `scripts/cross-skill.mjs` | 697-722 | Creates or updates a persona session with optional commit/branch context; resolves canonical repo ID for session joining. | _(internal)_ |
| [`cmdRecordPlanVerifyItems`](../scripts/cross-skill.mjs#L435) | function | `scripts/cross-skill.mjs` | 435-444 | Batch-inserts run results (individual test/check items) for a given run and plan. | _(internal)_ |
| [`cmdRecordPlanVerifyRun`](../scripts/cross-skill.mjs#L413) | function | `scripts/cross-skill.mjs` | 413-433 | Creates a learning run for a plan with criteria counts, duration, and pass/fail/skip breakdowns; returns the run ID. | _(internal)_ |
| [`cmdRecordRegressionSpec`](../scripts/cross-skill.mjs#L225) | function | `scripts/cross-skill.mjs` | 225-293 | Records a learning witness with pre-egress redaction for sensitive fields; conditionally requires specPath based on sourceKind. | _(internal)_ |
| [`cmdRecordRegressionSpecRun`](../scripts/cross-skill.mjs#L376) | function | `scripts/cross-skill.mjs` | 376-392 | Records a spec execution result (passed/failed) with commit SHA, regression capture, and diagnostics. | _(internal)_ |
| [`cmdRecordShipEvent`](../scripts/cross-skill.mjs#L471) | function | `scripts/cross-skill.mjs` | 471-492 | Records a ship event (e.g., PR/push outcome) with blocker reasons and violation counts. | _(internal)_ |
| [`cmdRecordSymbolDefinitions`](../scripts/cross-skill.mjs#L1081) | function | `scripts/cross-skill.mjs` | 1081-1091 | Maps symbol definition identifiers to database IDs. | _(internal)_ |
| [`cmdRecordSymbolEmbedding`](../scripts/cross-skill.mjs#L1107) | function | `scripts/cross-skill.mjs` | 1107-1119 | Stores embedding vectors for a symbol definition. | _(internal)_ |
| [`cmdRecordSymbolIndex`](../scripts/cross-skill.mjs#L1093) | function | `scripts/cross-skill.mjs` | 1093-1105 | Inserts symbol index rows into the database. | _(internal)_ |
| [`cmdResolveRepoIdentity`](../scripts/cross-skill.mjs#L1186) | function | `scripts/cross-skill.mjs` | 1186-1192 | Resolves repository identity from the current directory and optionally persists it. | _(internal)_ |
| [`cmdSetActiveEmbeddingModel`](../scripts/cross-skill.mjs#L1135) | function | `scripts/cross-skill.mjs` | 1135-1145 | Sets the active embedding model and dimension for a repository. | _(internal)_ |
| [`cmdUpdatePlanStatus`](../scripts/cross-skill.mjs#L216) | function | `scripts/cross-skill.mjs` | 216-223 | Updates the status of an existing learning plan. | _(internal)_ |
| [`cmdUpsertPersonaTestCandidate`](../scripts/cross-skill.mjs#L327) | function | `scripts/cross-skill.mjs` | 327-346 | Records a token violation canary with fingerprint, severity, and surface details. | _(internal)_ |
| [`cmdUpsertPlan`](../scripts/cross-skill.mjs#L198) | function | `scripts/cross-skill.mjs` | 198-214 | Creates or updates a learning plan with path, skill, status, principles, and focus areas; returns the plan ID. | _(internal)_ |
| [`cmdWhoami`](../scripts/cross-skill.mjs#L860) | function | `scripts/cross-skill.mjs` | 860-874 | Outputs the current cloud status, commit SHA, and branch name. | _(internal)_ |
| [`currentBranch`](../scripts/cross-skill.mjs#L147) | function | `scripts/cross-skill.mjs` | 147-152 | Returns the name of the current git branch, or null if git fails. | _(internal)_ |
| [`currentCommitSha`](../scripts/cross-skill.mjs#L140) | function | `scripts/cross-skill.mjs` | 140-145 | Returns the SHA of the current git HEAD commit, or null if git fails. | _(internal)_ |
| [`emitError`](../scripts/cross-skill.mjs#L133) | function | `scripts/cross-skill.mjs` | 133-136 | Emits an error response and exits with the given code. | _(internal)_ |
| [`main`](../scripts/cross-skill.mjs#L1416) | function | `scripts/cross-skill.mjs` | 1416-1440 | Routes subcommands to handlers and displays help or error messages. | _(internal)_ |
| [`parsePayload`](../scripts/cross-skill.mjs#L105) | function | `scripts/cross-skill.mjs` | 105-120 | Parses JSON payload from --json flag, --stdin, or bare JSON in the last argument. | _(internal)_ |
| [`resolveRepoId`](../scripts/cross-skill.mjs#L172) | function | `scripts/cross-skill.mjs` | 172-194 | Resolves a repository ID from payload repoId, repoUuid, or current repo context; fails closed on transient errors. | _(internal)_ |
...
| [`aggregateAuthorTier`](../scripts/lib/dashboard/author-tier-agg.mjs#L28) | function | `scripts/lib/dashboard/author-tier-agg.mjs` | 28-89 | Aggregates author-tier observations by suggested tier and provider/family/model ladder, calculating convergence percentages and diversity metrics. | `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`isConverged`](../scripts/lib/dashboard/author-tier-agg.mjs#L16) | function | `scripts/lib/dashboard/author-tier-agg.mjs` | 16-18 | Checks if a value is truthy or the string 'true' or 't'. | `scripts/lib/dashboard/collect-telemetry.mjs` |
...
| [`sectionAuthorTier`](../scripts/lib/dashboard/sections/author-tier.mjs#L14) | function | `scripts/lib/dashboard/sections/author-tier.mjs` | 14-63 | Renders an HTML dashboard section displaying author-tier statistics, ladder diversity status, and agreement metrics. | `scripts/lib/dashboard/render.mjs` |
...
| [`semanticId`](../scripts/lib/findings.mjs#L27) | function | `scripts/lib/findings.mjs` | 27-40 | Generates a short semantic hash of a finding based on linter rule/file or generic content. | `scripts/cross-skill.mjs`, `scripts/evolve-prompts.mjs`, `scripts/gemini-review.mjs`, +9 more |
...
| [`buildCopilotPromptFiles`](../scripts/sync-to-repos.mjs#L386) | function | `scripts/sync-to-repos.mjs` | 386-394 | Lists all .prompt.md files from the .github/prompts directory and returns their relative paths. | _(internal)_ |
| [`buildFileUniverse`](../scripts/sync-to-repos.mjs#L284) | function | `scripts/sync-to-repos.mjs` | 284-301 | Recursively scans the scripts and .claude directories to build a set of all files in the source repository, skipping node_modules, .git, and audit directories. | _(internal)_ |
| [`buildSkillFiles`](../scripts/sync-to-repos.mjs#L347) | function | `scripts/sync-to-repos.mjs` | 347-359 | Enumerates all files from each skill directory and maps them to both .claude/skills and .github/skills paths when enabled. | _(internal)_ |
| [`bundleForRepo`](../scripts/sync-to-repos.mjs#L416) | function | `scripts/sync-to-repos.mjs` | 416-423 | Bundles core, learning, and architecture entries plus non-code files, with optional debt entries for the wine-cellar-app repo. | _(internal)_ |
| [`deepMerge`](../scripts/sync-to-repos.mjs#L463) | function | `scripts/sync-to-repos.mjs` | 463-474 | Recursively merges a source object into a target object, preserving nested objects while overwriting primitive values. | _(internal)_ |
| [`main`](../scripts/sync-to-repos.mjs#L478) | function | `scripts/sync-to-repos.mjs` | 478-988 | <no body> | _(internal)_ |
| [`maybePromptSharedCloudUpdate`](../scripts/sync-to-repos.mjs#L990) | function | `scripts/sync-to-repos.mjs` | 990-1021 | Assesses and conditionally updates the shared cloud configuration by delegating to a library function with a readline-based prompt. | _(internal)_ |
| [`readSource`](../scripts/sync-to-repos.mjs#L304) | function | `scripts/sync-to-repos.mjs` | 304-307 | Reads a source file from disk relative to the source root, returning its UTF-8 content or null on failure. | _(internal)_ |
| [`realMissingDeps`](../scripts/sync-to-repos.mjs#L331) | function | `scripts/sync-to-repos.mjs` | 331-336 | Filters unresolved dependencies to return only relative path specifiers that don't contain shell metacharacters. | _(internal)_ |
| [`resolveBundle`](../scripts/sync-to-repos.mjs#L316) | function | `scripts/sync-to-repos.mjs` | 316-321 | Resolves entry points and assets into a complete bundle using a module resolver and the file universe, deduplicating the combined result. | _(internal)_ |
| [`sha256`](../scripts/sync-to-repos.mjs#L432) | function | `scripts/sync-to-repos.mjs` | 432-439 | Computes the SHA-256 hash of a file's raw bytes, returning the hex digest or null on read failure. | _(internal)_ |
| [`syncMigrations`](../scripts/sync-to-repos.mjs#L184) | function | `scripts/sync-to-repos.mjs` | 184-194 | Lists all SQL migration files from the supabase/migrations directory, returning their relative paths sorted alphabetically. | _(internal)_ |
| [`unifiedDiff`](../scripts/sync-to-repos.mjs#L441) | function | `scripts/sync-to-repos.mjs` | 441-454 | Generates a unified diff between two files using git diff --no-index, returning the diff output or an error message. | _(internal)_ |
...
> The `nav-audit` domain detects and extracts route information from Next.js and React Router projects by analyzing source files through framework-specific adapters that identify routing patterns and normalize destinations to route IDs.
...
| [`calleeName`](../scripts/lib/nav/ast.mjs#L151) | function | `scripts/lib/nav/ast.mjs` | 151-159 | Extracts the function name from a call expression (identifier or member expression). | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`classifyTarget`](../scripts/lib/nav/ast.mjs#L101) | function | `scripts/lib/nav/ast.mjs` | 101-118 | Classifies an AST node to extract its static literal, member reference, or template structure. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`componentNameOf`](../scripts/lib/nav/ast.mjs#L85) | function | `scripts/lib/nav/ast.mjs` | 85-92 | Extracts function, class, or variable declaration names that represent component definitions. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`jsxAttr`](../scripts/lib/nav/ast.mjs#L132) | function | `scripts/lib/nav/ast.mjs` | 132-140 | Finds a JSX attribute value by name(s) from an opening element. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`jsxLabel`](../scripts/lib/nav/ast.mjs#L121) | function | `scripts/lib/nav/ast.mjs` | 121-129 | Extracts plain text content from JSX element children, joining whitespace-trimmed parts. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`jsxTagName`](../scripts/lib/nav/ast.mjs#L143) | function | `scripts/lib/nav/ast.mjs` | 143-148 | Extracts the tag name from a JSX opening element (identifier or member expression). | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`parseSource`](../scripts/lib/nav/ast.mjs#L27) | function | `scripts/lib/nav/ast.mjs` | 27-39 | Parses JavaScript/TypeScript source into an AST using Babel with error recovery enabled. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`unwrapObjectExpression`](../scripts/lib/nav/ast.mjs#L73) | function | `scripts/lib/nav/ast.mjs` | 73-82 | Unwraps object expressions from call expressions, type assertions, and satisfies expressions. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`walk`](../scripts/lib/nav/ast.mjs#L49) | function | `scripts/lib/nav/ast.mjs` | 49-68 | Traverses an AST depth-first, visiting each node and passing enclosing component name and line number. | `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, `scripts/lib/nav/extract.mjs` |
| [`dedupe`](../scripts/lib/nav/bootstrap-draft.mjs#L69) | function | `scripts/lib/nav/bootstrap-draft.mjs` | 69-69 | Deduplicates an array by converting to Set and back. | `scripts/nav-audit.mjs` |
| [`draftContractFromLive`](../scripts/lib/nav/bootstrap-draft.mjs#L27) | function | `scripts/lib/nav/bootstrap-draft.mjs` | 27-67 | Builds a draft nav layers structure from live evidence by grouping containers with multiple targets and sorting by stickiness and CSS selectors. | `scripts/nav-audit.mjs` |
| [`bootstrapContract`](../scripts/lib/nav/contract.mjs#L205) | function | `scripts/lib/nav/contract.mjs` | 205-231 | Bootstraps a new nav contract by inferring personas and intents from observed navigation data and draftNavLayers. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`coerce`](../scripts/lib/nav/contract.mjs#L175) | function | `scripts/lib/nav/contract.mjs` | 175-186 | Coerces a raw string value to its declared type (boolean, list, or string). | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`contractExists`](../scripts/lib/nav/contract.mjs#L201) | function | `scripts/lib/nav/contract.mjs` | 201-203 | Checks if a nav contract file exists in the project root. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`isUtilityRoute`](../scripts/lib/nav/contract.mjs#L102) | function | `scripts/lib/nav/contract.mjs` | 102-105 | Checks if a destination ID matches utility route patterns (API, special Next.js files, etc.). | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`parseDocblockTokens`](../scripts/lib/nav/contract.mjs#L161) | function | `scripts/lib/nav/contract.mjs` | 161-173 | Parses space/equals-separated tokens from navMeta docblock syntax, coercing values to their declared types. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`parseNavMeta`](../scripts/lib/nav/contract.mjs#L119) | function | `scripts/lib/nav/contract.mjs` | 119-140 | Parses navMeta declarations from source code in export-object or docblock form, extracting key-value fields. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`parseObjectBody`](../scripts/lib/nav/contract.mjs#L145) | function | `scripts/lib/nav/contract.mjs` | 145-158 | Parses key-value pairs from navMeta object syntax, coercing values to their declared types. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`readContract`](../scripts/lib/nav/contract.mjs#L59) | function | `scripts/lib/nav/contract.mjs` | 59-95 | Reads and validates a nav contract JSON file, normalizing destination IDs and ensuring layer references are valid. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
| [`writeContract`](../scripts/lib/nav/contract.mjs#L239) | function | `scripts/lib/nav/contract.mjs` | 239-247 | Writes a validated nav contract to disk, throwing if the schema validation fails. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/findings.mjs`, `scripts/nav-audit.mjs` |
...
| [`dedupe`](../scripts/lib/nav/normalize.mjs#L69) | function | `scripts/lib/nav/normalize.mjs` | 69-71 | Removes duplicate entries from an array using a Set. | `scripts/lib/nav/adapters/next-file.mjs`, `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, +3 more |
| [`namespaceId`](../scripts/lib/nav/normalize.mjs#L80) | function | `scripts/lib/nav/normalize.mjs` | 80-82 | Qualifies a destination ID with an app root prefix if one is provided. | `scripts/lib/nav/adapters/next-file.mjs`, `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, +3 more |
| [`normalizeDestination`](../scripts/lib/nav/normalize.mjs#L18) | function | `scripts/lib/nav/normalize.mjs` | 18-67 | <no body> | `scripts/lib/nav/adapters/next-file.mjs`, `scripts/lib/nav/adapters/react-router.mjs`, `scripts/lib/nav/adapters/vanilla-switchview.mjs`, +3 more |
...
| [`computeConfigDigest`](../scripts/lib/nav/schema.mjs#L205) | function | `scripts/lib/nav/schema.mjs` | 205-207 | Combines adapter version and contract digest into a single SHA256 config fingerprint. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/contract.mjs`, `scripts/lib/nav/drift.mjs`, +4 more |
| [`computeContractDigest`](../scripts/lib/nav/schema.mjs#L167) | function | `scripts/lib/nav/schema.mjs` | 167-195 | Computes a SHA256 digest of a normalized navigation contract for change detection. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/contract.mjs`, `scripts/lib/nav/drift.mjs`, +4 more |
| [`sha256`](../scripts/lib/nav/schema.mjs#L218) | function | `scripts/lib/nav/schema.mjs` | 218-220 | Computes SHA256 hash of a string using Node's crypto module. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/contract.mjs`, `scripts/lib/nav/drift.mjs`, +4 more |
| [`sortRecordOfArrays`](../scripts/lib/nav/schema.mjs#L209) | function | `scripts/lib/nav/schema.mjs` | 209-216 | Sorts record keys alphabetically and normalizes each value array to sorted form. | `scripts/lib/dashboard/collect-nav.mjs`, `scripts/lib/nav/contract.mjs`, `scripts/lib/nav/drift.mjs`, +4 more |
...
| [`collectLiveNav`](../scripts/lib/nav/verify.mjs#L315) | function | `scripts/lib/nav/verify.mjs` | 315-402 | <no body> | `scripts/nav-audit.mjs` |
| [`discoverExpandTriggers`](../scripts/lib/nav/verify.mjs#L412) | function | `scripts/lib/nav/verify.mjs` | 412-460 | Evaluates declared selectors in the live page DOM to detect which are present and their container/nesting context. | `scripts/nav-audit.mjs` |
| [`extractTarget`](../scripts/lib/nav/verify.mjs#L480) | function | `scripts/lib/nav/verify.mjs` | 480-498 | Extracts the navigation target from an element's href or data-* attributes, prioritizing by a ranked list of attribute names. | `scripts/nav-audit.mjs` |
| [`normalizeLiveTarget`](../scripts/lib/nav/verify.mjs#L31) | function | `scripts/lib/nav/verify.mjs` | 31-65 | Normalizes live navigation targets (URLs, hash routes, view slugs) to canonical destination identifiers. | `scripts/nav-audit.mjs` |
| [`reconcile`](../scripts/lib/nav/verify.mjs#L73) | function | `scripts/lib/nav/verify.mjs` | 73-89 | Reconciles declared static destinations against collected live runtime targets, reporting confirmed/static-only/runtime-only matches. | `scripts/nav-audit.mjs` |
| [`runVerify`](../scripts/lib/nav/verify.mjs#L121) | function | `scripts/lib/nav/verify.mjs` | 121-305 | <no body> | `scripts/nav-audit.mjs` |
| [`selectorLayers`](../scripts/lib/nav/verify.mjs#L92) | function | `scripts/lib/nav/verify.mjs` | 92-98 | Extracts layer assignments from contract navLayers selectors. | `scripts/nav-audit.mjs` |
| [`usableHref`](../scripts/lib/nav/verify.mjs#L468) | function | `scripts/lib/nav/verify.mjs` | 468-473 | Validates that an href string is a usable navigation link (not javascript/mailto/tel/bare anchor). | `scripts/nav-audit.mjs` |
| [`collectRouteMeta`](../scripts/nav-audit.mjs#L244) | function | `scripts/nav-audit.mjs` | 244-261 | Parses nav-audit metadata comments from source files and binds them to discovered route destinations when unambiguous. | _(internal)_ |
| [`countBySeverity`](../scripts/nav-audit.mjs#L284) | function | `scripts/nav-audit.mjs` | 284-288 | Counts findings by severity level (P0, P1, P2, P3) and returns counts as an object. | _(internal)_ |
| [`gitChangedFiles`](../scripts/nav-audit.mjs#L295) | function | `scripts/nav-audit.mjs` | 295-305 | Finds files changed since the merge base of HEAD and origin/HEAD (or origin/main), falling back to HEAD if detection fails. | _(internal)_ |
| [`gitHeadDate`](../scripts/nav-audit.mjs#L310) | function | `scripts/nav-audit.mjs` | 310-312 | Returns the current git HEAD commit date in ISO format, or null if git is unavailable. | _(internal)_ |
| [`gitHeadSha`](../scripts/nav-audit.mjs#L307) | function | `scripts/nav-audit.mjs` | 307-309 | Returns the current git HEAD commit SHA, or null if git is unavailable. | _(internal)_ |
| [`listSourceFiles`](../scripts/nav-audit.mjs#L290) | function | `scripts/nav-audit.mjs` | 290-293 | Lists all JavaScript/TypeScript source files in the project using git ls-files. | _(internal)_ |
| [`main`](../scripts/nav-audit.mjs#L29) | function | `scripts/nav-audit.mjs` | 29-242 | <no body> | _(internal)_ |
| [`parseArgs`](../scripts/nav-audit.mjs#L263) | function | `scripts/nav-audit.mjs` | 263-282 | Parses command-line arguments into a configuration object with defaults for scope, format, bootstrap, verify, and other options. | _(internal)_ |
...
> The `scripts` domain provides utility functions and CLI tools for project setup, dependency analysis, plan orchestration, and API testing—including baseline generation from import graphs, template copying, plan status tracking, file archival, and Claude API connectivity verification.
...
| [`buildSurfacesManifest`](../scripts/build-surfaces-manifest.mjs#L311) | function | `scripts/build-surfaces-manifest.mjs` | 311-332 | Orchestrates fragment discovery, loading, merging, and schema validation, returning the final manifest and any validation errors. | _(internal)_ |
| [`canonicalLocator`](../scripts/build-surfaces-manifest.mjs#L137) | function | `scripts/build-surfaces-manifest.mjs` | 137-144 | Converts a locator object (by id, css selector, role, or text) into a canonical string representation. | _(internal)_ |
| [`findFragments`](../scripts/build-surfaces-manifest.mjs#L102) | function | `scripts/build-surfaces-manifest.mjs` | 102-127 | Recursively traverses a directory tree to find all fragment files matching a suffix, returning a sorted list of absolute paths. | _(internal)_ |
| [`loadFragment`](../scripts/build-surfaces-manifest.mjs#L153) | function | `scripts/build-surfaces-manifest.mjs` | 153-173 | Parses a JSON fragment file and validates that it contains at least one surface or collection definition. | _(internal)_ |
| [`main`](../scripts/build-surfaces-manifest.mjs#L335) | function | `scripts/build-surfaces-manifest.mjs` | 335-382 | CLI entry point that discovers/merges surface fragments and writes or verifies the output manifest file, supporting --verify and --verbose flags. | _(internal)_ |
| [`mergeFragments`](../scripts/build-surfaces-manifest.mjs#L184) | function | `scripts/build-surfaces-manifest.mjs` | 184-286 | <no body> | _(internal)_ |
| [`renderManifest`](../scripts/build-surfaces-manifest.mjs#L296) | function | `scripts/build-surfaces-manifest.mjs` | 296-298 | Serializes a manifest object to JSON with indentation and a trailing newline. | _(internal)_ |
...
| [`installInRepo`](../scripts/install-prepush-hook.mjs#L131) | function | `scripts/install-prepush-hook.mjs` | 131-181 | Installs, updates, or uninstalls a managed pre-push git hook in a repository. | _(internal)_ |
| [`isManagedHook`](../scripts/install-prepush-hook.mjs#L41) | function | `scripts/install-prepush-hook.mjs` | 41-45 | Checks if hook file content is managed by the installer using marker detection. | _(internal)_ |
| [`main`](../scripts/install-prepush-hook.mjs#L185) | function | `scripts/install-prepush-hook.mjs` | 185-209 | Resolves target repos and applies hook installation/uninstall with human or JSON output. | _(internal)_ |
...
| [`applyBootstrap`](../scripts/setup-postgres.mjs#L263) | function | `scripts/setup-postgres.mjs` | 263-270 | Applies the compatibility bootstrap SQL file (or reports dry-run intent). | _(internal)_ |
| [`applyMigration`](../scripts/setup-postgres.mjs#L251) | function | `scripts/setup-postgres.mjs` | 251-261 | Applies a single migration SQL file to the database (or reports dry-run intent). | _(internal)_ |
| [`canonicalise`](../scripts/setup-postgres.mjs#L323) | function | `scripts/setup-postgres.mjs` | 323-334 | Recursively canonicalizes an object by sorting array and object entries to enable consistent JSON string comparisons. | _(internal)_ |
| [`captureLiveSchema`](../scripts/setup-postgres.mjs#L282) | function | `scripts/setup-postgres.mjs` | 282-294 | Captures the current live database schema by running introspection queries and returning results as an object keyed by category. | _(internal)_ |
| [`diffSchemas`](../scripts/setup-postgres.mjs#L296) | function | `scripts/setup-postgres.mjs` | 296-320 | Compares expected vs. live schema objects and returns a list of differences by category with item-level diffs. | _(internal)_ |
| [`ensureLedger`](../scripts/setup-postgres.mjs#L220) | function | `scripts/setup-postgres.mjs` | 220-223 | Creates the migration ledger table and applies row-level security policies. | _(internal)_ |
| [`isSupabaseManaged`](../scripts/setup-postgres.mjs#L188) | function | `scripts/setup-postgres.mjs` | 188-200 | Checks if the auth schema is Supabase-managed by examining its owner in pg_namespace. | _(internal)_ |
| [`listMigrations`](../scripts/setup-postgres.mjs#L240) | function | `scripts/setup-postgres.mjs` | 240-243 | Lists migration SQL files from a directory, sorted alphabetically. | _(internal)_ |
| [`main`](../scripts/setup-postgres.mjs#L704) | function | `scripts/setup-postgres.mjs` | 704-777 | Main entry point that parses arguments, initializes the database pool, and dispatches to the appropriate subcommand (ensure-local, migrate, adopt, or check-drift). | _(internal)_ |
| [`parseArgs`](../scripts/setup-postgres.mjs#L59) | function | `scripts/setup-postgres.mjs` | 59-100 | Parses command-line arguments into an object with mode, format, and flag settings. | _(internal)_ |
| [`preflight`](../scripts/setup-postgres.mjs#L115) | function | `scripts/setup-postgres.mjs` | 115-138 | Queries the database for CREATEROLE privilege and extension installation status (pgcrypto, pg_trgm, vector). | _(internal)_ |
| [`readLedger`](../scripts/setup-postgres.mjs#L225) | function | `scripts/setup-postgres.mjs` | 225-228 | Reads applied migration records from the ledger table. | _(internal)_ |
| [`recordApplied`](../scripts/setup-postgres.mjs#L230) | function | `scripts/setup-postgres.mjs` | 230-236 | Inserts or updates a migration record in the ledger with SHA256 hash and timestamp. | _(internal)_ |
| [`renderHumanDriftReport`](../scripts/setup-postgres.mjs#L624) | function | `scripts/setup-postgres.mjs` | 624-645 | Prints human-readable migration drift report to stderr, showing unapplied, SHA-mismatched, and orphaned migration entries. | _(internal)_ |
| [`reportPreflight`](../scripts/setup-postgres.mjs#L140) | function | `scripts/setup-postgres.mjs` | 140-174 | Prints preflight check results to stderr with color coding, and returns false if strict mode requirements are unmet. | _(internal)_ |
| [`runAdopt`](../scripts/setup-postgres.mjs#L501) | function | `scripts/setup-postgres.mjs` | 501-550 | Runs adopt mode by comparing expected schema manifest against live schema, seeding the ledger if they match, or reporting drift if they don't. | _(internal)_ |
| [`runCheckDrift`](../scripts/setup-postgres.mjs#L571) | function | `scripts/setup-postgres.mjs` | 571-622 | Runs drift-check mode by comparing ledger vs. source files and detecting unapplied, SHA-mismatched, or orphaned migrations. | _(internal)_ |
| [`runEnsureLocal`](../scripts/setup-postgres.mjs#L655) | function | `scripts/setup-postgres.mjs` | 655-702 | Ensures a local Postgres installation exists and is accessible by verifying psql availability and AUDIT_DB_URL configuration. | _(internal)_ |
| [`runMigrate`](../scripts/setup-postgres.mjs#L460) | function | `scripts/setup-postgres.mjs` | 460-499 | Runs migrations by applying bootstrap (if not Supabase-managed), then executing unapplied migrations and recording them in the ledger. | _(internal)_ |
| [`sha256`](../scripts/setup-postgres.mjs#L245) | function | `scripts/setup-postgres.mjs` | 245-249 | Computes the SHA256 hash of a file. | _(internal)_ |
...
| [`cmdSpec`](../scripts/ux-lock-run.mjs#L63) | function | `scripts/ux-lock-run.mjs` | 63-153 | Runs Playwright specs, groups results by spec path, registers observations, and handles registration optionally. | _(internal)_ |
| [`cmdVerify`](../scripts/ux-lock-run.mjs#L157) | function | `scripts/ux-lock-run.mjs` | 157-228 | Verifies Playwright tests against acceptance criteria from a plan file, mapping tests to criteria and generating a report. | _(internal)_ |
| [`fail`](../scripts/ux-lock-run.mjs#L50) | function | `scripts/ux-lock-run.mjs` | 50-53 | Emits an error JSON object and exits with the specified code. | _(internal)_ |
| [`flag`](../scripts/ux-lock-run.mjs#L46) | function | `scripts/ux-lock-run.mjs` | 46-48 | Checks if a named command-line flag is present in argv. | _(internal)_ |
...
> The `shared-lib` domain configures and wraps Anthropic SDK/CLI clients with environment validation, caching, and payload redaction to sanitize sensitive data before sending requests.
...
| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`_resetClientCache`](../scripts/lib/anthropic-client.mjs#L300) | function | `scripts/lib/anthropic-client.mjs` | 300-303 | Clears the internal client cache and resets warning flags. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`applyRedactor`](../scripts/lib/anthropic-client.mjs#L265) | function | `scripts/lib/anthropic-client.mjs` | 265-294 | Recursively redacts system prompts and message content blocks by applying a redactor function. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`assertOneShotTextMessages`](../scripts/lib/anthropic-client.mjs#L378) | function | `scripts/lib/anthropic-client.mjs` | 378-407 | Validates that CLI backend messages are user-role text-only, rejecting assistant messages or non-text content. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`buildPromptFromMessages`](../scripts/lib/anthropic-client.mjs#L415) | function | `scripts/lib/anthropic-client.mjs` | 415-432 | Extracts and concatenates plain text from message content blocks (string or text-block array). | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`createAnthropicClient`](../scripts/lib/anthropic-client.mjs#L161) | function | `scripts/lib/anthropic-client.mjs` | 161-229 | Selects between SDK and CLI backends, resolves all environment/option values (baseURL, API keys, timeout), builds a cache key, and returns the effective client. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`createCliAdapter`](../scripts/lib/anthropic-client.mjs#L315) | function | `scripts/lib/anthropic-client.mjs` | 315-369 | Creates an adapter that implements the SDK's messages.create interface by spawning the `claude` CLI and parsing JSON output. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`getDefaultRedactor`](../scripts/lib/anthropic-client.mjs#L233) | function | `scripts/lib/anthropic-client.mjs` | 233-239 | Lazily imports and caches the default redactor function from sanitizer.mjs. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`keyDigest`](../scripts/lib/anthropic-client.mjs#L50) | function | `scripts/lib/anthropic-client.mjs` | 50-52 | Creates a 16-character cache key by SHA256-hashing the input value. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`normaliseCliOutput`](../scripts/lib/anthropic-client.mjs#L607) | function | `scripts/lib/anthropic-client.mjs` | 607-655 | Parses and validates the JSON output from `claude -p`, extracts text content and token usage, surfaces errors as exceptions. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`quoteWinArg`](../scripts/lib/anthropic-client.mjs#L681) | function | `scripts/lib/anthropic-client.mjs` | 681-686 | Quotes a Windows command-line argument, escaping internal quotes and wrapping if it contains whitespace or special characters. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`resolveBackend`](../scripts/lib/anthropic-client.mjs#L120) | function | `scripts/lib/anthropic-client.mjs` | 120-133 | Validates the CLAUDE_BACKEND environment variable against allowed values, hard-failing on invalid input. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`resolveTimeoutMs`](../scripts/lib/anthropic-client.mjs#L93) | function | `scripts/lib/anthropic-client.mjs` | 93-104 | Validates and returns the timeout in milliseconds, rejecting values outside the allowed range. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`runClaudeCli`](../scripts/lib/anthropic-client.mjs#L453) | function | `scripts/lib/anthropic-client.mjs` | 453-567 | Spawns a child process running the claude CLI, pipes prompt via stdin, collects JSON output, handles timeouts and abort signals. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
| [`wrapSdkWithRedactor`](../scripts/lib/anthropic-client.mjs#L246) | function | `scripts/lib/anthropic-client.mjs` | 246-255 | Wraps the Anthropic SDK client to apply redaction to message payloads before sending them. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, +5 more |
...
| [`buildAzureConfig`](../scripts/lib/config.mjs#L276) | function | `scripts/lib/config.mjs` | 276-345 | Loads Azure OpenAI endpoint configuration from environment variables, validating deployment names and API keys when active. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +27 more |
| [`normalizeLanguage`](../scripts/lib/config.mjs#L126) | function | `scripts/lib/config.mjs` | 126-139 | Normalizes language names to canonical forms (js, ts, py, go, other) using an alias map. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +27 more |
| [`validatedEnum`](../scripts/lib/config.mjs#L27) | function | `scripts/lib/config.mjs` | 27-34 | Reads an environment variable, warns if the value is not in a valid set, and returns the value or a fallback. | `scripts/anthropic-ping.mjs`, `scripts/azure-limits.mjs`, `scripts/bandit.mjs`, +27 more |
...
| [`_resetForTest`](../scripts/lib/db/client.mjs#L365) | function | `scripts/lib/db/client.mjs` | 365-367 | Resets the module state for testing by closing the connection pool. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`assertPublicSchema`](../scripts/lib/db/client.mjs#L181) | function | `scripts/lib/db/client.mjs` | 181-190 | Validates the Postgres schema is either unset or exactly 'public', rejecting arbitrary-schema configurations. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`assertSafeDsn`](../scripts/lib/db/client.mjs#L60) | function | `scripts/lib/db/client.mjs` | 60-80 | Validates the AUDIT_DB_URL is a valid PostgreSQL connection string and rejects invalid configurations (protocol, pooler type). | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`buildPoolConfig`](../scripts/lib/db/client.mjs#L208) | function | `scripts/lib/db/client.mjs` | 208-263 | Builds a pg Pool configuration with SSL mode validation, connection pool sizing, and custom type parsers for timestamp/date OIDs. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`closePool`](../scripts/lib/db/client.mjs#L343) | function | `scripts/lib/db/client.mjs` | 343-356 | Cleanly closes the global Postgres connection pool if it exists, handling edge cases like double-close. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`getActiveTxClient`](../scripts/lib/db/client.mjs#L99) | function | `scripts/lib/db/client.mjs` | 99-102 | Retrieves the active transaction client from the async-local store, returning null if no transaction is active. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`getPool`](../scripts/lib/db/client.mjs#L279) | function | `scripts/lib/db/client.mjs` | 279-331 | Lazily initializes a global Postgres connection pool with safety checks, type handlers, and error event logging. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`resolveDbUrl`](../scripts/lib/db/client.mjs#L133) | function | `scripts/lib/db/client.mjs` | 133-173 | Resolves the Postgres connection string from environment variables, handling aliases and validating that explicit AUDIT_STORE=postgres is not misconfigured. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
| [`warnAliasOnce`](../scripts/lib/db/client.mjs#L119) | function | `scripts/lib/db/client.mjs` | 119-126 | Logs a one-time deprecation warning when a legacy environment variable alias is used instead of the canonical name. | `scripts/audit-metrics.mjs`, `scripts/check-rls.mjs`, `scripts/lib/db/query.mjs`, +8 more |
...
| [`_exec`](../scripts/lib/db/query.mjs#L351) | function | `scripts/lib/db/query.mjs` | 351-371 | Executes a parameterized SQL query via transaction client or pool with error normalization. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`buildDelete`](../scripts/lib/db/query.mjs#L331) | function | `scripts/lib/db/query.mjs` | 331-336 | Builds a SQL DELETE statement from WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`buildInsert`](../scripts/lib/db/query.mjs#L151) | function | `scripts/lib/db/query.mjs` | 151-165 | Builds a SQL INSERT statement with column names, placeholders, and optional RETURNING. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`buildUpdate`](../scripts/lib/db/query.mjs#L305) | function | `scripts/lib/db/query.mjs` | 305-325 | Builds a SQL UPDATE statement from a patch object and WHERE conditions. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`buildUpsert`](../scripts/lib/db/query.mjs#L184) | function | `scripts/lib/db/query.mjs` | 184-255 | Builds a SQL UPSERT statement with row validation and ON CONFLICT update logic. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`deleteWhere`](../scripts/lib/db/query.mjs#L474) | function | `scripts/lib/db/query.mjs` | 474-479 | Deletes rows matching a WHERE clause and optionally returns results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`flattenWhere`](../scripts/lib/db/query.mjs#L272) | function | `scripts/lib/db/query.mjs` | 272-296 | Flattens a WHERE object into SQL clauses and parameters with null/undefined validation. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`insertReturning`](../scripts/lib/db/query.mjs#L423) | function | `scripts/lib/db/query.mjs` | 423-431 | Inserts a row and optionally returns specified columns. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`many`](../scripts/lib/db/query.mjs#L410) | function | `scripts/lib/db/query.mjs` | 410-413 | Executes a query and returns all rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`normalizeConflictTarget`](../scripts/lib/db/query.mjs#L88) | function | `scripts/lib/db/query.mjs` | 88-115 | Normalizes an ON CONFLICT target to column list or ON CONSTRAINT syntax. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`normalizeReturning`](../scripts/lib/db/query.mjs#L65) | function | `scripts/lib/db/query.mjs` | 65-74 | Normalizes the RETURNING clause to a list of quoted columns or wildcard. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`one`](../scripts/lib/db/query.mjs#L393) | function | `scripts/lib/db/query.mjs` | 393-400 | Executes a query expecting exactly zero or one row. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`query`](../scripts/lib/db/query.mjs#L380) | function | `scripts/lib/db/query.mjs` | 380-382 | Executes a parameterized SQL query and returns the result object. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`quoteIdent`](../scripts/lib/db/query.mjs#L36) | function | `scripts/lib/db/query.mjs` | 36-44 | Quotes a SQL identifier to safely embed column/table names. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`updateWhere`](../scripts/lib/db/query.mjs#L460) | function | `scripts/lib/db/query.mjs` | 460-465 | Updates rows matching a WHERE clause and optionally returns results. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`upsert`](../scripts/lib/db/query.mjs#L445) | function | `scripts/lib/db/query.mjs` | 445-450 | Performs upsert (insert or update on conflict) on multiple rows. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
| [`withTx`](../scripts/lib/db/query.mjs#L497) | function | `scripts/lib/db/query.mjs` | 497-545 | Executes a function within a database transaction with savepoint nesting. | `scripts/audit-metrics.mjs`, `scripts/cache-hitrate-check.mjs`, `scripts/check-setup.mjs`, +19 more |
...
| [`atomicWriteFileSync`](../scripts/lib/file-io.mjs#L16) | function | `scripts/lib/file-io.mjs` | 16-46 | Atomically writes a file to disk via temp-and-rename, preserving symlinks and creating parent directories. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +40 more |
| [`normalizePath`](../scripts/lib/file-io.mjs#L55) | function | `scripts/lib/file-io.mjs` | 55-59 | Normalizes a file path to lowercase, removes CWD prefix, and converts backslashes to forward slashes. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +40 more |
| [`readFileOrDie`](../scripts/lib/file-io.mjs#L71) | function | `scripts/lib/file-io.mjs` | 71-78 | Reads a file from disk or exits the process with an error message if the file doesn't exist. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +40 more |
| [`safeInt`](../scripts/lib/file-io.mjs#L64) | function | `scripts/lib/file-io.mjs` | 64-67 | Safely parses a string to integer, returning a fallback value if parsing fails. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +40 more |
| [`writeOutput`](../scripts/lib/file-io.mjs#L88) | function | `scripts/lib/file-io.mjs` | 88-99 | Outputs JSON data to a file or stdout, with optional directory creation and logging. | `scripts/arch-intent-bootstrap.mjs`, `scripts/brainstorm-round.mjs`, `scripts/build-dashboard.mjs`, +40 more |
...
| [`buildAuthorTierObservation`](../scripts/lib/learning/author-tier-observation.mjs#L188) | function | `scripts/lib/learning/author-tier-observation.mjs` | 188-232 | <no body> | `scripts/openai-audit.mjs` |
| [`deriveSignals`](../scripts/lib/learning/author-tier-observation.mjs#L93) | function | `scripts/lib/learning/author-tier-observation.mjs` | 93-121 | Derives learning signals from changed files and domains (floor-touch, mechanical-only, diff bucket, cross-domain flags). | `scripts/openai-audit.mjs` |
| [`diffBucket`](../scripts/lib/learning/author-tier-observation.mjs#L68) | function | `scripts/lib/learning/author-tier-observation.mjs` | 68-71 | Buckets a diff line count into a size category (s/m/l) based on predefined thresholds. | `scripts/openai-audit.mjs` |
| [`normalizeTierHint`](../scripts/lib/learning/author-tier-observation.mjs#L141) | function | `scripts/lib/learning/author-tier-observation.mjs` | 141-145 | Normalizes a tier hint string to a logical tier name or model-derived tier. | `scripts/openai-audit.mjs` |
| [`suggestTier`](../scripts/lib/learning/author-tier-observation.mjs#L128) | function | `scripts/lib/learning/author-tier-observation.mjs` | 128-133 | Recommends an audit tier (economy/standard/frontier) based on change signals and file/domain complexity. | `scripts/openai-audit.mjs` |
...
| [`_canonicalise`](../scripts/lib/learning/decision-logger.mjs#L182) | function | `scripts/lib/learning/decision-logger.mjs` | 182-189 | Recursively sorts object keys and canonicalizes nested structures for consistent JSON representation. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_getStateForTest`](../scripts/lib/learning/decision-logger.mjs#L534) | function | `scripts/lib/learning/decision-logger.mjs` | 534-541 | Returns current queue sizes and dropped counts as an object for test inspection. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_isKeyInt`](../scripts/lib/learning/decision-logger.mjs#L50) | function | `scripts/lib/learning/decision-logger.mjs` | 50-50 | Checks if a value is a non-negative safe integer (for use in composite keys). | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_isNonEmptyString`](../scripts/lib/learning/decision-logger.mjs#L49) | function | `scripts/lib/learning/decision-logger.mjs` | 49-49 | Checks if a value is a non-empty string without colons (for use in composite keys). | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`_resetForTest`](../scripts/lib/learning/decision-logger.mjs#L523) | function | `scripts/lib/learning/decision-logger.mjs` | 523-529 | Clears all internal queues, counters, flags, and store reference for test isolation. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`backfillOutcome`](../scripts/lib/learning/decision-logger.mjs#L262) | function | `scripts/lib/learning/decision-logger.mjs` | 262-294 | Backfills an outcome for an existing decision by key, searching queues first then creating an outcome-only update entry. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`buildDecisionKey`](../scripts/lib/learning/decision-logger.mjs#L155) | function | `scripts/lib/learning/decision-logger.mjs` | 155-170 | Constructs a unique decision key from decision type and either audit-run identifiers or external ID, validating format rules. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`bumpDropped`](../scripts/lib/learning/decision-logger.mjs#L89) | function | `scripts/lib/learning/decision-logger.mjs` | 89-91 | Increments the dropped-entry counter for a decision type. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`canonicaliseContext`](../scripts/lib/learning/decision-logger.mjs#L191) | function | `scripts/lib/learning/decision-logger.mjs` | 191-193 | Returns a stringified canonical JSON representation of a context object. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`contextHash`](../scripts/lib/learning/decision-logger.mjs#L195) | function | `scripts/lib/learning/decision-logger.mjs` | 195-197 | Returns a SHA256 hash of the canonical context string. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`DecisionLoggerError`](../scripts/lib/learning/decision-logger.mjs#L108) | class | `scripts/lib/learning/decision-logger.mjs` | 108-110 | Custom error class for decision logger validation and processing failures. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`drain`](../scripts/lib/learning/decision-logger.mjs#L484) | function | `scripts/lib/learning/decision-logger.mjs` | 484-494 | Initiates a single in-flight drain operation, returning the same promise if called concurrently. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`flush`](../scripts/lib/learning/decision-logger.mjs#L307) | function | `scripts/lib/learning/decision-logger.mjs` | 307-376 | Drains queued decision entries to cloud storage or outbox, tracking success/failure/retention per entry with two-phase commit (incomplete output in source). | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`getQueue`](../scripts/lib/learning/decision-logger.mjs#L83) | function | `scripts/lib/learning/decision-logger.mjs` | 83-87 | Returns or creates a queue for a decision type. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`installLifecycleHooks`](../scripts/lib/learning/decision-logger.mjs#L496) | function | `scripts/lib/learning/decision-logger.mjs` | 496-518 | Installs process-level hooks (beforeExit, SIGINT) to drain decision queues on exit with Ctrl-C handling (incomplete output in source). | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`isCiEnv`](../scripts/lib/learning/decision-logger.mjs#L58) | function | `scripts/lib/learning/decision-logger.mjs` | 58-60 | Detects whether the code is running in a CI environment by checking CI or GITHUB_ACTIONS env vars. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`reconcileOutbox`](../scripts/lib/learning/decision-logger.mjs#L387) | function | `scripts/lib/learning/decision-logger.mjs` | 387-412 | Scans the outbox directory and retries writing previously-failed decision entries to cloud storage. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`recordDecision`](../scripts/lib/learning/decision-logger.mjs#L217) | function | `scripts/lib/learning/decision-logger.mjs` | 217-251 | Records a decision entry into an in-memory queue per type, respecting queue capacity and dropping oldest entries when full. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`resolveQueueCap`](../scripts/lib/learning/decision-logger.mjs#L26) | function | `scripts/lib/learning/decision-logger.mjs` | 26-37 | Parses and validates an environment variable as a positive integer, falling back to a default if invalid. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`retryWithBackoff`](../scripts/lib/learning/decision-logger.mjs#L434) | function | `scripts/lib/learning/decision-logger.mjs` | 434-451 | Retries a function with exponential backoff in CI environments (3 attempts) or single attempt locally, treating truthy or { ok: true } as success. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`throttledWarn`](../scripts/lib/learning/decision-logger.mjs#L93) | function | `scripts/lib/learning/decision-logger.mjs` | 93-100 | Writes a throttled warning to stderr if the minimum interval has elapsed since the last warning for that key. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`tryWrite`](../scripts/lib/learning/decision-logger.mjs#L416) | function | `scripts/lib/learning/decision-logger.mjs` | 416-432 | Attempts to write a decision entry to cloud storage, dispatching outcome-only updates or full entries based on entry type. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`validateInput`](../scripts/lib/learning/decision-logger.mjs#L112) | function | `scripts/lib/learning/decision-logger.mjs` | 112-147 | Validates decision logger input by checking required fields, schema constraints, and audit-binding rules (incomplete output in source). | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
| [`writeOutbox`](../scripts/lib/learning/decision-logger.mjs#L453) | function | `scripts/lib/learning/decision-logger.mjs` | 453-467 | Writes a decision entry to a timestamped JSON file in the outbox directory using atomic rename. | `scripts/lib/neighbourhood-query.mjs`, `scripts/openai-audit.mjs` |
...
| [`_cli`](../scripts/lib/model-resolver.mjs#L563) | function | `scripts/lib/model-resolver.mjs` | 563-611 | CLI dispatcher for `resolve` (expand sentinels to concrete models) and `catalog` (show live vs static pool) commands. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`_resetCatalogCache`](../scripts/lib/model-resolver.mjs#L379) | function | `scripts/lib/model-resolver.mjs` | 379-384 | Clears all cached model catalogs and remapping warnings for reset. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`compareVersions`](../scripts/lib/model-resolver.mjs#L279) | function | `scripts/lib/model-resolver.mjs` | 279-289 | Compares two parsed model versions, preferring newer major/minor, GA over preview, and rolling aliases over dated snapshots. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`deprecatedRemap`](../scripts/lib/model-resolver.mjs#L334) | function | `scripts/lib/model-resolver.mjs` | 334-349 | Remaps deprecated model IDs to their current replacements, logging a warning unless silenced. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`describeModel`](../scripts/lib/model-resolver.mjs#L257) | function | `scripts/lib/model-resolver.mjs` | 257-275 | Extracts provider, family, tier, and concrete model name from any model ID, returning null if unparseable. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`fetchAnthropicModels`](../scripts/lib/model-resolver.mjs#L438) | function | `scripts/lib/model-resolver.mjs` | 438-445 | Fetches Anthropic's model list from their `/v1/models` API endpoint. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`fetchGoogleModels`](../scripts/lib/model-resolver.mjs#L426) | function | `scripts/lib/model-resolver.mjs` | 426-436 | Fetches Google's model list from their generativelanguage API, stripping the `models/` prefix. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`fetchOpenAIModels`](../scripts/lib/model-resolver.mjs#L417) | function | `scripts/lib/model-resolver.mjs` | 417-424 | Fetches OpenAI's model list from their `/v1/models` API endpoint. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`fetchWithTimeout`](../scripts/lib/model-resolver.mjs#L404) | function | `scripts/lib/model-resolver.mjs` | 404-415 | Fetches an HTTP response with a timeout abort signal, returning the response or throwing on error. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`getLiveCatalog`](../scripts/lib/model-resolver.mjs#L393) | function | `scripts/lib/model-resolver.mjs` | 393-398 | Returns the cached live catalog IDs for a provider if fresh, else empty. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`isSentinel`](../scripts/lib/model-resolver.mjs#L97) | function | `scripts/lib/model-resolver.mjs` | 97-99 | Checks whether a model ID is a sentinel (a placeholder that resolves to a concrete model). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`logicalFromParsed`](../scripts/lib/model-resolver.mjs#L199) | function | `scripts/lib/model-resolver.mjs` | 199-205 | Maps a parsed model object to a logical tier category (economy, standard, unknown). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`mergedPool`](../scripts/lib/model-resolver.mjs#L357) | function | `scripts/lib/model-resolver.mjs` | 357-363 | Merges live (cached) and static model pools for a provider, removing duplicates. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`parseAnyModel`](../scripts/lib/model-resolver.mjs#L195) | function | `scripts/lib/model-resolver.mjs` | 195-197 | Attempts to parse a model ID as Claude, Gemini, or OpenAI, returning the first match or null. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`parseClaudeModel`](../scripts/lib/model-resolver.mjs#L104) | function | `scripts/lib/model-resolver.mjs` | 104-117 | Parses Claude model IDs into structured components (provider, family, tier, version, date, preview status). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`parseGeminiModel`](../scripts/lib/model-resolver.mjs#L120) | function | `scripts/lib/model-resolver.mjs` | 120-152 | Parses Gemini model IDs into structured components, handling both versioned and alias forms like `gemini-pro-latest`. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`parseOpenAIModel`](../scripts/lib/model-resolver.mjs#L155) | function | `scripts/lib/model-resolver.mjs` | 155-172 | Parses OpenAI model IDs into structured components (family, major/minor version, variant, lite/preview flags). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`pickNewestClaude`](../scripts/lib/model-resolver.mjs#L302) | function | `scripts/lib/model-resolver.mjs` | 302-308 | Selects the newest Claude model matching a tier from a pool by version comparison. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`pickNewestGemini`](../scripts/lib/model-resolver.mjs#L291) | function | `scripts/lib/model-resolver.mjs` | 291-300 | Selects the newest Gemini model matching a tier from a pool, with short-circuit for Google's official alias. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`pickNewestOpenAI`](../scripts/lib/model-resolver.mjs#L314) | function | `scripts/lib/model-resolver.mjs` | 314-324 | Selects the newest OpenAI model matching a tier and optional variant from a pool. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`pricingKey`](../scripts/lib/model-resolver.mjs#L548) | function | `scripts/lib/model-resolver.mjs` | 548-556 | Returns a pricing key derived from a model ID's provider, family, tier, and lite status. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`refreshModelCatalog`](../scripts/lib/model-resolver.mjs#L455) | function | `scripts/lib/model-resolver.mjs` | 455-481 | Refreshes live model catalogs from OpenAI, Google, and Anthropic APIs in parallel, falling back gracefully on failure. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`resolveModel`](../scripts/lib/model-resolver.mjs#L495) | function | `scripts/lib/model-resolver.mjs` | 495-527 | Resolves a sentinel model ID to a concrete model by querying live and static pools in priority order. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`sentinelForTier`](../scripts/lib/model-resolver.mjs#L240) | function | `scripts/lib/model-resolver.mjs` | 240-248 | Returns a sentinel model ID for a given logical tier and provider, or null if unsupported. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`setCatalog`](../scripts/lib/model-resolver.mjs#L371) | function | `scripts/lib/model-resolver.mjs` | 371-376 | Updates the live model catalog cache for a provider if the ID array is valid. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`supportsReasoningEffort`](../scripts/lib/model-resolver.mjs#L535) | function | `scripts/lib/model-resolver.mjs` | 535-542 | Checks whether a model ID is a reasoning model (o-series or gpt-5+). | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
| [`tierForModel`](../scripts/lib/model-resolver.mjs#L212) | function | `scripts/lib/model-resolver.mjs` | 212-233 | Determines the tier classification (economy, standard, unknown) for any model ID, with deprecated remapping and fallback parsing. | `scripts/brainstorm-round.mjs`, `scripts/check-model-freshness.mjs`, `scripts/gemini-review.mjs`, +10 more |
...
| [`azureBaseUrl`](../scripts/lib/openai-client.mjs#L69) | function | `scripts/lib/openai-client.mjs` | 69-79 | Constructs the base URL for OpenAI or Azure API calls based on the deployment purpose and configuration. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/embed-text.mjs`, +1 more |
| [`createOpenAIClient`](../scripts/lib/openai-client.mjs#L91) | function | `scripts/lib/openai-client.mjs` | 91-132 | Creates or retrieves a cached OpenAI client instance, using Azure or standard OpenAI credentials and endpoint configuration. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/embed-text.mjs`, +1 more |
| [`keyDigest`](../scripts/lib/openai-client.mjs#L60) | function | `scripts/lib/openai-client.mjs` | 60-62 | Hashes a string key to a 16-character SHA256 hex digest for use as a cache identifier. | `scripts/azure-limits.mjs`, `scripts/gemini-review.mjs`, `scripts/lib/embed-text.mjs`, +1 more |
...
| [`canonicaliseRemoteUrl`](../scripts/lib/repo-identity.mjs#L61) | function | `scripts/lib/repo-identity.mjs` | 61-78 | Normalizes a Git remote URL (SSH or HTTPS) to a lowercase "host/path" canonical form. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`deriveName`](../scripts/lib/repo-identity.mjs#L108) | function | `scripts/lib/repo-identity.mjs` | 108-116 | Extracts a repository name from its canonical remote URL or falls back to directory basename. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`gitOriginUrl`](../scripts/lib/repo-identity.mjs#L80) | function | `scripts/lib/repo-identity.mjs` | 80-89 | Retrieves the git remote origin URL for a repository directory. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`gitTopLevel`](../scripts/lib/repo-identity.mjs#L91) | function | `scripts/lib/repo-identity.mjs` | 91-100 | Retrieves the top-level directory path of a git repository. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`persistRepoIdentity`](../scripts/lib/repo-identity.mjs#L171) | function | `scripts/lib/repo-identity.mjs` | 171-179 | Persists a repository UUID to a committed file in the git repository. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`resolveRepoIdentity`](../scripts/lib/repo-identity.mjs#L122) | function | `scripts/lib/repo-identity.mjs` | 122-162 | Resolves a repository's unique identity from git origin, committed file, or path fallback. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
| [`uuidv5`](../scripts/lib/repo-identity.mjs#L37) | function | `scripts/lib/repo-identity.mjs` | 37-48 | Generates a UUID v5 from a namespace UUID and name using SHA1 hashing per RFC 4122. | `scripts/cross-skill.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/store/repo.mjs`, +6 more |
...
| [`backfillPrimaryFile`](../scripts/lib/sanitizer.mjs#L75) | function | `scripts/lib/sanitizer.mjs` | 75-85 | Backfills the primaryFile field in outcomes using evaluation records with matching semantic hashes. | `scripts/evolve-prompts.mjs`, `scripts/lib/anthropic-client.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +3 more |
| [`recencyBucket`](../scripts/lib/sanitizer.mjs#L31) | function | `scripts/lib/sanitizer.mjs` | 31-37 | Categorizes a timestamp as "recent" (< 7 days), "mid" (< 30 days), or "old". | `scripts/evolve-prompts.mjs`, `scripts/lib/anthropic-client.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +3 more |
| [`redactSecrets`](../scripts/lib/sanitizer.mjs#L58) | function | `scripts/lib/sanitizer.mjs` | 58-67 | Redacts API keys, tokens, secrets, passwords, and private key blocks from text. | `scripts/evolve-prompts.mjs`, `scripts/lib/anthropic-client.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +3 more |
| [`sanitizeOutcomes`](../scripts/lib/sanitizer.mjs#L95) | function | `scripts/lib/sanitizer.mjs` | 95-134 | Filters and sanitizes outcomes by removing sensitive files, redacting secrets, and validating against schema. | `scripts/evolve-prompts.mjs`, `scripts/lib/anthropic-client.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +3 more |
| [`sanitizePath`](../scripts/lib/sanitizer.mjs#L42) | function | `scripts/lib/sanitizer.mjs` | 42-46 | Extracts the last two path segments (or one if shorter) from a file path for display. | `scripts/evolve-prompts.mjs`, `scripts/lib/anthropic-client.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, +3 more |
...
| [`redactFields`](../scripts/lib/secret-patterns.mjs#L111) | function | `scripts/lib/secret-patterns.mjs` | 111-124 | Redacts specified object fields containing secrets and returns the modified object and matches. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +11 more |
| [`redactSecrets`](../scripts/lib/secret-patterns.mjs#L80) | function | `scripts/lib/secret-patterns.mjs` | 80-103 | Redacts secret patterns in text with placeholder labels, preserving context or capturing groups. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +11 more |
| [`scanForSecrets`](../scripts/lib/secret-patterns.mjs#L54) | function | `scripts/lib/secret-patterns.mjs` | 54-67 | Scans text for secret patterns and returns matched pattern names without modifying the text. | `scripts/brainstorm-round.mjs`, `scripts/learning/backfill-outcomes.mjs`, `scripts/lib/brainstorm/resume-context.mjs`, +11 more |
...
| [`_resetDebugBanner`](../scripts/lib/sensitive-paths.mjs#L426) | function | `scripts/lib/sensitive-paths.mjs` | 426-428 | Resets the debug banner warning flag to allow it to display again on next run. | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +5 more |
...
| [`defaultHash`](../scripts/lib/sensitive-paths.mjs#L365) | function | `scripts/lib/sensitive-paths.mjs` | 365-367 | Generates an 8-character SHA256 hash of the input string for path obfuscation. | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +5 more |
| [`emptyDiff`](../scripts/lib/sensitive-paths.mjs#L275) | function | `scripts/lib/sensitive-paths.mjs` | 275-277 | Returns an empty diff structure with all action arrays initialized. | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +5 more |
| [`filterDiffFiles`](../scripts/lib/sensitive-paths.mjs#L291) | function | `scripts/lib/sensitive-paths.mjs` | 291-356 | <no body> | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +5 more |
...
| [`resolveAndClassify`](../scripts/lib/sensitive-paths.mjs#L179) | function | `scripts/lib/sensitive-paths.mjs` | 179-245 | <no body> | `scripts/lib/audit-scope.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, `scripts/lib/learning/author-tier-observation.mjs`, +5 more |
...
| [`buildCopilotPromptFiles`](../scripts/lib/sync-inventory.mjs#L158) | function | `scripts/lib/sync-inventory.mjs` | 158-166 | Lists generated Copilot prompt markdown files. | `scripts/check-isolation-inventory.mjs` |
| [`buildFileUniverse`](../scripts/lib/sync-inventory.mjs#L183) | function | `scripts/lib/sync-inventory.mjs` | 183-200 | Recursively walks scripts and .claude directories to build a file universe. | `scripts/check-isolation-inventory.mjs` |
| [`buildSkillFiles`](../scripts/lib/sync-inventory.mjs#L144) | function | `scripts/lib/sync-inventory.mjs` | 144-156 | Enumerates skill files for Claude and GitHub skill directories. | `scripts/check-isolation-inventory.mjs` |
| [`bundleForRepo`](../scripts/lib/sync-inventory.mjs#L222) | function | `scripts/lib/sync-inventory.mjs` | 222-234 | Assembles a complete file bundle for a given repository by combining core entries, learning materials, architecture files, skill files, prompts, and editor configs. | `scripts/check-isolation-inventory.mjs` |
| [`getAllConsumerInventories`](../scripts/lib/sync-inventory.mjs#L256) | function | `scripts/lib/sync-inventory.mjs` | 256-263 | Generates inventories for all known consumer repositories and returns them as a map keyed by alias. | `scripts/check-isolation-inventory.mjs` |
| [`getFileUniverse`](../scripts/lib/sync-inventory.mjs#L203) | function | `scripts/lib/sync-inventory.mjs` | 203-206 | Caches and returns the file universe set. | `scripts/check-isolation-inventory.mjs` |
| [`getSyncInventoryForRepo`](../scripts/lib/sync-inventory.mjs#L243) | function | `scripts/lib/sync-inventory.mjs` | 243-248 | Looks up a consumer repository by alias or name, validates it exists, and returns its bundled files with metadata. | `scripts/check-isolation-inventory.mjs` |
| [`readSource`](../scripts/lib/sync-inventory.mjs#L208) | function | `scripts/lib/sync-inventory.mjs` | 208-211 | Reads a source file from disk relative to repo root, returning its UTF-8 content or null on failure. | `scripts/check-isolation-inventory.mjs` |
| [`resolveBundle`](../scripts/lib/sync-inventory.mjs#L213) | function | `scripts/lib/sync-inventory.mjs` | 213-220 | Resolves entry points and assets into a complete bundle of files using a module resolver, returning both resolved files and unresolved dependencies. | `scripts/check-isolation-inventory.mjs` |
| [`syncMigrations`](../scripts/lib/sync-inventory.mjs#L132) | function | `scripts/lib/sync-inventory.mjs` | 132-142 | Lists SQL migration files in the supabase directory. | `scripts/check-isolation-inventory.mjs` |
| [`formatText`](../scripts/lib/sync-isolation-verify.mjs#L474) | function | `scripts/lib/sync-isolation-verify.mjs` | 474-487 | Formats gate results as human-readable text with checkmarks for passes and error messages for failures, returning both the text and an overall pass/fail status. | _(internal)_ |
| [`gate1`](../scripts/lib/sync-isolation-verify.mjs#L418) | function | `scripts/lib/sync-isolation-verify.mjs` | 418-433 | Reports uncommitted Git changes to stderr as advisory information without blocking, allowing the operator to decide on approval. | _(internal)_ |
| [`gate2A`](../scripts/lib/sync-isolation-verify.mjs#L157) | function | `scripts/lib/sync-isolation-verify.mjs` | 157-218 | <no body> | _(internal)_ |
| [`gate2B`](../scripts/lib/sync-isolation-verify.mjs#L220) | function | `scripts/lib/sync-isolation-verify.mjs` | 220-251 | Validates that all files recorded in the manifest exist on disk and have matching SHA-256 hashes, excluding the manifest file itself. | _(internal)_ |
| [`gate3`](../scripts/lib/sync-isolation-verify.mjs#L253) | function | `scripts/lib/sync-isolation-verify.mjs` | 253-278 | Detects stale ownership-confirmed source paths in command-bearing files by comparing invocations against the manifest's owned source tails. | _(internal)_ |
| [`gate4`](../scripts/lib/sync-isolation-verify.mjs#L280) | function | `scripts/lib/sync-isolation-verify.mjs` | 280-344 | <no body> | _(internal)_ |
| [`gate5`](../scripts/lib/sync-isolation-verify.mjs#L346) | function | `scripts/lib/sync-isolation-verify.mjs` | 346-390 | <no body> | _(internal)_ |
| [`gate6`](../scripts/lib/sync-isolation-verify.mjs#L392) | function | `scripts/lib/sync-isolation-verify.mjs` | 392-399 | Validates that the manifest's layout field is set to 'isolated', failing if it's missing or has a different value. | _(internal)_ |
| [`gate7`](../scripts/lib/sync-isolation-verify.mjs#L401) | function | `scripts/lib/sync-isolation-verify.mjs` | 401-416 | Checks that the .gitignore file exists and contains exactly one well-formed managed block with valid begin/end markers in correct order. | _(internal)_ |
| [`hashFile`](../scripts/lib/sync-isolation-verify.mjs#L77) | function | `scripts/lib/sync-isolation-verify.mjs` | 77-80 | Computes the SHA-256 hash of a file's contents and returns it prefixed with 'sha256:'. | _(internal)_ |
| [`listCommandBearingFiles`](../scripts/lib/sync-isolation-verify.mjs#L139) | function | `scripts/lib/sync-isolation-verify.mjs` | 139-149 | Collects all files under designated scan paths in the consumer root by checking existence and recursively walking directories. | _(internal)_ |
| [`loadConsumerManifest`](../scripts/lib/sync-isolation-verify.mjs#L102) | function | `scripts/lib/sync-isolation-verify.mjs` | 102-121 | Reads and validates the sync manifest from disk against a schema, returning structured errors for missing, unparseable, or malformed manifests. | _(internal)_ |
| [`main`](../scripts/lib/sync-isolation-verify.mjs#L489) | function | `scripts/lib/sync-isolation-verify.mjs` | 489-515 | Parses arguments, runs gates, formats output as JSON or text, and exits with a code corresponding to the first failed gate or 0 on success. | _(internal)_ |
| [`parseArgs`](../scripts/lib/sync-isolation-verify.mjs#L82) | function | `scripts/lib/sync-isolation-verify.mjs` | 82-100 | Parses command-line arguments into an options object with defaults for consumer root, manifest path, gates, output format, and self-check flags. | _(internal)_ |
| [`relativize`](../scripts/lib/sync-isolation-verify.mjs#L151) | function | `scripts/lib/sync-isolation-verify.mjs` | 151-153 | Converts an absolute file path to a forward-slash-delimited relative path from the consumer root. | _(internal)_ |
| [`runGates`](../scripts/lib/sync-isolation-verify.mjs#L437) | function | `scripts/lib/sync-isolation-verify.mjs` | 437-464 | Executes all requested gates in sequence, handling preflight manifest validation and catching exceptions per gate, returning results for each. | _(internal)_ |
| [`selfcheckInventoryNotAvailable`](../scripts/lib/sync-isolation-verify.mjs#L466) | function | `scripts/lib/sync-isolation-verify.mjs` | 466-472 | <no body> | _(internal)_ |
| [`walkDir`](../scripts/lib/sync-isolation-verify.mjs#L123) | function | `scripts/lib/sync-isolation-verify.mjs` | 123-137 | Recursively walks a directory tree yielding absolute paths to all files using a depth-first stack-based approach. | _(internal)_ |
...
> The `stores` domain persists architectural analysis data to a cloud database, including domain summaries with symbol composition, import dependency graphs across file refreshes, and symbol similarity queries for codebase understanding.
...
| [`getPersonaSessionsByRepo`](../scripts/lib/store/persona.mjs#L156) | function | `scripts/lib/store/persona.mjs` | 156-183 | Queries persona sessions for a repo optionally filtered to P0-only results. | `scripts/learning-store.mjs` |
| [`getPersonaSessionsByUrl`](../scripts/lib/store/persona.mjs#L189) | function | `scripts/lib/store/persona.mjs` | 189-207 | Queries persona sessions by URL ordered by creation date. | `scripts/learning-store.mjs` |
| [`isPersonaCloudEnabled`](../scripts/lib/store/persona.mjs#L26) | function | `scripts/lib/store/persona.mjs` | 26-28 | Checks if cloud persona storage is enabled. | `scripts/learning-store.mjs` |
| [`listPersonasForApp`](../scripts/lib/store/persona.mjs#L35) | function | `scripts/lib/store/persona.mjs` | 35-46 | Lists all personas associated with a given app URL. | `scripts/learning-store.mjs` |
| [`recordPersonaSession`](../scripts/lib/store/persona.mjs#L91) | function | `scripts/lib/store/persona.mjs` | 91-149 | Upserts a persona browser session with findings and metrics. | `scripts/learning-store.mjs` |
| [`upsertPersona`](../scripts/lib/store/persona.mjs#L55) | function | `scripts/lib/store/persona.mjs` | 55-83 | Inserts or updates a persona with name, description, and app details. | `scripts/learning-store.mjs` |
| [`getUnlockedFixes`](../scripts/lib/store/plans-ship.mjs#L240) | function | `scripts/lib/store/plans-ship.mjs` | 240-254 | Retrieves up to 20 unlocked fixes globally or for a specific repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`listConsistencyCandidates`](../scripts/lib/store/plans-ship.mjs#L142) | function | `scripts/lib/store/plans-ship.mjs` | 142-173 | Queries candidate regression specs for a repo optionally filtered by timestamp. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`promoteRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L180) | function | `scripts/lib/store/plans-ship.mjs` | 180-216 | Promotes a candidate regression spec to locked spec kind with path and promoter info. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readAuditEffectiveness`](../scripts/lib/store/plans-ship.mjs#L304) | function | `scripts/lib/store/plans-ship.mjs` | 304-312 | Retrieves audit effectiveness metrics for a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readCorrelationsForFinding`](../scripts/lib/store/plans-ship.mjs#L293) | function | `scripts/lib/store/plans-ship.mjs` | 293-301 | Queries correlations by audit finding ID. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readCorrelationsForRun`](../scripts/lib/store/plans-ship.mjs#L282) | function | `scripts/lib/store/plans-ship.mjs` | 282-290 | Queries correlations by audit run ID. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readPersistentPlanFailures`](../scripts/lib/store/plans-ship.mjs#L393) | function | `scripts/lib/store/plans-ship.mjs` | 393-401 | Queries plan run results for a specific plan. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readPlanSatisfaction`](../scripts/lib/store/plans-ship.mjs#L382) | function | `scripts/lib/store/plans-ship.mjs` | 382-390 | Retrieves plan satisfaction metrics for a specific plan. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`readShipEvents`](../scripts/lib/store/plans-ship.mjs#L440) | function | `scripts/lib/store/plans-ship.mjs` | 440-458 | Reads aggregated ship events by outcome and recent ship attempts for a repo. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPersonaAuditCorrelation`](../scripts/lib/store/plans-ship.mjs#L262) | function | `scripts/lib/store/plans-ship.mjs` | 262-279 | Inserts or updates a correlation record linking persona findings to audit findings. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPlanVerificationItems`](../scripts/lib/store/plans-ship.mjs#L342) | function | `scripts/lib/store/plans-ship.mjs` | 342-379 | Batch-inserts criterion results for a plan verification run. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordPlanVerificationRun`](../scripts/lib/store/plans-ship.mjs#L319) | function | `scripts/lib/store/plans-ship.mjs` | 319-339 | Inserts a plan verification run with criteria counts and pass/fail/skip tallies. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordRegressionSpec`](../scripts/lib/store/plans-ship.mjs#L69) | function | `scripts/lib/store/plans-ship.mjs` | 69-137 | <no body> | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordRegressionSpecRun`](../scripts/lib/store/plans-ship.mjs#L219) | function | `scripts/lib/store/plans-ship.mjs` | 219-234 | Records a regression spec test run result (passed, captured regression, errors). | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`recordShipEvent`](../scripts/lib/store/plans-ship.mjs#L408) | function | `scripts/lib/store/plans-ship.mjs` | 408-429 | Records a ship (deployment) event with outcome, blockers, and P0/P1 counts. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`updatePlanStatus`](../scripts/lib/store/plans-ship.mjs#L45) | function | `scripts/lib/store/plans-ship.mjs` | 45-55 | Updates a plan's status field to draft, in-progress, or completed. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
| [`upsertPlan`](../scripts/lib/store/plans-ship.mjs#L22) | function | `scripts/lib/store/plans-ship.mjs` | 22-42 | Inserts or updates a plan record with path, skill, and metadata. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs` |
...
| [`getRepoIdByName`](../scripts/lib/store/repo.mjs#L298) | function | `scripts/lib/store/repo.mjs` | 298-313 | Retrieves the most recently created audit_repos row matching a repository name. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`getRepoIdByUuid`](../scripts/lib/store/repo.mjs#L214) | function | `scripts/lib/store/repo.mjs` | 214-243 | Looks up a repository by UUID, returning id, name, and refresh metadata; optionally strict on errors. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`initLearningStore`](../scripts/lib/store/repo.mjs#L41) | function | `scripts/lib/store/repo.mjs` | 41-67 | Initializes the cloud learning store with connectivity probe, returning success/failure and diagnostic messages. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`isCloudEnabled`](../scripts/lib/store/repo.mjs#L76) | function | `scripts/lib/store/repo.mjs` | 76-83 | Checks whether cloud storage is enabled by attempting to acquire a database pool. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`listRepoIds`](../scripts/lib/store/repo.mjs#L323) | function | `scripts/lib/store/repo.mjs` | 323-332 | Lists all repository IDs from the audit_repos table. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`resolveRepoForStore`](../scripts/lib/store/repo.mjs#L142) | function | `scripts/lib/store/repo.mjs` | 142-203 | Resolves or creates a repository row in the audit_repos table, updating profile data and tracking last-audited time. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`upsertRepo`](../scripts/lib/store/repo.mjs#L108) | function | `scripts/lib/store/repo.mjs` | 108-116 | Upserts a repository record, delegating to the stable repo_uuid resolver and ignoring legacy fingerprint logic. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
| [`upsertRepoByUuid`](../scripts/lib/store/repo.mjs#L253) | function | `scripts/lib/store/repo.mjs` | 253-285 | Upserts a repository by UUID, handling race conditions with partial unique indexing on repo_uuid. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs`, `scripts/lib/dashboard/collect-telemetry.mjs`, +15 more |
...
| [`_resetPassStatsRoundColumnCache`](../scripts/lib/store/runs-findings.mjs#L103) | function | `scripts/lib/store/runs-findings.mjs` | 103-105 | <no body> | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`adjudicateFinalReviewFinding`](../scripts/lib/store/runs-findings.mjs#L434) | function | `scripts/lib/store/runs-findings.mjs` | 434-455 | Marks shadow-only findings as accepted or dismissed in the cloud database if the bucket column exists. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`auditRunExists`](../scripts/lib/store/runs-findings.mjs#L465) | function | `scripts/lib/store/runs-findings.mjs` | 465-473 | Checks whether an audit run record exists in the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`columnExists`](../scripts/lib/store/runs-findings.mjs#L760) | function | `scripts/lib/store/runs-findings.mjs` | 760-784 | Checks if a database column exists with caching to avoid repeated failed queries. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`detectClassificationColumns`](../scripts/lib/store/runs-findings.mjs#L81) | function | `scripts/lib/store/runs-findings.mjs` | 81-93 | Checks if the cloud database has sonar classification columns, caching the result after definitive probe. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`detectPassStatsRoundColumn`](../scripts/lib/store/runs-findings.mjs#L107) | function | `scripts/lib/store/runs-findings.mjs` | 107-119 | Checks if the cloud database has the audit_pass_stats.round column, caching the result after definitive probe. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getAuditRunConvergence`](../scripts/lib/store/runs-findings.mjs#L683) | function | `scripts/lib/store/runs-findings.mjs` | 683-700 | Fetches run metadata including convergence round and rigor pressure round information. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getFinalReviewStats`](../scripts/lib/store/runs-findings.mjs#L523) | function | `scripts/lib/store/runs-findings.mjs` | 523-572 | Queries the cloud database for final-review findings grouped by source model and bucket, and retrieves the shadow-only adjudication queue. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getPassTimings`](../scripts/lib/store/runs-findings.mjs#L706) | function | `scripts/lib/store/runs-findings.mjs` | 706-734 | Calculates average token usage and latency metrics per audit pass across all runs. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRecentFindingsByRepo`](../scripts/lib/store/runs-findings.mjs#L859) | function | `scripts/lib/store/runs-findings.mjs` | 859-896 | Fetches recent high/medium severity findings for a specific repository within a limit. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunFindingOutcomeCounts`](../scripts/lib/store/runs-findings.mjs#L662) | function | `scripts/lib/store/runs-findings.mjs` | 662-681 | Retrieves aggregate finding counts and adjudication status for a specific run. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunFindings`](../scripts/lib/store/runs-findings.mjs#L805) | function | `scripts/lib/store/runs-findings.mjs` | 805-837 | Retrieves all audit findings for a run with optional adjudication and remediation state. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`getRunMeta`](../scripts/lib/store/runs-findings.mjs#L914) | function | `scripts/lib/store/runs-findings.mjs` | 914-940 | Retrieves comprehensive metadata for a run including plan file, mode, rounds, and optional columns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`isUndefinedColumnError`](../scripts/lib/store/runs-findings.mjs#L38) | function | `scripts/lib/store/runs-findings.mjs` | 38-46 | Detects authoritative database errors (missing column/table) versus transient failures. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`markRunFindingsNeedsTriage`](../scripts/lib/store/runs-findings.mjs#L486) | function | `scripts/lib/store/runs-findings.mjs` | 486-507 | Resets findings to needs_triage status for specified fingerprints in a run if they have no user action and meet criteria. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`normaliseBucket`](../scripts/lib/store/runs-findings.mjs#L286) | function | `scripts/lib/store/runs-findings.mjs` | 286-291 | Validates a finding bucket value against allowed domain; returns null if invalid. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`probeColumn`](../scripts/lib/store/runs-findings.mjs#L66) | function | `scripts/lib/store/runs-findings.mjs` | 66-79 | Probes whether a SQL column exists by attempting to query it, retrying once on transient errors. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordAdjudicationEvent`](../scripts/lib/store/runs-findings.mjs#L999) | function | `scripts/lib/store/runs-findings.mjs` | 999-1037 | Updates a finding's adjudication outcome, remediation state, and ruling in the database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordFinalReviewFindings`](../scripts/lib/store/runs-findings.mjs#L389) | function | `scripts/lib/store/runs-findings.mjs` | 389-419 | Records final-review findings (primary and shadow) by replacing prior final-review rows and updating run metadata with model attribution and costs. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordFindings`](../scripts/lib/store/runs-findings.mjs#L307) | function | `scripts/lib/store/runs-findings.mjs` | 307-363 | Records audit findings in the cloud database with optional classification and source-model fields, writing only columns that exist. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordPassStats`](../scripts/lib/store/runs-findings.mjs#L584) | function | `scripts/lib/store/runs-findings.mjs` | 584-605 | Records pass-level statistics (findings raised/accepted/dismissed, tokens, latency) to the cloud database with optional per-round tracking. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordRunComplete`](../scripts/lib/store/runs-findings.mjs#L200) | function | `scripts/lib/store/runs-findings.mjs` | 200-234 | Updates an audit run's completion statistics (rounds, findings, costs, durations, tokens) in the cloud database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordRunStart`](../scripts/lib/store/runs-findings.mjs#L127) | function | `scripts/lib/store/runs-findings.mjs` | 127-194 | Records an audit run's start metadata in the cloud database, reusing an existing row if runId matches and repo_id aligns. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`recordSuppressionEvents`](../scripts/lib/store/runs-findings.mjs#L947) | function | `scripts/lib/store/runs-findings.mjs` | 947-986 | Records suppression and reopened finding events into the database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`updatePassStatsPostDeliberation`](../scripts/lib/store/runs-findings.mjs#L611) | function | `scripts/lib/store/runs-findings.mjs` | 611-642 | Updates audit pass statistics with findings counts to the latest round in the database. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
| [`updateRunMeta`](../scripts/lib/store/runs-findings.mjs#L240) | function | `scripts/lib/store/runs-findings.mjs` | 240-278 | Updates audit run metadata fields (skip reason, verdict, model attribution, shadow costs) with column-existence guards. | `scripts/learning-store.mjs`, `scripts/lib/dashboard/collect-audit-run.mjs` |
...
| [`appendEvents`](../scripts/lib/debt-memory.mjs#L116) | function | `scripts/lib/debt-memory.mjs` | 116-129 | Appends debt events to cloud and/or local storage based on the active event source and write permissions. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
| [`loadDebtLedger`](../scripts/lib/debt-memory.mjs#L86) | function | `scripts/lib/debt-memory.mjs` | 86-103 | Loads debt ledger entries from cloud or local storage depending on the configured event source. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
| [`persistDebtEntries`](../scripts/lib/debt-memory.mjs#L143) | function | `scripts/lib/debt-memory.mjs` | 143-157 | Persists debt entries to local JSON first, then mirrors to cloud if active, returning insertion/update counts. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
| [`reconcileLocalToCloud`](../scripts/lib/debt-memory.mjs#L192) | function | `scripts/lib/debt-memory.mjs` | 192-229 | Reconciles unsynced local debt events to cloud by finding the last reconciliation marker, syncing new events, and recording reconciliation completion. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
| [`removeDebt`](../scripts/lib/debt-memory.mjs#L162) | function | `scripts/lib/debt-memory.mjs` | 162-171 | Removes a debt entry from both local and cloud storage, returning success flags for each. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
| [`selectEventSource`](../scripts/lib/debt-memory.mjs#L59) | function | `scripts/lib/debt-memory.mjs` | 59-73 | Determines the debt event source (cloud, local, or disabled) based on flags and repo credentials, logging the decision. | `scripts/debt-resolve.mjs`, `scripts/openai-audit.mjs`, `scripts/shared.mjs` |
...
> The `tests` domain provides utility functions and fixtures for creating temporary file structures, directories, and test data—such as markdown documents, SQL parsers, and domain-map repositories—to support integration and unit testing across the codebase.
...
_Domain has 295 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._
...
| [`syntheticSurface`](../tests/build-surfaces-manifest.test.mjs#L35) | function | `tests/build-surfaces-manifest.test.mjs` | 35-49 | Constructs a synthetic surface object with ID, locator, severity floor, and enum field configuration for testing. | _(internal)_ |
...
| [`stubResolve`](../tests/gemini-review-shadow.test.mjs#L8) | function | `tests/gemini-review-shadow.test.mjs` | 8-11 | Maps sentinel model identifiers (like 'latest-opus') to their resolved canonical model names. | _(internal)_ |
...
| [`collectStream`](../tests/setup-postgres-check-drift.test.mjs#L57) | function | `tests/setup-postgres-check-drift.test.mjs` | 57-67 | Creates a writable stream that collects chunks into a text buffer for assertion. | _(internal)_ |
| [`mkdtemp`](../tests/setup-postgres-check-drift.test.mjs#L27) | function | `tests/setup-postgres-check-drift.test.mjs` | 27-29 | Creates and returns a temporary directory path for drift-check testing. | _(internal)_ |
| [`sha256OfString`](../tests/setup-postgres-check-drift.test.mjs#L71) | function | `tests/setup-postgres-check-drift.test.mjs` | 71-74 | Computes the SHA256 hash of a UTF-8 string. | _(internal)_ |
| [`spawnNode`](../tests/setup-postgres-check-drift.test.mjs#L444) | function | `tests/setup-postgres-check-drift.test.mjs` | 444-461 | Spawns a Node.js child process running setup-postgres.mjs with optional database URL stripping and returns status/stdout/stderr. | _(internal)_ |
| [`stubPool`](../tests/setup-postgres-check-drift.test.mjs#L43) | function | `tests/setup-postgres-check-drift.test.mjs` | 43-55 | Returns a stubbed PostgreSQL pool that mocks ledger and migration table queries. | _(internal)_ |
| [`writeMigrations`](../tests/setup-postgres-check-drift.test.mjs#L31) | function | `tests/setup-postgres-check-drift.test.mjs` | 31-35 | Writes migration file objects to disk in a given directory. | _(internal)_ |
...
| [`fakeSpawn`](../tests/ux-lock-run.test.mjs#L44) | function | `tests/ux-lock-run.test.mjs` | 44-51 | Returns a fake spawn function that optionally writes a test report to the playwright output file. | _(internal)_ |
| [`lastJson`](../tests/ux-lock-run.test.mjs#L206) | function | `tests/ux-lock-run.test.mjs` | 206-212 | Parses the last valid JSON line from CLI stdout, skipping banner text. | _(internal)_ |
| [`runCli`](../tests/ux-lock-run.test.mjs#L196) | function | `tests/ux-lock-run.test.mjs` | 196-205 | Executes ux-lock-run.mjs CLI as a child process and returns stdout and status. | _(internal)_ |
...
| [`finding`](../tests/visual-changed-scope.test.mjs#L13) | function | `tests/visual-changed-scope.test.mjs` | 13-13 | Creates a token violation finding object for a given surface and property. | _(internal)_ |
...
> The `visual-audit` domain detects and validates design system changes by analyzing file modifications against a contract that defines token families, surfaces, themes, and contrast rules, using glob matching and WCAG color computations to gate breaking visual changes.
...
_Domain has 83 symbols (>50). Diagram shows top-15 by file order; see flat table below for the full list._

### Symbols in this domain

| Symbol | Kind | Path | Lines | Purpose | File imported by |
|---|---|---|---|---|---|
| [`familyOfFinding`](../scripts/lib/visual/changed-scope.mjs#L22) | function | `scripts/lib/visual/changed-scope.mjs` | 22-34 | Classifies a design finding's property into a token family (colors, spacing, radius, etc.) or returns null if unclassifiable. | `scripts/lib/visual/drift.mjs` |
| [`globMatch`](../scripts/lib/visual/changed-scope.mjs#L75) | function | `scripts/lib/visual/changed-scope.mjs` | 75-86 | Matches a file path against a glob pattern, supporting *, ?, and ** wildcards with glob-to-regex conversion. | `scripts/lib/visual/drift.mjs` |
| [`resolveChangedScope`](../scripts/lib/visual/changed-scope.mjs#L46) | function | `scripts/lib/visual/changed-scope.mjs` | 46-72 | Filters findings to those eligible for gating based on whether changed file globs match surface sources, global styles, or token families. | `scripts/lib/visual/drift.mjs` |
...
| [`ageDivergences`](../scripts/lib/visual/drift.mjs#L43) | function | `scripts/lib/visual/drift.mjs` | 43-51 | Annotates each finding with its first-seen date and age in days based on historical capture records. | `scripts/visual-audit.mjs` |
| [`divergenceKey`](../scripts/lib/visual/drift.mjs#L12) | function | `scripts/lib/visual/drift.mjs` | 12-14 | Generates a stable deduplication key for a finding based on class, surface, node, and property. | `scripts/visual-audit.mjs` |
| [`firstSeenFromHistory`](../scripts/lib/visual/drift.mjs#L54) | function | `scripts/lib/visual/drift.mjs` | 54-64 | Builds a lookup function that retrieves the first-seen date for a divergence key from history rows. | `scripts/visual-audit.mjs` |
...
| [`scopeToChanged`](../scripts/lib/visual/drift.mjs#L33) | function | `scripts/lib/visual/drift.mjs` | 33-35 | Filters gate-eligible findings against changed file scopes to identify actionable divergences. | `scripts/visual-audit.mjs` |
...
| [`cascadeCompare`](../scripts/lib/visual/provenance-resolver.mjs#L82) | function | `scripts/lib/visual/provenance-resolver.mjs` | 82-90 | Sorts CSS declarations by importance flag, layer order, specificity, and source order to determine cascade winner. | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
| [`compareSpecificity`](../scripts/lib/visual/provenance-resolver.mjs#L93) | function | `scripts/lib/visual/provenance-resolver.mjs` | 93-100 | Compares two CSS specificity tuples [ids, classes, elements] lexicographically in reverse order (higher wins). | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
| [`declarationUsesToken`](../scripts/lib/visual/provenance-resolver.mjs#L60) | function | `scripts/lib/visual/provenance-resolver.mjs` | 60-62 | <no body> | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
| [`expandFor`](../scripts/lib/visual/provenance-resolver.mjs#L65) | function | `scripts/lib/visual/provenance-resolver.mjs` | 65-79 | Expands CSS declarations to find all matching longhands for a given property, including shorthand expansions and special border cases. | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
| [`extractVar`](../scripts/lib/visual/provenance-resolver.mjs#L103) | function | `scripts/lib/visual/provenance-resolver.mjs` | 103-106 | Extracts a CSS custom property variable name (e.g., `--color-primary`) from a var() expression. | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
| [`resolveProvenance`](../scripts/lib/visual/provenance-resolver.mjs#L46) | function | `scripts/lib/visual/provenance-resolver.mjs` | 46-52 | Resolves CSS property declarations through cascade rules, returning the winning value, whether it uses a token variable, and the variable name. | `scripts/lib/visual/extract.mjs`, `scripts/lib/visual/reconcile-tokens.mjs`, `scripts/lib/visual/theme-parity.mjs` |
...
| [`arrSort`](../scripts/lib/visual/schema.mjs#L289) | function | `scripts/lib/visual/schema.mjs` | 289-291 | Sorts an array of strings alphabetically, returning empty array if input is not an array. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
| [`computeConfigDigest`](../scripts/lib/visual/schema.mjs#L285) | function | `scripts/lib/visual/schema.mjs` | 285-287 | Hashes a contract digest and adapter version together to create a config fingerprint for change detection. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
| [`computeContractDigest`](../scripts/lib/visual/schema.mjs#L246) | function | `scripts/lib/visual/schema.mjs` | 246-277 | <no body> | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
| [`sha256`](../scripts/lib/visual/schema.mjs#L293) | function | `scripts/lib/visual/schema.mjs` | 293-295 | Generates a SHA-256 hash of a string input. | `scripts/lib/dashboard/collect-visual.mjs`, `scripts/lib/visual/changed-scope.mjs`, `scripts/lib/visual/contract.mjs`, +4 more |
...
| [`borderPaintedTop`](../scripts/lib/visual/theme-parity.mjs#L109) | function | `scripts/lib/visual/theme-parity.mjs` | 109-113 | Checks whether the top border of an element is visually painted by testing style and width. | `scripts/lib/visual/findings.mjs` |
| [`expandGeometry`](../scripts/lib/visual/theme-parity.mjs#L116) | function | `scripts/lib/visual/theme-parity.mjs` | 116-125 | Expands shorthand geometry properties (padding, margin, grid-template) into their longhand components. | `scripts/lib/visual/findings.mjs` |
| [`indexByKey`](../scripts/lib/visual/theme-parity.mjs#L102) | function | `scripts/lib/visual/theme-parity.mjs` | 102-106 | Indexes nodes by their nodeKey into a Map for fast lookup. | `scripts/lib/visual/findings.mjs` |
...
| [`emit`](../scripts/visual-audit.mjs#L191) | function | `scripts/visual-audit.mjs` | 191-195 | Writes audit findings to a file, stdout as JSON, or stdout as human-readable text based on output format arguments. | _(internal)_ |
| [`gitChangedFiles`](../scripts/visual-audit.mjs#L221) | function | `scripts/visual-audit.mjs` | 221-228 | Retrieves the set of files changed between the current HEAD and its merge-base with the origin branch using git. | _(internal)_ |
| [`gitHeadDate`](../scripts/visual-audit.mjs#L233) | function | `scripts/visual-audit.mjs` | 233-235 | Returns the ISO timestamp of the current git HEAD commit. | _(internal)_ |
| [`gitHeadSha`](../scripts/visual-audit.mjs#L230) | function | `scripts/visual-audit.mjs` | 230-232 | Returns the SHA hash of the current git HEAD commit. | _(internal)_ |
| [`main`](../scripts/visual-audit.mjs#L35) | function | `scripts/visual-audit.mjs` | 35-153 | <no body> | _(internal)_ |
| [`parseArgs`](../scripts/visual-audit.mjs#L157) | function | `scripts/visual-audit.mjs` | 157-178 | Parses command-line flags into an options object with defaults for bootstrap, device, theme, timeout, output format, and other audit settings. | _(internal)_ |
| [`readUsageCorpus`](../scripts/visual-audit.mjs#L199) | function | `scripts/visual-audit.mjs` | 199-205 | Reads and concatenates all token source files from the design contract to build a usage corpus. | _(internal)_ |
| [`resolveDevices`](../scripts/visual-audit.mjs#L180) | function | `scripts/visual-audit.mjs` | 180-189 | Converts device preset names into device configuration objects with viewport, scale factor, mobile, touch, and user-agent properties. | _(internal)_ |
| [`tokenSourceFamiliesChanged`](../scripts/visual-audit.mjs#L207) | function | `scripts/visual-audit.mjs` | 207-217 | Identifies which design token families were changed based on a set of modified file paths. | _(internal)_ |
