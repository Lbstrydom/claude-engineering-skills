...
1. **Held gemini-gate scope-fix** (audited in this session, ready to ship): see `docs/completed/gemini-gate-scope-fix-audit-summary.md` once /ship moves it. Includes scripts/gemini-review.mjs + canonical doc + auto-synced mirrors.
