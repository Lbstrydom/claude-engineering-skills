/**
 * @fileoverview FROZEN snapshot of `scripts/learning-store.mjs` for the postgres-parity
 * golden-fixture contract suite (M0 #4).
 *
 * **Do not edit.** This is a verbatim copy at the SHA below, captured BEFORE the
 * M3 rewrite so the contract suite has a stable baseline to compare against.
 * Regenerating requires deliberate manual action; see
 * docs/plans/postgres-parity-contract-matrix.md.
 *
 * Frozen from: scripts/learning-store.mjs
 * Source SHA: 777e1b179f11108002f6b2ca0539f8dccfde8542
 * Captured:   2026-05-20T12:04:17Z
 * Plan:       docs/plans/postgres-parity.md §7 P3 / §9 R2/H1
 */
