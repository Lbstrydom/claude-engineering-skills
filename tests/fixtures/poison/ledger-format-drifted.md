<!-- POISON FIXTURE: a consumer copy of a shared reference, edited away from its canonical
     source in docs/audit/shared-references/. Two files that must stay byte-identical and a
     human editing the one they happened to open is precisely how they drift. -->
---
